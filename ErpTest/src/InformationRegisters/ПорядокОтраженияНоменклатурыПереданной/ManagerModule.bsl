...
// заполняет счет передачи в переработку регистра сведений "ПорядокОтраженияНоменклатурыКонтрагентов".
//
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	
	ДополнительныеПараметры = ОбновлениеИнформационнойБазы.ДополнительныеПараметрыОтметкиОбработки();
	ДополнительныеПараметры.ЭтоНезависимыйРегистрСведений = Истина;
	ДополнительныеПараметры.ПолноеИмяРегистра = "РегистрСведений.ПорядокОтраженияНоменклатурыПереданной";
	...
	|ИЗ
	|	РегистрСведений.ПорядокОтраженияНоменклатурыПереданной КАК Т
	|ГДЕ
	|	Т.СчетУчетаПередачиВПереработку = ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.ПустаяСсылка)";
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|	ДанныеРегистра.СчетУчетаЗатратыНаПриобретение КАК СчетУчетаЗатратыНаПриобретение
	|ИЗ
	|	ВТДанныеПустыхСчетов КАК ДанныеПустыхСчетов
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ПорядокОтраженияНоменклатурыПереданной КАК ДанныеРегистра
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			НаборЗаписей = РегистрыСведений.ПорядокОтраженияНоменклатурыПереданной.СоздатьНаборЗаписей();
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(ОбновлениеИнформационнойБазы.СобытиеЖурналаРегистрации(), УровеньЖурналаРегистрации.Предупреждение,
				Метаданные.РегистрыСведений.ПорядокОтраженияНоменклатурыПереданной, Неопределено, ТекстСообщения);
