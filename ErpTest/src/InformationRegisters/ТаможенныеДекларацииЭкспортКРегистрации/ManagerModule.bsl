...
// Возвращает виды ценностей НДС, при реализации которых оформляется таможенная декларация на экспорт.
// 
// Параметры:
// Возвращаемое значение:
// 	ВидыЦенностей - Массив - Виды ценностей НДС
//
Функция ОтборВидовЦенностейНДС() Экспорт
...
Процедура ОбновитьСостояние(Знач РеализацииЭкспорт) Экспорт
	...
	|		И ДанныеОснованийСчетовФактур.ВидЦенности В (&ВидыЦенностей)
	...
	|		ДанныеОснованийСчетовФактур.Регистратор В (&РеализацииЭкспорт)
	|		И ДанныеОснованийСчетовФактур.ВидЦенности В (&ВидыЦенностей)
	|		И ДанныеОснованийСчетовФактур.НалогообложениеНДС В (&ПродажаНаЭкспорт)) ВложеннаяТаблица
	|	
	|СГРУППИРОВАТЬ ПО
	|	ВложеннаяТаблица.Организация,
	|	ВложеннаяТаблица.РеализацияЭкспорт,
	...
	ВидыЦенностей = ОтборВидовЦенностейНДС();
