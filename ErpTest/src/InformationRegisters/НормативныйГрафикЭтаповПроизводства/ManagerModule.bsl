...
Процедура РассчитатьДлительностьДоЗапуска(Этапы, Зависимости)
	...
	Для каждого Этап Из НайденныеСтроки Цикл
		...
		Циклы.Вставить(Этап.ЭтапПроизводства, 0);
		ЗаполнитьДлительностьРекурсивно(Этапы, Зависимости, Этап, "ДлительностьДоЗапуска", Истина, Циклы);
		Циклы.Удалить(Этап.ЭтапПроизводства);
...
Процедура РассчитатьДлительностьДоВыпуска(Этапы, Зависимости)
	...
	Для каждого Этап Из НайденныеСтроки Цикл
		...
		Циклы.Вставить(Этап.ЭтапПроизводства, 0);
		ЗаполнитьДлительностьРекурсивно(Этапы, Зависимости, Этап, "ДлительностьДоВыпуска", Ложь, Циклы);
		Циклы.Удалить(Этап.ЭтапПроизводства);
...
Процедура ЗаполнитьДлительностьРекурсивно(Этапы, Зависимости, ЭтапРодитель, ИмяКолонки, ОбходКОкончанию, Циклы)
	...
	Для каждого Этап Из ПоследующиеЭтапы Цикл
		...
		Если Длительность > Этап[ИмяКолонки] Тогда
			...
			Если Циклы.Получить(Этап.ЭтапПроизводства) = Неопределено Тогда
				
				Циклы.Вставить(Этап.ЭтапПроизводства, 0);
				ЗаполнитьДлительностьРекурсивно(Этапы, Зависимости, Этап, ИмяКолонки, ОбходКОкончанию, Циклы);
				Циклы.Удалить(Этап.ЭтапПроизводства);
				
			Иначе
				
				ВызватьИсключение СтрШаблон(
					НСтр("ru = 'В процессе расчета нормативного графика обнаружено зацикливание на этапе ""%1"".'"),
					ЭтапРодитель.ЭтапПроизводства);
