...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ПоступлениеОтПереработчикаВозвратныеОтходы.Номенклатура,
	|	ПоступлениеОтПереработчикаВозвратныеОтходы.Характеристика,
	|	ПоступлениеОтПереработчикаВозвратныеОтходы.Склад
	|ИЗ
...
Процедура ЗарегистрироватьКОбработкеПриОбновленииИБ(ПолноеИмяРегистра, Параметры) Экспорт
	...
	//-- НЕ УТ
	//++ НЕ УТКА
	Регистраторы.Добавить(Документы.ВыпускПродукции);
	Регистраторы.Добавить(Документы.ПоступлениеСырьяОтДавальца);
	//-- НЕ УТКА
	...
	//-- НЕ УТ
	//++ НЕ УТКА
	Распоряжения.Добавить(Документы.ЗаказНаПроизводство);
	Распоряжения.Добавить(Документы.ВыпускПродукции);
	Распоряжения.Добавить(Документы.ЗаказДавальца);
	Распоряжения.Добавить(Документы.ПоступлениеСырьяОтДавальца);
	//-- НЕ УТКА
	...
	Если ПолноеИмяРегистра = "РегистрНакопления.ГрафикОтгрузкиТоваров" Тогда
		...
		//-- НЕ УТ
		//++ НЕ УТКА
		РегистраторыСРаспоряжением.Вставить(Документы.ЗаказНаПроизводство, Истина);
		РегистраторыСРаспоряжением.Вставить(Документы.КорректировкаЗаказаМатериаловВПроизводство, Истина);
		//-- НЕ УТКА
