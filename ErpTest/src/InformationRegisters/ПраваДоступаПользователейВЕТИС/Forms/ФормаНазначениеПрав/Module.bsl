...
Функция ИспользуетсяКомиссияПриЗакупкахИлиПереработкаДавальческогоСырья()
	...
	Возврат ИнтеграцияВЕТИСПереопределяемый.ИспользуетсяКомиссияПриЗакупкахИлиПереработкаДавальческогоСырья();
...
Процедура ЗаполнитьДанныеНовогоПользователя()
	...
	ДанныеФизЛица = ИнтеграцияВЕТИСПереопределяемый.ДанныеФизическогоЛица(ФизическоеЛицо);
