...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ НЕ УТ
	Если Параметры.ТипОбъекта = "ОтгрузкаТоваровСХранения" Тогда
	...
	//++ НЕ УТ
	Если Параметры.ТипОбъекта = "ОтгрузкаТоваровСХранения" Тогда
		ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементовФормы(Элементы, "ГруппаОснование", "Видимость", Ложь);
	КонецЕсли;
	//-- НЕ УТ
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьУправлениеДоставкой")
		...
		//++ НЕ УТ
		Или Параметры.ТипОбъекта = "ОтгрузкаТоваровСХранения"
		//-- НЕ УТ
