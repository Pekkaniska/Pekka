...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЕстьПредоплата = РежимРеализации ИЛИ ЭтоЗаказ;
	...
	Если УпрощенныйРежим Тогда
		...
		Если РежимРеализации Тогда
			НеизменяемаяДатаПредоплаты = Параметры.Дата;
		КонецЕсли;
...
Процедура ОК(Команда)
	...
	Иначе
		...
		ИначеЕсли УпрощенныйРежим Тогда
			...
			Если НЕ ЕстьПредоплата ИЛИ ЕстьПредоплата И СуммаПлатежаПредоплата > 0 Тогда
...
Процедура УстановитьДоступностьЭлементовПоПорядкуРасчета()
	...
	Элементы.ГрафикОплаты.Видимость = Не ЗапретРедактированияГрафика И ЭтоЗаказ;
