...
//
// Параметры:
//  Проводка - РегистрБухгалтерииЗапись, Структура - добавляемая проводка
...
Процедура ПередЗаписью(Отказ, РежимЗаписи)
	...
	Если ФормироватьКорректировочныеПроводки Тогда
		...
		РежимЗаписиРегистратора = Неопределено;
		ОтменаПроведения = ДополнительныеСвойства.Свойство("РежимЗаписи", РежимЗаписиРегистратора)
			И РежимЗаписиРегистратора = РежимЗаписиДокумента.ОтменаПроведения;
