...
Функция ПолучитьТекстОбщегоЗапроса(ИсточникДанных, ТолькоРазрешенные) Экспорт
	...
	Если ВРег(ИсточникДанных) = ВРег("НачисленияУдержания") Тогда
		...
		|			И (РАЗНОСТЬДАТ(ОстаткиИОбороты.Период, СотрудникиМесяцы.Месяц, МЕСЯЦ) = 1)
		|
		|СГРУППИРОВАТЬ ПО
		...
		|	ЕСТЬNULL(ОстаткиИОборотыПоследние.КонечныйОстаток, ОстаткиИОбороты.НачальныйОстаток) КАК НачальныйОстаток,
		|	ОстаткиИОбороты.КонечныйОстаток КАК КонечныйОстаток,
		...
		|			И (РАЗНОСТЬДАТ(БухгалтерскиеОстаткиИОбороты.Период, СотрудникиМесяцы.Месяц, МЕСЯЦ) = 1)
		|
		|СГРУППИРОВАТЬ ПО
		|	СотрудникиМесяцы.Организация,
		|	СотрудникиМесяцы.Сотрудник,
		...
		|	ЕСТЬNULL(БухгалтерскиеОстаткиИОборотыПоследние.КонечныйОстаток, БухгалтерскиеОстаткиИОбороты.НачальныйОстаток) КАК НачальныйОстаток,
		|	БухгалтерскиеОстаткиИОбороты.КонечныйОстаток КАК КонечныйОстаток,
		...
		|	NULL КАК ПервыйМесяц,
		|	NULL КАК ПоследнийМесяц
