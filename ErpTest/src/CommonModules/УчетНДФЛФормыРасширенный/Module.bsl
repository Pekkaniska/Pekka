...
Процедура ВозвратНДФЛРаспределитьПоИсточникамФинансирования(Объект) Экспорт 
	...
	УдержанияПоРабочимМестам = УчетНачисленнойЗарплаты.РаспределениеПрочихУдержанийПоРабочимМестам(ДанныеНДФЛ, Объект.Месяц, Объект.Организация, Неопределено, Неопределено, Перечисления.ВидыОсобыхНачисленийИУдержаний.НДФЛ, 0);
	...
	Для Каждого СтрокаВозврата Из Объект.СуммыВозврата Цикл
		...
		РаспределениеРезультатовУдержаний = ОтражениеЗарплатыВБухучетеРасширенный.НоваяТаблицаРаспределениеРезультатовУдержаний();
