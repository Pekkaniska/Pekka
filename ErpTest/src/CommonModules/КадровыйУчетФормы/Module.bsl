...
Процедура ДобавитьКомандуПечатиСправкиОСреднемЗаработкеДляПособияПоБезработице(КомандыПечати) Экспорт
	...
	Если ДоступенПросмотрПлановыхНачислений() Тогда
		
		КомандаПечати = КомандаПечатиСправкиОСреднемЗаработкеДляПособияПоБезработице(КомандыПечати);
...
Функция КомандаПечатиСправкиОСреднемЗаработкеДляПособияПоБезработице(КомандыПечати) Экспорт
...
Функция ДоступенПросмотрПлановыхНачислений() Экспорт
	
	Возврат ПравоДоступа("Просмотр", Метаданные.РегистрыСведений.ПлановыеНачисления);
