...
Процедура ДополнитьОписаниеМодифицирующегоПараметраОтбора(СтруктураПараметра, ИмяМодификации) Экспорт
	ЗарплатаКадрыРасширенный.ДополнитьОписаниеМодифицирующегоПараметраОтбора(СтруктураПараметра, ИмяМодификации);
КонецПроцедуры
...
Процедура ПриОпределенииИмениКлиентскогоПриложения(ИмяПриложения) Экспорт
	ЗарплатаКадрыРасширенный.ПриОпределенииИмениКлиентскогоПриложения(ИмяПриложения);
КонецПроцедуры
