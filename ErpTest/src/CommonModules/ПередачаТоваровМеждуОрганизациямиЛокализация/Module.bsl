...
#Область ТекстПоступлениеУслуг                   // (Дт 44 :: Кт 60, 76)
	...
	|	ЕСТЬNULL(Расчеты.ГруппаФинансовогоУчета, Операция.ГруппаФинансовогоУчетаПолучателя) КАК АналитикаУчетаКт,
	|	НЕОПРЕДЕЛЕНО КАК МестоУчетаКт,
	|
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	|	МАКСИМУМ(Расчеты.ЗаказКлиента.ГруппаФинансовогоУчетаПолучателя) КАК ГруппаФинансовогоУчетаПолучателя
	...
	|	МАКСИМУМ(ВЫБОР КОГДА Расчеты.ЗаказПоставщику ССЫЛКА Справочник.ДоговорыКонтрагентов
	|		ТОГДА Расчеты.ЗаказПоставщику.ГруппаФинансовогоУчета 
	|		ИНАЧЕ Расчеты.ЗаказПоставщику.ГруппаФинансовогоУчетаПолучателя КОНЕЦ) КАК ГруппаФинансовогоУчета,
	|	МАКСИМУМ(Расчеты.ЗаказПоставщику.ГруппаФинансовогоУчетаПолучателя) КАК ГруппаФинансовогоУчетаПолучателя
	...
	|		ДокументыКОтражению.Ссылка = Расчеты.Регистратор
	|ГДЕ
	|	НЕ ТИПЗНАЧЕНИЯ(Расчеты.ЗаказПоставщику) В (
