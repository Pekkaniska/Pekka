...
//   ПараметрыИдентификацииВыраженийОстатки - Структура, Неопределено - состав используемых выражений.
//
// Возвращаемое значение:
//  Булево
...
Функция ШаблонПараметровПолученияФакта(ЗначенияПоУмолчанию = Неопределено, ПараметрыИдентификацииВыражений = Неопределено) Экспорт
	...
	Иначе
		...
		Параметры.УсловияВыражений.Вставить("ВыражениеЗаполненияАналитики1");
		Параметры.УсловияВыражений.Вставить("ВыражениеЗаполненияАналитики2");
		Параметры.УсловияВыражений.Вставить("ВыражениеЗаполненияАналитики3");
		Параметры.УсловияВыражений.Вставить("ВыражениеЗаполненияАналитики4");
		Параметры.УсловияВыражений.Вставить("ВыражениеЗаполненияАналитики5");
		Параметры.УсловияВыражений.Вставить("ВыражениеЗаполненияАналитики6");
