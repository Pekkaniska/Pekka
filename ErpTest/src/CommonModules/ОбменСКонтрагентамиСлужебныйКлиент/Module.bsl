...
//
Процедура НачатьОтправкуПолучениеЭлектронныхДокументов(ОповещениеОЗавершении) Экспорт
	...
	Если ИспользоватьЭлектронныеПодписи Тогда
		...
		ПоказатьОшибку = НЕ ЭлектроннаяПодписьКлиент.СоздаватьЭлектронныеПодписиНаСервере();
		ПолучитьОтпечаткиСертификатов(Оповещение, Истина, ПоказатьОшибку);
	Иначе
...
Процедура ОтправитьПолучитьПакетыЭлектронныхДокументовЗавершение(Результат, Контекст) Экспорт
	...
	Если РезультатОтправкиПолучения.Свойство("ДанныеПакетов", ДанныеПакетов) Тогда
