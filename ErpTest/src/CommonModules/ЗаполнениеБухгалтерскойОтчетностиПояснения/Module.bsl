...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения2(КонтекстВыполнения) Экспорт
	...
	ТаблицаЗначенийДопСтрок5200и5210 = НоваяТаблицаДопСтрокДляСтроки("5200");
	ТаблицаЗначенийДопСтрок5220и5230 = НоваяТаблицаДопСтрокДляСтроки("5220");
	ТаблицаЗначенийДопСтрок5240и5250 = НоваяТаблицаДопСтрокДляСтроки("5240");
	ТаблицаЗначенийДопСтрок5260      = НоваяТаблицаДопСтрокДляСтроки("5260");
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения4ЗаПериод(КонтекстВыполнения, ТипПериода, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета)
	...
	РассчитаныеПараметры = Новый Структура;
	РассчитаныеПараметры.Вставить("ЗаголовкиГраф", ЗаголовкиГраф);
	РассчитаныеПараметры.Вставить("СальдоИОборотыПоСчетам", СальдоИОборотыПоСчетам);
	РассчитаныеПараметры.Вставить("ОборотыМеждуСчетами",    ОборотыМеждуСчетами);
	
	КонтекстВыполнения.Вставить("РассчитаныеПараметры", РассчитаныеПараметры);
	...
	ЗаполнитьФормаОтчета2011Кв4_Пояснения4ЗаПериодСтрока5406и5426(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета);
	
	НомерСтроки = ?(ЭтоОтчетныйПериод, "5407", "5427");
	ЗаполнитьФормаОтчета2011Кв4_Пояснения4ЗаПериодСтрока5407и5427(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета);
	
	КонтекстВыполнения.Удалить("РассчитаныеПараметры");
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения4ЗаПериодСтрока5400и5420(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета)
	...
	ЗаголовкиГраф = КонтекстВыполнения.РассчитаныеПараметры.ЗаголовкиГраф;
	
	СальдоИОборотыПоСчетам = КонтекстВыполнения.РассчитаныеПараметры.СальдоИОборотыПоСчетам;
	ОборотыМеждуСчетами    = КонтекстВыполнения.РассчитаныеПараметры.ОборотыМеждуСчетами;
	...
	ДанныеСчета97ПоВидуАктива = ЗаполнениеБухгалтерскойОтчетностиИтоги.ДанныеСчета97ПоВидуАктива(ВидАктиваРБП, Организация, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета);
	
	Графа = "04";
	ЗаголовокГрафы = ЗаголовкиГраф[Графа];
	
	СНД_10 = ЗаполнениеБухгалтерскойОтчетностиИтоги.СНД("10", СальдоИОборотыПоСчетам);
	СНД_15 = ЗаполнениеБухгалтерскойОтчетностиИтоги.СНД("15", СальдоИОборотыПоСчетам);
	СНД_16 = ЗаполнениеБухгалтерскойОтчетностиИтоги.СНД("16", СальдоИОборотыПоСчетам);
	...
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", "!СНД " + Счет("15").Код, СНД_15, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, "15"));
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", "!СНД " + Счет("16").Код, СНД_16, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, "16"));
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", "!СНД " + Счет("20").Код, СНД_20, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, "20"));
	...
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", "!СНД " + Счет("41").Код, СНД_41, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, "41"));
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", "!СНД " + Счет("43").Код, СНД_43, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, "43"));
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", "!СНД " + Счет("44").Код, СНД_44, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, "44"));
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", "!СНД " + Счет("45").Код, СНД_45, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, "45"));
	...
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", ИмяСлагаемого, ДанныеСчета97ПоВидуАктива.СНД, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, Счет("97"), ОтборПоАналитике));
	...
	ОтборПоАналитике = Новый Соответствие;
	ОтборПоАналитике.Вставить("Субконто1.ВидАктива", ВидАктиваРБП);
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", ИмяСлагаемого, ДанныеСчета97ПоВидуАктива.ДО, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, Счет("97"), ОтборПоАналитике));
	...
	ОтборПоАналитике = Новый Соответствие;
	ОтборПоАналитике.Вставить("Субконто1.ВидАктива", ВидАктиваРБП);
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", ИмяСлагаемого, ДанныеСчета97ПоВидуАктива.КО, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, Счет("97"), ОтборПоАналитике));
	
	Графа = "08";
	ЗаголовокГрафы = ЗаголовкиГраф[Графа];
	
	ОБ_14__91_01 = ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("14", "91.01", ОборотыМеждуСчетами);
	
	ЗначениеПоказателя = ОБ_14__91_01;
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, "П000100" + НомерСтроки + Графа, ЗначениеПоказателя);
	
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", "!ОБ " + Счет("14").Код + " " + Счет("91.01").Код, ОБ_14__91_01, ИмяРаздела, НастройкиАнализаСчета(ПараметрыРасшифровки, "14", "91.01"));
	
	Графа = "09";
	ЗаголовокГрафы = ЗаголовкиГраф[Графа];
	
	ОБ_91_02__14 = ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("91.02", "14", ОборотыМеждуСчетами);
	
	ЗначениеПоказателя = ОБ_91_02__14;
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, "П000100" + НомерСтроки + Графа, -ЗначениеПоказателя); // вычитаемый
	
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", "!ОБ " + Счет("91.02").Код + " " + Счет("14").Код, ОБ_91_02__14, ИмяРаздела, НастройкиАнализаСчета(ПараметрыРасшифровки, "91.02", "14"));
	...
	ОтборПоАналитике = Новый Соответствие;
	ОтборПоАналитике.Вставить("Субконто1.ВидАктива", ВидАктиваРБП);
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "", "+", ИмяСлагаемого, ДанныеСчета97ПоВидуАктива.СКД, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, Счет("97"), ОтборПоАналитике));
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения4ЗаПериодСтрока5401и5421(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета)
	...
	ОБ_14_01__91_01 = ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("14.01", "91.01", ОборотыМеждуСчетами);
	
	ЗначениеПоказателя = ОБ_14_01__91_01;
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, "П000100" + НомерСтроки + Графа, ЗначениеПоказателя);
	
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", "!ОБ " + Счет("14.01").Код + " " + Счет("91.01").Код, ОБ_14_01__91_01, ИмяРаздела, НастройкиАнализаСчета(ПараметрыРасшифровки, "14.01", "91.01"));
	
	Графа = "09";
	ЗаголовокГрафы = ЗаголовкиГраф[Графа];
	
	ОБ_91_02__14_01 = ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("91.02", "14.01", ОборотыМеждуСчетами);
	
	ЗначениеПоказателя = ОБ_91_02__14_01;
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, "П000100" + НомерСтроки + Графа, -ЗначениеПоказателя); // вычитаемый
	
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", "!ОБ " + Счет("91.02").Код + " " + Счет("14.01").Код, ОБ_91_02__14_01, ИмяРаздела, НастройкиАнализаСчета(ПараметрыРасшифровки, "91.02", "14.01"));
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения4ЗаПериодСтрока5402и5422(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета)
	...
	ОБ_14_03__91_01 = ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("14.03", "91.01", ОборотыМеждуСчетами);
	
	ЗначениеПоказателя = ОБ_14_03__91_01;
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, "П000100" + НомерСтроки + Графа, ЗначениеПоказателя);
	
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", "!ОБ " + Счет("14.03").Код + " " + Счет("91.01").Код, ОБ_14_03__91_01, ИмяРаздела, НастройкиАнализаСчета(ПараметрыРасшифровки, "14.03", "91.01"));
	
	Графа = "09";
	ЗаголовокГрафы = ЗаголовкиГраф[Графа];
	
	ОБ_91_02__14_03 = ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("91.02", "14.03", ОборотыМеждуСчетами);
	
	ЗначениеПоказателя = ОБ_91_02__14_03;
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, "П000100" + НомерСтроки + Графа, -ЗначениеПоказателя); // вычитаемый
	
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", "!ОБ " + Счет("91.02").Код + " " + Счет("14.03").Код, ОБ_91_02__14_03, ИмяРаздела, НастройкиАнализаСчета(ПараметрыРасшифровки, "91.02", "14.03"));
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения4ЗаПериодСтрока5403и5423(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета)
	...
	ОБ_14_02__91_01 = ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("14.02", "91.01", ОборотыМеждуСчетами);
	
	ЗначениеПоказателя = ОБ_14_02__91_01;
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, "П000100" + НомерСтроки + Графа, ЗначениеПоказателя);
	
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", "!ОБ " + Счет("14.02").Код + " " + Счет("91.01").Код, ОБ_14_02__91_01, ИмяРаздела, НастройкиАнализаСчета(ПараметрыРасшифровки, "14.02", "91.01"));
	
	Графа = "09";
	ЗаголовокГрафы = ЗаголовкиГраф[Графа];
	
	ОБ_91_02__14_02 = ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("91.02", "14.02", ОборотыМеждуСчетами);
	
	ЗначениеПоказателя = ОБ_91_02__14_02;
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, "П000100" + НомерСтроки + Графа, -ЗначениеПоказателя); // вычитаемый
	
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", "!ОБ " + Счет("91.02").Код + " " + Счет("14.02").Код, ОБ_91_02__14_02, ИмяРаздела, НастройкиАнализаСчета(ПараметрыРасшифровки, "91.02", "14.02"));
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения4ЗаПериодСтрока5405и5425(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета)
	...
	ОБ_14_04__91_01 = ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("14.04", "91.01", ОборотыМеждуСчетами);
	
	ЗначениеПоказателя = ОБ_14_04__91_01;
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, "П000100" + НомерСтроки + Графа, ЗначениеПоказателя);
	
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", "!ОБ " + Счет("14.04").Код + " " + Счет("91.01").Код, ОБ_14_04__91_01, ИмяРаздела, НастройкиАнализаСчета(ПараметрыРасшифровки, "14.04", "91.01"));
	
	Графа = "09";
	ЗаголовокГрафы = ЗаголовкиГраф[Графа];
	
	ОБ_91_02__14_04 = ЗаполнениеБухгалтерскойОтчетностиИтоги.ОБ("91.02", "14.04", ОборотыМеждуСчетами);
	
	ЗначениеПоказателя = ОБ_91_02__14_04;
	УстановитьЗначениеПоказателя(РассчитанныеПоказатели, ИмяРаздела, "П000100" + НомерСтроки + Графа, -ЗначениеПоказателя); // вычитаемый
	
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", "!ОБ " + Счет("91.02").Код + " " + Счет("14.04").Код, ОБ_91_02__14_04, ИмяРаздела, НастройкиАнализаСчета(ПараметрыРасшифровки, "91.02", "14.04"));
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения4ЗаПериодСтрока5406и5426(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета)
	...
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", "!СНД " + Счет("44").Код, СНД_44, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, "44"));
	...
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", "!ДО " + Счет("44").Код, ДО_44, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, "44"));
	...
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", "!КО " + Счет("44"), КО_44, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, "44"));
	...
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", "!СКД " + Счет("44").Код, СКД_44, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, "44"));
	
КонецПроцедуры

Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения4ЗаПериодСтрока5407и5427(КонтекстВыполнения, НомерСтроки, ДатаНачалаПериодаОтчета, ДатаКонцаПериодаОтчета)
	...
	ИмяСлагаемого = "Сальдо на начало периода по дебету счета 97 /объекты со значением реквизита ""Вид актива"" - """ + Строка(ВидАктиваРБП) + """/";
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", ИмяСлагаемого, ДанныеСчета97ПоВидуАктива.СНД, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, Счет("97"), ОтборПоАналитике));
	...
	ИмяСлагаемого = "Оборот по дебету счета 97 /объекты со значением реквизита ""Вид актива"" - """ + Строка(ВидАктиваРБП) + """/";
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", ИмяСлагаемого, ДанныеСчета97ПоВидуАктива.ДО, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, Счет("97"), ОтборПоАналитике));
	...
	ИмяСлагаемого = "Оборот по кредиту счета 97 /объекты со значением реквизита ""Вид актива"" - """ + Строка(ВидАктиваРБП) + """/";
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", ИмяСлагаемого, ДанныеСчета97ПоВидуАктива.КО, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, Счет("97"), ОтборПоАналитике));
	...
	ИмяСлагаемого = "Сальдо на конец периода по дебету счета 97 /объекты со значением реквизита ""Вид актива"" - """ + Строка(ВидАктиваРБП) + """/";
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, "П000100" + НомерСтроки + Графа, "Строка " + НомерСтроки + " """ + НаименованиеСтроки + """, графа """ + ЗаголовокГрафы + """", "+", ИмяСлагаемого, ДанныеСчета97ПоВидуАктива.СКД, ИмяРаздела, НастройкиОСВПоСчету(ПараметрыРасшифровки, Счет("97"), ОтборПоАналитике));
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5510и5530(КонтекстВыполнения, НомерСтроки)
	...
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаАвансов, "АвансыВыданные");
	СчетаНДСАвансов = "76.ВА";
	СчетаПрочие   = "68.01, 68.02, 68.03, 68.04.1, 68.06, 68.07, 68.08, 68.09, 68.10, 68.11, 68.12, 68.13, 68.22,
	...
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПрочие, "Лизинг, НДСПоАренде, Факторинг, РаботникиОрганизаций");
	СчетаРезервов = "63";
	
	СчетаПеревода = "76.01.1, 76.06, 76.21, 76.26, 76.36, 68.01, 68.02, 68.03, 68.04.1, 68.06, 68.07, 68.08, 68.09, 68.10, 68.11, 68.12, 68.13,
	                |69.01, 69.02.1, 69.02.2, 69.02.3, 69.02.4, 69.02.5, 69.02.6, 69.02.7, 69.03.1, 69.03.2, 69.04, 69.05.1, 69.05.2,
	...
	Если УчитыватьСчетаИП2015 Тогда
		СчетаПрочие = СтрЗаменить(СчетаПрочие, "68.01", "68.01, 68.21");
		ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПрочие, "ВидыПлатежейВГосБюджет");
		СчетаПеревода = СтрЗаменить(СчетаПеревода, "68.01", "68.01, 68.21");
	...
	СчетаГрафы07 = "62.01, 62.21, 62.31, 62.03, 76.06, 76.26, 76.36, 60.02, 60.22, 60.32, 73.01, 73.02, 73.03,
	               |76.01.1, 76.01.2, 76.01.9, 76.21, 76.02, 76.22, 76.32, 76.03, 76.05, 76.25, 76.35, 76.09, 76.29, 76.39";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы07, "Факторинг, АвансыВыданные");
	...
	СчетаГрафы09 = "62.01, 62.21, 62.31, 62.03, 76.06, 76.26, 76.36, 60.02, 60.22, 60.32, 71.01, 71.21, 73.01, 73.02, 73.03,
	               |76.02, 76.22, 76.32, 76.03, 76.05, 76.25, 76.35, 76.09, 76.29, 76.39, 76.07.2";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы09, "Лизинг, Факторинг, АвансыВыданные, РаботникиОрганизаций");
	СчетаГрафы10 = СчетаРезервов;
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5513и5533(КонтекстВыполнения, НомерСтроки)
	...
	СчетаПеревода = "68.01, 68.02, 68.03, 68.04.1, 68.06, 68.07, 68.08, 68.09, 68.10, 68.11, 68.12, 68.13,
	                |69.01, 69.02.1, 69.02.2, 69.02.3, 69.02.4, 69.02.5, 69.02.6, 69.02.7, 69.03.1, 69.03.2, 69.04, 69.05.1, 69.05.2,
	...
	СчетаГрафы07 = "73.01, 73.02, 73.03, 76.01.1, 76.01.2, 76.01.9, 76.21, 76.02, 76.22, 76.32, 76.03, 76.05, 76.25, 76.35,
	               |76.09, 76.29, 76.39";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы07, "Факторинг");
	СчетаГрафы08 = СчетаПрочие;
	СчетаГрафы09 = "71.01, 71.21, 73.01, 73.02, 73.03, 76.02, 76.22, 76.32, 76.03, 76.05, 76.25, 76.35,
	               |76.09, 76.29, 76.39, 76.07.2";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаГрафы09, "Лизинг, Факторинг, РаботникиОрганизаций");
	СчетаГрафы10 = СчетаРезервов;
	СчетаГрафы12 = СчетаПрочие;
	СчетаГрафы13 = СчетаРезервов;
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения51_Краткосрочная(КонтекстВыполнения)
	...
	Пока Выборка.Следующий() Цикл
		...
		НаименованиеСоставляющей = "Оборот с дебета счета " + СчетСоставляющейДт.Код + " по контрагентам и договорам со сроком оплаты не превышающим 365 дней в дебет счета "
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5560и5580(КонтекстВыполнения, НомерСтроки)
	...
	СчетаНДСАвансов = "76.АВ";
	СчетаРасчетовПоНалогам = "68.01, 68.02, 68.03, 68.04.1, 68.06, 68.07, 68.08, 68.09, 68.10, 68.11, 68.12, 68.13, 68.32, 68.42, 68.52,
	...
	СчетаШтрафыПени = "68.01, 68.02, 68.03, 68.04.1, 68.06, 68.07, 68.08, 68.09, 68.10, 68.11, 68.12, 68.13, 68.32, 68.42, 68.52,
	...
	СчетаПеревода = "76.01.1, 76.03, 76.21, 76.05, 76.25, 76.35, 76.06, 76.26, 76.36, 68.01, 68.02, 68.03, 68.04.1, 68.06, 68.07, 68.08, 68.09, 68.10, 68.11, 68.12, 68.13,
	                |69.01, 69.02.1, 69.02.2, 69.02.3, 69.02.4, 69.02.5, 69.02.6, 69.02.7, 69.03.1, 69.03.2, 69.04, 69.05.1, 69.05.2,
	                |69.06.1, 69.06.2, 69.06.3, 69.06.4, 69.06.5, 69.11, 69.12, 69.13.1, 69.13.2,
	...
	Если УчитыватьСчетаИП2015 Тогда
		СчетаРасчетовПоНалогам = СтрЗаменить(СчетаРасчетовПоНалогам, "68.01", "68.01, 68.21");
		ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаРасчетовПоНалогам, "ВидыПлатежейВГосБюджет");
		СчетаШтрафыПени = СтрЗаменить(СчетаШтрафыПени, "68.01", "68.01, 68.21");
...
Процедура ЗаполнитьФормаОтчета2011Кв4_Пояснения5Строки5566и5586(КонтекстВыполнения, НомерСтроки)
	...
	СчетаПрочие = "70, 71.01, 71.21, 73.03, 75.02, 76.01.1, 76.21, 76.03, 76.04, 76.09, 76.29, 76.39, 76.49, 76.41, 76.НА, 76.07.2";
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаПрочие, "РаботникиОрганизаций, Лизинг");
...
Функция НоваяТаблицаДопСтрокДляСтроки(НомерСтроки)
