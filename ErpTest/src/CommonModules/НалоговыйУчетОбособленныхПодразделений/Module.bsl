...
Функция ПодготовитьТаблицуРасчетДолейБазыНалогаНаПрибыль(Знач Реквизиты, СписокОрганизаций) Экспорт
	...
	|				&КонПериода,
	|				Организация В (&СписокОрганизаций)
	|					И ГруппаОС = ЗНАЧЕНИЕ(Перечисление.ГруппыОС.КапитальныеВложенияВАрендованноеИмущество)) КАК ПервоначальныеСведенияОС
...
Функция ВыполнитьЗапросРасчетНалогаНаПрибыль(Организация, КонецПериода) Экспорт
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.СтавкиНалогаНаПрибыльВБюджетСубъектовРФ.СрезПоследних(&КонецПериода, ) КАК СтавкиНалогаНаПрибыльВБюджетСубъектовРФСрезПоследних
	|		ПО НалогГод.РегистрацияВНалоговомОргане = СтавкиНалогаНаПрибыльВБюджетСубъектовРФСрезПоследних.РегистрацияВНалоговомОргане
	|			И НалогГод.Организация = СтавкиНалогаНаПрибыльВБюджетСубъектовРФСрезПоследних.Организация,
