...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(Знач ИсточникиДанных) Экспорт
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ЗаказКлиента",	                       "Дата", "ПродажиВозвратыОтКлиентов", "Организация");
	//-- Рарус Лимаренко 19.06.2018
	...
	//++ НЕ УТКА
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПроизводственнаяОперация2_2",                "ОкончаниеВыполнения", "Производство", "Этап.Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.СменноеЗадание",                             "Дата",                "Производство", "");
	//-- НЕ УТКА
	...
	//++ Рарус Лимаренко 18.06.2018
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.пкЗаказНаряд","Дата", "ПродажиВозвратыОтКлиентов", "Организация");	
	//ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.УатПутевойЛист","Дата", "ПродажиВозвратыОтКлиентов", "Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.пкЗаправочнаяВедомость","Дата", "ПродажиВозвратыОтКлиентов", "Организация");
...
//++ Рарус Лимаренко 18.06.2018
		Если ТипОбъекта = Тип("ДокументСсылка.СверкаВзаиморасчетов") Тогда
			ВыполнятьПроверку = Ложь;
		ИначеЕсли ТипОбъекта = Тип("ДокументОбъект.СверкаВзаиморасчетов") Тогда
			ВыполнятьПроверку = Ложь;	
		ИначеЕсли ТипОбъекта = Тип("ДокументОбъект.пкЗаказНаряд") Тогда
			ВыполнятьПроверку = Ложь;
		ИначеЕсли ТипОбъекта = Тип("РегистрНакопленияНаборЗаписей.уатОстаткиГСМнаТС") ИЛИ ТипОбъекта = Тип("РегистрНакопленияНаборЗаписей.уатВыработкаТС") Тогда
			 ВыполнятьПроверку = Ложь;
		 ИначеЕсли ТипОбъекта = Тип("РегистрНакопленияНаборЗаписей.ПартииПрочихРасходов") ТОгда
			 ВыполнятьПроверку = Ложь;
