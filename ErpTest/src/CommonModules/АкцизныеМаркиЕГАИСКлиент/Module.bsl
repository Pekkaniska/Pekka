...
Процедура ОбработатьДанныеШтрихкода(ОповещениеПриЗавершении, Форма, СтруктураШтрихкода, ПараметрыСканированияАкцизныхМарок = Неопределено) Экспорт
	...
	Если ИнтеграцияЕГАИСКлиентСервер.ЕстьРеквизитОбъекта(Форма, "СоответствиеШтрихкодовСтрокДерева")
		И Форма.СоответствиеШтрихкодовСтрокДерева.Получить(СтруктураШтрихкода.Штрихкод) <> Неопределено Тогда
		
		// В дереве упаковок формы проверки найден штрихкод.
		ВыполнитьОбработкуОповещения(ОповещениеПриЗавершении, СтруктураШтрихкода);
	...
	Иначе
		...
		Если РезультатОбработки <> Неопределено Тогда
			...
			Если ПараметрыСканированияАкцизныхМарок.ИспользуетсяСоответствиеШтрихкодовСтрокДерева 
				...
				Если Форма.СоответствиеШтрихкодовСтрокДерева.Получить(СтруктураШтрихкода.Штрихкод) <> Неопределено Тогда
			...
			Иначе
				ДанныеШтрихкода = ДанныеШтрихкодов.ОбработанныеШтрихкоды[СтруктураШтрихкода.Штрихкод];
				Если ДанныеШтрихкода <> Неопределено Тогда
					ДанныеШтрихкода.ВложенныеШтрихкоды = РезультатОбработки.АдресДереваУпаковок;
					ВыполнитьОбработкуОповещения(ОповещениеПриЗавершении, ДанныеШтрихкода);
				Иначе
					ДанныеШтрихкода = ДанныеШтрихкодов.НеобработанныеШтрихкоды[СтруктураШтрихкода.Штрихкод];
					ВыполнитьОбработкуОповещения(ОповещениеПриЗавершении, ДанныеШтрихкода);
				КонецЕсли;
			КонецЕсли;
