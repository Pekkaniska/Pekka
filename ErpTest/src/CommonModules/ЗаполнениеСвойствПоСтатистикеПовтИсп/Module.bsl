...
#Область ЗаказМатериаловВПроизводство
	Если ОбъектМетаданных = Метаданные.Документы.ЗаказМатериаловВПроизводство Тогда
		
		СтруктураНезаполняемыхРеквизитов.Вставить("ПотреблениеДляДеятельности");
		
		ЗаполнениеСвойствПоСтатистикеСервер.ДобавитьЗаполняемыеРеквизиты(ДополнительныеРеквизиты,
			"Подразделение, ЦеховаяКладовая", "УправлениеПроизводством2_2");
...
#Область ПриемкаТоваровНаХранение
	Если ОбъектМетаданных = Метаданные.Документы.ПриемкаТоваровНаХранение Тогда
...
#Область ПроизводствоБезЗаказа
	Если ОбъектМетаданных = Метаданные.Документы.ПроизводствоБезЗаказа Тогда
		
		ЗаполнениеСвойствПоСтатистикеСервер.ДобавитьЗаполняемыеРеквизиты(ДополнительныеРеквизиты,
			"ГруппировкаЗатрат", "", "Ответственный");
...
#Область ЗаказДавальца
	Если ОбъектМетаданных = Метаданные.Документы.ЗаказДавальца Тогда
		...
		ИменаДопРеквизитов = "СкладПоступления, ВернутьМногооборотнуюТару";
		ЗаполнениеСвойствПоСтатистикеСервер.ДобавитьЗаполняемыеРеквизиты(ДополнительныеРеквизиты, ИменаДопРеквизитов, "Автор");
