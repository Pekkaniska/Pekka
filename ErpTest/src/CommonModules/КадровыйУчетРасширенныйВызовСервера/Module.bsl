...
Функция ПродолжительностьСтажа(Знач ОписаниеСтажа, Знач ДатаАктуальности) Экспорт
	...
	Если ДатаАктуальности = ОписаниеСтажа.ДатаОтсчета Тогда
		
		РазмерМесяцев = ОписаниеСтажа.Месяцев + ОписаниеСтажа.Лет * 12;
		...
		ПродолжительностьСтажа.Дней = ОписаниеСтажа.Дней;
...
Функция НастройкиКадровогоУчета() Экспорт
	...
	Возврат КадровыйУчетРасширенный.НастройкиКадровогоУчета();
