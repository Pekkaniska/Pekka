...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
    ...
    пкМодификацияСервер.ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка); 
    //---rarus-spb_zlov 04.07.2016 
...
Процедура ПриЧтенииНаСервере(Форма, ТекущийОбъект) Экспорт
    //+++rarus-spb_zlov 04.07.2016    
    пкМодификацияСервер.ПриЧтенииНаСервере(Форма, ТекущийОбъект);  
    //---rarus-spb_zlov 04.07.2016 
КонецПроцедуры
...
Процедура ПередЗаписьюНаСервере(Форма, Отказ, ТекущийОбъект, ПараметрыЗаписи)Экспорт
    //+++rarus-spb_zlov 14.08.2016    
    пкМодификацияСервер.ПередЗаписьюНаСервере(Форма, Отказ, ТекущийОбъект, ПараметрыЗаписи);
    //---rarus-spb_zlov 14.08.2016 
КонецПроцедуры
...
Процедура ПослеЗаписиНаСервере(Форма, ТекущийОбъект, ПараметрыЗаписи)Экспорт
    //+++rarus-spb_vlpodr 12.07.2016    
    пкМодификацияСервер.ПослеЗаписи(Форма, ТекущийОбъект, ПараметрыЗаписи);
    //---rarus-spb_vlpodr 12.07.2016 
