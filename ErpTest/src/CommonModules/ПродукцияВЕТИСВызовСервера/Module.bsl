...
//  Структура - см. функцию ИнтеграцияВЕТИСКлиентСервер.РезультатВыполненияЗапросаЭлементовКлассификатора().
//
Функция ИсторияИзмененийПродукции(Интервал, НомерСтраницы = 1, КоличествоЭлементовНаСтранице = Неопределено) Экспорт
...
//  Структура - см. функцию ИнтеграцияВЕТИСКлиентСервер.РезультатВыполненияЗапросаЭлементовКлассификатора().
//
Функция ИсторияИзмененийВидовПродукции(Интервал, НомерСтраницы = 1, КоличествоЭлементовНаСтранице = Неопределено) Экспорт
...
//  Структура - см. функцию ИнтеграцияВЕТИСКлиентСервер.РезультатВыполненияЗапросаЭлементовКлассификатора().
//
Функция ИсторияИзмененийНаименованийПродукции(Интервал, НомерСтраницы = 1, КоличествоЭлементовНаСтранице = Неопределено) Экспорт
...
Функция ЗапросЭлементовКлассификатораПродукцииXML(КодТипаПродукции, НомерСтраницы)
...
Функция ЗапросИзмененныхЭлементовКлассификатораПродукцииXML(Интервал, НомерСтраницы, КоличествоЭлементовНаСтранице)
...
Функция ЗапросЭлементовКлассификатораВидовПродукцииXML(GUIDПродукции, НомерСтраницы)
...
Функция ЗапросИзмененныхЭлементовКлассификатораВидовПродукцииXML(Интервал, НомерСтраницы, КоличествоЭлементовНаСтранице)
...
Функция ЗапросЭлементовКлассификатораНаименованийПродукцииXML(ПараметрыОтбора, НомерСтраницы)
	...
	Если ПараметрыОтбора.Свойство("Продукция") Тогда
		Запрос.product = ИнтеграцияВЕТИС.ОбъектXDTOПоИмениТипа(Запрос, "product");
		Запрос.product.guid = ПараметрыОтбора.Продукция;
	КонецЕсли;
	
	Если ПараметрыОтбора.Свойство("ВидПродукции") Тогда
		Запрос.subProduct = ИнтеграцияВЕТИС.ОбъектXDTOПоИмениТипа(Запрос, "subProduct");
	...
	Если ПараметрыОтбора.Свойство("ПроизводительХозяйствующийСубъект")
	 ИЛИ ПараметрыОтбора.Свойство("ПроизводительПредприятие") Тогда
		ЭлементProducer = ИнтеграцияВЕТИС.ОбъектXDTOПоИмениТипа(Запрос, "producer");
		
		Если ПараметрыОтбора.Свойство("ПроизводительХозяйствующийСубъект") Тогда
			ЭлементProducer.businessEntity = ИнтеграцияВЕТИС.ОбъектXDTOПоИмениТипа(ЭлементProducer, "businessEntity");
		...
		Если ПараметрыОтбора.Свойство("ПроизводительПредприятие") Тогда
			ЭлементProducer.enterprise = ИнтеграцияВЕТИС.ОбъектXDTOПоИмениТипа(ЭлементProducer, "enterprise");
...
Функция ЗапросИзмененныхЭлементовКлассификатораНаименованийПродукцииXML(Интервал, НомерСтраницы, КоличествоЭлементовНаСтранице)
