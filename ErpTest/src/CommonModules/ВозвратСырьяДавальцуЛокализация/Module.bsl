...
#КонецОбласти
	...
	ТекстыОтражения.Добавить(ТекстСторноПоступленияМатериаловОтДавальца);
	ТекстыОтражения.Добавить(ТекстСторноПоступленияМатериаловОтДавальцаСкладПроизводства);
