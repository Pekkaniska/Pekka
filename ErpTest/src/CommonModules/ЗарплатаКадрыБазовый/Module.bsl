...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.КадровыйПеревод",                   "Дата",   "КадровыйУчет", "Организация");
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ЗаявлениеНаПредоставлениеСтандартныхВычетовПоНДФЛ",        "Месяц",               "НДФЛ", "Организация");
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.АвансовыйПлатежИностранцаПоНДФЛ",                          "ДатаОперации",        "НДФЛ", "Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПерерасчетНДФЛ",                                           "МесяцПерерасчета",    "НДФЛ", "Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ПрекращениеСтандартныхВычетовНДФЛ",                        "Месяц",               "НДФЛ", "Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.СправкиНДФЛДляПередачиВНалоговыйОрган",                    "Дата",				 "НДФЛ", "Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.УведомлениеОПравеНаИмущественныйВычетДляНДФЛ",             "ПрименятьВычетыС",    "НДФЛ", "Организация");
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "РегистрСведений.ПрименениеСтандартныхВычетовПоНДФЛ",                "Период",              "НДФЛ", "ГоловнаяОрганизация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "РегистрСведений.СтандартныеВычетыНаДетейНДФЛ",                      "МесяцРегистрации",    "НДФЛ", "");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "РегистрСведений.СтандартныеВычетыФизическихЛицНДФЛ",                "Период",              "НДФЛ", "");
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "РегистрНакопления.АвансовыеПлатежиИностранцевПоНДФЛ",               "Период",              "НДФЛ", "ГоловнаяОрганизация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "РегистрНакопления.ИмущественныеВычетыНДФЛ",                         "МесяцРегистрации",    "НДФЛ", "ГоловнаяОрганизация");
...
Процедура ЗаполнитьСведенияОПерсональныхДанных(ТаблицаСведений) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПодсистемы.ОбъектыБазовойРеализации") Тогда
		МодульОбъектыБазовойРеализации = ОбщегоНазначения.ОбщийМодуль("ЗарплатаКадрыОбъектыБазовойРеализации");
		МодульОбъектыБазовойРеализации.ЗаполнитьСведенияОПерсональныхДанных(ТаблицаСведений);
	КонецЕсли;
	...
	Для Каждого Показатель Из СписокПоказателей Цикл
		...
		ИначеЕсли ИмяПоказателя = "СистемыНалогообложения" Тогда
			...
			Если Тарифы.Количество() > 0 Тогда
				...
				Если ВидТарифа = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.БлаготворительныеОрганизации") Тогда
					СистемыНалогообложения.Добавить("УСН");
				ИначеЕсли ВидТарифа = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ИндивидуальныйПредпринимательПрименяющийПатент") Тогда
					СистемыНалогообложения.Добавить("ПСН");
				ИначеЕсли ВидТарифа = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.НекоммерческиеОрганизации") Тогда
					СистемыНалогообложения.Добавить("УСН");
				ИначеЕсли ВидТарифа = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.СельХозПроизводители") Тогда
					СистемыНалогообложения.Добавить("ОСНО");
				ИначеЕсли ВидТарифа = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ЕСХН") Тогда
					СистемыНалогообложения.Добавить("ЕСХН");
				ИначеЕсли ВидТарифа = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ОбщийНалоговыйРежим") Тогда
					СистемыНалогообложения.Добавить("ОСНО");
				ИначеЕсли ВидТарифа = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.УпрощенныйНалоговыйРежимПроизводство") Тогда
					СистемыНалогообложения.Добавить("УСН");
				ИначеЕсли ВидТарифа = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.УпрощенныйНалоговыйРежим") Тогда
					СистемыНалогообложения.Добавить("УСН");
				Иначе	
					СистемыНалогообложения.Добавить("ОСНО");
				КонецЕсли;	
		...
		ИначеЕсли ИмяПоказателя = "АдрПрописки" 
			ИЛИ ИмяПоказателя = "АдрПрописки_XML" Тогда
		...
		ИначеЕсли ИмяПоказателя = "АдрМЖРукРФ"
			ИЛИ ИмяПоказателя = "АдрМЖРукРФ_XML" Тогда
		...
		ИначеЕсли ИмяПоказателя = "АдрМЖБухРФ"
			Или ИмяПоказателя = "АдрМЖБухРФ_XML" Тогда
...
Процедура ЗаполнитьПоказателиРегламентированногоОтчета(ПоказателиОтчета, ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета = Неопределено) Экспорт
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчет4ФСС" Тогда
		...
		ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2017Кв1" Или ИДРедакцииОтчета = "ФормаОтчета2017Кв3" Тогда
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетСтатистикаФормаП4" Тогда
		...
		Иначе	
			СтатистикаПерсонала.ОписаниеПоказателей_СтатистикаФормаП4_2013Кв1(ПоказателиОтчета);
		КонецЕсли;
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетСтатистикаФормаП4НЗ" Тогда
		Если ИДРедакцииОтчета < "ФормаОтчета2015Кв1" Тогда
		Иначе	
			СтатистикаПерсонала.ОписаниеПоказателей_СтатистикаФормаП4НЗ_2015Кв1(ПоказателиОтчета);
		КонецЕсли;
	КонецЕсли;
...
Процедура ЗаполнитьРегламентированныйОтчет(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета, Контейнер) Экспорт
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетСтатистикаФормаП4" Тогда
		...
		ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2013Кв1"
			Или ИДРедакцииОтчета = "ФормаОтчета2014Кв1" Тогда
			СтатистикаПерсонала.ЗначенияПоказателей_СтатистикаФормаП4_2013Кв1(ПараметрыОтчета, Контейнер);
		Иначе
			СтатистикаПерсонала.ЗначенияПоказателей_СтатистикаФормаП4_2017Кв1(ПараметрыОтчета, Контейнер);
		КонецЕсли;
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетСтатистикаФормаП4НЗ" Тогда
		Если ИДРедакцииОтчета < "ФормаОтчета2015Кв1" Тогда
		Иначе
			СтатистикаПерсонала.ЗначенияПоказателей_СтатистикаФормаП4НЗ_2015Кв1(ПараметрыОтчета, Контейнер);
		КонецЕсли;
	КонецЕсли;
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	...
	|РегистрСведений.ВидыЗанятостиСотрудников.Изменение.ГруппыФизическихЛиц
	|РегистрСведений.ВидыЗанятостиСотрудников.Изменение.Организации
	...
	|РегистрСведений.ВидыЗанятостиСотрудниковИнтервальный.Изменение.ГруппыФизическихЛиц
	|РегистрСведений.ВидыЗанятостиСотрудниковИнтервальный.Изменение.Организации
	...
	// ЗарплатаКадрыПодсистемы.ОбъектыБазовойРеализации
	Описание = Описание + "
	...
	// Конец ЗарплатаКадрыПодсистемы.ОбъектыБазовойРеализации
	...
	|РегистрСведений.ПрименениеСтандартныхВычетовПоНДФЛВторичный.Изменение.ГруппыФизическихЛиц
	...
	|РегистрСведений.СтандартныеВычетыПоНДФЛВторичный.Изменение.ГруппыФизическихЛиц
...
Функция АдресВФормате9Запятых(Запись, ВидАдреса)
	...
	СтруктураАдреса = ЗарплатаКадры.СтруктураАдресаИзXML(Запись.ЗначенияПолей, ВидАдреса);
...
Функция АдресВФорматеXML(Запись, ВидАдреса)
	Возврат УправлениеКонтактнойИнформацией.КонтактнаяИнформацияВXML(Запись.ЗначенияПолей, Запись.Представление, ВидАдреса);
КонецФункции
