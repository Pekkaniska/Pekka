...
//	Форма			 - УправляемаяФорма - Форма, которая содержит ПоляФормы и ЗаголовкиПолей.
//	ПоляФормы		 - Структура - Ключи, которой Субконто1..3, а значения имена соответствующих полей на форме (поля субконто).
//	ЗаголовкиПолей	 - Структура, Неопределено - Ключи, которой Субконто1..3, а значения имена соответствующих полей на форме (заголовки субконто).
