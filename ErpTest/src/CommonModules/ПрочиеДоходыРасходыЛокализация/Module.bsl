...
#КонецОбласти
	...
	ТекстыОтражения.Добавить(ТекстПередачаРасходовСОбособленногоПодразделения);
	ТекстыОтражения.Добавить(ТекстПередачаРасходовНаОбособленноеПодразделение);
	...
	Для каждого ТабличнаяЧасть Из ИзмененияДокумента.ТабличныеЧасти Цикл
			...
			Для каждого Строка Из ТабличнаяЧасть.Значение Цикл
				...
				Для каждого Организация Из ОрганизацииДляРегистрации Цикл
					РеглУчетПроведениеСервер.ДобавитьПараметрыВыборочнойРегистрацииКОтражениюВРеглУчете(
						ДополнительныеСвойства, Организация, Строка.ДатаОтражения);
				КонецЦикла;
		...
		Иначе
			...
			Для каждого Строка Из ТабличнаяЧасть.Значение Цикл
				...
				РеглУчетПроведениеСервер.ДобавитьПараметрыВыборочнойРегистрацииКОтражениюВРеглУчете(
					ДополнительныеСвойства, Объект.Организация, Строка.ДатаОтражения);
