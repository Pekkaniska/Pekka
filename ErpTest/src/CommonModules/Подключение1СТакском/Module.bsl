...
Функция НовыйОпределенияСервиса(
	...
	ОписаниеWSDL = ИнтернетПоддержкаПользователейКлиентСервер.ЗагрузитьСодержимоеИзИнтернет(
		МестоположениеWSDL,
		,
		,
...
Функция ОтправитьЗапросSOAP(ТекстКонверта, ПроксиСервиса, Таймаут = -1, НастройкиПрокси = Неопределено)
	...
	ИнтернетПоддержкаПользователейКлиентСервер.ПроверитьURL(ПроксиСервиса.АдресТочкиПодключения);
	...
	ОтветСервера = ИнтернетПоддержкаПользователейКлиентСервер.ЗагрузитьСодержимоеИзИнтернет(
