...
//++ НЕ УТ
	...
	СоответствиеПолей["ВыкупПринятыхНаХранениеТоваров"].Вставить("ГрузополучательПредприятие", "Склад");
//-- НЕ УТ
...
Функция ПараметрыФормыПодбораТоваров(Форма, ПараметрыУказанияСерий) Экспорт
	...
	Если ПараметрыУказанияСерий <> Неопределено Тогда
		...
		Если ЗначениеЗаполнено(ИмяПоляСклад)
			И ИнтеграцияИСКлиентСервер.ЕстьРеквизитОбъекта(Форма[ИмяИсточникаЗначений], ИмяПоляСклад) Тогда
...
Функция ПересчитатьКоличествоЕдиницВЕТИС(Количество, Номенклатура, ЕдиницаИзмеренияВЕТИС, КэшированныеЗначения, ТекстОшибки = Неопределено) Экспорт
	...
	НовоеКоличествоВЕТИС = ИнтеграцияВЕТИСУТКлиентСервер.ПересчитатьКоличествоЕдиницВЕТИС(
										Количество,
										Номенклатура,
...
Функция ПересчитатьКоличествоЕдиниц(КоличествоВЕТИС, Номенклатура, ЕдиницаИзмеренияВЕТИС, КэшированныеЗначения, ТекстОшибки = Неопределено) Экспорт
	...
	НовоеКоличество = ИнтеграцияВЕТИСУТКлиентСервер.ПересчитатьКоличествоЕдиниц(
										КоличествоВЕТИС,
										Номенклатура,
										ЕдиницаИзмеренияВЕТИС,
										Истина,
...
Функция ПараметрыОформленияСерииПоДаннымСтроки(ДанныеСтроки) Экспорт
	...
	Возврат ИнтеграцияВЕТИСУТКлиентСервер.ПараметрыОформленияСерииПоДаннымСтроки("СерииВсегдаВТЧТовары", ДанныеСтроки);
