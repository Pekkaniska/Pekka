...
Процедура ДобавитьСчетаЗаполнения(ИмяФормы, ВидОтчета, ТаблицаСчетов) Экспорт
	...
	Если ИмяФормы = "ФормаОтчета2017Кв3" Тогда
		Если ВидОтчета = "ОСВПоСчету" Тогда
			ДобавитьСчетаЗаполненияОСВПоСчету2017Кв3(ТаблицаСчетов);
		ИначеЕсли ВидОтчета = "АнализСчета" Тогда
			ДобавитьСчетаЗаполненияАнализСчета2017Кв3(ТаблицаСчетов);
		КонецЕсли;
...
Процедура ПолучитьСведенияОПоказателях(ИДРедакцииОтчета, ПоказателиОтчета, ПараметрыОтчета) Экспорт
	...
	Если ИДРедакцииОтчета = "ФормаОтчета2011Кв4" Тогда
		ДобавитьПоказатели2011Кв4(ПоказателиОтчета, ПараметрыОтчета);
		
	ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2017Кв3" Тогда
		ДобавитьПоказатели2017Кв3(ПоказателиОтчета);
...
Процедура ЗаполнитьОтчетБухгалтерскаяОтчетностьВБанкФормаОтчета2011Кв4(ПараметрыОтчета, Контейнер)
	...
	Для Каждого Организация Из ПолныйСписокОрганизаций Цикл
		...
		Если ЗаполнятьДополнительныеПоказатели Тогда
			...
			ЗаполнитьОтчетБухгалтерскаяОтчетностьВБанкФормаОтчета2011Кв4_ДополнительныеПоказателиПоГрафе(КонтекстВыполнения);
		...
		Если ЗаполнятьОСВ_66 Тогда
			...
			Если СведенияОСВ.Количество() <> 0 Тогда
				Для Каждого СтрокаОСВ из СведенияОСВ Цикл
					...
					ГрафикПлатежей = ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ГрафикПлатежейКредитовДепозитов(СтрокаОСВ.Договор);
...
Процедура ДобавитьПоказатели2011Кв4(ПоказателиОтчета, ПараметрыОтчета)
	...
	Иначе
		...
		ЗаписьЖурналаРегистрации("Заполнение бухгалтерской отчетности", УровеньЖурналаРегистрации.Ошибка, , , СтрокаОшибки + " - """ + ИмяСекцииПоказателей + """");
...
Процедура ДобавитьПоказатели2017Кв3(ПоказателиОтчета)
	
	ВнестиСведенияОПоказателяхФормаОтчета2017Кв3_Баланс(ПоказателиОтчета);
	ВнестиСведенияОПоказателяхФормаОтчета2017Кв3_ОФР(ПоказателиОтчета);
...
Процедура ВнестиСведенияОПоказателяхФормаОтчета2017Кв3_ОФР(ПоказателиОтчета)
...
Процедура ДобавитьСчетаЗаполненияОСВПоСчету2017Кв3(ТаблицаСчетов)
	
	ДобавитьОбщиеСчетаЗаполненияОСВПоСчетуАнализаСчета2017Кв3_Часть1(ТаблицаСчетов);
	...
	ДобавитьОбщиеСчетаЗаполненияОСВПоСчетуАнализаСчета2017Кв3_Часть2(ТаблицаСчетов);
...
Процедура ДобавитьСчетаЗаполненияАнализСчета2017Кв3(ТаблицаСчетов)
...
Процедура ДобавитьОбщиеСчетаЗаполненияОСВПоСчетуАнализаСчета2017Кв3_Часть1(ТаблицаСчетов)
...
Процедура ДобавитьОбщиеСчетаЗаполненияОСВПоСчетуАнализаСчета2017Кв3_Часть2(ТаблицаСчетов)
...
Процедура ЗаполнитьОтчетБухгалтерскаяОтчетностьВБанкФормаОтчета2011Кв4_ДополнительныеПоказателиПоГрафе(КонтекстВыполнения) Экспорт
	...
	ЗаполнитьОтчетБухгалтерскаяОтчетностьВБанкФормаОтчета2011Кв4_ДополнительныеПоказателиПоГрафе_Строка5030(КонтекстВыполнения);
	
	// Строка 5040.
	
	ЗаполнитьОтчетБухгалтерскаяОтчетностьВБанкФормаОтчета2011Кв4_ДополнительныеПоказателиПоГрафе_Строка5040(КонтекстВыполнения);
	...
	ПараметрыРасшифровки = НастройкиЗадолженностиПокупателей(ОбщиеПараметрыРасшифровки);
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, ЗаголовокРасшифровки, "+", НаименованиеСтроки, ЗначениеПоказателя, ИмяРаздела, ПараметрыРасшифровки);
	...
	ПараметрыРасшифровки = НастройкиЗадолженностиПоставщикам(ОбщиеПараметрыРасшифровки);
	ДобавитьСтрокуРасшифровки(ТаблицаРасшифровки, ИмяОбластиПоказателя, ЗаголовокРасшифровки, "+", НаименованиеСтроки, ЗначениеПоказателя, ИмяРаздела, ПараметрыРасшифровки);
...
Процедура ЗаполнитьОтчетБухгалтерскаяОтчетностьВБанкФормаОтчета2011Кв4_ДополнительныеПоказателиПоГрафе_Строка5030(КонтекстВыполнения)
...
Процедура ЗаполнитьОтчетБухгалтерскаяОтчетностьВБанкФормаОтчета2011Кв4_ДополнительныеПоказателиПоГрафе_Строка5040(КонтекстВыполнения)
	...
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДобавитьСчета(СчетаАвансов, "РаботникиОрганизаций, Лизинг, НДСПоАренде");
...
Процедура Заполнить2017Кв3_РасшифровкиОбеспеченийПолученные(ПараметрыОтчета)
	...
	НачалоПериода = НачалоКвартала(ПараметрыОтчета.мДатаКонцаПериодаОтчета);
	...
	ПараметрыЗаполнения.Вставить("НачалоПериода", НачалоПериода);
	ПараметрыЗаполнения.Вставить("КонецПериода", КонецПериода);
	ПараметрыЗаполнения.Вставить("СчетОСВ", Счет("008"));
	ПараметрыЗаполнения.Вставить("Макет", ПараметрыОтчета[ИмяРаздела + "_МакетРаздела"]);
	
	ДанныеИПредставлениеСтраницы = Новый Структура;
	
	Заполнить2017Кв3_РасшифровкиОбеспечений_ЗаПериод(ДанныеИПредставлениеСтраницы, ПараметрыЗаполнения);
...
Процедура Заполнить2017Кв3_РасшифровкиОбеспеченийВыданные(ПараметрыОтчета)
	...
	ПараметрыЗаполнения.Вставить("НачалоПериода", НачалоПериода);
	ПараметрыЗаполнения.Вставить("КонецПериода", КонецПериода);
	ПараметрыЗаполнения.Вставить("СчетОСВ", Счет("009"));
	ПараметрыЗаполнения.Вставить("Макет", ПараметрыОтчета[ИмяРаздела + "_МакетРаздела"]);
...
Процедура Заполнить2017Кв3_РасшифровкиОбеспечений_ЗаПериод(ЗаполняемаяСтруктура, ПараметрыЗаполнения)
	...
	СчетОСВ        = ПараметрыЗаполнения.СчетОСВ;
	...
	ПараметрыОСВ.Вставить("Счет", СчетОСВ);
	
	ВиртуальныеПараметрыОтчета = Новый Структура;
	ВиртуальныеПараметрыОтчета.Вставить("мДатаНачалаПериодаОтчета", НачалоПериода);
	ВиртуальныеПараметрыОтчета.Вставить("мДатаКонцаПериодаОтчета",  КонецПериода);
	
	СведенияСтраницы = ОСВ_ПоКонтрагентамДоговорам(ПараметрыОСВ);
	ТабличныйДокументСтраницы = ПредставлениеРасшифровкиОбеспечений(Макет, СведенияСтраницы, ВиртуальныеПараметрыОтчета);
...
Процедура Заполнить2017Кв3_ЗадолженностьПоКредитамЗаймам_ЗаПериод(ПараметрыЗаполнения, СтраницаРаздела)
	...
	Если СведенияОСВ.Количество() <> 0 Тогда
		Для Каждого СтрокаОСВ из СведенияОСВ Цикл
			...
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100001", СтрокаОСВ.КодСчета);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100002", СтрокаОСВ.СНД);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100003", СтрокаОСВ.СНК);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100004", СтрокаОСВ.ДО);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100005", СтрокаОСВ.КО);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100006", СтрокаОСВ.СКД);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100007", СтрокаОСВ.СКК);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100008", СтрокаОСВ.КонтрагентНаименование);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100009", СтрокаОСВ.КонтрагентИНН);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100010", СтрокаОСВ.КонтрагентКПП);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100011", СтрокаОСВ.Договор);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100012", СтрокаОСВ.ДоговорНомер);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100013", СтрокаОСВ.ДоговорДата);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100014", СтрокаОСВ.ДоговорСрокДействия);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100015", СтрокаОСВ.Продукт);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100016", СтрокаОСВ.Сумма);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100017", СтрокаОСВ.Валюта);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100018", СтрокаОСВ.Процент);
			...
			Для каждого СтрокаИсточник Из ГрафикПлатежей Цикл
				...
				СтрокаМСЧ2.Данные.Вставить(ПрефиксМСЧ + "М200002", СтрокаИсточник.СуммаПлатежа);
		...
		ЗаполнитьРасшифровку_ЗадолженностьПоКредитамЗаймам(ТаблицаРасшифровки, ПараметрыЗаполнения, СведенияОСВ);
...
Процедура Заполнить2017Кв3_Операции51(ПараметрыОтчета)
	...
	СводныеДанные = Заполнить2017Кв3_Операции_СводныеСведения(ПараметрыОтчета, СчетВерхнегоУровня);
...
Функция Заполнить2017Кв3_Операции_СводныеСведения(ПараметрыОтчета, СчетВерхнегоУровня)
	
	СводныеДанные = Заполнить2017Кв3_Операции_НовыеСводныеДанные();
	
	СтрокаСчетаВерхнегоУровня = СводныеДанные.Строки.Добавить();
	СтрокаСчетаВерхнегоУровня.Счет = СчетВерхнегоУровня;
	СтрокаСчетаВерхнегоУровня.Представление = СчетВерхнегоУровня.Код;
	
	Запрос = Заполнить2017Кв3_Операции_НовыйЗапросСПараметрами(ПараметрыОтчета);
	...
	Запрос.УстановитьПараметр("СчетаУчета", БухгалтерскийУчетПовтИсп.СчетаВИерархии(СчетВерхнегоУровня));
...
Функция Заполнить2017Кв3_Операции_НовыйЗапросСПараметрами(ПараметрыОтчета)
...
Процедура Заполнить2017Кв3_Операции_СводныеСведенияПоСубсчету(СтрокиПоСубсчетам, ВыборкаПоСубсчетам, Запрос)
	...
	Иначе
		...
		Запрос.Текст =
			...
			|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ ТаблицаБанковскиеСчетаПереопределяемый КАК БанковскиеСчета
...
Процедура Заполнить2017Кв3_Операции_ДетальныеСведения(ПараметрыОтчета, СчетВерхнегоУровня)
	...
	Запрос.Текст =
		...
		|	ВЫБОР
		|		КОГДА ХозрасчетныйДвиженияССубконто.ВидСубконтоДт1 В (&ВидыСубконтоКонтрагентов)
		|			ТОГДА ХозрасчетныйДвиженияССубконто.СубконтоДт1
		|		КОГДА ХозрасчетныйДвиженияССубконто.ВидСубконтоДт2 В (&ВидыСубконтоКонтрагентов)
		|			ТОГДА ХозрасчетныйДвиженияССубконто.СубконтоДт2
		|		КОГДА ХозрасчетныйДвиженияССубконто.ВидСубконтоДт3 В (&ВидыСубконтоКонтрагентов)
		|			ТОГДА ХозрасчетныйДвиженияССубконто.СубконтоДт3
		|		КОГДА ХозрасчетныйДвиженияССубконто.ВидСубконтоКт1 В (&ВидыСубконтоКонтрагентов)
		|			ТОГДА ХозрасчетныйДвиженияССубконто.СубконтоКт1
		|		КОГДА ХозрасчетныйДвиженияССубконто.ВидСубконтоКт2 В (&ВидыСубконтоКонтрагентов)
		|			ТОГДА ХозрасчетныйДвиженияССубконто.СубконтоКт2
		|		КОГДА ХозрасчетныйДвиженияССубконто.ВидСубконтоКт3 В (&ВидыСубконтоКонтрагентов)
		|			ТОГДА ХозрасчетныйДвиженияССубконто.СубконтоКт3
		|	КОНЕЦ КАК Контрагент,
		|	ВЫБОР
		|		КОГДА ХозрасчетныйДвиженияССубконто.ВидСубконтоДт1 В (&ВидыСубконтоДоговоров)
		|			ТОГДА ХозрасчетныйДвиженияССубконто.СубконтоДт1
		|		КОГДА ХозрасчетныйДвиженияССубконто.ВидСубконтоДт2 В (&ВидыСубконтоДоговоров)
		|			ТОГДА ХозрасчетныйДвиженияССубконто.СубконтоДт2
		|		КОГДА ХозрасчетныйДвиженияССубконто.ВидСубконтоДт3 В (&ВидыСубконтоДоговоров)
		|			ТОГДА ХозрасчетныйДвиженияССубконто.СубконтоДт3
		|		КОГДА ХозрасчетныйДвиженияССубконто.ВидСубконтоКт1 В (&ВидыСубконтоДоговоров)
		|			ТОГДА ХозрасчетныйДвиженияССубконто.СубконтоКт1
		|		КОГДА ХозрасчетныйДвиженияССубконто.ВидСубконтоКт2 В (&ВидыСубконтоДоговоров)
		|			ТОГДА ХозрасчетныйДвиженияССубконто.СубконтоКт2
		|		КОГДА ХозрасчетныйДвиженияССубконто.ВидСубконтоКт3 В (&ВидыСубконтоДоговоров)
		|			ТОГДА ХозрасчетныйДвиженияССубконто.СубконтоКт3
		|	КОНЕЦ КАК Договор,
		|	ВЫБОР
		|		КОГДА ХозрасчетныйДвиженияССубконто.СчетДт В (&СчетаУчета)
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ДокументыПоСчету КАК ВТ_ДокументыПоСчету
		...
		|	ЕСТЬNULL(ДанныеКонтрагентов.ИНН, """") КАК ИНН,
		|	ЕСТЬNULL(ДанныеКонтрагентов.КПП, """") КАК КПП,
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ДанныеКонтрагентов КАК ДанныеКонтрагентов
		|		ПО ВТ_ОперацииПоСчету.Контрагент = ДанныеКонтрагентов.Ссылка
		|
		|УПОРЯДОЧИТЬ ПО
		|	ДатаОперации,
		|	Документ,
	...
	ВидыСубконтоКонтрагентов = ВидыСубконтоПоСтроке("Комиссионеры,Контрагенты,Продавцы,РаботникиОрганизаций,Учредители");
	ВидыСубконтоДоговоров = ВидыСубконтоПоСтроке("Договоры");
	Запрос.УстановитьПараметр("ВидыСубконтоКонтрагентов", ВидыСубконтоКонтрагентов);
	Запрос.УстановитьПараметр("ВидыСубконтоДоговоров", ВидыСубконтоДоговоров);
	...
	Пока ВыборкаПоБанковскимСчетам.Следующий() Цикл
		...
		Пока ВыборкаПоОперациям.Следующий() Цикл
			...
			ИмяФайла = НСтр("ru = 'Сегмент %1 перечня проводок по счету %2'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()); // строка записывается в ИБ
...
Функция ЗапросОСВПоСчету(ПараметрыЗаполнения)
	...
	ШаблонЗапроса = "ВЫБРАТЬ
	                ...
	                |	ХозрасчетныйОстаткиИОбороты.Субконто2.ИНН,
	                |	ХозрасчетныйОстаткиИОбороты.Субконто2.КПП
	                |ИЗ
	...
	Для Инд = 1 По ПараметрыСчета.Количество() - 1 Цикл
		...
		Если ПараметрыСчета[Инд].Субконто.Количество() < 2 Тогда
			...
			ТекстСегментаЗапроса = СтрЗаменить(ТекстСегментаЗапроса, "ХозрасчетныйОстаткиИОбороты.Субконто2.ИНН", "null");
			ТекстСегментаЗапроса = СтрЗаменить(ТекстСегментаЗапроса, "ХозрасчетныйОстаткиИОбороты.Субконто2.КПП", "null");
...
Процедура УстановитьПараметрыСчета(ОтправляемыйСчет, ПараметрыСчета)
...
Процедура УстановитьПараметрыСчета_01(ПараметрыСчета)
	...
	СтрокаПараметров.Счета    = Новый Массив;
	СтрокаПараметров.Субконто = Новый Массив;
	СтрокаПараметров.Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.ОсновныеСредства);
...
Процедура УстановитьПараметрыСчета_04(ПараметрыСчета)
	...
	СтрокаПараметров.Счета    = Новый Массив;
	СтрокаПараметров.Субконто = Новый Массив;
	СтрокаПараметров.Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.НематериальныеАктивы);
...
Процедура УстановитьПараметрыСчета_08(ПараметрыСчета)
	...
	СтрокаПараметров.Счета    = Новый Массив;
	СтрокаПараметров.Субконто = Новый Массив;
	СтрокаПараметров.Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.ОбъектыСтроительства);
...
Процедура УстановитьПараметрыСчета_09(ПараметрыСчета)
	...
	СтрокаПараметров.Счета    = Новый Массив;
	СтрокаПараметров.Субконто = Новый Массив;
	СтрокаПараметров.Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.ВидыАктивовИОбязательств);
...
Процедура УстановитьПараметрыСчета_50(ПараметрыСчета)
	...
	СтрокаПараметров.Счета    = Новый Массив;
	СтрокаПараметров.Субконто = Новый Массив;
	СтрокаПараметров.Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.СтатьиДвиженияДенежныхСредств);
...
Процедура УстановитьПараметрыСчета_51(ПараметрыСчета)
	...
	СтрокаПараметров.Счета    = Новый Массив;
	СтрокаПараметров.Субконто = Новый Массив;
	СтрокаПараметров.Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.БанковскиеСчета);
	СтрокаПараметров.Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.СтатьиДвиженияДенежныхСредств);
...
Процедура УстановитьПараметрыСчета_58(ПараметрыСчета)
	...
	СтрокаПараметров.Счета    = Новый Массив;
	СтрокаПараметров.Субконто = Новый Массив;
	СтрокаПараметров.Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Контрагенты);
	СтрокаПараметров.Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Договоры);
	
	СтрокаПараметров = ПараметрыСчета.Добавить();
	СтрокаПараметров.Счета    = Новый Массив;
	СтрокаПараметров.Субконто = Новый Массив;
	СтрокаПараметров.Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Контрагенты);
	СтрокаПараметров.Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.ЦенныеБумаги);
...
Процедура УстановитьПараметрыСчета_68(ПараметрыСчета)
	...
	СтрокаПараметров.Счета    = Новый Массив;
	СтрокаПараметров.Субконто = Новый Массив;
	СтрокаПараметров.Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.ВидыПлатежейВГосБюджет);
...
Процедура УстановитьПараметрыСчета_79(ПараметрыСчета)
	...
	СтрокаПараметров.Счета    = Новый Массив;
	СтрокаПараметров.Субконто = Новый Массив;
	СтрокаПараметров.Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.ОбособленныеПодразделения);
...
Процедура УстановитьПараметрыСчета_86(ПараметрыСчета)
	...
	СтрокаПараметров.Счета    = Новый Массив;
	СтрокаПараметров.Субконто = Новый Массив;
	НазначениеЦелевыхСредств = ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ПредопределенныйЭлемент("ПланВидовХарактеристик.ВидыСубконтоХозрасчетные.НазначениеЦелевыхСредств");
	СтрокаПараметров.Субконто.Добавить(НазначениеЦелевыхСредств);
	СтрокаПараметров.Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.Договоры);
...
Процедура УстановитьПараметрыСчета_90(ПараметрыСчета)
	...
	СтрокаПараметров.Счета    = Новый Массив;
	СтрокаПараметров.Субконто = Новый Массив;
	СтрокаПараметров.Субконто.Добавить(ПланыВидовХарактеристик.ВидыСубконтоХозрасчетные.НоменклатурныеГруппы);
...
Процедура Заполнить2017Кв3_ЛизингОбязательства(ПараметрыОтчета)
	...
	Заполнить2017Кв3_ЛизингОбязательства_ЗаПериод(ПараметрыЗаполнения, СтраницаРаздела);
	
	ПоместитьВоВременноеХранилище(ДанныеРаздела, ПараметрыОтчета[ИмяРаздела + "_АдресДанныхРаздела"]);
	
КонецПроцедуры

Процедура Заполнить2017Кв3_ЛизингОбязательства_ЗаПериод(ПараметрыЗаполнения, СтраницаРаздела)
	...
	СведенияОСВ = ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ОСВ_ПоЛизингу(ПараметрыОСВ);
	...
	Если СведенияОСВ.Количество() <> 0 Тогда
		Для Каждого СтрокаОСВ из СведенияОСВ Цикл
			...
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100105", СтрокаОСВ.ДоговорДата);
			...
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100113", СтрокаОСВ.ДатаПоследнегоПлатежа);
			СтрокаМСЧ1.Данные.Вставить(ПрефиксМСЧ + "М100114", СтрШаблон(НСтр("ru = 'Договор: ""%1""'"), СтрокаОСВ.ДоговорПредставление));
			СтрокаМСЧ1.ДанныеМногострочныхЧастей = Новый Структура;
...
Функция ОСВ_ПоКонтрагентамДоговорам(ПараметрыОСВ)
	...
	ТекстЗапроса = "ВЫБРАТЬ
	               |	ХозрасчетныйОстаткиИОбороты.Счет.Код КАК КодСчета,
	               |	ХозрасчетныйОстаткиИОбороты.Субконто1.Наименование КАК КонтрагентНаименование,
	               |	ХозрасчетныйОстаткиИОбороты.Субконто1.ИНН КАК КонтрагентИНН,
	               |	ХозрасчетныйОстаткиИОбороты.Субконто1.КПП КАК КонтрагентКПП,
	               |	ДоговорыКонтрагентов.Наименование КАК ДоговорПредставление,
	               |	ДоговорыКонтрагентов.Номер КАК ДоговорНомер,
	               |	ДоговорыКонтрагентов.Дата КАК ДоговорДата,
	               |	ДоговорыКонтрагентов.СрокДействия КАК ДоговорСрокДействия,
	               |	ХозрасчетныйОстаткиИОбороты.СуммаНачальныйОстатокДт КАК СНД,
	               |	ХозрасчетныйОстаткиИОбороты.СуммаНачальныйОстатокКт КАК СНК,
	               |	ХозрасчетныйОстаткиИОбороты.СуммаОборотДт КАК ДО,
	               |	ХозрасчетныйОстаткиИОбороты.СуммаОборотКт КАК КО,
...
Функция ОСВ_ПоКредитамЗаймам(ПараметрыОСВ)
	...
	ТекстЗапроса = "ВЫБРАТЬ
				   ...
				   |	ЕСТЬNULL(ДоговорыКредитовДепозитов.Валюта, """") КАК Валюта,
...
Функция СпособыОбработкиСчетовПояснений5()
	// Метод аналогичный почти ЗаполнениеБухгалтерскойОтчетностиПояснения.СпособыОбработкиСчетовПояснений5. Может стоить сделать тот метод экспортным и обращаться к нему?
...
Процедура РазместитьРезультатыАвтозаполнения(СтраницаРаздела, РассчитанныеПоказатели)
...
Процедура РазместитьРасшифровкуАвтозаполнения(ПараметрыЗаполнения, СтраницаРаздела, ТаблицаРасшифровки)
...
Процедура ДобавитьСчетВТаблицу(ТаблицаСчетов, ПредопределенноеИмя)
...
Функция ВидыСубконтоПоСтроке(ИменаВидовСубконтоСтрокой)
	
	ВидыСубконто = Новый Массив;
	Для каждого ИмяВидаСубконто Из СтрРазделить(ИменаВидовСубконтоСтрокой, ",") Цикл
		ВидСубконто = ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ПредопределенныйЭлемент("ПланВидовХарактеристик.ВидыСубконтоХозрасчетные." + ИмяВидаСубконто);
...
Функция НастройкиЗадолженностиПокупателей(ОбщиеНастройки) Экспорт
...
Функция НастройкиЗадолженностиПоставщикам(ОбщиеНастройки) Экспорт
...
Процедура ЗаполнитьРасшифровку_ЛизингОбязательства(ТаблицаРасшифровки, ПараметрыЗаполнения, ДанныеЗаполнения) Экспорт
	...
	Для каждого СтрокаДанных Из ДанныеЗаполнения Цикл
		...
		НастройкиРасшифровки = Новый Структура;
		НастройкиРасшифровки.Вставить("Отчет", Новый Структура);
		НастройкиРасшифровки.Отчет.Вставить("ИмяОтчета", "Отчет.РеестрДоговоровЛизинга.Форма");
		НастройкиРасшифровки.Отчет.Вставить("ПараметрыФормы", Новый Структура);
		НастройкиРасшифровки.Отчет.ПараметрыФормы.Вставить("СформироватьПриОткрытии", Истина);
