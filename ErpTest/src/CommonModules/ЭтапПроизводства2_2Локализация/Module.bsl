...
Процедура ПередЗаписью(Объект, Отказ, РежимЗаписи, РежимПроведения) Экспорт
	...
	//++ Локализация
	УстановитьНеобходимостьВыборочнойРегистрацииВРеглУчете(Объект, Объект.ДополнительныеСвойства);
	//-- Локализация
...
#Область ТекстВключениеИсключениеНДСВСтоимость // (Дт 20 :: Кт 19.03)
	...
	|	ЕСТЬNULL(СчетаУчетаПрочихАктивов.Субконто1, ЗНАЧЕНИЕ(Перечисление.ТипыЗатратРегл.МатериальныеЗатраты)) КАК СубконтоДт1,
...
Процедура УстановитьНеобходимостьВыборочнойРегистрацииВРеглУчете(Объект, ДополнительныеСвойства)
...
Процедура УстановитьПараметрыВыборочнойРегистрацииКОтражениюВРеглУчете(Объект, ДополнительныеСвойства)
	...
	ИзменилисьПараметрыРегистрации = Неопределено;
	Если Не ДополнительныеСвойства.Свойство("ИзменилисьПараметрыРегистрацииВРеглУчете", ИзменилисьПараметрыРегистрации) Или Не ИзменилисьПараметрыРегистрации Тогда
		Возврат;
	КонецЕсли;
