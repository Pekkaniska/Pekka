...
Функция ЗапросСтатусаОформленияАктПостановкиНаБалансЕГАИС(ДокументОснование) Экспорт
	...
	Если ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ОприходованиеИзлишковТоваров") Тогда
		...
		Возврат ЗапросСтатусаОформленияАктПостановкиНаБалансЕГАИСНаОснованииОприходованияИзлишковТовара();
		
	ИначеЕсли ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ПересортицаТоваров") Тогда
	
		Возврат ЗапросСтатусаОформленияАктПостановкиНаБалансЕГАИСНаОснованииПересортицыТоваров();
...
// См. процедуру ИнтеграцияЕГАИСПереопределяемый.РассчитатьСтатусОформленияАктСписанияЕГАИС.
//
...
// См. процедуру ИнтеграцияЕГАИСПереопределяемый.ЗапросСтатусаОформленияАктСписанияЕГАИС.
//
Функция ЗапросСтатусаОформленияАктСписанияЕГАИС(ДокументОснование) Экспорт
	...
	Если ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ВнутреннееПотреблениеТоваров") Тогда
		...
		Возврат ЗапросСтатусаОформленияЕГАИСНаОснованииВнутреннееПотреблениеТоваров();
		
	ИначеЕсли ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.СписаниеНедостачТоваров") Тогда
		
		Возврат ЗапросСтатусаОформленияАктСписанияЕГАИСНаОснованииСписаниеНедостачТоваров();
		
	ИначеЕсли ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ПересортицаТоваров") Тогда
		
		Возврат ЗапросСтатусаОформленияАктСписанияЕГАИСНаОснованииПересортицаТоваров();
		
	ИначеЕсли ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ОтчетОРозничныхПродажах") Тогда
		
		Возврат ЗапросСтатусаОформленияАктСписанияЕГАИСНаОснованииОтчетОРозничныхПродажах();
		
	ИначеЕсли ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.СборкаТоваров") Тогда
		
		Возврат ЗапросСтатусаОформленияЕГАИСНаОснованииСборкаТоваров();
...
// См. процедуру ИнтеграцияЕГАИСПереопределяемый.РассчитатьСтатусОформленияВозвратИзРегистра2ЕГАИС.
//
...
// См. процедуру ИнтеграцияЕГАИСПереопределяемый.ЗапросСтатусаОформленияВозвратИзРегистра2ЕГАИС.
//
Функция ЗапросСтатусаОформленияВозвратИзРегистра2ЕГАИС(ДокументОснование) Экспорт
	...
	Если ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ТТНИсходящаяЕГАИС") Тогда
		...
		Возврат ЗапросСтатусаОформленияВозвратИзРегистра2ЕГАИСНаОснованииТТНИсходящаяЕГАИС();
...
// См. процедуру ИнтеграцияЕГАИСПереопределяемый.РассчитатьСтатусОформленияПередачаВРегистр2ЕГАИС.
//
...
// См. процедуру ИнтеграцияЕГАИСПереопределяемый.ЗапросСтатусаОформленияПередачаВРегистр2ЕГАИС.
//
Функция ЗапросСтатусаОформленияПередачаВРегистр2ЕГАИС(ДокументОснование) Экспорт
	...
	Если ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ТТНВходящаяЕГАИС") Тогда
		...
		Возврат ЗапросСтатусаОформленияПередачаВРегистр2ЕГАИСНаОснованииТТНВходящаяЕГАИС();
...
Функция ЗапросСтатусаОформленияТТНИсходящаяЕГАИС(ДокументОснование) Экспорт
	...
	Если ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ВозвратТоваровПоставщику") Тогда
		...
		Возврат ЗапросСтатусаОформленияТТНИсходящаяЕГАИСНаОснованииВозвратТоваровПоставщику();
		
	ИначеЕсли ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.РеализацияТоваровУслуг") Тогда
		
		Возврат ЗапросСтатусаОформленияЕГАИСНаОснованииРеализацииТоваровУслуг();
		
	ИначеЕсли ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ПеремещениеТоваров") Тогда
		
		Возврат ЗапросСтатусаОформленияТТНИсходящаяЕГАИСНаОснованииПеремещениеТоваров();
		
	ИначеЕсли ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ВозвратТоваровМеждуОрганизациями") Тогда
		
		Возврат ЗапросСтатусаОформленияТТНИсходящаяЕГАИСНаОснованииВозвратТоваровМеждуОрганизациями();
		
	ИначеЕсли ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ПередачаТоваровМеждуОрганизациями") Тогда
		
		Возврат ЗапросСтатусаОформленияТТНИсходящаяЕГАИСНаОснованииПередачаТоваровМеждуОрганизациями();
...
Функция ЗапросСтатусаОформленияТТНВходящаяЕГАИС(ДокументОснование) Экспорт
	...
	Если ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ПриобретениеТоваровУслуг") Тогда
		...
		Возврат ЗапросСтатусаОформленияТТНВходящаяЕГАИСНаОснованииПриобретениеТоваровУслуг();
		
	ИначеЕсли ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ПеремещениеТоваров") Тогда
		
		Возврат ЗапросСтатусаОформленияТТНВходящаяЕГАИСНаОснованииПеремещениеТоваров();
		
	ИначеЕсли ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ВозвратТоваровМеждуОрганизациями") Тогда
		
		Возврат ЗапросСтатусаОформленияТТНВходящаяЕГАИСНаОснованииВозвратТоваровМеждуОрганизациями();
		
	ИначеЕсли ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ПередачаТоваровМеждуОрганизациями") Тогда
		
		Возврат ЗапросСтатусаОформленияТТНВходящаяЕГАИСНаОснованииПередачаТоваровМеждуОрганизациями();
...
// См. процедуру ИнтеграцияЕГАИСПереопределяемый.РассчитатьСтатусОформленияЧекЕГАИС.
//
...
// См. процедуру ИнтеграцияЕГАИСПереопределяемый.ЗапросСтатусаОформленияЧекЕГАИС.
//
...
// См. процедуру ИнтеграцияЕГАИСПереопределяемый.РассчитатьСтатусОформленияЧекЕГАИСВозврат.
//
...
// См. процедуру ИнтеграцияЕГАИСПереопределяемый.ЗапросСтатусаОформленияЧекЕГАИСВозврат.
//
Функция ЗапросСтатусаОформленияЧекЕГАИСВозврат(ДокументОснование) Экспорт
	...
	Если ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ВозвратТоваровОтКлиента") Тогда
		...
		Возврат ЗапросСтатусаОформленияЧекЕГАИСВозвратНаОснованииВозвратТоваровОтКлиента();
...
Процедура ЗаполнитьАктПостановкиНаБалансНаОснованииОприходованияИзлишковТовара(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Запрос = Новый Запрос;
	Запрос.Текст = ТекстЗапросаЗаполнения("АктПостановкиНаБалансЕГАИС", "ОприходованиеИзлишковТоваров", "Товары");
...
Процедура ЗаполнитьАктПостановкиНаБалансНаОснованииПересортицыТоваров(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Запрос = Новый Запрос;
	Запрос.Текст = ТекстЗапросаЗаполнения("АктПостановкиНаБалансЕГАИС", "ПересортицаТоваров", "Товары")
	+"
	|;
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ ПЕРВЫЕ 2
...
Процедура ЗаполнитьАктСписанияЕГАИСНаОснованииСписанияНедостачТоваров(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Запрос = Новый Запрос;
	Запрос.Текст = ТекстЗапросаЗаполнения("АктСписанияЕГАИС", "СписаниеНедостачТоваров", "Товары");
...
Процедура ЗаполнитьАктСписанияЕГАИСНаОснованииПересортицыТоваров(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Запрос = Новый Запрос;
	Запрос.Текст = ТекстЗапросаЗаполнения("АктСписанияЕГАИС", "ПересортицаТоваров", "Товары");
...
Процедура ЗаполнитьАктСписанияЕГАИСНаОснованииСборкиТоваров(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	ВозможныеДокументыЕГАИС = "АктСписанияЕГАИС,ЧекЕГАИС";
	ДополнительноеУсловие   = "И ТабличнаяЧасть.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РазборкаТоваров)";
	
	Запрос = Новый Запрос;
	Запрос.Текст = ТекстЗапросаЗаполнения(ВозможныеДокументыЕГАИС, "СборкаТоваров", "Шапка", ДополнительноеУсловие);
...
Функция ЗапросСтатусаОформленияВозвратИзРегистра2ЕГАИСНаОснованииТТНИсходящаяЕГАИС()
	
	ТекстЗапроса = ТекстЗапросаСтатусаОформленияДляРегистра2("ВозвратИзРегистра2ЕГАИС", "ТТНИсходящаяЕГАИС");
...
Процедура ЗаполнитьЧекЕГАИСНаОснованииСборкиТоваров(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	|И И СправочникНоменклатура.ВидАлкогольнойПродукции.Маркируемый";
...
Процедура ЗаполнитьЧекЕГАИСНаОснованииВнутреннегоПотребленияТоваров(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	ВозможныеДокументыЕГАИС = "АктСписанияЕГАИС,ЧекЕГАИС";
	ДополнительноеУсловие   = "И СправочникНоменклатура.ВидАлкогольнойПродукции.Маркируемый";
...
Процедура СформироватьДанныеОснованияСписаниеНедостачТоваров(ДокументОснование, ДокументЕГАИС, ТаблицаДанных)
	...
	|	ИЗ
	|		Документ.АктСписанияЕГАИС.Товары КАК ОформленныеТовары
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.СписаниеНедостачТоваров.Товары КАК ТабличнаяЧасть
	...
	|				И (ТабличнаяЧасть.Серия = ОформленныеТовары.Серия)
	|	ГДЕ
...
//
// Параметры:
//  ТабличнаяЧасть        - Строка - табличная часть документа-основания (источник товаров), из списка:
//   * ТоварыСерии
//   * Товары
//   * Шапка
//
Функция ШаблонТоварыПрикладногоДокумента(ТабличнаяЧасть)
	...
	Если ТабличнаяЧасть = "ТоварыСерии" Тогда
		...
		|ПОМЕСТИТЬ ТоварыКОформлению
		|ИЗ
		|	Документ.%1.Товары КАК ТабличнаяЧасть
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Номенклатура КАК СправочникНоменклатура
		|		ПО ТабличнаяЧасть.Номенклатура = СправочникНоменклатура.Ссылка
		|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.%1.Серии КАК ТаблицаСерии
		|		ПО ТаблицаСерии.Ссылка = ТабличнаяЧасть.Ссылка
		|			И ТаблицаСерии.Номенклатура = ТабличнаяЧасть.Номенклатура
		|			И ТаблицаСерии.Характеристика = ТабличнаяЧасть.Характеристика
		|ГДЕ
		...
		|	0                             КАК Факт
		|ИЗ
		|	Документ.%1.Серии КАК ТабличнаяЧасть
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Номенклатура КАК СправочникНоменклатура
		|		ПО ТабличнаяЧасть.Номенклатура = СправочникНоменклатура.Ссылка
		|ГДЕ
		|	ТабличнаяЧасть.Ссылка = &ДокументОснование
...
// Функция возвращает шаблон запроса итога оформления товаров
// 
Функция ШаблонИтогоТовары()
...
// Функция возвращает шаблон запроса с расчетом расхождений по алкогольной продукции
// 
// Параметры:
//  ПересчитыватьНемаркированную - Булево - необходимость пересчета немаркированной продукции
//
Функция ШаблонИтогоАлкогольнойПродукции(ПересчитыватьНемаркированную)
	...
	Если ПересчитыватьНемаркированную Тогда
		...
		|			ТОГДА 1
		|		ИНАЧЕ ЕСТЬNULL(ОформленныеТовары.Номенклатура.ОбъемДАЛ, 1)
		|	КОНЕЦ                                  КАК Факт
		|ИЗ
		|	Документ.%2.Товары КАК ОформленныеТовары
		|ГДЕ
		|	ОформленныеТовары.Ссылка В (ВЫБРАТЬ Т.Ссылка ИЗ ОформленныеДокументы%2 КАК Т)
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
...
// Функция возвращает шаблон запроса итога расчета статусов
// 
Функция ШаблонСтатус()
...
// Функция возвращает текст запроса статуса оформления по шаблону
//
// Параметры:
...
//  ТабличнаяЧасть               - Строка - табличная часть документа-основания (источник товаров), из списка:
//   * ТоварыСерии (по умолчанию)
//   * Товары
//   * Шапка
//  ДополнительноеУсловие        - Строка - дополнительное условие отбора по документу-основанию
//  ПересчитыватьНемаркированную - Булево - необходимость пересчета с единиц ЕГАИС (для входящей ТТН)
// Возвращаемое значение:
//  Строка - текст запроса статуса оформления
//
Функция ТекстЗапросаСтатусаОформления(ИменаДокументов, ИмяДокументаОснования, ТабличнаяЧасть = "ТоварыСерии", ДополнительноеУсловие = "", ПересчитыватьНемаркированную = Ложь)
	...
	Шаблон = ШаблонОформленныеДокументы(Ложь);
	...
	Шаблон = ШаблонТоварыПрикладногоДокумента(ТабличнаяЧасть);
	МассивСтрок.Добавить(СтрШаблон(Шаблон,ИмяДокументаОснования,ДополнительноеУсловие));
	
	//ТЧ оформленных документов
	Шаблон = ШаблонОформленныеТовары(ПересчитыватьНемаркированную);
	Для Каждого ИмяДокумента Из ИменаДокументов Цикл
		МассивСтрок.Добавить(СтрШаблон(Шаблон,ИмяДокумента));
	КонецЦикла;
	
	//Сумма и итоговый статус
	Шаблон = ШаблонИтогоТовары();
...
// Функция возвращает текст запроса статуса оформления (документы Регистра 2, без прикладной номенклатуры) по шаблону
//
// Параметры:
//  ИмяДокумента                 - Строка - имя документа ЕГАИС по регистру2
//  ИмяДокументаОснования        - Строка - имя документа-основания
//  ПересчитыватьНемаркированную - Булево - необходимость пересчета с единиц ЕГАИС (для входящей ТТН)
// Возвращаемое значение:
//  Строка - текст запроса статуса оформления
//
Функция ТекстЗапросаСтатусаОформленияДляРегистра2(ИмяДокумента, ИмяДокументаОснования, ПересчитыватьНемаркированную = Ложь)
	...
	Шаблон = ШаблонИтогоАлкогольнойПродукции(ПересчитыватьНемаркированную);
	МассивСтрок.Добавить(СтрШаблон(Шаблон,ИмяДокументаОснования,ИмяДокумента));
...
Функция ЗапросСтатусаОформленияПередачаВРегистр2ЕГАИСНаОснованииТТНВходящаяЕГАИС()
	
	ТекстЗапроса = ТекстЗапросаСтатусаОформленияДляРегистра2("ПередачаВРегистр2ЕГАИС", "ТТНВходящаяЕГАИС", Истина);
	//Модификация поля Количество входящей ТТН
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,
		"	Товары.Количество",
		"	ВЫБОР
		|		КОГДА Товары.Ссылка.ЕстьРасхождения
		|			ТОГДА Товары.КоличествоФакт
...
Функция ЗапросСтатусаОформленияАктПостановкиНаБалансЕГАИСНаОснованииОприходованияИзлишковТовара()
	
	ТекстЗапроса = ТекстЗапросаСтатусаОформления("АктПостановкиНаБалансЕГАИС", "ОприходованиеИзлишковТоваров", "Товары");
	Возврат Новый Запрос(ТекстЗапроса);
...
Функция ЗапросСтатусаОформленияАктПостановкиНаБалансЕГАИСНаОснованииПересортицыТоваров()
	
	ТекстЗапроса = ТекстЗапросаСтатусаОформления("АктПостановкиНаБалансЕГАИС", "ПересортицаТоваров", "Товары");
	//В документе Пересортица товаров нестандартные поля оприходуемой номенклатуры
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "ТабличнаяЧасть.Номенклатура"  , "ТабличнаяЧасть.НоменклатураОприходование");
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "ТабличнаяЧасть.Характеристика", "ТабличнаяЧасть.ХарактеристикаОприходование");
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "ТабличнаяЧасть.Серия"         , "ТабличнаяЧасть.СерияОприходование");
	Возврат Новый Запрос(ТекстЗапроса);
	
КонецФункции

Функция ЗапросСтатусаОформленияАктСписанияЕГАИСНаОснованииПересортицаТоваров()
	
	ТекстЗапроса = ТекстЗапросаСтатусаОформления("АктСписанияЕГАИС", "ПересортицаТоваров", "Товары");
	Возврат Новый Запрос(ТекстЗапроса);
...
Функция ЗапросСтатусаОформленияЕГАИСНаОснованииВнутреннееПотреблениеТоваров()
	
	ВозможныеДокументыЕГАИС = "АктСписанияЕГАИС,ЧекЕГАИС";
	ТекстЗапроса = ТекстЗапросаСтатусаОформления(ВозможныеДокументыЕГАИС, "ВнутреннееПотреблениеТоваров");
	Возврат Новый Запрос(ТекстЗапроса);
...
Функция ЗапросСтатусаОформленияАктСписанияЕГАИСНаОснованииСписаниеНедостачТоваров()
	
	ТекстЗапроса = ТекстЗапросаСтатусаОформления("АктСписанияЕГАИС", "СписаниеНедостачТоваров", "Товары");
	Возврат Новый Запрос(ТекстЗапроса);
...
Функция ЗапросСтатусаОформленияАктСписанияЕГАИСНаОснованииОтчетОРозничныхПродажах()
	
	ДополнительноеУсловие = 
	"И НЕ СправочникНоменклатура.ВидАлкогольнойПродукции.Маркируемый";
	ТекстЗапроса = ТекстЗапросаСтатусаОформления("АктСписанияЕГАИС", "ОтчетОРозничныхПродажах",, ДополнительноеУсловие);
	Возврат Новый Запрос(ТекстЗапроса);
...
Функция ЗапросСтатусаОформленияЕГАИСНаОснованииСборкаТоваров()
	
	ДополнительноеУсловие   = "И ТабличнаяЧасть.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РазборкаТоваров)";
	ВозможныеДокументыЕГАИС = "АктСписанияЕГАИС,ЧекЕГАИС";
	ТекстЗапроса = ТекстЗапросаСтатусаОформления(ВозможныеДокументыЕГАИС, "СборкаТоваров", "Шапка", ДополнительноеУсловие);
	Возврат Новый Запрос(ТекстЗапроса);
...
Функция ЗапросСтатусаОформленияТТНИсходящаяЕГАИСНаОснованииВозвратТоваровПоставщику()
	
	ТекстЗапроса = ТекстЗапросаСтатусаОформления("ТТНИсходящаяЕГАИС", "ВозвратТоваровПоставщику");
	Возврат Новый Запрос(ТекстЗапроса);
...
Функция ЗапросСтатусаОформленияТТНИсходящаяЕГАИСНаОснованииПеремещениеТоваров()
	
	ТекстЗапроса = ТекстЗапросаСтатусаОформления("ТТНИсходящаяЕГАИС", "ПеремещениеТоваров");
	Возврат Новый Запрос(ТекстЗапроса);
	
КонецФункции

Функция ЗапросСтатусаОформленияТТНВходящаяЕГАИСНаОснованииПеремещениеТоваров()
	
	ТекстЗапроса = ТекстЗапросаСтатусаОформления("ТТНВходящаяЕГАИС", "ПеремещениеТоваров",,, Истина);
	Возврат Новый Запрос(ТекстЗапроса);
...
Функция ЗапросСтатусаОформленияТТНИсходящаяЕГАИСНаОснованииВозвратТоваровМеждуОрганизациями()
	
	ТекстЗапроса = ТекстЗапросаСтатусаОформления("ТТНИсходящаяЕГАИС", "ВозвратТоваровМеждуОрганизациями", "Товары");
	Возврат Новый Запрос(ТекстЗапроса);
	
КонецФункции


Функция ЗапросСтатусаОформленияТТНВходящаяЕГАИСНаОснованииВозвратТоваровМеждуОрганизациями()
	
	ТекстЗапроса = ТекстЗапросаСтатусаОформления("ТТНВходящаяЕГАИС", "ВозвратТоваровМеждуОрганизациями", "Товары",, Истина);
	Возврат Новый Запрос(ТекстЗапроса);
...
Функция ЗапросСтатусаОформленияТТНИсходящаяЕГАИСНаОснованииПередачаТоваровМеждуОрганизациями()
	
	ТекстЗапроса = ТекстЗапросаСтатусаОформления("ТТНИсходящаяЕГАИС", "ПередачаТоваровМеждуОрганизациями", "Товары");
	Возврат Новый Запрос(ТекстЗапроса);
	
КонецФункции

Функция ЗапросСтатусаОформленияТТНВходящаяЕГАИСНаОснованииПередачаТоваровМеждуОрганизациями()
	
	ТекстЗапроса = ТекстЗапросаСтатусаОформления("ТТНВходящаяЕГАИС", "ПередачаТоваровМеждуОрганизациями", "Товары",, Истина);
	Возврат Новый Запрос(ТекстЗапроса);
...
Функция ЗапросСтатусаОформленияЕГАИСНаОснованииРеализацииТоваровУслуг()
	
	ВозможныеДокументыЕГАИС = "ТТНИсходящаяЕГАИС,ЧекЕГАИС";
	ТекстЗапроса = ТекстЗапросаСтатусаОформления(ВозможныеДокументыЕГАИС, "РеализацияТоваровУслуг");
	Возврат Новый Запрос(ТекстЗапроса);
...
Функция ЗапросСтатусаОформленияТТНВходящаяЕГАИСНаОснованииПриобретениеТоваровУслуг()
	
	ТекстЗапроса = ТекстЗапросаСтатусаОформления("ТТНВходящаяЕГАИС", "ПриобретениеТоваровУслуг",,, Истина);
	Возврат Новый Запрос(ТекстЗапроса);
...
Функция ЗапросСтатусаОформленияЧекЕГАИСВозвратНаОснованииВозвратТоваровОтКлиента()
	
	ТекстЗапроса = ТекстЗапросаСтатусаОформления("ЧекЕГАИСВозврат", "ВозвратТоваровОтКлиента");
	Возврат Новый Запрос(ТекстЗапроса);
...
//  (вариант 1 - количественное заполнение)
// Параметры:
//  ИменаДокументов              - Массив,Строка - имена документов которые могут быть введены по документу-основанию
//  ИмяДокументаОснования        - Строка - имя документа-основания
//  ТабличнаяЧасть               - Строка - табличная часть документа-основания (источник товаров), из списка:
...
Функция ТекстЗапросаЗаполнения(ИменаДокументов, ИмяДокументаОснования, ТабличнаяЧасть = "ТоварыСерии", ДополнительноеУсловие = "", ПересчитыватьНемаркированную = Ложь)
...
Процедура ЗаполнитьТТНИсходящуюЕГАИСНаОснованииПеремещенияТоваров(ДокументОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	МассивСтрок.Добавить(СтрШаблон(ШаблонОформленныеДокументы(Истина),"ТТНИсходящаяЕГАИС"));
	МассивСтрок.Добавить(СтрШаблон(ШаблонТоварыПрикладногоДокумента("ТоварыСерии"),"ПеремещениеТоваров"));
...
Функция ЕстьАлкогольнаяПродукция(ДокументСсылка, ИмяТабличнойЧасти, ИмяКолонкиНоменклатура = "Номенклатура")
	...
	Запрос = Новый Запрос(
		СтрШаблон(
			...
			|	ИСТИНА КАК Поле1
			|ИЗ
			|	%1.%2 КАК ТабличнаяЧасть
			|ГДЕ
			|	     ТабличнаяЧасть.Ссылка = &ДокументСсылка
			|	И    ТабличнаяЧасть.%3.АлкогольнаяПродукция
			|	И Не ТабличнаяЧасть.%3.АлкогольнаяПродукцияВоВскрытойТаре",
...
Функция ЕстьМаркируемаяАлкогольнаяПродукция(ДокументСсылка, ИмяТабличнойЧасти, ИмяКолонкиНоменклатура = "Номенклатура")
	...
	Запрос = Новый Запрос(
		СтрШаблон(
			...
			|	И    ТабличнаяЧасть.%3.АлкогольнаяПродукция
			|	И Не ТабличнаяЧасть.%3.АлкогольнаяПродукцияВоВскрытойТаре
			|	И    ТабличнаяЧасть.%3.ВидАлкогольнойПродукции.Маркируемый",
			ДокументСсылка.Метаданные().ПолноеИмя(),
			ИмяТабличнойЧасти,
			ИмяКолонкиНоменклатура)
		);
...
Функция ЕстьНеМаркируемаяАлкогольнаяПродукция(ДокументСсылка, ИмяТабличнойЧасти, ИмяКолонкиНоменклатура = "Номенклатура")
	...
	Запрос = Новый Запрос(
		СтрШаблон(
			...
			|	И    ТабличнаяЧасть.%3.АлкогольнаяПродукция
			|	И Не ТабличнаяЧасть.%3.АлкогольнаяПродукцияВоВскрытойТаре
			|	И Не ТабличнаяЧасть.%3.ВидАлкогольнойПродукции.Маркируемый",
			ДокументСсылка.Метаданные().ПолноеИмя(),
			ИмяТабличнойЧасти,
			ИмяКолонкиНоменклатура)
		);
