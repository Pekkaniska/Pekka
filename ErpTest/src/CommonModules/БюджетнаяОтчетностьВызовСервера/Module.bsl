...
Функция ПолучитьПараметрыОтчета(ПараметрыОтчета, ДанныеЯчеек, СвязаннаяСтрокаДанных, ВидРасшифровки, ИмяПоказателя)
	...
	Если ЗначениеЗаполнено(НастройкиАналитики) Тогда
		...
		СтруктураРеквизитов.Вставить("Аналитика1", "ВидАналитики1");
		СтруктураРеквизитов.Вставить("Аналитика2", "ВидАналитики2"); 
		СтруктураРеквизитов.Вставить("Аналитика3", "ВидАналитики3");
		СтруктураРеквизитов.Вставить("Аналитика4", "ВидАналитики4");
		СтруктураРеквизитов.Вставить("Аналитика5", "ВидАналитики5");
		СтруктураРеквизитов.Вставить("Аналитика6", "ВидАналитики6");
