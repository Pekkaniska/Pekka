...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	Списки.Вставить(Метаданные.РегистрыСведений.УдалитьЛицевыеСчетаСотрудниковПоЗарплатнымПроектам, Истина);
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "РегистрыСведений.УдалитьЛицевыеСчетаСотрудниковПоЗарплатнымПроектам.ЗаполнитьЗарплатныйПроект";
	...
	Обработчик.Процедура = "РегистрыСведений.УдалитьЛицевыеСчетаСотрудниковПоЗарплатнымПроектам.ЗаполнитьПериодРегистрации";
...
//
Функция СоответствиеПолейФайла(ВидОперации, ФорматФайла = Неопределено)
...
Функция СостояниеЗачисленияЗарплатыДляПодтверждения(ПодтверждениеЗачисленияЗарплаты) Экспорт
	...
	Если Не ЭтоВедомостьВБанк(ПервичныйДокумент) Тогда
	...
	Для каждого ДанныеСотрудника Из ДанныеСотрудников Цикл
		...
		Если ЗаявкаНаОткрытиеЛицевыхСчетов = Неопределено Тогда
			...
			Если ДанныеПоЛицевымСчетамСотрудника <> Неопределено Тогда
				...
				СтрокаОткрытиеЛицевыхСчетов.АнкетаЗаполнена = АнкетаЗаполнена(СтрокаОткрытиеЛицевыхСчетов);
				Продолжить;
			КонецЕсли;
		КонецЕсли;
		...
		ИмяЛатиницей     = СтроковыеФункцииКлиентСервер.СтрокаЛатиницей(ДанныеСотрудника.Имя);
		ФамилияЛатиницей = СтроковыеФункцииКлиентСервер.СтрокаЛатиницей(ДанныеСотрудника.Фамилия);
...
//
Функция АнкетаЗаполнена(СтрокаОткрытиеЛицевыхСчетов)
