...
Функция ЗаголовокДокументаВводОстатковПоТипуОперации(Документ, НомерДокумента, ДатаДокумента, ТипОперации) Экспорт
	...
	//++ НЕ УТ
	ИначеЕсли ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиПрочихРасходовУСН Тогда
			Заголовок = ?(ЗначениеЗаполнено(Документ.Ссылка),
							НСтр("ru = 'Расходы по УСН (прочие) %1 от %2'"),
							НСтр("ru = 'Расходы по УСН (прочие) (создание)'"));
	ИначеЕсли ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиРасходовУСНПоТоварам Тогда
			Заголовок = ?(ЗначениеЗаполнено(Документ.Ссылка),
							НСтр("ru = 'Расходы по УСН (товары) %1 от %2'"),
							НСтр("ru = 'Расходы по УСН (товары) (создание)'"));
	ИначеЕсли ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиРасходовУСНПоМатериалам Тогда
			Заголовок = ?(ЗначениеЗаполнено(Документ.Ссылка),
							НСтр("ru = 'Расходы по УСН (материалы) %1 от %2'"),
							НСтр("ru = 'Расходы по УСН (материалы) (создание)'"));
	//-- НЕ УТ
	КонецЕсли;
