...
//
Процедура ЗаполнитьСопоставленнуюНоменклатуруПоАкцизнойМарке(Штрихкод, ДанныеШтрихкода, КэшКодовАлкогольнойПродукции) Экспорт
...
Функция ПолучитьДанныеПоШтрихкодам(СписокШтрихкодов, ПараметрыСканированияАкцизныхМарок, КэшированныеЗначения, УникальныйИдентификатор) Экспорт
	...
	Иначе
		// В форме проверки и подбора адрес дерева упаковок используется при обработке штрихкодов.
		Если ПараметрыСканированияАкцизныхМарок.ИспользуетсяСоответствиеШтрихкодовСтрокДерева
	...
	Для Каждого КлючЗначение Из ДанныеПоШтрихкодам.ОбработанныеШтрихкоды Цикл
		...
		Если РезультатОбработки.ТребуетсяВыборНоменклатуры Тогда
			...
			РезультатОбработки.ПараметрыВыбораНоменклатуры.Вставить("ЗначениеШтрихкода",             ДанныеШтрихкода.Штрихкод);
			...
			РезультатОбработки.ПараметрыВыбораНоменклатуры.Вставить("АдресДанныхДокументаОснования", ПараметрыСканированияАкцизныхМарок.АдресДанныхДокументаОснования);
			РезультатОбработки.ПараметрыВыбораНоменклатуры.Вставить("ДокументОснование",             ПараметрыСканированияАкцизныхМарок.ДокументОснование);
