...
Функция ОписаниеФильтраСоздатьВТСостоянияСотрудниковНаДаты() Экспорт
	...
	ОписаниеФильтра.ТаблицаФильтра = "ВТСотрудникиПериоды";
	ОписаниеФильтра.ИзмеренияФильтра = "Сотрудник,Период";
...
//
// Возвращаемое значение:
//		СписокСостояний - Массив - Значений перечисления СостоянияСотрудника.
//
Функция СостоянияОтклоненийСотрудников() Экспорт
	...
	СписокСостояний.Добавить(Перечисления.СостоянияСотрудника.ВынужденныйПрогул);
	СписокСостояний.Добавить(Перечисления.СостоянияСотрудника.ПростойПоВинеРаботника);
	СписокСостояний.Добавить(Перечисления.СостоянияСотрудника.ПростойПоВинеРаботодателя);
	СписокСостояний.Добавить(Перечисления.СостоянияСотрудника.ПростойНеЗависящийОтРаботодателяИРаботника);
	...
	СписокСостояний.Добавить(Перечисления.СостоянияСотрудника.ОтсутствиеССохранениемОплаты);
	СписокСостояний.Добавить(Перечисления.СостоянияСотрудника.ВыполнениеГосударственныхОбязанностей);
	СписокСостояний.Добавить(Перечисления.СостоянияСотрудника.ОтсутствиеПоНевыясненнымПричинам);
	СписокСостояний.Добавить(Перечисления.СостоянияСотрудника.Болезнь);
	СписокСостояний.Добавить(Перечисления.СостоянияСотрудника.БолезньБезОплаты);
...
//
Функция ПредставлениеСостоянияСотрудника(Состояние) Экспорт
