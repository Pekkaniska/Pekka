...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	...
	Объекты.Добавить(Метаданные.Документы.РегистрацияНаработок);
	...
	Объекты.Добавить(Метаданные.Справочники.ВариантыГрафиковЛизинга);
	...
	//++ Рарус Лимаренко 28.05.2018
	Объекты.Добавить(Метаданные.Документы.пкЗаданиеНаПеревозку);
	Объекты.Добавить(Метаданные.Документы.пкЗаданиеНаРемонт);
	Объекты.Добавить(Метаданные.Документы.пкЗаказНаряд);
	Объекты.Добавить(Метаданные.Документы.пкЗаявкаНаАрендуТехники);
	Объекты.Добавить(Метаданные.Документы.пкЗаявкаНаВыездМеханика);
	Объекты.Добавить(Метаданные.Документы.пкОперацииСТехникой);
	Объекты.Добавить(Метаданные.Документы.пкДоставка);
	Объекты.Добавить(Метаданные.Документы.пкКорректировкаНетиповыхРегистров);
	Объекты.Добавить(Метаданные.Документы.пкИзменениеСтатусаТехники);
	Объекты.Добавить(Метаданные.Документы.пкЗаявкаНаРемонтУДилера);
	Объекты.Добавить(Метаданные.Документы.пкВыдачаТопливныхКарт);
	Объекты.Добавить(Метаданные.Документы.пкИнвентаризацияРасчетовСКонтрагентами);
	Объекты.Добавить(Метаданные.Документы.пкПретензия);
	Объекты.Добавить(Метаданные.Документы.пкСудебныйИск);	
	Объекты.Добавить(Метаданные.Документы.уатВводВЭксплуатациюТСиОборудования);
	Объекты.Добавить(Метаданные.Документы.пкЗаправочнаяВедомость);
	Объекты.Добавить(Метаданные.Справочники.пкДополнительныеСоглашенияКДоговорам);
	Объекты.Добавить(Метаданные.Документы.пкЗаявкаНаРемонтЗапчасти);
	Объекты.Добавить(Метаданные.Документы.пкОперацииСПультами);
	//-- Рарус Лимаренко 28.05.2018
