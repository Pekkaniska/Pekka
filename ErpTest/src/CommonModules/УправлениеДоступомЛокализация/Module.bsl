...
#КонецОбласти
	...
	#Область Дополнить_профиль_БухгалтерПоВнеоборотнымАктивам
	ОписаниеПрофиля = НайтиПрофиль("БухгалтерПоВнеоборотнымАктивам", ОписанияПрофилей, ИндексПрофилей);
	ДополнитьПрофильОбязательнымиРолями(ОписаниеПрофиля);
...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	Списки.Вставить(Метаданные.Документы.РегистрацияНаработокТМЦВЭксплуатации, Истина);
