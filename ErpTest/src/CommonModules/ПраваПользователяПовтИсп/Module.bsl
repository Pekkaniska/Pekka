...
//++ НЕ УТ
Функция УтверждениеЭкземпляровБюджетов(Пользователь = Неопределено) Экспорт
	Возврат Пользователи.РолиДоступны("УтверждениеЭкземпляровБюджетов", Пользователь, Ложь);
КонецФункции
//-- НЕ УТ
