...
//			*ТолькоПросмотр - признак того, что доли стоимости в документе можно только просматривать (значение по умолчанию ЛОЖЬ).
//
...
Функция ЗаголовокТабличнойЧастиПоТипуПроцесса(ТипПроизводственногоПроцесса) Экспорт
...
//  НастройкиЗаполнения - Соответстие          - Ключ:     Имя проверяемого реквизита ТЧ
//						   					   - Значение: тип Соответствие - Ключ:     значение проверяемого реквизита
//                                                                           Значение: значение заполняемого реквизита 
//  ПроверитьЗаполнение - Булево               - Признак установки значение в случаи ее отсутствие
//	Результат           - Булево               - Принимает значение Истина при установки значения реквизита хотя бы у 
//												 одной строки
//
Процедура ЗаполнитьЗначениеРеквизита(ДанныеТЧ, ИмяРеквизита, НастройкиЗаполнения, ПроверитьЗаполнение = Ложь, Результат = Ложь) Экспорт
