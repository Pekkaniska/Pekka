...
Функция ОпределитьНаличиеСчетовФактурПолученных(ПараметрыПоискаСчетовФактур) Экспорт
	...
	|	ЕСТЬNULL(СчетФактураПолученный.Ссылка,ЕСТЬNULL(СчетФактураПолученныйНА.Ссылка,ЕСТЬNULL(СчетФактураВыданный.Ссылка,НЕОПРЕДЕЛЕНО))) КАК СчетФактура,
	|	ЕСТЬNULL(СчетФактураПолученный.Ссылка.Проведен,ЕСТЬNULL(СчетФактураПолученныйНА.Ссылка.Проведен,ЕСТЬNULL(СчетФактураВыданный.Ссылка.Проведен,ЛОЖЬ))) КАК СчетФактураПроведен,
	...
	|					ИЛИ НЕ СчетФактураПолученныйНА.Ссылка ЕСТЬ NULL 
	|					ИЛИ НЕ СчетФактураВыданный.Ссылка ЕСТЬ NULL
	|		ИНАЧЕ
	|			СчетФактураПолученный.Ссылка ЕСТЬ NULL
	|				И СчетФактураПолученныйНА.Ссылка ЕСТЬ NULL
	...
	|				ТОГДА ЕСТЬNULL(СчетФактураПолученный.Ссылка.Проведен,
	|						ЕСТЬNULL(СчетФактураПолученныйНА.Ссылка.Проведен,
	|							ЕСТЬNULL(СчетФактураВыданный.Ссылка.Проведен, НЕОПРЕДЕЛЕНО))) = ИСТИНА
	|			ИНАЧЕ
