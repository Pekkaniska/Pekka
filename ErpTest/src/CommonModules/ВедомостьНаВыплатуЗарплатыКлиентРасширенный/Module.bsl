...
//		строка
//
Функция ИмяСобытияВыбораДокументовОснованийВедомости() Экспорт
	Возврат "ВыборДокументовОснованийВедомостейНаВыплатуЗарплаты"
КонецФункции
...
Процедура ОбработкаОповещения(Форма, ИмяСобытия, Параметр, Источник) Экспорт
	...
	ИначеЕсли ИмяСобытия = ИмяСобытияВыбораДокументовОснованийВедомости() Тогда
