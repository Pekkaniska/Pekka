...
//
// Параметры:
//   Форма - УправляемаяФорма - управляемая форма регл. отчета.
...
Процедура ПриИнициализацииФормыРегламентированногоОтчетаОбщиеДействия(Форма, КонтролирующийОрган)
	...
	// Устанавливаем видимость ЭУ загрузки данных регламентированных отчетов из настроек.
...
Функция ОперацииСРегламентированнымОтчетом(ИмяОтчета, ИмяФормы) Экспорт
	...
	// Шаблон операций с регламентированным отчетом.
	ОперацииСРеглОтчетом = Новый Структура;
	ОперацииСРеглОтчетом.Вставить("АвтоФормированиеНаСервере", 		   Истина);
	ОперацииСРеглОтчетом.Вставить("ВыгрузкаНаСервере", 				   Истина);
	ОперацииСРеглОтчетом.Вставить("ПечатьСоШтрихкодомPDF417НаСервере", Истина);
	...
	ОперацииСРеглОтчетом.Вставить("ПечатьБезШтрихкодаPDF417НаСервере", Истина);
