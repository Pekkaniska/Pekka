...
//  Структура - список параметров состава документа
//   * ИмяРеквизитаКраткийСостав                      - Строка - имя реквизита краткий состав документа
//   * ИмяТабличнойЧастиФизическиеЛица                - Строка - имя табличной части физические лица документа
//   * ЗаполнятьТабличнуюЧастьФизическиеЛицаДокумента - Булево - заполнять табличную часть Физические лица документа
//   * ИспользоватьКраткийСостав                      - Булево - заполнять реквизит краткий состав документа
...
//                                                               частях/шапке документа
//   * ИспользоватьОграничениеДоступа                 - Булево - заполнять регистр Физические лица документа для
//                                                               ограничения доступа
...
//      для добавления используется ДобавитьОписаниеХраненияСотрудниковФизическихЛиц.
//
Функция НовоеОписаниеСоставаДокумента() Экспорт
...
// Возвращает описание хранения сотрудников и физических лиц документа.
//
// Возвращаемое значение
...
//
// Параметры:
//			МассивОписаний     - Массив - содержит структуры со свойствами см. НовоеОписаниеСоставаДокумента.
//			ИмяТаблицы         - Строка - имя таблицы, хранящей сотрудников и/или физические лица
//			ПолеФизическоеЛицо - Строка - имя ревизита ФизическоеЛицо.
...
//
// Возвращаемое значение
//  Структура - см. НовоеОписаниеСоставаДокумента.
//
Функция ОписаниеСоставаДокументаФизическоеЛицоВШапке(ИмяРеквизитаФизическоеЛицо = "ФизическоеЛицо", ИмяРеквизитаСотрудник = "Сотрудник") Экспорт
	ОписаниеСостава = НовоеОписаниеСоставаДокумента();
...
// Возвращает описание состава документа по метаданным, в случае хранения физических лиц в табличных частях.
//
// Возвращаемое значение
//  Структура - см. НовоеОписаниеСоставаДокумента.
//
Функция ОписаниеСоставаДокументаПоМетаданнымФизическиеЛицаВТабличныхЧастях(МетаданныеДокумента) Экспорт
	
	ИспользоватьКраткийСостав = МетаданныеДокумента.Реквизиты.Найти("КраткийСоставДокумента") <> Неопределено;
	ЗаполнятьТабличнуюЧастьФизическиеЛицаДокумента = МетаданныеДокумента.ТабличныеЧасти.Найти("ФизическиеЛица") <> Неопределено;
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "ЗарплатаКадрыСоставДокументов.ЗаполнитьСоставСотрудниковДокумента";
	Обработчик.РежимВыполнения = ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОсновнойРежимВыполненияОбновления();
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("7070b35e-a85d-4efe-818b-199158ece401");
	Обработчик.Комментарий = НСтр("ru='Заполняет состав сотрудников и физических лиц документов'");
...
Функция ОписаниеДокументаПоИсточнику(Источник) Экспорт
	
	МетаданныеДокумента = Источник.Метаданные();
	МенеджерДокумента = ОбщегоНазначения.МенеджерОбъектаПоПолномуИмени(МетаданныеДокумента.ПолноеИмя());
	Возврат МенеджерДокумента.ОписаниеСоставаДокумента();
	
КонецФункции

Функция СотрудникиФизическиеЛица(Источник, ОписаниеДокумента) Экспорт
	...
	Для Каждого ОписаниеХраненияСотрудниковФизическихЛиц Из ОписаниеДокумента.ОписаниеХраненияСотрудниковФизическихЛиц Цикл
...
Процедура ЗаполнитьТабличнуюЧастьФизическиеЛицаДокумента(Источник, ОписаниеДокумента, ФизическиеЛица) Экспорт
	...
	ТабличнаяЧастьФизичсекиеЛица = Источник[ИмяТаблицы];
	ТабличнаяЧастьФизичсекиеЛица.Очистить();
	
	Для Каждого ФизическоеЛицо Из ФизическиеЛица Цикл
		Если Не ЗначениеЗаполнено(ФизическоеЛицо) Тогда
			Продолжить;
		КонецЕсли;
		НоваяСтрока = ТабличнаяЧастьФизичсекиеЛица.Добавить();
...
Процедура УстановитьКонтекстЗаполненияСоставаДокумента(Источник, ФизическиеЛица, СотрудникиФизическиеЛица) Экспорт
	
	Источник.ДополнительныеСвойства.Вставить("СоставДокумента_ФизическиеЛица", ФизическиеЛица);
	Источник.ДополнительныеСвойства.Вставить("СоставДокумента_СотрудникиФизическиеЛица", СотрудникиФизическиеЛица);
	
КонецПроцедуры

Функция КонтекстЗаполненияСоставаДокумента(Источник) Экспорт
	
	Если Не Источник.ДополнительныеСвойства.Свойство("СоставДокумента_ФизическиеЛица")
		Или Не Источник.ДополнительныеСвойства.Свойство("СоставДокумента_СотрудникиФизическиеЛица") Тогда
		
		Возврат Неопределено;
	КонецЕсли;
	
	ФизическиеЛица = Источник.ДополнительныеСвойства.СоставДокумента_ФизическиеЛица;
	СотрудникиФизическиеЛица = Источник.ДополнительныеСвойства.СоставДокумента_СотрудникиФизическиеЛица;
	
	Возврат Новый Структура("ФизическиеЛица, СотрудникиФизическиеЛица", ФизическиеЛица, СотрудникиФизическиеЛица);
	
КонецФункции

#Область ОбновлениеИнформационнойБазы

Процедура ЗаполнитьСоставСотрудниковДокумента(ПараметрыОбновления = Неопределено) Экспорт
	
	ТипыДокументовФизическихЛиц = Метаданные.ОпределяемыеТипы.ДокументПоФизическомуЛицу.Тип.Типы();
	...
	Пока Истина Цикл
		...
		Для Каждого ТипДокумента Из ТипыДокументовФизическихЛиц Цикл
			...
			ОписаниеДокумента = Документы[Документ.Имя].ОписаниеСоставаДокумента();
			Если Не ОписаниеДокумента.ЗаполнятьСоставДокументов
				И Не ОписаниеДокумента.ИспользоватьОграничениеДоступа Тогда
		...
		Пока Выборка.СледующийПоЗначениюПоля("ДокументФизическогоЛица") Цикл
			...
			НаборЗаписейСоставДокументовЗарплатаКадры = РегистрыСведений.СоставДокументовЗарплатаКадры.СоздатьНаборЗаписей();
			...
			Пока Выборка.Следующий() Цикл
				...
				Если Выборка.ЗаполнятьСоставДокументов Тогда
					СуществующиеСтроки = СотрудникиФизическихЛиц[Выборка.ФизическоеЛицо];
					Если СуществующиеСтроки = Неопределено Тогда
						НоваяСтрока = НаборЗаписейСоставДокументовЗарплатаКадры.Добавить();
						ЗаполнитьЗначенияСвойств(НоваяСтрока, Выборка);
						СтрокиПоФизическимЛицам = Новый Массив;
						СтрокиПоФизическимЛицам.Добавить(НоваяСтрока);
						СотрудникиФизическихЛиц.Вставить(Выборка.ФизическоеЛицо, СтрокиПоФизическимЛицам);
						Продолжить;
					КонецЕсли;
					...
					СотрудникСуществует = Ложь;
					Для Каждого СтрокаФизическогоЛица Из СуществующиеСтроки Цикл
						Если Не ЗначениеЗаполнено(СтрокаФизическогоЛица.Сотрудник) Тогда
							СтрокаФизическогоЛица.Сотрудник = Выборка.Сотрудник;
							СтрокаФизическогоЛица.ГоловнойСотрудник = Выборка.ГоловнойСотрудник;
						КонецЕсли;
						Если СтрокаФизическогоЛица.Сотрудник = Выборка.Сотрудник Тогда
							СотрудникСуществует = Истина;
							Прервать;
						КонецЕсли;
					КонецЦикла;
					
					Если Не СотрудникСуществует Тогда
						НоваяСтрока = НаборЗаписейСоставДокументовЗарплатаКадры.Добавить();
						ЗаполнитьЗначенияСвойств(НоваяСтрока, Выборка);
						СуществующиеСтроки.Добавить(НоваяСтрока);
					КонецЕсли;
				КонецЕсли;
			КонецЦикла;
			...
			Если НаборЗаписейСоставДокументовЗарплатаКадры.Количество() > 0 Тогда
				НаборЗаписейСоставДокументовЗарплатаКадры.Отбор.ДокументФизическогоЛица.Установить(Выборка.ДокументФизическогоЛица);
				ОбновлениеИнформационнойБазы.ЗаписатьДанные(НаборЗаписейСоставДокументовЗарплатаКадры);
			КонецЕсли;
...
Функция ЗапросДокументовКОбработке(ИмяДокумента, ОписаниеДокумента, КоличествоКОбработке)
	...
	ТекстЗапросаДокументов = 
		...
		|		ПО ДокументКОбработке.Ссылка = СоставДокументовЗарплатаКадры.ДокументФизическогоЛица
		...
		|	И СоставДокументовЗарплатаКадры.ДокументФизическогоЛица ЕСТЬ NULL
...
Процедура ЗаполнитьДатыДокументов(ПараметрыОбновления = Неопределено) Экспорт
	...
	Выборка.Сбросить();
 	...
 	ДатыДокументов = ОбщегоНазначенияБЗК.ЗначениеРеквизитаОбъектов(ПорцияДокументов, "Дата");
