...
// Возвращает признак того, что конфигурация является объединенной с УСО
//
Функция ОбъединеннаяКонфигурацияУСО() Экспорт
	Возврат Метаданные.Справочники.СМ_ОбъектыСтроительства.Реквизиты.Найти("СтатусСтроительства") <> Неопределено;
КонецФункции // ОбъединеннаяКонфигурацияУСО()
