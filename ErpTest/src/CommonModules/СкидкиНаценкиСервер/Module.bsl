...
//++ Рарус IA 2017.03.15
	...
	ИначеЕсли ИмяТЧ = "ПлановыеРаботы" Тогда
		ИмяКоличества = "Количество";
//-- Рарус IA 2017.03.15
	Иначе
...
Функция АдресДанныхДляРасчетаРучныхСкидокВоВременномХранилище(Форма, ИмяТаблицы, УникальныйИдентификатор, ТолькоДляВыделенныхСтрок,
	...
	Если ИмяТаблицы = "Услуги" Тогда
		ИмяКоличества = "Количество";
//++ Рарус IA 2017.03.15
	ИначеЕсли ИмяТаблицы = "Работы" Тогда
		ИмяКоличества = "КоличествоРеализация";
	ИначеЕсли ИмяТаблицы = "ПлановыеРаботы" Тогда
		ИмяКоличества = "Количество";
//-- Рарус IA 2017.03.15
	Иначе
		ИмяКоличества = "КоличествоУпаковок";
...
//  ПримененныеСкидки		 - ТаблицаЗначений - Примененные скидки (наценки).
//
...
//
// Параметры:
//  Форма  - УправляемаяФорма - форма, для которой заполняются строковые переменные, содержащие информацию о количестве
//                              скидок (наценок)
...
//	ТаблицаЗначений - Расшифровка скидок.
//
Функция СкидкиНаценкиДляОптовойТорговли(ТекущаяДата, Склад, Соглашение, КартаЛояльности)
