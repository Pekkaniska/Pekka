...
Функция ПостроитьДеревоОператоров() Экспорт
	...
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "=", " = ");
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "<>", " <> ");
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "И", " И ");
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "ИЛИ", " ИЛИ ");
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "НЕ", " НЕ ");
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "ИСТИНА", " ИСТИНА ");
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "ЛОЖЬ", " ЛОЖЬ ");
	
	ГруппаОператоров = ДобавитьГруппуОператоров(Дерево, "Функции");
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "Максимум", "Макс(,)", 2);
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "Минимум", "Мин(,)", 2);
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "Округление", "Окр(,)", 2);
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "Целая часть", "Цел()", 1);
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "Условие", "?(,,)", 3);
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "Значение заполнено", "ЗначениеЗаполнено()", 1);
...
Функция ПолучитьСтандартноеДеревоОператоров() Экспорт
	...
	Дерево = ПолучитьПустоеДеревоОператоров();
	ГруппаОператоров = уатРаботаСФормулами.ДобавитьГруппуОператоров(Дерево, "Операторы");
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "+", " + ");
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "-", " - ");
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "*", " * ");
	уатРаботаСФормулами.ДобавитьОператор(Дерево, ГруппаОператоров, "/", " / ");
