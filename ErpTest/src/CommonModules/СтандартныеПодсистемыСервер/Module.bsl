...
//++ Рарус Лимаренко 24.06.2018
Если ЭтотОбъект.ИмяФормы = "Документ.ЗаявкаНаРасходованиеДенежныхСредств.Форма.ФормаСписка" 
	ИЛИ ЭтотОбъект.ИмяФормы = "Документ.ЗаявкаНаРасходованиеДенежныхСредств.Форма.ФормаСпискаДокументов" Тогда	
		Возврат;		
	КонецЕсли;
//-- Рарус Лимаренко 24.06.2018
