...
Функция СоздатьДокументыКвартальнойОтчетности2014(Организация, ОтчетныйПериод, ПараметрыФормированияДокументов, ПараметрыОтбора = Неопределено) 
	...
	Иначе
		ПачкиРазделов6 = ОбщегоНазначенияКлиентСервер.СкопироватьРекурсивно(ПараметрыФормированияДокументов.ЗамещаемыеДокументы);
	КонецЕсли;	
...
Процедура СоздатьВТДанныеСтажаПФР(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод, ПараметрыПолученияДанных, ПараметрыОтбора) Экспорт 
	Если ОтчетныйПериод >= '20140101' Тогда
		СоздатьВТДанныеСтажаПФР2014(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод, ПараметрыПолученияДанных, ПараметрыОтбора);	
	Иначе
		СоздатьВТДанныеСтажаПФР2013(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод, ПараметрыПолученияДанных, ПараметрыОтбора);	
	КонецЕсли;	
КонецПроцедуры

Процедура СоздатьВТДанныеСтажаПФР2014(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод, ПараметрыПолученияДанных, ПараметрыОтбора)
	...
	Если ПараметрыПолученияДанных.ИсточникДанныхОСтаже = ВариантыИсточниковДанныхСтажа.ДанныеУчета Тогда
		СоздатьВТЗаписиСтажаПоДаннымУчета2014(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод, ПараметрыПолученияДанных, ПараметрыОтбора);
...
Процедура СоздатьВТДанныеСтажаПФР2013(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод, ПараметрыПолученияДанных, ПараметрыОтбора)
	...
	Если ПараметрыПолученияДанных.ИсточникДанныхОСтаже = ВариантыИсточниковДанныхСтажа.ДанныеУчета Тогда
		ПерсонифицированныйУчетВнутренний.СоздатьВТЗаписиСтажаПоДаннымУчета(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод, ПараметрыПолученияДанных, ПараметрыОтбора);
...
Процедура СоздатьВТЗаписиСтажаПоДаннымУчета2014(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод, ПараметрыПолученияДанных, ПараметрыОтбора)
	ПерсонифицированныйУчетВнутренний.СоздатьВТЗаписиСтажаПоДаннымУчета(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод, ПараметрыПолученияДанных, ПараметрыОтбора);
...
Функция СоздатьВТДанныеСтажаПФРИзВТЗаписиСтажа(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод, ИмяВТИсточникаДанных, ПараметрыОтбора)
...
Процедура ЗаполнитьДанныеДосрочногоНазначенияПенсии(Объект, Организация, ОтчетныйПериод) Экспорт 
	...
	ПерсонифицированныйУчетВнутренний.ЗаполнитьДанныеДосрочногоНазначенияПенсии(Объект, Организация, ОтчетныйПериод);
...
Процедура СоздатьВТИсчисленныеВзносыВПФРИзДанныхУчета2013(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод, ПараметрыПолученияДанных, ПараметрыОтбора, ИмяВТРезультат = "ВТИсчисленныеВзносыВПФР")
	...
	ПерсонифицированныйУчет.СформироватьВТСоответствиеТарифаИВидаЗЛКатегории(МенеджерВременныхТаблиц);
	Запрос.УстановитьПараметр("ОтчетныйГод", Год(ОтчетныйПериод));
	Запрос.УстановитьПараметр("ОбщийНалоговыйРежим", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ОбщийНалоговыйРежим")); 
	Запрос.УстановитьПараметр("ТарифМоряков", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ДляЧленовЭкипажейМорскихСудовПодФлагомРФ"));
...
Процедура СоздатьТаблицыСведенийОЗаработке(Организация, ОтчетныйПериод, ПараметрыПолученияЗаработка, ПараметрыОтбора, ПостфиксВТРезульт, ТаблицыЗаработка)
	...
	Если ОтчетныйПериод < '20150401' Тогда
		СоздатьТаблицыСведенийОЗаработке2014(Организация, ОтчетныйПериод, ПараметрыПолученияЗаработка, ПараметрыОтбора, ПостфиксВТРезульт, ТаблицыЗаработка)
	Иначе
		СоздатьТаблицыСведенийОЗаработке2015(Организация, ОтчетныйПериод, ПараметрыПолученияЗаработка, ПараметрыОтбора, ПостфиксВТРезульт, ТаблицыЗаработка)
	КонецЕсли;
	
КонецПроцедуры	

Процедура СоздатьТаблицыСведенийОЗаработке2014(Организация, ОтчетныйПериод, ПараметрыПолученияЗаработка, ПараметрыОтбора, ПостфиксВТРезульт, ТаблицыЗаработка)
	...
	Запрос.УстановитьПараметр("СписокНестрахуемыхДоходов", СписокНестрахуемыхВидовДохода());
	Запрос.УстановитьПараметр("ОбщийНалоговыйРежим", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ОбщийНалоговыйРежим")); 
	Запрос.УстановитьПараметр("УпрощенныйНалоговыйРежим", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.УпрощенныйНалоговыйРежим"));
	Запрос.УстановитьПараметр("ЕНВД", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ЕНВД")); 
	Запрос.УстановитьПараметр("ОтчетныйПериод", ОтчетныйПериод);
	...
	ПерсонифицированныйУчет.СформироватьВТСоответствиеТарифаИВидаЗЛКатегории(МенеджерВременныхТаблицПромежуточный);
...
Процедура СоздатьТаблицыСведенийОЗаработке2015(Организация, ОтчетныйПериод, ПараметрыПолученияЗаработка, ПараметрыОтбора, ПостфиксВТРезульт, ТаблицыЗаработка)
	...
	ПерсонифицированныйУчет.СформироватьВТСоответствиеТарифаИВидаЗЛКатегории(МенеджерВременныхТаблицПромежуточный, Год(ОтчетныйПериод));
...
Функция КатегорииЗастрахованныхЛицОрганизации(Организация, ОтчетныйПериод, ОкончаниеОтчетногоПериода = Неопределено, КорректирующиеСведения = Ложь) Экспорт
	...
	Запрос.УстановитьПараметр("ТарифЕНВД", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ЕНВД"));
	Запрос.УстановитьПараметр("ТарифФармацевтов", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ДляФармацевтовАптек"));
	Запрос.УстановитьПараметр("ТарифМоряков", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ДляЧленовЭкипажейМорскихСудовПодФлагомРФ"));
...
Процедура СформироватьВТСоответствиеТарифаКатегории(МенеджерВременныхТаблиц)
	...
	Запрос.УстановитьПараметр("ОбщийНалоговыйРежим", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ОбщийНалоговыйРежим"));
	Запрос.УстановитьПараметр("ЕНВД", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ЕНВД"));
	Запрос.УстановитьПараметр("СельХозПроизводители", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.СельХозПроизводители"));
	Запрос.УстановитьПараметр("УпрощенныйНалоговыйРежим", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.УпрощенныйНалоговыйРежим"));
	Запрос.УстановитьПараметр("ЕСХН", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ЕСХН"));
	Запрос.УстановитьПараметр("ОрганизацияИнвалидов", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ОрганизацияИнвалидов"));
	Запрос.УстановитьПараметр("РезидентТехникоВнедренческойЗоны", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.РезидентТехникоВнедренческойЗоны"));
	Запрос.УстановитьПараметр("УчастникПроектаИнновационныйЦентрСколково", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.УчастникПроектаИнновационныйЦентрСколково"));
	Запрос.УстановитьПараметр("ITОрганизации", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ITОрганизации"));
	Запрос.УстановитьПараметр("ХозОбществаБюджетныхВУЗов", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ХозОбществаБюджетныхВУЗов"));
	Запрос.УстановитьПараметр("УпрощенныйНалоговыйРежимПроизводство", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.УпрощенныйНалоговыйРежимПроизводство"));
	Запрос.УстановитьПараметр("СМИ", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.СМИ"));
	Запрос.УстановитьПараметр("НародныеХудожественныеПромыслы", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.НародныеХудожественныеПромыслы"));
	Запрос.УстановитьПараметр("ДляЧленовЭкипажейМорскихСудовПодФлагомРФ", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ДляЧленовЭкипажейМорскихСудовПодФлагомРФ"));
	Запрос.УстановитьПараметр("ДляФармацевтовАптек", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ДляФармацевтовАптек"));
	Запрос.УстановитьПараметр("НекоммерческиеОрганизации", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.НекоммерческиеОрганизации"));
	Запрос.УстановитьПараметр("БлаготворительныеОрганизации", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.БлаготворительныеОрганизации"));
	Запрос.УстановитьПараметр("ОрганизацииОказывающиеИнжиниринговыеУслуги", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ОрганизацииОказывающиеИнжиниринговыеУслуги"));
	Запрос.УстановитьПараметр("ИндивидуальныйПредпринимательПрименяющийПатент", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ИндивидуальныйПредпринимательПрименяющийПатент"));
	Запрос.УстановитьПараметр("ТОР", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.РезидентТерриторииОпережающегоСоциальноЭкономическогоРазвития"));
	Запрос.УстановитьПараметр("КРЫМ", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.УчастникОсобойЗоныВКрыму"));
	Запрос.УстановитьПараметр("Владивосток", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.РезидентПортаВладивосток"));
	Запрос.УстановитьПараметр("Мультипликаторы", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.Мультипликаторы"));
	Запрос.УстановитьПараметр("Калининград", ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.РезидентОсобойЗоныВКалининградскойОбласти"));
...
Процедура СформироватьВТСоответствиеТарифаИВидаЗЛКатегории(МенеджерВременныхТаблиц, Год = 0) Экспорт
	...
	|	СоответствиеТарифаКатегории.КатегорияЗастрахованныхЛиц,
	|	СоответствиеТарифаКатегории.Порядок,
...
Процедура СформироватьВТДанныеОДопВзносах(ПериодРегистрации, ИмяВременнойТаблицы, МенеджерВременныхТаблиц) Экспорт
	...
	Запрос.Текст =  
	"ВЫБРАТЬ
	|	УдержанияРаботниковОрганизаций.ФизическоеЛицо КАК ФизическоеЛицо,
	|	СУММА(УдержанияРаботниковОрганизаций.СуммаОборот) КАК СуммаВзносов
	...
	|						Сотрудники.ФизическоеЛицо
	|					ИЗ
	|						ИсточникДанных КАК Сотрудники)
	|				И НачислениеУдержание.КатегорияУдержания = ЗНАЧЕНИЕ(Перечисление.КатегорииУдержаний.ДСВ)) КАК УдержанияРаботниковОрганизаций
	|
	|СГРУППИРОВАТЬ ПО
	...
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "ИсточникДанных", ИмяВременнойТаблицы);
...
Функция ПолучитьТаблицуИтоговСтажаПоСотруднику(ЗаписиОСтаже, Сотрудник) Экспорт
	...
	Для Каждого Запись Из ТаблицаЗаписейОСтаже Цикл
		...
		МесяцевПоПериоду = 0;
		ДнейПоПериоду = 0;
		ПерсонифицированныйУчет.ПолучитьСтажЗаПериод(Запись.ДатаОкончанияПериода,	Запись.ДатаНачалаПериода, ЛетПоПериоду,	МесяцевПоПериоду, ДнейПоПериоду);
	...
	Для Каждого Запись Из ТаблицаЗаписейОСтаже Цикл
		...
		МесяцевПоПериоду = 0;
		ДнейПоПериоду = 0;
		ПерсонифицированныйУчет.ПолучитьСтажЗаПериод(ТекущаяОсновнаяЗапись.ДатаОкончанияПериода,	ТекущаяОсновнаяЗапись.ДатаНачалаПериода, ЛетПоПериоду,	МесяцевПоПериоду, ДнейПоПериоду);
...
Функция ЗаполнитьНаборЗаписейВходящаяОписьСЗВ6(УзелПФР, ДеревоФормата, ТипДокумента, ВыборкаПоШапкеДокумента, КоличествоДокументов, НомерДокументаВПачке, МакетВходящейОписи = "ВХОДЯЩАЯ_ОПИСЬ", НаборЗаписейВходящаяОпись = Неопределено, ТегВходящейОписи = "ВХОДЯЩАЯ_ОПИСЬ_ПО_СТРАХОВЫМ_ВЗНОСАМ") Экспорт
	...
	Если ТипДокумента = "СВЕДЕНИЯ_О_СТРАХОВЫХ_ВЗНОСАХ_И_СТРАХОВОМ_СТАЖЕ_ЗЛ" Тогда
		...
		НаборЗаписейВходящаяОпись.КодКатегории.Значение = ПерсонифицированныйУчет.ПолучитьИмяЭлементаПеречисленияПоЗначению(ВыборкаПоШапкеДокумента.КатегорияЗастрахованныхЛиц);
...
Процедура ВписатьСтавкуВНаборДанныхИсчисляемогоСтажа2019(Ставка, НаборДанных) Экспорт
...
Процедура ВписатьСтавкуВНаборДанныхТеррУсловий2019(ТерриториальныеУсловия, Ставка, НаборДанных) Экспорт
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "ПерсонифицированныйУчет.ЗаполнитьСправочникКомплектыОтчетности";
	...
	Обработчик.Процедура = "ПерсонифицированныйУчет.ЗаполнитьРеквизитКатегорияЗастрахованныхЛицВРегистреРасчетовСПФР";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.0.6.30";
	Обработчик.Процедура = "РегистрыСведений.СтатусыЗастрахованныхФизическихЛиц.ПеренестиСведенияОСтатусахЗастрахованныхФизическихЛиц";
	...
	Обработчик.Процедура = "ПерсонифицированныйУчет.ЗаполнитьОкончанияОтчетногоПериода";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.0.6.38";
	Обработчик.Процедура = "ПерсонифицированныйУчет.ЗаполнитьРегистрационныйНомерПФР";
	
	Если ЗарплатаКадры.АвтономнаяРаботаРазрешеноИзменениеДанных(Метаданные.Справочники.ТерриториальныеУсловияПФР) Тогда
		Обработчик = Обработчики.Добавить();
		Обработчик.Версия = "3.0.6.38";
		Обработчик.Процедура = "ПерсонифицированныйУчет.ЗаполнитьТерриториальныеУсловияПФР";
		Обработчик.ОбщиеДанные = Истина;
	КонецЕсли;	

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.0.7.6";
	Обработчик.Процедура = "ПерсонифицированныйУчет.ЗаполнитьНовыеРеквизитыСправочникаКомплектыОтчетностиПФР";
	...
	Если ЗарплатаКадры.АвтономнаяРаботаРазрешеноИзменениеДанных(Метаданные.Справочники.ПараметрыИсчисляемогоСтраховогоСтажа) Тогда
		...
		Обработчик.Процедура = "Справочники.ПараметрыИсчисляемогоСтраховогоСтажа.УстановитьРеквизитыИспользования2014ДляНовыхПараметровСтраховогоСтажа";
		Обработчик.ОбщиеДанные = Истина;
	КонецЕсли;
	...
	Если ЗарплатаКадры.АвтономнаяРаботаРазрешеноИзменениеДанных(Метаданные.Справочники.ВидыОбщественноПолезнойДеятельностиСЗВК) Тогда
		...
		Обработчик.Процедура = "Справочники.ВидыОбщественноПолезнойДеятельностиСЗВК.ДополнитьВидыОбщественноПолезнойДеятельностиСЗВК";
		Обработчик.ОбщиеДанные = Истина;
	КонецЕсли;
	...
	Если ЗарплатаКадры.АвтономнаяРаботаРазрешеноИзменениеДанных(Метаданные.Справочники.ВидыОбщественноПолезнойДеятельностиСЗВК) Тогда
		...
		Обработчик.Процедура = "Справочники.ВидыОбщественноПолезнойДеятельностиСЗВК.ОбновитьНаименованияВидыОбщественноПолезнойДеятельностиСЗВК";
		Обработчик.ОбщиеДанные = Истина;
	КонецЕсли;
	
	Если ЗарплатаКадры.АвтономнаяРаботаРазрешеноИзменениеДанных(Метаданные.Справочники.ОснованияДосрочногоНазначенияПенсии) Тогда
		Обработчик = Обработчики.Добавить();
		Обработчик.Версия = "3.0.22.146";
		Обработчик.Процедура = "Справочники.ОснованияДосрочногоНазначенияПенсии.ВписатьКоды2015Года";
		Обработчик.ОбщиеДанные = Истина;
	КонецЕсли;
	...
	Если ЗарплатаКадры.АвтономнаяРаботаРазрешеноИзменениеДанных(Метаданные.Справочники.ПараметрыИсчисляемогоСтраховогоСтажа) Тогда
		Обработчик = Обработчики.Добавить();
		Обработчик.Версия = "3.0.22.146";
		Обработчик.Процедура = "Справочники.ПараметрыИсчисляемогоСтраховогоСтажа.УстановитьРеквизитыИспользования2015";
		Обработчик.ОбщиеДанные = Истина;
	КонецЕсли;

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.0.22.146";
	Обработчик.Процедура = "ПерсонифицированныйУчет.ОтметитьРазделы6За2015Год";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.0.22.189";
	Обработчик.Процедура = "РегистрыСведений.ДопустимыеСочетанияКодовГруппСтажа.НачальноеЗаполнение";
	Обработчик.ОбщиеДанные = Истина;
	Обработчик.НачальноеЗаполнение = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.1.1.118";
	Обработчик.Процедура = "ПерсонифицированныйУчет.УточнитьФайлыАДВ123поПостановлению473п";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.1.3.151";
	Обработчик.Процедура = "ПерсонифицированныйУчет.ЗаполнитьИдентификаторСтрокиСотрудникаСЗВ_ИСХ";
	Обработчик.РежимВыполнения = ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОсновнойРежимВыполненияОбновления();
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("2cde6088-e00a-448e-996b-cdb445730f19");
	Обработчик.Комментарий = НСтр("ru = 'Заполнение реквизита «Идентификатор cтроки cотрудника» документа «Сведения о заработке и стаже застрахованных лиц, СЗВ-ИСХ».'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.1.4.5";
	Обработчик.Процедура = "Справочники.ОснованияДосрочногоНазначенияПенсии.ЗаполнитьКоды2002Года";
	Обработчик.ОбщиеДанные = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.1.4.5";
	Обработчик.Процедура = "Справочники.ОсобыеУсловияТрудаПФР.ЗаполнитьКоды2002Года";
	Обработчик.ОбщиеДанные = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.1.5.164";
	Обработчик.Процедура = "ПерсонифицированныйУчет.ЗаполнитьЗаписиОСтажеСведенияОСтраховомСтажеЗастрахованныхЛицСЗВ_СТАЖ";
	Обработчик.РежимВыполнения = ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОсновнойРежимВыполненияОбновления();
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("5e2aeb36-0c42-41b3-a893-ca84aa40dc0d");
	Обработчик.Комментарий = НСтр("ru = 'Заполнение регистра «Записи о стаже сведения о страховом стаже застрахованных лиц СЗВ-СТАЖ».'");
...
Процедура ЗаполнитьНовыеРеквизитыСправочникаКомплектыОтчетностиПФР() Экспорт
	Запрос = Новый Запрос;
	Запрос.Текст = 
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|ИЗ
	|	Справочник.КомплектыОтчетностиПерсучета КАК КомплектыОтчетностиПерсучета
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.КомплектыОтчетностиПерсучета.СписокПачекСЗВ КАК КомплектыОтчетностиПерсучетаСписокПачекСЗВ
	|		ПО (КомплектыОтчетностиПерсучетаСписокПачекСЗВ.Ссылка = КомплектыОтчетностиПерсучета.Ссылка)
	|			И (КомплектыОтчетностиПерсучетаСписокПачекСЗВ.ПачкаДокументов.ТипСведенийСЗВ = ЗНАЧЕНИЕ(Перечисление.ТипыСведенийСЗВ.Корректирующая))
	|ГДЕ
	|	КомплектыОтчетностиПерсучета.ПериодФормирования = ДАТАВРЕМЯ(1, 1, 1)
	|
	|УПОРЯДОЧИТЬ ПО
	|	Ссылка,
	...
	Пока Выборка.СледующийПоЗначениюПоля("Ссылка") Цикл
		...
		КомплектОбъект.ПериодФормирования = КомплектОбъект.ОтчетныйПериод;
		
		КомплектОбъект.УстановитьПредставлениеСоставаКомплекта();
		
		Если КомплектОбъект.СостояниеКомплекта = Перечисления.СостояниеКомплектаОтчетностиПерсучета.УдалитьОперационнаяДеятельностьНеВелась
			Или КомплектОбъект.СостояниеКомплекта = Перечисления.СостояниеКомплектаОтчетностиПерсучета.УдалитьКомплектСформированИОтправлен Тогда
			
			КомплектОбъект.СостояниеКомплекта = Перечисления.СостояниеКомплектаОтчетностиПерсучета.СведенияНеБудутПередаваться;
		КонецЕсли;  
				
		Пока Выборка.Следующий() Цикл
			Если ЗначениеЗаполнено(Выборка.КорректируемыйПериод) Тогда 
				ОписаниеПериода = КомплектОбъект.КорректируемыеПериоды.Добавить();
		...
		КомплектОбъект.ОбменДанными.Загрузка = Истина;
		КомплектОбъект.Записать();
	КонецЦикла;	
КонецПроцедуры	

Процедура ЗаполнитьСправочникКомплектыОтчетности() Экспорт
	Запрос = Новый Запрос;
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	УдалитьКомплектыОтчетностиПерсучета.Организация,
	|	УдалитьКомплектыОтчетностиПерсучета.ОтчетныйПериод,
	|	УдалитьКомплектыОтчетностиПерсучета.НомерКомплекта,
	|	УдалитьКомплектыОтчетностиПерсучета.Состояние,
	|	УдалитьКомплектыОтчетностиПерсучета.АДВ_6_2,
	|	УдалитьКомплектыОтчетностиПерсучета.АДВ_11,
	|	УдалитьКомплектыОтчетностиПерсучета.РСВ
	|ПОМЕСТИТЬ ВТКомплектыОтчетности
	|ИЗ
	|	РегистрСведений.УдалитьКомплектыОтчетностиПерсучета КАК УдалитьКомплектыОтчетностиПерсучета
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.КомплектыОтчетностиПерсучета КАК КомплектыОтчетностиПерсучета
	|		ПО УдалитьКомплектыОтчетностиПерсучета.Организация = КомплектыОтчетностиПерсучета.Организация
	|			И УдалитьКомплектыОтчетностиПерсучета.ОтчетныйПериод = КомплектыОтчетностиПерсучета.ОтчетныйПериод
	|			И УдалитьКомплектыОтчетностиПерсучета.НомерКомплекта = КомплектыОтчетностиПерсучета.НомерКомплекта
	|ГДЕ
	|	КомплектыОтчетностиПерсучета.Ссылка ЕСТЬ NULL 
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	КомплектыОтчетности.НомерКомплекта,
	|	КомплектыОтчетности.Состояние,
	|	КомплектыОтчетности.АДВ_6_2,
	|	КомплектыОтчетности.АДВ_11,
	...
	|		ПО КомплектыОтчетности.АДВ_6_2 = ОписьПачекСЗВ_6ПачкиДокументов.Ссылка
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	КомплектыОтчетности.ОтчетныйПериод,
	|	КомплектыОтчетности.НомерКомплекта,
	|	ПачкаДокументовСЗВ_6_3.Ссылка КАК ПачкаДокументов
	|ИЗ
	|	ВТКомплектыОтчетности КАК КомплектыОтчетности
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПачкаДокументовСЗВ_6_3 КАК ПачкаДокументовСЗВ_6_3
	|		ПО КомплектыОтчетности.АДВ_6_2 = ПачкаДокументовСЗВ_6_3.УдалитьОписьАДВ62";
	
	Результаты = Запрос.ВыполнитьПакет();
	
	ВсегоРезультатов = Результаты.Количество();
	
	ВыборкаКомплектов = Результаты[ВсегоРезультатов - 3].Выбрать();
	ПачкиСЗВ6Комплектов = Результаты[ВсегоРезультатов  - 2].Выгрузить();
	ПачкиСЗВ63Комплектов = Результаты[ВсегоРезультатов  - 1].Выгрузить();
	
	Пока ВыборкаКомплектов.Следующий() Цикл
		Комплект = Справочники.КомплектыОтчетностиПерсучета.НовыйКомплектСведений(ВыборкаКомплектов.Организация, ВыборкаКомплектов.ОтчетныйПериод, ВыборкаКомплектов.РСВ);
		
		Комплект.ОписьПачекСЗВ = ВыборкаКомплектов.АДВ_6_2;
		Комплект.ВедомостьУплатыАДВ11 = ВыборкаКомплектов.АДВ_11;
		Комплект.РСВ_1 = ВыборкаКомплектов.РСВ;

		Комплект.НомерКомплекта = ВыборкаКомплектов.НомерКомплекта;
		Комплект.СостояниеКомплекта = ВыборкаКомплектов.Состояние;
		
		Комплект.Наименование = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Комплект №%1 за %2'"),
									Комплект.НомерКомплекта,
									ПерсонифицированныйУчетКлиентСервер.ПредставлениеОтчетногоПериода(Комплект.ОтчетныйПериод, Истина));
									
		СтруктураПоиска = Новый Структура("Организация, ОтчетныйПериод, НомерКомплекта", ВыборкаКомплектов.Организация, ВыборкаКомплектов.ОтчетныйПериод, ВыборкаКомплектов.НомерКомплекта);
		
		ПачкиСЗВ6 = ПачкиСЗВ6Комплектов.НайтиСтроки(СтруктураПоиска);
		
		Для Каждого ПачкаСЗВ6 Из ПачкиСЗВ6 Цикл
			ПачкаСЗВ6Комплекта = Комплект.СписокПачекСЗВ.Добавить();
			ПачкаСЗВ6Комплекта.ПачкаДокументов = ПачкаСЗВ6.ПачкаДокументов;
		КонецЦикла;
		
		
		ПачкиСЗВ63 = ПачкиСЗВ63Комплектов.НайтиСтроки(СтруктураПоиска);
		
		Для Каждого ПачкаСЗВ63 Из ПачкиСЗВ63 Цикл
			ПачкаСЗВ63Комплекта = Комплект.СписокПачекСЗВ6_3.Добавить();
			ПачкаСЗВ63Комплекта.ПачкаДокументов = ПачкаСЗВ63.ПачкаДокументов;
		КонецЦикла;
...
Процедура ЗаполнитьРеквизитКатегорияЗастрахованныхЛицВРегистреРасчетовСПФР() Экспорт
	Запрос = Новый Запрос;
	Запрос.Текст = 
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	СтраховыеВзносыПереданныеВПФР.Регистратор
	|ИЗ
	|	РегистрНакопления.СтраховыеВзносыПереданныеВПФР КАК СтраховыеВзносыПереданныеВПФР
	|ГДЕ
	|	СтраховыеВзносыПереданныеВПФР.УдалитьКатегорияЗастрахованныхЛиц <> ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФР.ПустаяСсылка)";
	...
	Пока Выборка.Следующий() Цикл
		...
		Для Каждого СтрокаНабора Из НаборЗаписей Цикл
			СтрокаНабора.КатегорияЗастрахованныхЛиц = СтрокаНабора.УдалитьКатегорияЗастрахованныхЛиц;
			СтрокаНабора.УдалитьКатегорияЗастрахованныхЛиц = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ПустаяСсылка();
		КонецЦикла;
...
Процедура ЗаполнитьОкончанияОтчетногоПериода() Экспорт
	...
	|	Документ.ВедомостьУплатыАДВ_11 КАК ВедомостьУплатыАДВ_11
	|ГДЕ
	|	ВедомостьУплатыАДВ_11.ОкончаниеОтчетногоПериода = ДАТАВРЕМЯ(1, 1, 1)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|ГДЕ
	|	ОписьПачекСЗВ_6.ОкончаниеОтчетногоПериода = ДАТАВРЕМЯ(1, 1, 1)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|	Документ.ПачкаДокументовАДВ_1 КАК ПачкаДокументовАДВ_1
	|ГДЕ
	|	ПачкаДокументовАДВ_1.ОкончаниеОтчетногоПериода = ДАТАВРЕМЯ(1, 1, 1)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|	Документ.ПачкаДокументовАДВ_2 КАК ПачкаДокументовАДВ_2
	|ГДЕ
	|	ПачкаДокументовАДВ_2.ОкончаниеОтчетногоПериода = ДАТАВРЕМЯ(1, 1, 1)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|	Документ.ПачкаДокументовАДВ_3 КАК ПачкаДокументовАДВ_3
	|ГДЕ
	|	ПачкаДокументовАДВ_3.ОкончаниеОтчетногоПериода = ДАТАВРЕМЯ(1, 1, 1)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|	Документ.ПачкаДокументовДСВ_1 КАК ПачкаДокументовДСВ_1
	|ГДЕ
	|	ПачкаДокументовДСВ_1.ОкончаниеОтчетногоПериода = ДАТАВРЕМЯ(1, 1, 1)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|ГДЕ
	|	ПачкаДокументовСЗВ_6_1.ОкончаниеОтчетногоПериода = ДАТАВРЕМЯ(1, 1, 1)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|ГДЕ
	|	ПачкаДокументовСЗВ_6_3.ОкончаниеОтчетногоПериода = ДАТАВРЕМЯ(1, 1, 1)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|ГДЕ
	|	ПачкаДокументовСЗВ_6_4.ОкончаниеОтчетногоПериода = ДАТАВРЕМЯ(1, 1, 1)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|	Документ.ПачкаДокументовСЗВ_К КАК ПачкаДокументовСЗВ_К
	|ГДЕ
	|	ПачкаДокументовСЗВ_К.ОкончаниеОтчетногоПериода = ДАТАВРЕМЯ(1, 1, 1)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|	Документ.ПачкаДокументовСПВ_1 КАК ПачкаДокументовСПВ_1
	|ГДЕ
	|	ПачкаДокументовСПВ_1.ОкончаниеОтчетногоПериода = ДАТАВРЕМЯ(1, 1, 1)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|	Документ.РеестрДСВ_3 КАК РеестрДСВ_3
	|ГДЕ
	|	РеестрДСВ_3.ОкончаниеОтчетногоПериода = ДАТАВРЕМЯ(1, 1, 1)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|ГДЕ
	|	РеестрСЗВ_6_2.ОкончаниеОтчетногоПериода = ДАТАВРЕМЯ(1, 1, 1)";
	...
	Пока Выборка.Следующий() Цикл
		...
		ДокументОбъект.ОкончаниеОтчетногоПериода = ДокументОбъект.ОкончаниеОтчетногоПериода();
...
Процедура ЗаполнитьРегистрационныйНомерПФР() Экспорт
...
Процедура ЗаполнитьТерриториальныеУсловияПФР() Экспорт
	...
	|	Организации.УдалитьТерриториальныеУсловияПФР КАК ТерриториальныеУсловияПФР
	|ИЗ
	|	Справочник.Организации КАК Организации
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ТерриториальныеУсловияПФР КАК ТерриториальныеУсловия
	|		ПО Организации.Ссылка = ТерриториальныеУсловия.СтруктурнаяЕдиница
	|ГДЕ
	|	Организации.УдалитьТерриториальныеУсловияПФР <> ЗНАЧЕНИЕ(Справочник.ТерриториальныеУсловияПФР.ПустаяСсылка)
	|	И ТерриториальныеУсловия.ТерриториальныеУсловияПФР ЕСТЬ NULL 
	|
	|УПОРЯДОЧИТЬ ПО
	|	СтруктурнаяЕдиница";
	...
	Пока Выборка.СледующийПоЗначениюПоля("СтруктурнаяЕдиница") Цикл
		Набор = РегистрыСведений.ТерриториальныеУсловияПФР.СоздатьНаборЗаписей();
		...
		Пока Выборка.Следующий() Цикл
			...
			ЗаписьРегистра.ТерриториальныеУсловияПФР = Выборка.ТерриториальныеУсловияПФР;
...
Процедура ОтметитьРазделы6За2015Год() Экспорт
	...
	Пока Выборка.Следующий() Цикл
	    ДокументОбъект = Выборка.Ссылка.ПолучитьОбъект();
		ДокументОбъект.ОбменДанными.Загрузка = Истина;
		ДокументОбъект.СпециальныйДокумент2015года = Истина;
		ДокументОбъект.Записать();
	КонецЦикла;
	
КонецПроцедуры

Процедура УточнитьФайлыАДВ123поПостановлению473п() Экспорт
	...
	|	Документ.ПачкаДокументовАДВ_1 КАК ПачкаДокументовАДВ_1
	|ГДЕ
	|	НЕ ПачкаДокументовАДВ_1.ДокументПринятВПФР
	|	И ПачкаДокументовАДВ_1.Дата >= &Дата473п
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Документ.ПачкаДокументовАДВ_2 КАК ПачкаДокументовАДВ_2
	|ГДЕ
	|	НЕ ПачкаДокументовАДВ_2.ДокументПринятВПФР
	|	И ПачкаДокументовАДВ_2.Дата >= &Дата473п
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Документ.ПачкаДокументовАДВ_3 КАК ПачкаДокументовАДВ_3
	|ГДЕ
	|	НЕ ПачкаДокументовАДВ_3.ДокументПринятВПФР
	|	И ПачкаДокументовАДВ_3.Дата >= &Дата473п";
	Запрос.УстановитьПараметр("Дата473п", '20161008');
	Выборка = Запрос.Выполнить().Выбрать();
	Пока Выборка.Следующий() Цикл
		ДокументОбъект = Выборка.Ссылка.ПолучитьОбъект();
		ДокументОбъект.Записать();
...
Процедура ЗаполнитьИдентификаторСтрокиСотрудникаСЗВ_ИСХ(ПараметрыОбновления = Неопределено) Экспорт 
	...
	Запрос.Текст = "ВЫБРАТЬ РАЗЛИЧНЫЕ
	               ...
	               |ИЗ
	               |	Документ.СведенияОЗаработкеСтажеЗастрахованныхЛицСЗВ_ИСХ.Сотрудники КАК СведенияОЗаработкеСтаже
	               |
	               |СГРУППИРОВАТЬ ПО
	               |	СведенияОЗаработкеСтаже.Ссылка
	               |
	               |ИМЕЮЩИЕ
	               |	МАКСИМУМ(СведенияОЗаработкеСтаже.ИдентификаторСтрокиСотрудника) = 0";
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Не ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ПодготовитьОбновлениеДанных(ПараметрыОбновления, "Документ.СведенияОЗаработкеСтажеЗастрахованныхЛицСЗВ_ИСХ", "Ссылка", Выборка.Ссылка) Тогда
			Продолжить;
		КонецЕсли;
		...
		Для Каждого СтрокаСотрудника Из ДокументОбъект.Сотрудники Цикл
			...
			СтрокаСотрудника.ИдентификаторСтрокиСотрудника = ИдентификаторСтроки;
			СтруктураПоиска = Новый Структура("Сотрудник", СтрокаСотрудника.Сотрудник);
			
			СтрокиСведенияОЗаработке = ДокументОбъект.СведенияОЗаработке.НайтиСтроки(СтруктураПоиска);
			Для Каждого СтрокаЗаработок Из СтрокиСведенияОЗаработке Цикл
				СтрокаЗаработок.ИдентификаторСтрокиСотрудника = ИдентификаторСтроки;
			КонецЦикла;	
			
			СтрокиСведенияОЗаработкеПоКлассамУсловий = ДокументОбъект.СведенияОЗаработкеНаВредныхИТяжелыхРаботах.НайтиСтроки(СтруктураПоиска);
			Для Каждого СтрокаЗаработок Из СтрокиСведенияОЗаработкеПоКлассамУсловий Цикл
				СтрокаЗаработок.ИдентификаторСтрокиСотрудника = ИдентификаторСтроки;
			КонецЦикла;	
			
			СтрокиЗаписиОСтаже = ДокументОбъект.ЗаписиОСтаже.НайтиСтроки(СтруктураПоиска);
			Для Каждого СтрокаСтаж Из СтрокиЗаписиОСтаже Цикл
				СтрокаСтаж.ИдентификаторСтрокиСотрудника = ИдентификаторСтроки;
			КонецЦикла;	
			
			СтрокиНачисленныхВзносов = ДокументОбъект.НачисленныеВзносы.НайтиСтроки(СтруктураПоиска);
			Для Каждого СтрокаНачисленныхВзносов Из СтрокиНачисленныхВзносов Цикл
				СтрокаНачисленныхВзносов.ИдентификаторСтрокиСотрудника = ИдентификаторСтроки;
			КонецЦикла;	
			
			СтрокиСведенияОбУплаченныхВзносах = ДокументОбъект.СведенияОбУплаченныхВзносах.НайтиСтроки(СтруктураПоиска);
			Для Каждого СтрокаУплаченныеВзносы Из СтрокиСведенияОбУплаченныхВзносах Цикл 
				СтрокаУплаченныеВзносы.ИдентификаторСтрокиСотрудника = ИдентификаторСтроки;
			КонецЦикла;
...
Процедура ЗаполнитьЗаписиОСтажеСведенияОСтраховомСтажеЗастрахованныхЛицСЗВ_СТАЖ(ПараметрыОбновления = Неопределено) Экспорт 
	
	Запрос = Новый Запрос;
	
	Запрос.Текст = "ВЫБРАТЬ РАЗЛИЧНЫЕ
	               |	ЗаписиОСтажеРегистр.ДокументОснование КАК ДокументОснование
	               |ПОМЕСТИТЬ ВТОснования
	               |ИЗ
	               |	РегистрСведений.ЗаписиОСтажеСведенияОСтраховомСтажеЗастрахованныхЛицСЗВ_СТАЖ КАК ЗаписиОСтажеРегистр
	               |;
	               |
	               |////////////////////////////////////////////////////////////////////////////////
	               |ВЫБРАТЬ
	               |	ЗаписиОСтажеДокумент.Ссылка КАК ДокументОснование,
	               |	ЗаписиОСтажеДокумент.Сотрудник КАК Сотрудник,
	               |	ЗаписиОСтажеДокумент.НомерОсновнойЗаписи КАК НомерОсновнойЗаписи,
	               |	ЗаписиОСтажеДокумент.НомерДополнительнойЗаписи КАК НомерДополнительнойЗаписи,
	               |	ЗаписиОСтажеДокумент.ДатаНачалаПериода КАК ДатаНачалаПериода,
	               |	ЗаписиОСтажеДокумент.ДатаОкончанияПериода КАК ДатаОкончанияПериода,
	               |	ЗаписиОСтажеДокумент.ОсобыеУсловияТруда КАК ОсобыеУсловияТруда,
	               |	ЗаписиОСтажеДокумент.КодПозицииСписка КАК КодПозицииСписка,
	               |	ЗаписиОСтажеДокумент.ОснованиеИсчисляемогоСтажа КАК ОснованиеИсчисляемогоСтажа,
	               |	ЗаписиОСтажеДокумент.ПервыйПараметрИсчисляемогоСтажа КАК ПервыйПараметрИсчисляемогоСтажа,
	               |	ЗаписиОСтажеДокумент.ВторойПараметрИсчисляемогоСтажа КАК ВторойПараметрИсчисляемогоСтажа,
	               |	ЗаписиОСтажеДокумент.ТретийПараметрИсчисляемогоСтажа КАК ТретийПараметрИсчисляемогоСтажа,
	               |	ЗаписиОСтажеДокумент.ОснованиеВыслугиЛет КАК ОснованиеВыслугиЛет,
	               |	ЗаписиОСтажеДокумент.ПервыйПараметрВыслугиЛет КАК ПервыйПараметрВыслугиЛет,
	               |	ЗаписиОСтажеДокумент.ВторойПараметрВыслугиЛет КАК ВторойПараметрВыслугиЛет,
	               |	ЗаписиОСтажеДокумент.ТретийПараметрВыслугиЛет КАК ТретийПараметрВыслугиЛет,
	               |	ЗаписиОСтажеДокумент.ТерриториальныеУсловия КАК ТерриториальныеУсловия,
	               |	ЗаписиОСтажеДокумент.ПараметрТерриториальныхУсловий КАК ПараметрТерриториальныхУсловий,
	               |	ЗаписиОСтажеДокумент.ЗамещениеГосударственныхМуниципальныхДолжностей КАК ЗамещениеГосударственныхМуниципальныхДолжностей,
	               |	ЗаписиОСтажеДокумент.Ссылка.Организация КАК Организация
	               |ИЗ
	               |	Документ.СведенияОСтраховомСтажеЗастрахованныхЛицСЗВ_СТАЖ.УдалитьЗаписиОСтаже КАК ЗаписиОСтажеДокумент
	               |		ЛЕВОЕ СОЕДИНЕНИЕ ВТОснования КАК Основания
	               |		ПО ЗаписиОСтажеДокумент.Ссылка = Основания.ДокументОснование
	               |ГДЕ
	               |	Основания.ДокументОснование ЕСТЬ NULL
	               |
	               |УПОРЯДОЧИТЬ ПО
	               |	ДокументОснование,
	               |	Сотрудник,
	...
	Пока Выборка.СледующийПоЗначениюПоля("ДокументОснование") Цикл
		...
		Если Не ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ПодготовитьОбновлениеДанных(ПараметрыОбновления, "РегистрСведений.ЗаписиОСтажеСведенияОСтраховомСтажеЗастрахованныхЛицСЗВ_СТАЖ", "ДокументОснование", Выборка.ДокументОснование) Тогда
			Продолжить;
		КонецЕсли;
...
Функция ПолучитьДанныеДокументаВФорматеПФР(ДокументВид, ДокументСерия, ДокументНомер, ДокументДатаВыдачи, ДокументКемВыдан, ДокументКодПФР, ДокументНаименование) Экспорт 
	...
	СерииДокумента = ПерсонифицированныйУчет.РазложитьСериюДокумента(ДокументВид, ДокументСерия);
...
Функция СтрокаВОтчет(Знач Строка, ЗаменятьБуквуЁ = Ложь) Экспорт 
	Если ЗаменятьБуквуЁ Тогда
		ПерсонифицированныйУчет.ЗаменитьБуквуЁ(Строка, "");
	КонецЕсли;	
...
Процедура ЗаполнитьАдрес(НаборЗаписейАдрес, СтрокаАдрес, СписокСтран, ФорматНеструктурированныйАдрес, ФорматИностранныйАдрес, ЗаменятьБуквуЕ = Ложь) Экспорт
	...
	Иначе
		...
		НаборЗаписейРоссийскийАдрес.Регион.Значение.ГеографическоеНазвание = ПерсонифицированныйУчет.НаименованиеИАдресноеСокращение(ВРЕГ(СокрЛП(АдресСписком.Регион)), НаборЗаписейРоссийскийАдрес.Регион.Значение.Сокращение);
		Если ЗаменятьБуквуЕ Тогда
			ЗаменитьБуквуЁ(НаборЗаписейРоссийскийАдрес.Регион.Значение.ГеографическоеНазвание, "Регион");
		КонецЕсли;	
		
		НаборЗаписейРоссийскийАдрес.Район.Значение.ГеографическоеНазвание = ПерсонифицированныйУчет.НаименованиеИАдресноеСокращение(ВРЕГ(СокрЛП(АдресСписком.Район)), НаборЗаписейРоссийскийАдрес.Район.Значение.Сокращение);
		Если ЗаменятьБуквуЕ Тогда
			ЗаменитьБуквуЁ(НаборЗаписейРоссийскийАдрес.Район.Значение.ГеографическоеНазвание, "Район");
		КонецЕсли;
		
		НаборЗаписейРоссийскийАдрес.Город.Значение.ГеографическоеНазвание = ПерсонифицированныйУчет.НаименованиеИАдресноеСокращение(ВРЕГ(СокрЛП(АдресСписком.Город)), НаборЗаписейРоссийскийАдрес.Город.Значение.Сокращение);		
		Если ЗаменятьБуквуЕ Тогда	
			ЗаменитьБуквуЁ(НаборЗаписейРоссийскийАдрес.Город.Значение.ГеографическоеНазвание, "Город");
		КонецЕсли;
		
		НаборЗаписейРоссийскийАдрес.НаселенныйПункт.Значение.ГеографическоеНазвание = ПерсонифицированныйУчет.НаименованиеИАдресноеСокращение(ВРЕГ(СокрЛП(АдресСписком.НаселенныйПункт)), НаборЗаписейРоссийскийАдрес.НаселенныйПункт.Значение.Сокращение);
		Если ЗаменятьБуквуЕ Тогда
			ЗаменитьБуквуЁ(НаборЗаписейРоссийскийАдрес.НаселенныйПункт.Значение.ГеографическоеНазвание, "Населенный пункт");
		КонецЕсли;	
		
		НаборЗаписейРоссийскийАдрес.Улица.Значение.ГеографическоеНазвание = ПерсонифицированныйУчет.НаименованиеИАдресноеСокращение(ВРЕГ(СокрЛП(АдресСписком.Улица)), НаборЗаписейРоссийскийАдрес.Улица.Значение.Сокращение);
		Если ЗаменятьБуквуЕ Тогда
...
Процедура УстановитьВыводВФайл(Элемент, ПроверяемоеСвойство) Экспорт 
	...
	Если Не ЗначениеЗаполнено(Свойство) Тогда 
		Элемент.НеВыводитьВФайл = Истина;
	КонецЕсли;
...
Процедура УстановитьВыводВФайлСвойстваЗначенияЭлемента(Элемент, ИмяСвойства) Экспорт
	...
	Если Не ЗначениеЗаполнено(Элемент.Значение[ИмяСвойства]) Тогда 
		Элемент.Значение.Удалить(ИмяСвойства);
		СтрокаПоля = Элемент.Поля.Найти(ИмяСвойства, "ИмяПоля");
		Если СтрокаПоля <> Неопределено Тогда
			Элемент.Поля.Удалить(СтрокаПоля);
		КонецЕсли;		
	КонецЕсли;
...
Функция ПолучитьПредставлениеАдресаДляПФР(СтруктураАдрес) Экспорт 
	...
	Если СтруктураАдрес <> Неопределено Тогда 
		...
		Если Не ЗаПределамиРФ Тогда
			СокращениеРегион = "";
			Регион = ПерсонифицированныйУчет.НаименованиеИАдресноеСокращение(ВРЕГ(СокрЛП(СтруктураАдрес.Регион)), СокращениеРегион);
			СокращениеРайон = "";
			Район = ПерсонифицированныйУчет.НаименованиеИАдресноеСокращение(ВРЕГ(СокрЛП(СтруктураАдрес.Район)), СокращениеРайон);
			СокращениеГород = "";
			Город = ПерсонифицированныйУчет.НаименованиеИАдресноеСокращение(ВРЕГ(СокрЛП(СтруктураАдрес.Город)), СокращениеГород);
			СокращениеНаселенныйПункт = "";
			НаселенныйПункт = ПерсонифицированныйУчет.НаименованиеИАдресноеСокращение(ВРЕГ(СокрЛП(СтруктураАдрес.НаселенныйПункт)), СокращениеНаселенныйПункт);
			СокращениеУлица = "";
			Улица = ПерсонифицированныйУчет.НаименованиеИАдресноеСокращение(ВРЕГ(СокрЛП(СтруктураАдрес.Улица)), СокращениеУлица);
...
Функция ВывестиОписьАДВ6(МассивОбъектов, ОбъектыПечати,  ТипДокумента, Знач ИмяМакета = Неопределено) Экспорт
	...
	КонецЕсли;
	МакетОписи = УправлениеПечатью.МакетПечатнойФормы("ОбщийМакет." + ИмяМакета);
...
Функция СтрокаАдресаПоXDTO(АдресXDTO) Экспорт
	...
	Регион = "" + ПерсонифицированныйУчет.ЗначениеXDTOИзДерева(АдресXDTO,"РоссийскийАдрес/Регион/ГеографическоеНазвание") + " " + ПерсонифицированныйУчет.ЗначениеXDTOИзДерева(АдресXDTO,"РоссийскийАдрес/Регион/Сокращение"); 
	
	Если Не ПустаяСтрока(Регион) Тогда
		СтруктураАдреса.Регион = Регион;
	КонецЕсли;

	Район = "" + ПерсонифицированныйУчет.ЗначениеXDTOИзДерева(АдресXDTO,"РоссийскийАдрес/Район/ГеографическоеНазвание") + " " + ПерсонифицированныйУчет.ЗначениеXDTOИзДерева(АдресXDTO,"РоссийскийАдрес/Район/Сокращение");
	
	Если Не ПустаяСтрока(Район) Тогда
		СтруктураАдреса.Район = Район;
	КонецЕсли;
	
	Город = "" + ПерсонифицированныйУчет.ЗначениеXDTOИзДерева(АдресXDTO,"РоссийскийАдрес/Город/ГеографическоеНазвание") + " " + ПерсонифицированныйУчет.ЗначениеXDTOИзДерева(АдресXDTO,"РоссийскийАдрес/Город/Сокращение");
	
	Если Не ПустаяСтрока(Город) Тогда
		СтруктураАдреса.Город = Город;
	КонецЕсли;
	
	НаселенныйПункт = "" + ПерсонифицированныйУчет.ЗначениеXDTOИзДерева(АдресXDTO,"РоссийскийАдрес/НаселенныйПункт/ГеографическоеНазвание") + " " + ПерсонифицированныйУчет.ЗначениеXDTOИзДерева(АдресXDTO,"РоссийскийАдрес/НаселенныйПункт/Сокращение");
	
	Если Не ПустаяСтрока(НаселенныйПункт) Тогда
		СтруктураАдреса.НаселенныйПункт = НаселенныйПункт;
	КонецЕсли;
	
	Улица = "" + ПерсонифицированныйУчет.ЗначениеXDTOИзДерева(АдресXDTO,"РоссийскийАдрес/Улица/ГеографическоеНазвание") + " " + ПерсонифицированныйУчет.ЗначениеXDTOИзДерева(АдресXDTO,"РоссийскийАдрес/Улица/Сокращение");
	
	Если Не ПустаяСтрока(Улица) Тогда
		СтруктураАдреса.Улица = Улица;
	КонецЕсли;
	
	Дом = "" + ПерсонифицированныйУчет.ЗначениеXDTOИзДерева(АдресXDTO,"РоссийскийАдрес/Дом/Номер");
	...
	Корпус = "" + ПерсонифицированныйУчет.ЗначениеXDTOИзДерева(АдресXDTO,"РоссийскийАдрес/Корпус/Номер");
	...
	Квартира = "" + ПерсонифицированныйУчет.ЗначениеXDTOИзДерева(АдресXDTO,"РоссийскийАдрес/Квартира/Номер");
...
Процедура ПроверитьДанныеОрганизации(Объект, Организация, Отказ, ДатаАктуальности = Неопределено) Экспорт 
	Если ЗначениеЗаполнено(Организация) Тогда
		...
		Если ДанныеОрганизации.ЮридическоеФизическоеЛицо = Перечисления.ЮридическоеФизическоеЛицо.ЮридическоеЛицо Тогда
			...
			ИначеЕсли СтрДлина(СокрЛП(ДанныеОрганизации.КПП)) <> 9 Тогда
		...
		ИначеЕсли НЕ РегламентированныеДанныеКлиентСервер.ИННСоответствуетТребованиям(ДанныеОрганизации.ИНН, ЗарплатаКадры.ЭтоЮридическоеЛицо(Организация), "")  Тогда
...
Процедура ПроверитьСоответствиеИзменившихсяДанныхДаннымСвидетельства(Ссылка, ДанныеСотрудника, Отказ) Экспорт
	Если ЗначениеЗаполнено(ДанныеСотрудника.ФамилияВСвидетельстве) И ВРег(СокрЛП(ДанныеСотрудника.Фамилия)) = ВРег(СокрЛП(ДанныеСотрудника.ФамилияВСвидетельстве)) Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстОшибки, Ссылка, "Объект.Сотрудники[" + Формат(ДанныеСотрудника.НомерСтроки - 1, "ЧН=0; ЧГ=0") + "].Сотрудник",,Отказ);
	КонецЕсли;
...
Функция ВыгрузитьДокументы(ДокументСсылка, УникальныйИдентификатор) Экспорт
	...
	Иначе	
		...
		ДанныеФайлаДокумента = ЗарплатаКадры.ПолучитьДанныеФайла(ДокументСсылка, УникальныйИдентификатор, Истина);
...
Функция ПолучитьДатыПериодаДокумента(ДокументСсылка) Экспорт
	...
	Если ТипДокумента = Тип("ДокументСсылка.ВедомостьУплатыАДВ_11")
		...
		Если ТипДокумента = Тип("ДокументСсылка.ПачкаДокументовСЗВ_6_3") Или
			ТипДокумента = Тип("ДокументСсылка.ВедомостьУплатыАДВ_11") Тогда
			
			ДатаНачала = Дата(ДанныеДокумента.ОтчетныйПериод, 1, 1);
			ДатаОкончания = Дата(ДанныеДокумента.ОтчетныйПериод, 12, 31, 23, 59, 59);
		ИначеЕсли ТипДокумента = Тип("ДокументСсылка.СведенияОЗастрахованныхЛицахСЗВ_М") Тогда
			ДатаНачала = ДанныеДокумента.ОтчетныйПериод;
			ДатаОкончания = КонецМесяца(ДатаНачала);
		ИначеЕсли ТипДокумента = Тип("ДокументСсылка.ОписьОДВ_1")
			Или ТипДокумента = Тип("ДокументСсылка.СведенияОСтраховомСтажеЗастрахованныхЛицСЗВ_СТАЖ")
			Или ТипДокумента = Тип("ДокументСсылка.ДанныеОКорректировкеСведенийЗастрахованныхЛицСЗВ_КОРР") 
			Или ТипДокумента = Тип("ДокументСсылка.СведенияОЗаработкеСтажеЗастрахованныхЛицСЗВ_ИСХ") Тогда
			ДатаНачала = ДанныеДокумента.ОтчетныйПериод;
...
// Возвращает различаются ли значения контактной информации, переданные в параметрах, или нет.
//
// Параметры:
...
//
// Возвращаемое значение:
//		Булево - если Истина, то переданные значения различаются
//			иначе - Ложь.
//
Функция ЗначенияКИРазличаются(Данные1, Данные2) Экспорт
	
	РазличияКонтактнойИнформации = УправлениеКонтактнойИнформациейСлужебный.РазличияКонтактнойИнформации(Данные1, Данные2);
	
	Возврат РазличияКонтактнойИнформации.Количество() > 0;
