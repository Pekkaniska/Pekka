...
Функция КодыВидовОперацийПолученныхСчетовФактур(ЭтоЖурнал = Ложь) Экспорт
	...
	ЭтоНовыйСписок        = ЭтоСписокКодовСЯнваря2019();
	ИспользоватьСтарые    = НЕ ЭтоНовыйСписок; // Удалены в новом списке
	ИспользоватьНовые     = ЭтоНовыйСписок; // Добавлены в новом списке
	УдаленоТолькоВЖурнале = ИспользоватьСтарые И ЭтоЖурнал ИЛИ НЕ ЭтоЖурнал;
	ДляВсех               = Истина;
	...
	ДобавитьКод(СписокКодов, "03", "03 - Возврат от покупателя", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "04", "04 - Товары, работы, услуги комитента", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "05", "05 - Авансы за товары, работы, услуги комитента", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "06", "06 - Налоговый агент, ст. 161 НК", УдаленоТолькоВЖурнале);
	ДобавитьКод(СписокКодов, "07", "07 - Списание за счет прибыли, пп.2 п.1 ст. 146 НК", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "08", "08 - Строительно-монтажные работы, пп.3 п.1 ст. 146 НК", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "09", "09 - Суммы, связанные с расчетами по оплате, ст. 162 НК", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "10", "10 - Полученные безвозмездно товары, работы, услуги", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "11", "11 - Полученные товары, права, п.3,4,5.1 статьи 154, пп.1-4 статьи 155 НК", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "12", "12 - Авансы выданные за товары, права, п.3,4,5.1 статьи 154, пп.1-4 статьи 155 НК", ИспользоватьСтарые);
	...
	ДобавитьКод(СписокКодов, "16", "16 - Возврат от покупателя-неплательщика НДС", УдаленоТолькоВЖурнале);
	ДобавитьКод(СписокКодов, "17", "17 - Возврат от покупателя-физического лица", УдаленоТолькоВЖурнале);
	...
	ДобавитьКод(СписокКодов, "21", "21 - Восстановление НДС, п.8 ст. 145, п.3 ст. 170, ст. 171.1 НК, а также при операциях, облагаемых по ставке 0%", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "22", "22 - Возврат, зачет авансовых платежей, п.5 статьи 171, п.6 статьи 172 НК", УдаленоТолькоВЖурнале);
	ДобавитьКод(СписокКодов, "23", "23 - Командировочные расходы по бланку строгой отчетности, п.7 статьи 171 НК", УдаленоТолькоВЖурнале);
	ДобавитьКод(СписокКодов, "24", "24 - Подтверждение ставки 0% после истечения 180 дней", УдаленоТолькоВЖурнале);
	ДобавитьКод(СписокКодов, "25", "25 - Подтверждение ставки 0%", УдаленоТолькоВЖурнале);
	ДобавитьКод(СписокКодов, "26", "26 - Реализация товаров, работ, услуг неплательщикам НДС, получение авансов", УдаленоТолькоВЖурнале);
	...
	ДобавитьКод(СписокКодов, "33", НСтр("ru = '33 - Авансы полученные за товары п.8 ст. 161 НК'"), ИспользоватьНовые И ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "34", НСтр("ru = '34 - Реализация товаров п.8 ст. 161 НК'"), ИспользоватьНовые);
	ДобавитьКод(СписокКодов, "36", НСтр("ru = '36 - Вычет НДС при реализации гражданину иностранного государства, п.4.1 ст. 171 НК'"), ИспользоватьНовые И НЕ ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "37", НСтр("ru = '37 - Реализация сырьевых товаров на экспорт по ставке 18%, п.7 ст.164 НК'"), ИспользоватьНовые И ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "38", НСтр("ru = '38 - Реализация несырьевых товаров на экспорт по ставке 18%, п.7 ст.164 НК'"), ИспользоватьНовые И ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "39", НСтр("ru = '39 - Реализация несырьевых товаров на экспорт по ставке 10%, п.7 ст.164 НК'"), ИспользоватьНовые И ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "40", НСтр("ru = '40 - Реализация работ (услуг) в отношении экспортируемых товаров по ставке 18%, пп.2.1-2.5,2.7 и 2.8 п.1, п.7 ст.164 НК'"), ИспользоватьНовые И ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "41", НСтр("ru = '41 - Авансы выданные за товары п.8 ст. 161 НК'"), ИспользоватьНовые И НЕ ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "42", НСтр("ru = '42 - Получение товаров п.8 ст. 161 НК'"), ИспользоватьНовые И НЕ ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "43", НСтр("ru = '43 - Возврат, зачет авансовых платежей за товары п.8 ст. 161 НК'"), ИспользоватьНовые И НЕ ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "44", НСтр("ru = '44 - Изменение стоимости полученных товаров п.8 ст. 161 НК в сторону уменьшения'"), ИспользоватьНовые И НЕ ЭтоЖурнал);
...
Функция КодыВидовОперацийВыданныхСчетовФактур(ЭтоЖурнал = Ложь, ЭтоНетКнигаПрод = Ложь) Экспорт
	...
	ДобавитьКод(СписокКодов, "03", "03 - Возврат поставщику", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "04", "04 - Товары, работы, услуги комитента", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "05", "05 - Авансы за товары, работы, услуги комитента", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "06", "06 - Налоговый агент, статья 161 НК", ИспользоватьСтарые И ЭтоЖурнал ИЛИ НЕ ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "07", "07 - Списание за счет прибыли, пп.2 п.1 статьи 146 НК", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "08", "08 - Строительно-монтажные работы, пп.3 п.1 статьи 146 НК", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "09", "09 - Суммы, связанные с расчетами по оплате, статья 162 НК", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "10", "10 - Переданные безвозмездно товары, работы, услуги", ИспользоватьСтарые И ЭтоЖурнал ИЛИ НЕ ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "11", "11 - Реализованные товары, права, п.3,4,5.1 статьи 154, пп.1-4 статьи 155 НК", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "12", "12 - Авансы полученные за товары, права, п.3,4,5.1 статьи 154, пп.1-4 статьи 155 НК", ИспользоватьСтарые);
	ДобавитьКод(СписокКодов, "13", "13 - Капитальное строительство, модернизация (реконструкция) объектов недвижимости", ДляВсех);
	ДобавитьКод(СписокКодов, "14", "14 - Реализация прав, пп.1-4 ст. 155 НК", НЕ ЭтоЖурнал И НЕ ЭтоНетКнигаПрод ИЛИ ИспользоватьНовые И ЭтоНетКнигаПрод);
	ДобавитьКод(СписокКодов, "15", "15 - Совместная реализация собственных и комиссионных товаров, работ, услуг", ДляВсех);
	ДобавитьКод(СписокКодов, "16", "16 - Возврат от покупателя-неплательщика НДС", ИспользоватьСтарые ИЛИ ЭтоНетКнигаПрод);
	ДобавитьКод(СписокКодов, "17", "17 - Возврат от покупателя-физического лица", ИспользоватьСтарые ИЛИ ЭтоНетКнигаПрод);
	ДобавитьКод(СписокКодов, "18", "18 - Изменение стоимости полученных товаров (работ, услуг) в сторону уменьшения", ДляВсех);
	ДобавитьКод(СписокКодов, "19", "19 - Ввоз товаров из Евразийского экономического союза", ИспользоватьСтарые ИЛИ ЭтоЖурнал ИЛИ ЭтоНетКнигаПрод);
	ДобавитьКод(СписокКодов, "20", "20 - Ввоз импортных товаров на территорию РФ", ИспользоватьСтарые ИЛИ ЭтоЖурнал ИЛИ ЭтоНетКнигаПрод);
	ДобавитьКод(СписокКодов, "21", "21 - Восстановление НДС, п.8 статьи 145, п.3 статьи 170, статья 171.1 НК, а также при операциях, облагаемых по ставке 0%", ИспользоватьСтарые И ЭтоЖурнал ИЛИ НЕ ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "22", "22 - Возврат, зачет авансовых платежей, п.5 статьи 171, п.6 статьи 172 НК", ИспользоватьСтарые ИЛИ ЭтоНетКнигаПрод);
	ДобавитьКод(СписокКодов, "23", "23 - Командировочные расходы по бланку строгой отчетности, п.7 статьи 171 НК", ИспользоватьСтарые ИЛИ ЭтоНетКнигаПрод);
	ДобавитьКод(СписокКодов, "24", "24 - Подтверждение ставки 0% после истечения 180 дней", ИспользоватьСтарые ИЛИ ЭтоНетКнигаПрод);
	ДобавитьКод(СписокКодов, "25", "25 - Подтверждение ставки 0%", ИспользоватьСтарые ИЛИ ЭтоНетКнигаПрод);
	ДобавитьКод(СписокКодов, "26", "26 - Счета-фактуры не составляются по письменному согласию сторон", ИспользоватьСтарые И ЭтоЖурнал ИЛИ НЕ ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "27", "27 - Сводный комиссионный счет-фактура, п.3.1 статьи 169 НК", ДляВсех);
	ДобавитьКод(СписокКодов, "28", "28 - Сводный комиссионный счет-фактура на аванс, п.3.1 статьи 169 НК", ДляВсех);
	...
	ДобавитьКод(СписокКодов, "31", "31 - Уплата НДС в ОЭЗ Калининградской обл., абз.2 пп.1.1 п.1 ст. 151 НК", НЕ ЭтоЖурнал И НЕ ЭтоНетКнигаПрод ИЛИ ИспользоватьНовые И ЭтоНетКнигаПрод);
	ДобавитьКод(СписокКодов, "32", НСтр("ru = '32 - Вычет НДС в ОЭЗ Калининградской обл., п.14 ст. 171 НК'"), ИспользоватьНовые И ЭтоНетКнигаПрод);
	ДобавитьКод(СписокКодов, "33", НСтр("ru = '33 - Авансы полученные за товары п.8 ст. 161 НК'"), ИспользоватьНовые);
	ДобавитьКод(СписокКодов, "34", НСтр("ru = '34 - Реализация товаров п.8 ст. 161 НК'"), ИспользоватьНовые);
	ДобавитьКод(СписокКодов, "35", НСтр("ru = '35 - Оформление документа для компенсации НДС гражданину иностранного государства'"), ИспользоватьНовые И НЕ ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "36", НСтр("ru = '36 - Вычет НДС при реализации гражданину иностранного государства, п.4.1 ст. 171 НК'"), ИспользоватьНовые И ЭтоНетКнигаПрод);
	ДобавитьКод(СписокКодов, "37", НСтр("ru = '37 - Реализация сырьевых товаров на экспорт по ставке 18%, п.7 ст.164 НК'"), ИспользоватьНовые);
	ДобавитьКод(СписокКодов, "38", НСтр("ru = '38 - Реализация несырьевых товаров на экспорт по ставке 18%, п.7 ст.164 НК'"), ИспользоватьНовые);
	ДобавитьКод(СписокКодов, "39", НСтр("ru = '39 - Реализация несырьевых товаров на экспорт по ставке 10%, п.7 ст.164 НК'"), ИспользоватьНовые);
	ДобавитьКод(СписокКодов, "40", НСтр("ru = '40 - Реализация работ (услуг) в отношении экспортируемых товаров по ставке 18%, пп.2.1-2.5,2.7 и 2.8 п.1, п.7 ст.164 НК'"), ИспользоватьНовые);
	ДобавитьКод(СписокКодов, "41", НСтр("ru = '41 - Авансы выданные за товары п.8 ст. 161 НК'"), ИспользоватьНовые И НЕ ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "42", НСтр("ru = '42 - Получение товаров п.8 ст. 161 НК'"), ИспользоватьНовые И НЕ ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "43", НСтр("ru = '43 - Возврат, зачет авансовых платежей за товары п.8 ст. 161 НК'"), ИспользоватьНовые И НЕ ЭтоЖурнал);
	ДобавитьКод(СписокКодов, "44", НСтр("ru = '44 - Изменение стоимости полученных товаров п.8 ст. 161 НК в сторону уменьшения'"), ИспользоватьНовые И НЕ ЭтоЖурнал);
...
&НаКлиенте
Функция ЭтоСписокКодовСЯнваря2019() Экспорт
	
	Возврат ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отв.тр.НДС 05.02.02");
