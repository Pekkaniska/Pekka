...
Функция СведенияОДоходахПоДоговорамСтраховыеВзносы(Организация, ПериодРегистрации, МенеджерВременныхТаблиц) Экспорт
	...
	|	ЕСТЬNULL(ВЫРАЗИТЬ(СписокНачислений.Подразделение КАК Справочник.ПодразделенияОрганизаций).ПрименяемыйЛьготныйТерриториальныйТариф, ЗНАЧЕНИЕ(Справочник.ВидыТарифовСтраховыхВзносов.ПустаяСсылка)) КАК ЛьготныйТерриториальныйТариф,
