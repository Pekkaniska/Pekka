...
//   * Идентификатор - ОпределяемыйТип.УникальныйИдентификаторВЕТИС - GUID упаковки
...
// Возвращаемое значение:
//	ТаблицаЗначений - Таблица с колонками:
//		* ИдентификаторПродукции	- ОпределяемыйТип.УникальныйИдентификаторВЕТИС	- УИД продукции, типа продукции
...
Функция СпецифическаяПродукция() Экспорт
	...
	ТипУникальныйИдентификаторВЕТИС	= Метаданные.ОпределяемыеТипы.УникальныйИдентификаторВЕТИС.Тип;
	ТипСтрокаВЕТИС					= Метаданные.ОпределяемыеТипы.СтрокаВЕТИС.Тип;
	ТипБулево						= Новый ОписаниеТипов("Булево");
	
	ТаблицаРезультата = Новый ТаблицаЗначений;
	ТаблицаРезультата.Колонки.Добавить("ИдентификаторПродукции",	ТипУникальныйИдентификаторВЕТИС);
...
//
// Параметры:
//  GUID - ОпределяемыйТип.УникальныйИдентификаторВЕТИС - ключ поиска
// 
// Возвращаемое значение:
...
Функция СтранаМира(GUID) Экспорт
	...
	Если Не ЗначениеЗаполнено(СтранаМира) Тогда
		...
		ДанныеКлассификатораСтранМира = УправлениеКонтактнойИнформацией.ТаблицаКлассификатора();
		ДанныеСтраныМира = ДанныеКлассификатораСтранМира.Найти(СтрокаТЧ.КодАльфа2, "КодАльфа2");
		
		Если ДанныеСтраныМира <> Неопределено Тогда
			
			СтранаМираОбъект = Справочники.СтраныМира.СоздатьЭлемент();
			ЗаполнитьЗначенияСвойств(СтранаМираОбъект, ДанныеСтраныМира);
			УстановитьПривилегированныйРежим(Истина);
			СтранаМираОбъект.Записать();
			УстановитьПривилегированныйРежим(Ложь);
			СтранаМира = СтранаМираОбъект.Ссылка;
...
//
// Параметры:
//  Идентификатор	 - ОпределяемыйТип.УникальныйИдентификаторВЕТИС - ключ поиска
// 
// Возвращаемое значение:
...
//		* ЕдиницаИзмеренияGUID			- ОпределяемыйТип.УникальныйИдентификаторВЕТИС - Уникальный идентификатор единицы 
//																						измерения ВЕТИС.
//		* БазоваяЕдиницаИзмеренияGUID	- ОпределяемыйТип.УникальныйИдентификаторВЕТИС - Уникальный идентификатор базовой 
...
Функция ДанныеКлассификатораЕдиницИзмеренияВЕТИС() Экспорт
	...
	ДанныеКлассификатора.Колонки.Добавить("ЕдиницаИзмеренияGUID",        ТипУникальныйИдентификаторВЕТИС);
	ДанныеКлассификатора.Колонки.Добавить("БазоваяЕдиницаИзмеренияGUID", ТипУникальныйИдентификаторВЕТИС);
