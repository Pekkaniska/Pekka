...
//
Функция ОтобратьТоварИзЯчеек(МенеджерВременныхТаблиц, Склад, Помещение, пкСкладскаяЯчейка = Неопределено) Экспорт
//---DubI Рарус-СПб
...
//+++DubI Рарус-СПб 17.01.2017
	...
	ПодобратьЯчейкиДляОтбора(МенеджерВременныхТаблиц, Склад, Помещение, СтруктураТаблицАлгоритмаОтборТоваров, Ложь, пкСкладскаяЯчейка);
//---DubI Рарус-СПб
...
//+++DubI Рарус-СПб 17.01.2017
		...
		ПодобратьЯчейкиДляОтбора(МенеджерВременныхТаблиц, Склад, Помещение, СтруктураТаблицАлгоритмаОтборТоваров, Истина, пкСкладскаяЯчейка);
//---DubI Рарус-СПб
	КонецЕсли;
...
Функция СтруктураТаблицАлгоритмаОтборТоваров()
	...
	Возврат СтруктураВозврата;
КонецФункции
Процедура ПодобратьЯчейкиДляОтбора(МенеджерВременныхТаблиц, Склад, Помещение, СтруктураТаблиц, ОтборТары, пкСкладскаяЯчейка=Неопределено)
//---DubI Рарус-СПб
...
//+++DubI Рарус-СПб 17.01.2017
		|ГДЕ
		|	ВЫБОР
		|			КОГДА &пкСкладскаяЯчейка = НЕОПРЕДЕЛЕНО
		|				ТОГДА ИСТИНА
		|			ИНАЧЕ ТоварыВЯчейкахОстатки.Ячейка = &пкСкладскаяЯчейка
		|		КОНЕЦ
//---DubI Рарус-СПб
		|;
		|
...
//---DubI Рарус-СПб
	...
	Запрос.УстановитьПараметр("Помещение",Помещение);
//DubI Рарус+СПб
	Запрос.УстановитьПараметр("пкСкладскаяЯчейка",пкСкладскаяЯчейка); //DubI Рарус-СПб
//DubI Рарус-СПб
