...
Процедура ОткрытьФормуПрисоединенныеФайлы(Результат, ДопПараметры) Экспорт
	...
	Иначе
		...
		ПараметрыОткрываемойФормы = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ДопПараметры);
...
Процедура ПриАктивизацииОбластиСтатистическогоОтчета(Форма) Экспорт 
