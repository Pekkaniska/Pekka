...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|	ВидыЗапасовТоваров.Договор.Подразделение КАК ПодразделениеДт,
	|	ВидыЗапасовТоваров.Договор.НаправлениеДеятельности КАК НаправлениеДеятельностиДт,
	|
	|	ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.ТоварыКОформлениюОтчетовКомитенту) КАК СчетДт,
	|	ВидыЗапасовТоваров.Контрагент КАК СубконтоДт1,
