...
//
Функция ОтправитьPOSTЗапрос(АдресСервера, Ресурс, Заголовки, Данные = Неопределено, ПолучитьТелоКакСтроку = Ложь, Таймаут = 60) Экспорт
	
	Перенаправления = Новый Массив;
	Возврат ОтправитьPOSTЗапросРекурсивно(АдресСервера, Ресурс, Заголовки, Данные, ПолучитьТелоКакСтроку, Таймаут, Перенаправления)
...
Функция ОтправитьPOSTЗапросРекурсивно(АдресСервера, Ресурс, Заголовки, Данные, ПолучитьТелоКакСтроку, Таймаут, Перенаправления = Неопределено)
	...
	Если ОтветHTTP.КодСостояния = 301 // 301 Moved Permanently
		...
		Иначе
			...
			Перенаправления.Добавить(АдресСервера);
			...
			Возврат ОтправитьPOSTЗапросРекурсивно(НовыйURL, Ресурс, Заголовки, Данные, ПолучитьТелоКакСтроку, Таймаут, Перенаправления);
