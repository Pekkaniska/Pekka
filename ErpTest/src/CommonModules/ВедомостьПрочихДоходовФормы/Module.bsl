...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Если Форма.Параметры.Ключ.Пустая() Тогда
		ЗаполнитьПервоначальныеЗначения(Форма);
...
//
Процедура ЗаполнитьПервоначальныеЗначения(Форма)
...
Процедура ПриПолученииДанныхНаСервере(Форма, ТекущийОбъект) Экспорт
	...
	Для Каждого СтрокаСостава Из Форма.Объект.Состав Цикл
		ПриПолученииДанныхСтрокиСостава(Форма, СтрокаСостава, ШаблонРасшифровкиФинансирование);
	КонецЦикла;
...
Процедура ПриПолученииДанныхСтрокиСостава(Форма, СтрокаСостава, ШаблонРасшифровкиФинансирование = Неопределено) Экспорт
