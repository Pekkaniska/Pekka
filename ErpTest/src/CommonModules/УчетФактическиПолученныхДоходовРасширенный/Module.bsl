...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ВнешниеХозяйственныеОперации.УчетФактическиПолученныхДоходов") Тогда
		...
		Обработчик.Процедура = "УчетФактическиПолученныхДоходовВХО.ЗаполнитьОрганизациюВРегистреДатыВыплатыДоходов";
	КонецЕсли;
...
Процедура ПеренестиВыплаченныйДоходНаДату(Движения, Ведомость, ДатаВыплаты, ДатаОперации, Отказ, Регистратор = Неопределено) Экспорт
	...
	|				И НЕ РасчетыНалогоплательщиковСБюджетомПоНДФЛ.КатегорияДохода В (&НепереносимыеКатегорииДохода))
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
