...
//
Процедура ВыявитьОшибкиЗаполненияПрепятствующиеФормированиюЭлектронногоПредставления_ФормаОтчета2017Кв1(Отчет, МакетОформления, НаименованиеДекларации, АдресХранилища) Экспорт
	
	ДанныеОтчета = СформироватьСтруктуруПоказателей_ФормаОтчета2017Кв1(Отчет);
	ПараметрыВыгрузки = ПараметрыВыгрузки_ФормаОтчета2017Кв1(Отчет, ДанныеОтчета);
	...
	ПроверитьЗаполнение_ТитульныйЛист_ФормаОтчета2017Кв1(КонтекстВыполнения);
	ПроверитьЗаполнение_Раздел1_ФормаОтчета2017Кв1(КонтекстВыполнения);
	ПроверитьЗаполнение_Раздел2_ФормаОтчета2017Кв1(КонтекстВыполнения);
	ПроверитьЗаполнение_Раздел3Приложение1_ФормаОтчета2017Кв1(КонтекстВыполнения);
	ПроверитьЗаполнение_Раздел3Приложение2_ФормаОтчета2017Кв1(КонтекстВыполнения);
	ПроверитьЗаполнение_Раздел4_ФормаОтчета2017Кв1(КонтекстВыполнения);
	ПроверитьЗаполнение_Раздел5_ФормаОтчета2017Кв1(КонтекстВыполнения);
	ПроверитьЗаполнение_Раздел6_ФормаОтчета2017Кв1(КонтекстВыполнения);
	ПроверитьЗаполнение_Раздел7_ФормаОтчета2017Кв1(КонтекстВыполнения);
	
	ПроверитьРазделыНДС_ФормаОтчета2017Кв1(КонтекстВыполнения);
	
	СформироватьПредставлениеОшибок_ФормаОтчета2017Кв1(КонтекстВыполнения);
...
#Область ПроверкиФормаОтчета2017Кв1

Функция СформироватьСтруктуруПоказателей_ФормаОтчета2017Кв1(Отчет)
	...
	Для Каждого Раздел Из ПоказателиОтчета Цикл
		Если ЭтоОтчетСтарогоОбразца Тогда
			...
			ВосстановитьСтруктуруДанныхРазделаСтарогоОбразца_ФормаОтчета2017Кв1(
...
Процедура ВосстановитьСтруктуруДанныхРазделаСтарогоОбразца_ФормаОтчета2017Кв1(Отчет, ПоказателиОтчета, ИмяСтруктурыДанных, ИмяРаздела)
...
Функция ПараметрыВыгрузки_ФормаОтчета2017Кв1(Отчет, ДанныеОтчета)
...
Процедура ПроверитьЗаполнение_ТитульныйЛист_ФормаОтчета2017Кв1(КонтекстВыполнения)
...
Процедура ПроверитьЗаполнение_Раздел1_ФормаОтчета2017Кв1(КонтекстВыполнения)
...
Процедура ПроверитьЗаполнение_Раздел2_ФормаОтчета2017Кв1(КонтекстВыполнения)
	...
	Для Каждого СтраницаРаздела Из ДанныеРаздела Цикл
		...
		Если НЕ ЗаполненаСтраница_Раздел2_ФормаОтчета2017Кв1(ДанныеСтраницы) Тогда
			Продолжить;
		КонецЕсли;
...
Функция ЗаполненаСтраница_Раздел2_ФормаОтчета2017Кв1(ДанныеСтраницы)
...
Процедура ПроверитьЗаполнение_Раздел3Приложение1_ФормаОтчета2017Кв1(КонтекстВыполнения)
	...
	Для Каждого СтраницаРаздела Из ДанныеРаздела Цикл
		...
		Если НЕ ЗаполненаСтраница_Раздел3_Прил1_ФормаОтчета2017Кв1(ДанныеСтраницы) Тогда
			Продолжить;
...
Функция ЗаполненаСтраница_Раздел3_Прил1_ФормаОтчета2017Кв1(ДанныеСтраницы)
...
Процедура ПроверитьЗаполнение_Раздел3Приложение2_ФормаОтчета2017Кв1(КонтекстВыполнения)
...
Процедура ПроверитьЗаполнение_Раздел4_ФормаОтчета2017Кв1(КонтекстВыполнения)
...
Процедура ПроверитьЗаполнение_Раздел5_ФормаОтчета2017Кв1(КонтекстВыполнения)
	...
	Для Каждого СтраницаРаздела Из ДанныеРаздела Цикл
		...
		Если НЕ ЗаполненаСтраница_Раздел5_ФормаОтчета2017Кв1(ДанныеСтраницы) Тогда
			Продолжить;
		КонецЕсли;
...
Функция ЗаполненаСтраница_Раздел5_ФормаОтчета2017Кв1(ДанныеСтраницы)
...
Процедура ПроверитьЗаполнение_Раздел6_ФормаОтчета2017Кв1(КонтекстВыполнения)
...
Процедура ПроверитьЗаполнение_Раздел7_ФормаОтчета2017Кв1(КонтекстВыполнения)
...
Процедура ПроверитьРазделыНДС_ФормаОтчета2017Кв1(КонтекстВыполнения)
	...
	Если ПараметрыВыгрузки.ПоМесту = "231" Тогда
		...
		Для Каждого ЛистРаздела Из Раздел2 Цикл
			...
			Если ЗаполненаСтраница_Раздел2_ФормаОтчета2017Кв1(ДанныеЛиста) Тогда
	...
	Если ПроверятьРаздел8 Тогда
		ПроверитьЗаполнение_Раздел8_ФормаОтчета2017Кв1(КонтекстВыполнения, ДанныеРаздел8);
	КонецЕсли;
	ПроверитьЗаполнение_Раздел8_Прил1_ФормаОтчета2017Кв1(КонтекстВыполнения, ДанныеРаздел8_Прил1);
	
	Если ПроверятьРаздел9 Тогда
		ПроверитьЗаполнение_Раздел9_ФормаОтчета2017Кв1(КонтекстВыполнения, ДанныеРаздел9);
	КонецЕсли;
	ПроверитьЗаполнение_Раздел9_Прил1_ФормаОтчета2017Кв1(КонтекстВыполнения, ДанныеРаздел9_Прил1);
	
	ПроверитьЗаполнение_Раздел10_ФормаОтчета2017Кв1(КонтекстВыполнения, ДанныеРаздел10);
	ПроверитьЗаполнение_Раздел11_ФормаОтчета2017Кв1(КонтекстВыполнения, ДанныеРаздел11);
	ПроверитьЗаполнение_Раздел12_ФормаОтчета2017Кв1(КонтекстВыполнения, ДанныеРаздел12);
	
КонецПроцедуры

Процедура ПроверитьЗаполнение_Раздел8_ФормаОтчета2017Кв1(КонтекстВыполнения, ДанныеРаздела)
	...
	СписокДопустимыхКодовОпераций = КодыОперацийФормаОтчета2017Кв1("Раздел8", КонтекстВыполнения);
	ДопустимыеКодыОперации = СтрРазделить(СписокДопустимыхКодовОпераций, ",");
	
	СписокКодовПоПродавцам = КодыОперацийПоПродавцамФормаОтчета2017Кв1(КонтекстВыполнения);
	...
	Если ТипЗнч(ДанныеРаздела) = Тип("Массив") Тогда
		...
		Для Каждого НомерПервойСтрокиСекции Из ДанныеРаздела Цикл
			...
			Для Каждого СтрокаДанных ИЗ СтрокиСегментаРаздела Цикл
				...
				ПроверитьЗаполнениеСтрокиДанных_Раздел8_ФормаОтчета2017Кв1(СтрокаДанных, НомерСтроки, КонтекстВыполнения);
...
Процедура ПроверитьЗаполнение_Раздел8_Прил1_ФормаОтчета2017Кв1(КонтекстВыполнения, ДанныеРаздела)
	...
	СписокДопустимыхКодовОпераций = КодыОперацийФормаОтчета2017Кв1("Раздел8_Прил1", КонтекстВыполнения);
	ДопустимыеКодыОперации = СтрРазделить(СписокДопустимыхКодовОпераций, ",");
...
Процедура ПроверитьЗаполнениеСтрокиДанных_Раздел8_ФормаОтчета2017Кв1(СтрокаДанных, НомерСтроки, КонтекстВыполнения)
	...
	Для Каждого РегистрационныйНомерТД Из СтрокаДанных.РегНомТД Цикл
		...
		= УказанНекорректныйРегистрационныйНомерТаможеннойДекларации
		ИЛИ НекорректныйРегистрационныйНомерТаможеннойДекларации(РегистрационныйНомерТД);
	КонецЦикла;
...
Процедура ПроверитьЗаполнение_Раздел9_ФормаОтчета2017Кв1(КонтекстВыполнения, ДанныеРаздела)
	...
	СписокДопустимыхКодовОпераций = КодыОперацийФормаОтчета2017Кв1("Раздел9", КонтекстВыполнения);
	ДопустимыеКодыОперации = СтрРазделить(СписокДопустимыхКодовОпераций, ",");
	...
	Если ТипЗнч(ДанныеРаздела) = Тип("Массив") Тогда
		...
		Для Каждого НомерПервойСтрокиСекции Из ДанныеРаздела Цикл
			...
			Для Каждого СтрокаДанных ИЗ СтрокиСегментаРаздела Цикл
				НомерСтроки = СтрокаЧГ0(ОбщийНомерСтроки);
				ПроверитьЗаполнениеСтрокиДанных_Раздел9_ФормаОтчета2017Кв1(СтрокаДанных, НомерСтроки, КонтекстВыполнения);
...
Процедура ПроверитьЗаполнение_Раздел9_Прил1_ФормаОтчета2017Кв1(КонтекстВыполнения, ДанныеРаздела)
	...
	СписокДопустимыхКодовОпераций = КодыОперацийФормаОтчета2017Кв1("Раздел9_Прил1", КонтекстВыполнения);
	ДопустимыеКодыОперации = СтрРазделить(СписокДопустимыхКодовОпераций, ",");
...
Процедура ПроверитьЗаполнениеСтрокиДанных_Раздел9_ФормаОтчета2017Кв1(СтрокаДанных, НомерСтроки, КонтекстВыполнения)
...
Процедура ПроверитьЗаполнение_Раздел10_ФормаОтчета2017Кв1(КонтекстВыполнения, ДанныеРаздела)
	...
	СписокДопустимыхКодовОпераций = КодыОперацийФормаОтчета2017Кв1("Раздел10", КонтекстВыполнения);
	ДопустимыеКодыОперации = СтрРазделить(СписокДопустимыхКодовОпераций, ",");
	...
	Если ТипЗнч(ДанныеРаздела) = Тип("Массив") Тогда
		...
		Для Каждого НомерПервойСтрокиСекции Из ДанныеРаздела Цикл
			...
			Для Каждого СтрокаДанных ИЗ СтрокиСегментаРаздела Цикл
				НомерСтроки = СтрокаЧГ0(ОбщийНомерСтроки);
				ПроверитьЗаполнениеСтрокиДанных_Раздел10_ФормаОтчета2017Кв1(СтрокаДанных, НомерСтроки, КонтекстВыполнения);
...
Процедура ПроверитьЗаполнениеСтрокиДанных_Раздел10_ФормаОтчета2017Кв1(СтрокаДанных, НомерСтроки, КонтекстВыполнения)
...
Процедура ПроверитьЗаполнение_Раздел11_ФормаОтчета2017Кв1(КонтекстВыполнения, ДанныеРаздела)
	...
	СписокДопустимыхКодовОпераций = КодыОперацийФормаОтчета2017Кв1("Раздел11", КонтекстВыполнения);
	ДопустимыеКодыОперации = СтрРазделить(СписокДопустимыхКодовОпераций, ",");
	...
	Если ТипЗнч(ДанныеРаздела) = Тип("Массив") Тогда
		...
		Для Каждого НомерПервойСтрокиСекции Из ДанныеРаздела Цикл
			...
			Для Каждого СтрокаДанных ИЗ СтрокиСегментаРаздела Цикл
				НомерСтроки = СтрокаЧГ0(ОбщийНомерСтроки);
				ПроверитьЗаполнениеСтрокиДанных_Раздел11_ФормаОтчета2017Кв1(СтрокаДанных, НомерСтроки, КонтекстВыполнения);
...
Процедура ПроверитьЗаполнениеСтрокиДанных_Раздел11_ФормаОтчета2017Кв1(СтрокаДанных, НомерСтроки, КонтекстВыполнения)
...
Процедура ПроверитьЗаполнение_Раздел12_ФормаОтчета2017Кв1(КонтекстВыполнения, ДанныеРаздела)
	...
	Если ТипЗнч(ДанныеРаздела) = Тип("Массив") Тогда
		...
		Для Каждого НомерПервойСтрокиСекции Из ДанныеРаздела Цикл
			...
			Для Каждого СтрокаДанных ИЗ СтрокиСегментаРаздела Цикл
				НомерСтроки = СтрокаЧГ0(ОбщийНомерСтроки);
				ПроверитьЗаполнениеСтрокиДанных_Раздел12_ФормаОтчета2017Кв1(СтрокаДанных, НомерСтроки, КонтекстВыполнения);
...
Процедура ПроверитьЗаполнениеСтрокиДанных_Раздел12_ФормаОтчета2017Кв1(СтрокаДанных, НомерСтроки, КонтекстВыполнения)
...
Процедура СформироватьПредставлениеОшибок_ФормаОтчета2017Кв1(КонтекстВыполнения)
	...
	Иначе
		ВывестиОшибки_ФормаОтчета2017Кв1(КонтекстВыполнения, ПредставлениеОшибок, "ОшибкиТитульногоЛиста");
		ВывестиОшибки_ФормаОтчета2017Кв1(КонтекстВыполнения, ПредставлениеОшибок, "ОшибкиОтчета");
		ВывестиОшибки_ФормаОтчета2017Кв1(КонтекстВыполнения, ПредставлениеОшибок, "ОшибкиРазделов17");
...
Процедура ВывестиОшибки_ФормаОтчета2017Кв1(КонтекстВыполнения, ПредставлениеОшибок, ИмяТаблицыОшибок)
...
Функция КодыОперацийФормаОтчета2017Кв1(ИмяРаздела, КонтекстВыполнения)
...
Функция КодыОперацийПоПродавцамФормаОтчета2017Кв1(КонтекстВыполнения)
