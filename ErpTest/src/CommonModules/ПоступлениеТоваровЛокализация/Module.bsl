...
#Область ПоступлениеЦенностей  // (Дт 10, 41, 20 :: Кт 15, 60.НП)
	...
	|		Документ.ПоступлениеТоваров КАК Операция
	|	ПО
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	|	ВЫБОР КОГДА КорАналитика.Склад ССЫЛКА Справочник.Склады ТОГДА
	|		КорАналитика.Склад.Подразделение 
	|	ИНАЧЕ
	|		КорАналитика.Склад 
	|	КОНЕЦ КАК Подразделение,
	|	КорАналитика.Номенклатура КАК Номенклатура,
	|	КорАналитика.Склад КАК Склад,
