...
Процедура ПередЗаписью(Форма, Отказ, ПараметрыЗаписи) Экспорт
	...
	//++ НЕ ГОСИС
	Если ИнтеграцияИСКлиентСервер.ЕстьРеквизитОбъекта(Форма, "Объект") Тогда
		
		Если ИнтеграцияИСКлиентСервер.ЕстьРеквизитОбъекта(ПараметрыЗаписи, "РежимЗаписи") Тогда
