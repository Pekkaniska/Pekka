...
Процедура УправлениеВидимостьюНДС(Форма) Экспорт
	...
	ВидимостьНалогообложениеНДС = УчетНДСУПКлиентСервер.ПродажаОблагаетсяНДС(Форма.Объект.НалогообложениеНДС);
...
Функция ТекстЗапросаТабличныеЧастиАктаОРасхожденияхПослеПриемкиИПриемкиТоваровНаХранение(АктОРасхождениях, Основание, СтруктураВозврата, ИзменениеДокумента)
	...
	|	ПриемкаТоваровНаХранениеТовары.СтавкаНДС
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	Номенклатура,
	|	НоменклатураПоставщика,
	...
	|				И АктОРасхожденияхТовары.СтавкаНДС              = ПриемкаТоваровНаХранениеТовары.СтавкаНДС
	...
	|				И ПриемкаТоваровНаХранениеТовары.СтавкаНДС              = АктОРасхожденияхТовары.СтавкаНДС
	...
	|		ПриемкаТоваровНаХранениеТовары.ЗаказПоставщику,
	|		ПриемкаТоваровНаХранениеТовары.Склад,
	|		ПриемкаТоваровНаХранениеТовары.СтавкаНДС) КАК ВложенныйЗапрос
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////5
	|
