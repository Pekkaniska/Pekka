...
Процедура ОткрытьФормуВыбораНоменклатуры(ФормаВладелец, Реквизиты) Экспорт
	...
	Если ЗначениеЗаполнено(Реквизиты) Тогда
		...
		Если Реквизиты.Свойство("ВидАлкогольнойПродукцииМаркируемый") Тогда
			ПараметрыОтбора.Вставить("ВидАлкогольнойПродукцииМаркируемый", Реквизиты.ВидАлкогольнойПродукцииМаркируемый);
		КонецЕсли;
