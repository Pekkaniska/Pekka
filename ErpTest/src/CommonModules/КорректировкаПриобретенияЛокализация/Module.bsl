...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	|	ЕСТЬNULL(Договоры.ГруппаФинансовогоУчета, ЕСТЬNULL(Заказы.ГруппаФинансовогоУчета, ЗНАЧЕНИЕ(Справочник.ГруппыФинансовогоУчетаРасчетов.ПустаяСсылка))) КАК ГруппаФинансовогоУчета,
	|	ЕСТЬNULL(Договоры.Подразделение, ЕСТЬNULL(Заказы.Подразделение, ЗНАЧЕНИЕ(Справочник.СтруктураПредприятия.ПустаяСсылка))) КАК Подразделение,
	...
	|	ЕСТЬNULL(Договоры.ГруппаФинансовогоУчета, ЕСТЬNULL(Заказы.ГруппаФинансовогоУчета, ЗНАЧЕНИЕ(Справочник.ГруппыФинансовогоУчетаРасчетов.ПустаяСсылка))),
	|	ЕСТЬNULL(Договоры.Подразделение, ЕСТЬNULL(Заказы.Подразделение, ЗНАЧЕНИЕ(Справочник.СтруктураПредприятия.ПустаяСсылка))),
	|	Расчеты.Валюта
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
