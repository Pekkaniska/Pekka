...
Процедура ПолучитьНаборДанныхНачислениеРеализацияСложныйУчетНДС(Запрос, СтруктураВнешнихНаборов) 
	...
	|	ЕСТЬNULL(СчетФактураВыданныйДокументыОснования.Ссылка, СчетФактураКомиссионеру.Ссылка) КАК СчетФактура,
	|	2 КАК РангОшибки
	...
	|ГДЕ
	|	ЕСТЬNULL(СчетФактураВыданныйДокументыОснования.Ссылка, СчетФактураКомиссионеру.Ссылка) ЕСТЬ NULL 
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
...
Процедура ПолучитьНаборДанныхНачислениеАвансыПолученныеУпрощенныйУчетНДС(Запрос, СтруктураВнешнихНаборов)
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	АналитикаУчетаПоПартнерам.Договор КАК ДоговорКонтрагента,
	|	РасчетыСКлиентами.РасчетныйДокумент КАК СчетФактура,
	|	ВЫБОР РасчетыСКлиентами.АналитикаУчетаПоПартнерам.Договор.СтавкаНДС
	|		КОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.ПустаяСсылка)
	...
	|		ИНАЧЕ РасчетыСКлиентами.АналитикаУчетаПоПартнерам.Договор.СтавкаНДС
	|	КОНЕЦ КАК СтавкаНДСПредположительная,
	|	-РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток КАК Сумма,
	|	ВЫБОР РасчетыСКлиентами.АналитикаУчетаПоПартнерам.Договор.СтавкаНДС
	|		КОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.ПустаяСсылка)
	|			ТОГДА -(ВЫРАЗИТЬ(РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток - РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток * &ПроцентНДС / (100 + &ПроцентНДС) КАК ЧИСЛО(31,2)))
	|		КОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС20)
	|			ТОГДА -(ВЫРАЗИТЬ(РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток - РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток * 20 / 120 КАК ЧИСЛО(31,2)))
	|		КОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС20_120)
	|			ТОГДА -(ВЫРАЗИТЬ(РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток - РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток * 20 / 120 КАК ЧИСЛО(31,2)))
	|		КОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС18)
	|			ТОГДА -(ВЫРАЗИТЬ(РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток - РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток * 18 / 118 КАК ЧИСЛО(31,2)))
	|		КОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС18_118)
	|			ТОГДА -(ВЫРАЗИТЬ(РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток - РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток * 18 / 118 КАК ЧИСЛО(31,2)))
	|		КОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС10)
	|			ТОГДА -(ВЫРАЗИТЬ(РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток - РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток * 10 / 110 КАК ЧИСЛО(31,2)))
	|		КОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС10_110)
	|			ТОГДА -(ВЫРАЗИТЬ(РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток - РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток * 10 / 110 КАК ЧИСЛО(31,2)))
	|		ИНАЧЕ -ВЫРАЗИТЬ(РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток КАК ЧИСЛО(31,2))
	|	КОНЕЦ КАК СуммаБезНДС,
	|	ВЫБОР РасчетыСКлиентами.АналитикаУчетаПоПартнерам.Договор.СтавкаНДС
	|		КОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.ПустаяСсылка)
	|			ТОГДА -(ВЫРАЗИТЬ(РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток * &ПроцентНДС / (100 + &ПроцентНДС) КАК ЧИСЛО(31,2)))
	|		КОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС20)
	|			ТОГДА -(ВЫРАЗИТЬ(РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток * 20 / 120 КАК ЧИСЛО(31,2)))
	|		КОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС20_120)
	|			ТОГДА -(ВЫРАЗИТЬ(РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток * 20 / 120 КАК ЧИСЛО(31,2)))
	|		КОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС18)
	|			ТОГДА -(ВЫРАЗИТЬ(РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток * 18 / 118 КАК ЧИСЛО(31,2)))
	|		КОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС18_118)
	|			ТОГДА -(ВЫРАЗИТЬ(РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток * 18 / 118 КАК ЧИСЛО(31,2)))
	|		КОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС10)
	|			ТОГДА -(ВЫРАЗИТЬ(РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток * 10 / 110 КАК ЧИСЛО(31,2)))
	|		КОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС10_110)
	|			ТОГДА -(ВЫРАЗИТЬ(РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток * 10 / 110 КАК ЧИСЛО(31,2)))
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК СуммаНДС
	...
	|				И ВЫРАЗИТЬ(ЗаказКлиента КАК Справочник.ДоговорыКонтрагентов).НалогообложениеНДС = ЗНАЧЕНИЕ(Перечисление.ТипыНалогообложенияНДС.ПроизводствоСДЦ))
	|		) КАК РасчетыСКлиентами
	|		
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ДанныеПервичныхДокументов КАК ДанныеРасчетныхДокументов
	|		ПО РасчетыСКлиентами.РасчетныйДокумент = ДанныеРасчетныхДокументов.Документ
	|			И РасчетыСКлиентами.АналитикаУчетаПоПартнерам.Организация = ДанныеРасчетныхДокументов.Организация
	|ГДЕ
	|	РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток < РасчетыСКлиентами.ПредоплатаРеглНачальныйОстаток
	|	И РасчетыСКлиентами.ПредоплатаРеглКонечныйОстаток <> 0
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	ВЫБОР
	|		КОГДА Платежи.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.ПустаяСсылка)
	|			ТОГДА &СтавкаНДСПоУмолчанию
	|		КОГДА Платежи.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС20)
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС20_120)
	|		КОГДА Платежи.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС18)
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС18_118)
	|		КОГДА Платежи.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС10)
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС10_110)
	...
	ПодстановкаСтавкаНДС = УчетНДСУП.ТекстВыбораСтавкиНДСПоУмолчанию("ДанныеРасчетныхДокументов.Дата", Истина);
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&СтавкаНДСПоУмолчанию", ПодстановкаСтавкаНДС);
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&ПроцентНДС", УчетНДСУП.ТекстВыбораПроцентаНДС(ПодстановкаСтавкаНДС));
...
Процедура ПолучитьНаборДанныхНачислениеНалоговыйАгент(Запрос, СтруктураВнешнихНаборов) 
	...
	|	СУММА(ВложенныйЗапрос.Сумма) КАК СуммаОборот,
	|	ВЫРАЗИТЬ(СУММА(ВложенныйЗапрос.Сумма) * 0.18 КАК ЧИСЛО(31,2)) КАК СуммаНДСОборот
...
Процедура ПолучитьНаборДанныхНачислениеРеализация0(Запрос, СтруктураВнешнихНаборов) 
	...
	|	&ТекстОтраженыВКнигеПродаж КАК ПризнакОтраженияНДС,
	|	1 КАК КоличествоДокументов,
	|	КнигаПродаж.НДСОборот КАК СуммаВключенные,
	|	КнигаПродаж.ВидЦенности,
...
Процедура ПолучитьНаборДанныхВычетПоПриобретеннымЦенностям(Запрос, СтруктураВнешнихНаборов) 
	...
	|		КОГДА ЕСТЬNULL(СостоянияБлокировкиВычета.Состояние, НЕОПРЕДЕЛЕНО) = ЗНАЧЕНИЕ(Перечисление.СостоянияБлокировкиВычетаНДС.Установлена)
	...
	|			ТОГДА ДанныеПервичныхДокументов.НомерРегистратора
	|		КОГДА НДСПредъявленныйОстатки.ДокументРегистратор ССЫЛКА Документ.ОтчетКомиссионера
	|			ТОГДА СчетФактураПолученныйДокументыОснования.Ссылка.Номер
	|		ИНАЧЕ ЕСТЬNULL(СчетФактураПолученныйДокументыОснования.Ссылка.Номер, СчетФактураВыданныйДокументыОснования.Ссылка.Номер)
	|	КОНЕЦ КАК НомерВходящегоДокумента,
	|	ВЫБОР
	|		КОГДА НДСПредъявленныйОстатки.ДокументРегистратор ССЫЛКА Документ.СчетФактураВыданный
	|				ИЛИ НДСПредъявленныйОстатки.ДокументРегистратор ССЫЛКА Документ.ТаможеннаяДекларацияИмпорт
	...
	|			ТОГДА ДанныеПервичныхДокументов.ДатаРегистратора
	|		КОГДА НДСПредъявленныйОстатки.ДокументРегистратор ССЫЛКА Документ.ОтчетКомиссионера
	|			ТОГДА СчетФактураПолученныйДокументыОснования.Ссылка.Дата
	|		ИНАЧЕ ЕСТЬNULL(СчетФактураПолученныйДокументыОснования.Ссылка.Дата, СчетФактураВыданныйДокументыОснования.Ссылка.Дата)
	|	КОНЕЦ КАК ДатаВходящегоДокумента
	|ИЗ
	...
	|	
	|	ЛЕВОЕ СОЕДИНЕНИЕ 
	|		РегистрСведений.СостоянияБлокировкиВычетаНДСПоСчетамФактурам.СрезПоследних(&КонецПериода, Организация В (&Организация)) КАК СостоянияБлокировкиВычета
	|	ПО 
	|		НДСПредъявленныйОстатки.ДокументРегистратор = СостоянияБлокировкиВычета.СчетФактура
	|	
	|	ЛЕВОЕ СОЕДИНЕНИЕ 
...
Процедура ПолучитьНаборДанныхВычетНалоговыйАгент(Запрос, СтруктураВнешнихНаборов) 
	...
	|	СУММА(ПодтверждениеОплатыНДСВБюджет.Сумма) КАК СуммаОплаты,
	|	ПодтверждениеОплатыНДСВБюджет.СтрокаПлатежноРасчетныеДокументы КАК СтрокаПлатежноРасчетныеДокументы
	...
	|	ПодтверждениеОплатыНДСВБюджет.СтрокаПлатежноРасчетныеДокументы
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	НДСЗаписиКнигиПокупокОбороты.СчетФактура КАК СчетФактура,
	|	ОплатыВБюджет.СтрокаПлатежноРасчетныеДокументы КАК ДокументОплатыВБюджет,
	|	1 КАК КоличествоДокументов,
	|	&ТекстОтраженыВКнигеПокупок КАК ПризнакОтраженияНДС,
	|	&ТекстБезОшибок КАК ПризнакНаличияОшибок,
	|	НДСЗаписиКнигиПокупокОбороты.ВидЦенности,
...
Процедура ПолучитьНаборДанныхВычетАвансыВыданныеУпрощенныйУчетНДС(Запрос, СтруктураВнешнихНаборов) 
	...
	|	СУММА(ВЫРАЗИТЬ(РасчетыСПоставщиками.ПредоплатаРегл - РасчетыСПоставщиками.ПредоплатаРегл * &ПроцентНДС / (100 + &ПроцентНДС) КАК ЧИСЛО(31,2))) КАК СуммаБезНДС,
	|	СУММА(ВЫРАЗИТЬ(РасчетыСПоставщиками.ПредоплатаРегл * &ПроцентНДС / (100 + &ПроцентНДС) КАК ЧИСЛО(31,2))) КАК СуммаНДС
	|ПОМЕСТИТЬ ВТАвансыВыданныеВременнаяТаблица
	|ИЗ
	|	РегистрНакопления.РасчетыСПоставщикамиПоДокументам КАК РасчетыСПоставщиками
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ДанныеПервичныхДокументов КАК ДанныеРасчетныхДокументов
	|		ПО РасчетыСПоставщиками.РасчетныйДокумент = ДанныеРасчетныхДокументов.Документ
	|			И РасчетыСПоставщиками.АналитикаУчетаПоПартнерам.Организация = ДанныеРасчетныхДокументов.Организация
	|ГДЕ
	...
	|			И АвансыВыданные.СтавкаНДС = СоставКнигиПокупокВЧастиАвансов.СтавкаНДС
	...
	ПодстановкаСтавкаНДС = УчетНДСУП.ТекстВыбораСтавкиНДСПоУмолчанию("ДанныеРасчетныхДокументов.Дата", Истина);
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "&СтавкаНДСПоУмолчанию", ПодстановкаСтавкаНДС);
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "&ПроцентНДС", УчетНДСУП.ТекстВыбораПроцентаНДС(ПодстановкаСтавкаНДС));
