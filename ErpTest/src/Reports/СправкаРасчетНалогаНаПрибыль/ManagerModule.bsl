...
Функция ВариантыНастроек() Экспорт
	...
	Вариант.Вставить("Имя",           "РасчетНалогаНаПрибыль");
	Вариант.Вставить("Представление", НСтр("ru = 'Расчет налога на прибыль'"));
...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета, ОрганизацияВНачале = Истина) Экспорт 
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Справка-расчет налога на прибыль %1'"),
...
Функция ПолучитьВнешниеНаборыДанных(ПараметрыОтчета, МакетКомпоновки) Экспорт
	...
	ЗапросРасчетСтавкиНалогаНаПрибыль 	= НалоговыйУчетОбособленныхПодразделений.ВыполнитьЗапросРасчетСтавкиНалогаНаПрибыльЗаМесяц(ПараметрыОтчета.Организация, КонецДня(ПараметрыОтчета.КонецПериода));
	ЗапросРасчетНалогаНаПрибыль 		= НалоговыйУчетОбособленныхПодразделений.ВыполнитьЗапросРасчетНалогаНаПрибыль(ПараметрыОтчета.Организация, КонецДня(ПараметрыОтчета.КонецПериода));
...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	Для Каждого ИмяТаблицы Из МассивТаблицОтчета Цикл
		...
		ГруппаПрибыльУбытокПрошлыеМесяцы.Заголовок	 = НСтр(
			"ru = 'Прибыль (+)
			|убыток (-)
			|гр.2 - гр.3'");
		...
		ГруппаПрибыльУбытокГод.Заголовок	 = НСтр(
			"ru = 'Прибыль (+)
			|убыток (-)
			|гр.2 - гр.3'");
		...
		Для Каждого ИмяПоказателя Из МассивПоказателей Цикл
			Если ПараметрыОтчета["Показатель" + ИмяПоказателя] Тогда 
				...
				// Отбор для итоговых таблиц, если есть только один вид деятельности то не нужно выводить таблицу с итогом по всем
				// видам деятельности.
...
Процедура ПослеКомпоновкиМакета(ПараметрыОтчета, МакетКомпоновки) Экспорт
	...
	Если ТелоНалогНаПрибыль.Имя = "ЗаголовокНалогНаПрибыль" Тогда
		...
		МакетКомпоновки.Макеты[ТелоНалогНаПрибыль.Тело[1].Строки[0].МакетПодвала.Макет].Макет[0].Ячейки[0].Элементы[0].Значение = НСтр("ru = 'Налог на прибыль'");
