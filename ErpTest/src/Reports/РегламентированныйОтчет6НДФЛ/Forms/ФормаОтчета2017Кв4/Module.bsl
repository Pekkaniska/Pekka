...
Процедура ПроверитьКС_1_1(СтруктураРезультата)
	...
	ТекстФормулы    = НСтр("ru='Проверка Титульного листа (КС 1.1)'");
...
Процедура ПроверитьКС_3_1а(СтруктураРезультата)
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='ст. 126.1, ст. 226, ст. 230, ст. 23, ст. 24 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Сумма начисленных доходов (строка 020 Раздела 1) по соответствующей ставке налога (строка 010 '") +
...
Процедура ПроверитьКС_3_1б(СтруктураРезультата)
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Сумма начисленных доходов (строка 020 Раздела 1) по соответствующей ставке налога (строка 010 '") +
		НСтр("ru='Раздела 1) должна быть равна общей сумме доходов (строка 020) Приложений №2 к Декларации по налогу '") +
		НСтр("ru='на прибыль по соответствующей ставке налога (строка 010) Приложений №2 к Декларации по налогу на '") +
...
Процедура ПроверитьКС_3_2а(СтруктураРезультата)
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='ст. 126.1, ст. 226, ст. 230, ст. 23, ст. 24 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Сумма начисленных доходов в виде дивидендов (строка 025 Раздела 1) должна '") +
...
Процедура ПроверитьКС_3_2б(СтруктураРезультата)
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='ст. 126.1, ст. 226, ст. 230, ст. 23, ст. 24 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Сумма начисленных доходов в виде дивидендов (строка 025 Раздела 1) должна быть равна общей сумме '") +
		НСтр("ru='доходов в виде дивидендов (строка 041) Приложений №2 к Декларации по налогу на прибыль (по коду '") +
...
Процедура ПроверитьКС_3_3а(СтруктураРезультата)
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='ст. 126.1, ст. 226, ст. 230, ст. 23, ст. 24 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Сумма исчисленного налога (строка 040 Раздела 1) по соответствующей ставке налога (строка 010 '") +
...
Процедура ПроверитьКС_3_3б(СтруктураРезультата)
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Сумма исчисленного налога (строка 040 Раздела 1) по соответствующей ставке налога (строка 010 '") +
		НСтр("ru='Раздела 1) должна быть равна сумме исчисленного налога (строка 030) Приложений №2 к Декларации '") +
		НСтр("ru='по налогу на прибыль по соответствующей ставке налога (строка 010) Приложений №2 к Декларации '") +
...
Процедура ПроверитьКС_3_4а(СтруктураРезультата)
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='ст. 126.1, ст. 226, ст. 230, ст. 23, ст. 24 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Сумма налога, не удержанная налоговым агентом (строка 080 Раздела 1) должна быть равна сумме '") +
...
Процедура ПроверитьКС_3_5а(СтруктураРезультата)
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='ст. 126.1, ст. 230, ст. 23, ст. 24 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Количество физических лиц, получивших доход (строка 060 Раздела 1) должна быть равна '") +
...
Функция	ПредставлениеПоказателя(Показатель, ПолноеПредставление = Истина)
	...
	Раздел.Вставить("П00002", "Приложения 2 к Декларации по налогу на прибыль");
	
	Если Найти(Показатель.Имя, "П000") = 0 Тогда
