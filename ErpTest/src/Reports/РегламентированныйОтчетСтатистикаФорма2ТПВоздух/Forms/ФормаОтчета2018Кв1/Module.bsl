...
Процедура ОчиститьТабличноеПолеНаСервере()
	...
	СписокПоказателейНеПодлежащихОчистке.Добавить(ВыбТабличноеПоле.Области["КодОНВ"].Значение,                   "КодОНВ");
	СписокПоказателейНеПодлежащихОчистке.Добавить(ВыбТабличноеПоле.Области["КодОКТМООНВ"].Значение,              "КодОКТМООНВ");
	СписокПоказателейНеПодлежащихОчистке.Добавить(ВыбТабличноеПоле.Области["КодОКВЭД2ОНВ"].Значение,             "КодОКВЭД2ОНВ");
	СписокПоказателейНеПодлежащихОчистке.Добавить(ВыбТабличноеПоле.Области["ОргПоле1"].Значение,                 "ОргПоле1");
	СписокПоказателейНеПодлежащихОчистке.Добавить(ВыбТабличноеПоле.Области["ОргПоле2"].Значение,                 "ОргПоле2");
	СписокПоказателейНеПодлежащихОчистке.Добавить(ВыбТабличноеПоле.Области["ОргПолеЗнач1"].Значение,             "ОргПолеЗнач1");
	СписокПоказателейНеПодлежащихОчистке.Добавить(ВыбТабличноеПоле.Области["ОргПолеЗнач2"].Значение,             "ОргПолеЗнач2");
