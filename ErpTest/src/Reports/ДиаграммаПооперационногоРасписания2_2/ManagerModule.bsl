...
Функция ПодсказкаИнтервала(Знач ЗначенияЗаполнения)
	...
	Если ЗначенияЗаполнения.Состояние = ТекстРабота()
		...
		Если НЕ ЗначенияЗаполнения.ПараллельнаяЗагрузка Тогда
			...
			Результат = Результат
				+ Символы.ПС
				+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Операция: %1'"), ЗначенияЗаполнения.ОперацияПредставление)
				+ ?(ЗначениеЗаполнено(ЗначенияЗаполнения.НомерПартии), Символы.ПС 
				+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Партия: %1'"), ЗначенияЗаполнения.НомерПартии), "")
				+ Символы.ПС
...
Функция ПредставлениеПартииОперации(Операция, НомерПартии)
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Операция ""%1"", партия %2'"), Операция, НомерПартии);
