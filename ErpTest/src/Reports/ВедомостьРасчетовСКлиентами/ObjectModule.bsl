...
Функция ТекстЗапроса(ВалютаОтчета)
	...
	|	Расчеты.ДолгКлиентаНачальныйОстаток                     КАК ДолгКлиентаНачальныйОстаток,
	...
	|	Расчеты.ПлановаяОтгрузкаНачальныйОстаток                КАК ПлановаяОтгрузкаНачальныйОстаток,
	|	
	...
	|	
	|	Расчеты.ДолгКлиентаКонечныйОстаток                      КАК ДолгКлиентаКонечныйОстаток,
	...
	|	Расчеты.ПлановаяОтгрузкаКонечныйОстаток                 КАК ПлановаяОтгрузкаКонечныйОстаток
	|ИЗ (
	|	ВЫБРАТЬ
	...
	|		0                                           КАК ПлановаяОтгрузкаКонечныйОстаток
	|	ИЗ
	|		РегистрНакопления.РасчетыСКлиентамиПланОтгрузок.Остатки({&НачалоОстатки}) КАК РасчетыПланОтгрузок
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.АналитикаУчетаПоПартнерам КАК АналитикаУчета
	...
	|	ИЗ
	|		РегистрНакопления.РасчетыСКлиентамиПланОтгрузок.Остатки({&КонецПериода}) КАК РасчетыПланОтгрузок
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.АналитикаУчетаПоПартнерам КАК АналитикаУчета
	|				ПО РасчетыПланОтгрузок.АналитикаУчетаПоПартнерам = АналитикаУчета.КлючАналитики
	|			ЛЕВОЕ СОЕДИНЕНИЕ КурсыВалют КАК Курсы
	|				ПО Курсы.Валюта = РасчетыПланОтгрузок.Валюта
	...
	|		0                                           КАК ПлановаяОтгрузкаКонечныйОстаток
	|	ИЗ
	|		РегистрНакопления.РасчетыСКлиентами.Остатки({&КонецПериода}) КАК РасчетыСКлиентами
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.АналитикаУчетаПоПартнерам КАК АналитикаУчета
