...
Процедура ВывестиВТабличныйДокументПаспортныеХарактеристики(Выборка, ТабличныйДокумент, Макет)
	...
	ОбластьМакета = Макет.ПолучитьОбласть("ЗаголовокРаздела");
	ОбластьМакета.Параметры.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Паспортные характеристики - %1'"), Выборка.Количество());
	ТабличныйДокумент.Вывести(ОбластьМакета);
...
Процедура ВывестиВТабличныйДокументПодчиненныеУзлы(Выборка, ТабличныйДокумент, Макет)
	...
	ОбластьМакета = Макет.ПолучитьОбласть("ЗаголовокРаздела");
	ОбластьМакета.Параметры.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Подчиненные узлы - %1'"), Выборка.Количество());
	ТабличныйДокумент.Вывести(ОбластьМакета);
...
Процедура ВывестиВТабличныйДокументНаработки(Выборка, ТабличныйДокумент, Макет)
	...
	ОбластьМакета = Макет.ПолучитьОбласть("ЗаголовокРаздела");
	ОбластьМакета.Параметры.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Наработки - %1'"), Выборка.Количество());
	ТабличныйДокумент.Вывести(ОбластьМакета);
...
Процедура ВывестиВТабличныйДокументРемонты(Выборка, ТабличныйДокумент, Макет)
	...
	ОбластьМакета = Макет.ПолучитьОбласть("ЗаголовокРаздела");
	ОбластьМакета.Параметры.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Ремонты - %1'"), Выборка.Количество());
	ТабличныйДокумент.Вывести(ОбластьМакета);
	...
	Пока Выборка.Следующий() Цикл
		...
		ОбластьМакета.Параметры.Заполнить(Выборка);
		ОбластьМакета.Параметры.НомерИДата = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='№ %1 от %2'"),Выборка.Номер, Формат(Выборка.Дата, "ДЛФ=DD"));
		ТабличныйДокумент.Вывести(ОбластьМакета);
...
Процедура ВывестиВТабличныйДокументДефекты(Выборка, ТабличныйДокумент, Макет)
	...
	ОбластьМакета = Макет.ПолучитьОбласть("ЗаголовокРаздела");
	ОбластьМакета.Параметры.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Дефекты - %1'"), Выборка.Количество());
	ТабличныйДокумент.Вывести(ОбластьМакета);
