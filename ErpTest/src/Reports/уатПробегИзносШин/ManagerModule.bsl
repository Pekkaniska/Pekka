...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Пробег и износ шин");
	НастройкиВарианта.Описание = НСтр("ru = 'Отчет предназначен для анализа пробега и износа шин за определенный период в разрезе транспортных средств, моделей шин и самих шин.'");
