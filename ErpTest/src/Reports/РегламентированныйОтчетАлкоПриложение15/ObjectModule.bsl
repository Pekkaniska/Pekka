...
Процедура ПроверитьЗаполнениеТаблицыДекларацияПроизводство(СтатусПроверки, ИдГруппы, ДополнительныеДанные, 
	...
	Пока Истина Цикл
		...
		Для каждого СтрокаДекларации Из РезЗапросаДанных Цикл
			...
			Если ЕстьИдОП и ЗначениеЗаполнено(КодВидаПродукции) Тогда
...
Процедура ПроверитьЗаполнениеТаблицыДекларацияПоставщики(СтатусПроверки, ИдГруппы, ДополнительныеДанные, 
	...
	Пока Истина Цикл
		...
		Для каждого СтрокаДекларации Из РезЗапросаДанных Цикл
			...
			ИмяПоказателяНаименования = ИмяНаименованияПоставщика + "_" + НомерСтрокиСтроковый;
			НаименованиеПоставщика = СтрокаДекларации[ИмяНаименованияПоставщика];
			Если НЕ ЗначениеЗаполнено(НаименованиеПоставщика) Тогда
