...
Процедура ПриСозданииНаСервере(ЭтаФорма, Отказ, СтандартнаяОбработка) Экспорт
	...
	ЭтаФорма.ШиринаСхемы = Экран[0].Ширина / ?(DPI = 0, 72, DPI) * 25.4; // Ширина рисунка геосхемы в мм
	...
	Ползунок.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru = 'Масштаб %1%'"), Строка(ЭтаФорма.МасштабСхемы));
