...
Процедура ПриСозданииНаСервере(ЭтаФорма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Если Не ЭтаФорма.Параметры.Свойство("ПараметрКоманды", ДокументРаспределения) Тогда
		Возврат;
	КонецЕсли;
	
	ОтборОтчета = ЭтаФорма.Параметры.Отбор;
	...
	ОтборОтчета.Вставить("ПартионныйУчетВключен", УниверсальныеМеханизмыПартийИСебестоимостиПовтИсп.ПартионныйУчетВключен(ОтборОтчета.НачалоПериода));
	ОтборОтчета.Вставить("АналитическийУчетПоГруппамПродукции", ПолучитьФункциональнуюОпцию("АналитическийУчетПоГруппамПродукции"));
	ОтборОтчета.Вставить("НеВедетсяУчетСебестоимостиПоВидамЗапасов", НЕ ПолучитьФункциональнуюОпцию("УчитыватьСебестоимостьТоваровПоВидамЗапасов"));
	...
	ЭтаФорма.Параметры.КлючВарианта = КлючВарианта;
...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Организация   = КомпоновкаДанныхКлиентСервер.ПолучитьПараметр(НастройкиОтчета, "Организация").Значение;
