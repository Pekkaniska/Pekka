...
Функция ТекстЗапросаДенежныеСредства()
	...
	|	КОНЕЦ КАК СуммаКонечныйОстаток
	|ИЗ
	|	РегистрНакопления.ДенежныеДокументы.ОстаткиИОбороты(,, Авто, Движения) КАК ДенежныеДокументы
	//-- НЕ УТ
	|";
...
Функция ТекстЗапросаРасчетыСКлиентами()
	...
	|	КОНЕЦ КАК СуммаКонечныйОстаток
	|ИЗ
	|	РегистрНакопления.РасчетыСКлиентамиПоСрокам.ОстаткиИОбороты(,, Авто) КАК РасчетыСКлиентами
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ
...
Функция ТекстЗапросаРасчетыСПоставщиками()
	...
	|	КОНЕЦ КАК СуммаКонечныйОстаток
	|ИЗ
	|	РегистрНакопления.РасчетыСПоставщикамиПоСрокам.ОстаткиИОбороты(,, Авто) КАК РасчетыСПоставщиками
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ
	|		РегистрСведений.АналитикаУчетаПоПартнерам КАК РегистрАналитикаУчетаПоПартнерам
	|	ПО
...
Функция ТекстЗапросаРасчетыПоФинансовымИнструментам()
	...
	|	КОНЕЦ КАК СуммаКонечныйОстаток
	|ИЗ
	|	РегистрНакопления.РасчетыПоФинансовымИнструментам.ОстаткиИОбороты(, , Авто) КАК Расчеты
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ
