...
Функция ТекстЗапроса()
	...
	|	
	|	Расчеты.ПлановоеПоступление           КАК ПлановоеПоступление,
	|	Расчеты.ПлановоеПоступлениеПросрочено КАК ПлановоеПоступлениеПросрочено
	|ИЗ (
	|	ВЫБРАТЬ
	...
	|	ИЗ
	|		РегистрНакопления.РасчетыСПоставщикамиПоСрокам.Остатки(&ДатаОтчета) КАК РасчетыПоСрокам
	...
	|		0                                                              КАК ПлановоеПоступлениеПросрочено
	|	ИЗ
	|		РегистрНакопления.РасчетыСПоставщикамиПланОплат.Остатки(&ДатаОтчета) КАК РасчетыПланОплат
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.АналитикаУчетаПоПартнерам КАК АналитикаУчета
	...
	|	ИЗ
	|		РегистрНакопления.РасчетыСПоставщикамиПланПоставок.Остатки(&ДатаОтчета) КАК РасчетыПланПоставок
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.АналитикаУчетаПоПартнерам КАК АналитикаУчета
	...
	|	ИЗ
	|		РегистрНакопления.РасчетыСПоставщиками.Остатки(&ДатаОтчета) КАК РасчетыСПоставщиками
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.АналитикаУчетаПоПартнерам КАК АналитикаУчета
