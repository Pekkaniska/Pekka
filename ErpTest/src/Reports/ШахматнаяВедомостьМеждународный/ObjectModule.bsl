...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	МеждународнаяОтчетностьСервер.УстановитьВалюту(ДокументРезультат, ВалютаМУ.Функциональная, НСтр("ru = 'В функциональной валюте'"));
	МеждународнаяОтчетностьСервер.УстановитьВалюту(ДокументРезультат, ВалютаМУ.Представления, НСтр("ru = 'В валюте представления'"));
