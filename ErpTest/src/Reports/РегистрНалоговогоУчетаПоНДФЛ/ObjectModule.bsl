...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ОтчетыКлиентСервер.ДобавитьВыбранноеПоле(Группировка.Выбор, "ГоловнаяОрганизация");
	ОтчетыКлиентСервер.ДобавитьВыбранноеПоле(Группировка.Выбор, "Организация");
	ОтчетыКлиентСервер.ДобавитьВыбранноеПоле(Группировка.Выбор, "ГОД");
	ОтчетыКлиентСервер.ДобавитьВыбранноеПоле(Группировка.Выбор, "ФизическоеЛицо");
...
Процедура ПолучитьДанныеДляПостроенияОтчета(СписокФизЛицОрганизация)
	...
	Период = ОтчетыКлиентСервер.ПолучитьПараметр(КомпоновщикНастроек, "Период").Значение; 
	
	ДатаНачалаНП = Период.ДатаНачала;
	ДатаКонцаНП  = Период.ДатаОкончания;
	ДатаПодписи  = ОтчетыКлиентСервер.ПолучитьПараметр(КомпоновщикНастроек, "ДатаПодписи").Значение;
