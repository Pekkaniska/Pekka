...
Процедура ПослеКомпоновкиМакета(ПараметрыОтчета, МакетКомпоновки) Экспорт
	...
	Если КоличествоПоказателей = 1 Тогда
		Для Каждого Макет Из МакетКомпоновки.Макеты Цикл
			Для Каждого СтрокаМакета Из Макет.Макет Цикл
				Если СтрокаМакета.Ячейки.Количество() > 3 Тогда // игнорируем заголовок и данные о параметрах (в них элементов не больше 3)
	...
	Если МакетКомпоновки.Тело.Количество() > 2 Тогда
		МакетКомпоновки.Тело.Сдвинуть(МакетКомпоновки.Тело.Получить(0), 2);
	КонецЕсли;
...
Процедура ПослеВыводаРезультата(ПараметрыОтчета, Результат) Экспорт
	...
	ВысотаПараметров = БухгалтерскиеОтчетыПереопределяемый.ВысотаВыводимыхПараметров(ПараметрыОтчета.СхемаКомпоновкиДанных);
