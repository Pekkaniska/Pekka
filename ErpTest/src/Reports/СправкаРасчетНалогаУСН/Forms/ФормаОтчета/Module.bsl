...
Процедура ОрганизацияПриИзмененииНаСервере()
	...
	БухгалтерскиеОтчетыКлиентСервер.ОрганизацияПриИзменении(ЭтотОбъект);
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.УменьшитьПериод.Доступность = НачалоКвартала(Отчет.КонецПериода) > НачалоКвартала(Форма.ДатаРегистрацииОрганизации);
...
Процедура ОбновитьНастройкиОтчета()
	...
	НалоговыйПериодРасширен = УчетУСНСервер.НалоговыйПериодРасширен(Отчет.Организация, Отчет.КонецПериода, ДатаРегистрацииОрганизации);
	НалоговыйПериодПропущен = УчетУСНСервер.НалоговыйПериодПропущен(Отчет.Организация, Отчет.КонецПериода, ДатаРегистрацииОрганизации);
