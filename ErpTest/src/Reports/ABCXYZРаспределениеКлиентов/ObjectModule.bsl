...
Процедура ПриЗагрузкеПользовательскихНастроекНаСервере(ЭтаФорма, НовыеНастройкиКД) Экспорт
	...
	Если Не Параметры.Свойство("Расшифровка") Или Параметры.Расшифровка = Неопределено Тогда
		Возврат;
	КонецЕсли;
	...
	// Если есть "Расшифровка", то "Отбор" и "Параметры данных" попадут в "Настройки" из "Фиксированных настроек".
