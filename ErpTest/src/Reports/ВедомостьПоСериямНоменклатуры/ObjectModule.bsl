...
Функция ТекстЗапросаОтчета()
	...
	|	ВЫБОР
	|		КОГДА &ЕдиницыКоличества = 0
	|			ТОГДА МатериалыИРаботыВПроизводствеОстаткиИОбороты.КоличествоНачальныйОстаток
	|		КОГДА &ЕдиницыКоличества = 1
	|			ТОГДА ВЫБОР
	|					КОГДА МатериалыИРаботыВПроизводствеОстаткиИОбороты.Номенклатура.КоэффициентЕдиницыДляОтчетов <> 0
	|						ТОГДА МатериалыИРаботыВПроизводствеОстаткиИОбороты.КоличествоНачальныйОстаток / МатериалыИРаботыВПроизводствеОстаткиИОбороты.Номенклатура.КоэффициентЕдиницыДляОтчетов
	|					ИНАЧЕ 0
	|				КОНЕЦ
	|	КОНЕЦ,
	|	ВЫБОР
