...
Функция ПолучитьТаблицуФорм() Экспорт 
	...
	Стр.ОписаниеФормы = "Форму уведомления о контролируемых иностранных компаниях в соответствии с приказом ФНС России от 13.12.2016 № ММВ-7-13/679@";
...
Функция ПолучитьСтруктураЛистГ1ДляВыгрузки()
	Возврат Новый Структура("УИД, УИДРодителя, НомерРосОрг, ОГРН, ИННЮЛ, КПП, НаимОрг");
КонецФункции

Функция ПолучитьСтруктураЛистГ2ДляВыгрузки()
...
Процедура СформироватьПараметрыДляЛистовГ(Параметры)
	...
	Для Каждого КЗ Из ВсеУчастникиЛистыГ Цикл
		Стр = ПолучитьСтруктураЛистГДляВыгрузки();
		...
		Для Каждого Элт Из КЗ.Значение Цикл
			Стр = ПолучитьСтруктураЛистГ0ДляВыгрузки();
			...
			Для Каждого СтрокаМнг Из МнгСтрСтроки Цикл
				СтрПодч = ПолучитьСтруктураЛистГ00ДляВыгрузки();
			...
			Для Каждого ЛистГ1 Из Параметры.ДанныеМногостраничныхРазделов.ЛистГ1 Цикл 
				Если ЛистГ1.Значение.УИДРодителя = Элт.Значение.УИД 
					...
					СтрГ1 = ПолучитьСтруктураЛистГ1ДляВыгрузки();
			...
			Для Каждого ЛистГ2 Из Параметры.ДанныеМногостраничныхРазделов.ЛистГ2 Цикл 
				Если ЛистГ2.Значение.УИДРодителя = Элт.Значение.УИД 
					...
					СтрГ2 = ПолучитьСтруктураЛистГ2ДляВыгрузки();
...
Процедура ДополнитьПараметры(Параметры)
	СформироватьПараметрыДляЛистовГ(Параметры);
