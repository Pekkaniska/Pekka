...
//
&НаКлиенте
Процедура ВидДеятельностиНажатие(Элемент = Неопределено, СтандартнаяОбработка = Ложь) Экспорт
	
	РегламентированнаяОтчетностьАЛКОКлиент.ВидДеятельностиПоЛицензииНажатиеАЛКО(
...
Функция ЗагрузкаОтчетаИзФайлаНаСервере(ДанныеДляЗагрузки)
	...
	ДеревоДляЗагрузки = РегламентированнаяОтчетность.ИзвлечьСтруктуруXML(ЭтотОбъект, "СхемаВыгрузки431");
...
&НаКлиенте
Процедура ПриАктивизацииСтрокиНаКлиенте() Экспорт

	РегламентированнаяОтчетностьАЛКОКлиент.ПриАктивизацииСтрокиАЛКО(ЭтаФорма);
