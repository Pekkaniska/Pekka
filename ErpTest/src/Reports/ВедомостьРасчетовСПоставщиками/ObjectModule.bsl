...
Функция ТекстЗапроса(ВалютаОтчета)
	...
	|	Расчеты.ДолгПоставщикаНачальныйОстаток                  КАК ДолгПоставщикаНачальныйОстаток,
	|	Расчеты.НашДолгНачальныйОстаток                         КАК НашДолгНачальныйОстаток,
	|	Расчеты.ПлановаяОплатаНачальныйОстаток                  КАК ПлановаяОплатаНачальныйОстаток,
	|	Расчеты.ПлановаяПоставкаНачальныйОстаток                КАК ПлановаяПоставкаНачальныйОстаток,
	|	
	...
	|	
	|	Расчеты.ДолгПоставщикаКонечныйОстаток                   КАК ДолгПоставщикаКонечныйОстаток,
	|	Расчеты.НашДолгКонечныйОстаток                          КАК НашДолгКонечныйОстаток,
	|	Расчеты.ПлановаяОплатаКонечныйОстаток                   КАК ПлановаяОплатаКонечныйОстаток,
	|	Расчеты.ПлановаяПоставкаКонечныйОстаток                 КАК ПлановаяПоставкаКонечныйОстаток
	|ИЗ (
	|	ВЫБРАТЬ
	...
	|		0                                           КАК ПлановаяПоставкаКонечныйОстаток
	|	ИЗ
	|		РегистрНакопления.РасчетыСПоставщикамиПланПоставок.Остатки({&НачалоОстатки}) КАК РасчетыПланОтгрузок
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.АналитикаУчетаПоПартнерам КАК АналитикаУчета
	...
	|	ИЗ
	|		РегистрНакопления.РасчетыСПоставщикамиПланПоставок.Остатки({&КонецПериода}) КАК РасчетыПланОтгрузок
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.АналитикаУчетаПоПартнерам КАК АналитикаУчета
	|				ПО РасчетыПланОтгрузок.АналитикаУчетаПоПартнерам = АналитикаУчета.КлючАналитики
	|			ЛЕВОЕ СОЕДИНЕНИЕ КурсыВалют КАК Курсы
	|				ПО Курсы.Валюта = РасчетыПланОтгрузок.Валюта
	...
	|		0                                           КАК ПлановаяПоставкаКонечныйОстаток
	|	ИЗ
	|		РегистрНакопления.РасчетыСПоставщиками.Остатки({&КонецПериода}) КАК РасчетыСПоставщиками
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.АналитикаУчетаПоПартнерам КАК АналитикаУчета
