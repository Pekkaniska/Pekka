	...
	Если ИмяРаздела = "Раздел1" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяРаздела Тогда
			...
			Если ЗначениеЗаполнено(ОбластьИмя) И СтрНачинаетсяС(ОбластьИмя, "П0") Тогда
				...
				Стр1_1_Гр2 = Макс(?(Стр1_1_Гр1 = 0, 0, Окр(Стр1_1_Гр3 * 100 / Стр1_1_Гр1, 2)), 0);
				...
				Стр1_2_Гр7 = ОкрПоФормату(Форма, ОбластиТД["П000001200007"].Значение);
				Стр1_2_Гр2 = Макс(?(Стр1_2_Гр1 = 0, 0, Окр(Стр1_2_Гр7 * 100 / Стр1_2_Гр1, 2)), 0);
				...
				Стр1_Гр2 = Макс(?(Стр1_Гр1 = 0, 0, Окр(Стр1_Гр3 * 100 / Стр1_Гр1, 2)), 0);
				...
				Стр2_3_1_Гр2 = Макс(?(Стр2_3_1_Гр1 = 0, 0, Окр(Стр2_3_1_Гр3 * 100 / Стр2_3_1_Гр1, 2)), 0);
				...
				Стр2_3_2_Гр2 = Макс(?(Стр2_3_2_Гр1 = 0, 0, Окр(Стр2_3_2_Гр3 * 100 / Стр2_3_2_Гр1, 2)), 0);
				...
				Стр2_3_3_Гр2 = Макс(?(Стр2_3_3_Гр1 = 0, 0, Окр(Стр2_3_3_Гр3 * 100 / Стр2_3_3_Гр1, 2)), 0);
				...
				Стр2_3_4_Гр2 = Макс(?(Стр2_3_4_Гр1 = 0, 0, Окр(Стр2_3_4_Гр3 * 100 / Стр2_3_4_Гр1, 2)), 0);
				...
				Стр2_3_5_Гр2 = Макс(?(Стр2_3_5_Гр1 = 0, 0, Окр(Стр2_3_5_Гр3 * 100 / Стр2_3_5_Гр1, 2)), 0);
				...
				Стр3_Гр2 = Макс(?(Стр3_Гр1 = 0, 0, Окр(Стр3_Гр3 * 100 / Стр3_Гр1, 2)), 0);
				...
				Стр3_1_Гр2 = Макс(?(Стр3_1_Гр1 = 0, 0, Окр(Стр3_1_Гр3 * 100 / Стр3_1_Гр1, 2)), 0);
				...
				Стр3_2_Гр2 = Макс(?(Стр3_2_Гр1 = 0, 0, Окр(Стр3_2_Гр3 * 100 / Стр3_2_Гр1, 2)), 0);
				...
				Стр3_3_Гр2 = Макс(?(Стр3_3_Гр1 = 0, 0, Окр(Стр3_3_Гр3 * 100 / Стр3_3_Гр1, 2)), 0);
				...
				Стр3_4_Гр2 = Макс(?(Стр3_4_Гр1 = 0, 0, Окр(Стр3_4_Гр3 * 100 / Стр3_4_Гр1, 2)), 0);
				...
				Стр5_Гр2 = Макс(?(Стр5_Гр1 = 0, 0, Окр(Стр5_Гр3 * 100 / Стр5_Гр1, 2)), 0);
...
Функция СформироватьСтруктуруПараметров()
	...
	ПараметрыВыгрузки.Вставить("ДатаФормирования", Формат(ДатаФормирования, "ДФ=""гггг-ММ-дд'T'ЧЧ:мм:сс"""));
...
Процедура ПроверитьКС_02(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = Макс(?(Показатели.С001Г1.Значение = 0, 0, Окр(Показатели.С001Г3.Значение * 100 / 
			Показатели.С001Г1.Значение, 4)), 0);
		РасчетнаяСуммаОкр = Окр(РасчетнаяСумма, 2);
		Настройки.ЭтоОшибка = НЕ Показатели.С001Г2.Значение = РасчетнаяСуммаОкр;
...
Процедура ПроверитьКС_05(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = Макс(?(Показатели.С011Г1.Значение = 0, 0, Окр(Показатели.С011Г3.Значение * 100 / 
			Показатели.С011Г1.Значение, 4)), 0);
		РасчетнаяСуммаОкр = Окр(РасчетнаяСумма, 2);
		Настройки.ЭтоОшибка = НЕ Показатели.С011Г2.Значение = РасчетнаяСуммаОкр;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_44(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = Макс(?(Показатели.С231Г1.Значение = 0, 0, Окр(Показатели.С231Г3.Значение * 100 / 
			Показатели.С231Г1.Значение, 4)), 0);
		РасчетнаяСуммаОкр = Окр(РасчетнаяСумма, 2);
		Настройки.ЭтоОшибка = НЕ Показатели.С231Г2.Значение = РасчетнаяСуммаОкр;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_46(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = Макс(?(Показатели.С232Г1.Значение = 0, 0, Окр(Показатели.С232Г3.Значение * 100 / 
			Показатели.С232Г1.Значение, 4)), 0);
		РасчетнаяСуммаОкр = Окр(РасчетнаяСумма, 2);
		Настройки.ЭтоОшибка = НЕ Показатели.С232Г2.Значение = РасчетнаяСуммаОкр;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_48(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = Макс(?(Показатели.С233Г1.Значение = 0, 0, Окр(Показатели.С233Г3.Значение * 100 / 
			Показатели.С233Г1.Значение, 4)), 0);
		РасчетнаяСуммаОкр = Окр(РасчетнаяСумма, 2);
		Настройки.ЭтоОшибка = НЕ Показатели.С233Г2.Значение = РасчетнаяСуммаОкр;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_50(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = Макс(?(Показатели.С234Г1.Значение = 0, 0, Окр(Показатели.С234Г3.Значение * 100 / 
			Показатели.С234Г1.Значение, 4)), 0);
		РасчетнаяСуммаОкр = Окр(РасчетнаяСумма, 2);
		Настройки.ЭтоОшибка = НЕ Показатели.С234Г2.Значение = РасчетнаяСуммаОкр;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_52(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = Макс(?(Показатели.С235Г1.Значение = 0, 0, Окр(Показатели.С235Г3.Значение * 100 / 
			Показатели.С235Г1.Значение, 4)), 0);
		РасчетнаяСуммаОкр = Окр(РасчетнаяСумма, 2);
		Настройки.ЭтоОшибка = НЕ Показатели.С235Г2.Значение = РасчетнаяСуммаОкр;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_60(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = Макс(?(Показатели.С003Г1.Значение = 0, 0, Окр(Показатели.С003Г3.Значение * 100 / 
			Показатели.С003Г1.Значение, 4)), 0);
		РасчетнаяСуммаОкр = Окр(РасчетнаяСумма, 2);
		Настройки.ЭтоОшибка = НЕ Показатели.С003Г2.Значение = РасчетнаяСуммаОкр;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_62(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = Макс(?(Показатели.С031Г1.Значение = 0, 0, Окр(Показатели.С031Г3.Значение * 100 / 
			Показатели.С031Г1.Значение, 4)), 0);
		РасчетнаяСуммаОкр = Окр(РасчетнаяСумма, 2);
		Настройки.ЭтоОшибка = НЕ Показатели.С031Г2.Значение = РасчетнаяСуммаОкр;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_64(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = Макс(?(Показатели.С032Г1.Значение = 0, 0, Окр(Показатели.С032Г3.Значение * 100 / 
			Показатели.С032Г1.Значение, 4)), 0);
		РасчетнаяСуммаОкр = Окр(РасчетнаяСумма, 2);
		Настройки.ЭтоОшибка = НЕ Показатели.С032Г2.Значение = РасчетнаяСуммаОкр;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_66(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = Макс(?(Показатели.С033Г1.Значение = 0, 0, Окр(Показатели.С033Г3.Значение * 100 / 
			Показатели.С033Г1.Значение, 4)), 0);
		РасчетнаяСуммаОкр = Окр(РасчетнаяСумма, 2);
		Настройки.ЭтоОшибка = НЕ Показатели.С033Г2.Значение = РасчетнаяСуммаОкр;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_68(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = Макс(?(Показатели.С034Г1.Значение = 0, 0, Окр(Показатели.С034Г3.Значение * 100 / 
			Показатели.С034Г1.Значение, 4)), 0);
		РасчетнаяСуммаОкр = Окр(РасчетнаяСумма, 2);
		Настройки.ЭтоОшибка = НЕ Показатели.С034Г2.Значение = РасчетнаяСуммаОкр;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_71(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = ?(Показатели.С036Г1.Значение = 0, 0, Окр(Показатели.С036Г3.Значение * 100 / 
			Показатели.С036Г1.Значение, 4));
		РасчетнаяСуммаОкр = Окр(РасчетнаяСумма, 2);
		Настройки.ЭтоОшибка = НЕ Показатели.С036Г2.Значение = РасчетнаяСуммаОкр;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_78(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = Макс(?(Показатели.С005Г1.Значение = 0, 0, Окр(Показатели.С005Г3.Значение * 100 / 
			Показатели.С005Г1.Значение, 4)), 0);
		РасчетнаяСуммаОкр = Окр(РасчетнаяСумма, 2);
		Настройки.ЭтоОшибка = НЕ Показатели.С005Г2.Значение = РасчетнаяСуммаОкр;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_79(СтруктураРезультата)
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = Макс(?(Показатели.С012Г1.Значение = 0, 0, Окр(Показатели.С012Г7.Значение * 100 / 
			Показатели.С012Г1.Значение, 4)), 0);
		РасчетнаяСуммаОкр = Окр(РасчетнаяСумма, 2);
		Настройки.ЭтоОшибка = НЕ Показатели.С012Г2.Значение = РасчетнаяСуммаОкр;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
...
Процедура ПроверитьКС_80(СтруктураРезультата)
	...
	// Проверка содержит противоречия, до их устранения приостановлена
	Возврат;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru='Проверка Раздела 1 (КС 80)'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Гр.3 стр.4 = гр.3 стр.1 - гр.3 стр.2. ""Сальдо операций"" показателя ""Привлечение ресурсов в Контракт/Пер"
	...
	Для каждого СтраницаРаздела Из мДанныеОтчета.Раздел1 Цикл
		...
		РасчетнаяСумма = Показатели.С001Г3.Значение - Показатели.С002Г3.Значение;
		Настройки.ЭтоОшибка = НЕ Показатели.С004Г3.Значение = РасчетнаяСумма;
		Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
			Показатели.С004Г3.Значение, Показатели.С001Г3.Значение, Показатели.С002Г3.Значение, РасчетнаяСумма);
		ДополнитьСтруктуруОшибок(Настройки);
