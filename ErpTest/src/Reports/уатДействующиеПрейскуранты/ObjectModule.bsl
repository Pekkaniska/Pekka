...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если Не СтрокаЗаголовка = Неопределено Тогда 
		...
		СтрокаЗаголовка.Текст = "Прейскурант тарифов на " + Формат(ДатаОтчета, "ДФ=dd.MM.yyyy") + " г.
			|на оказание транспортных услуг" + ?(ВыбраннаяОрганизация=Неопределено, "", Символы.ПС + ВыбраннаяОрганизация);
	КонецЕсли;
