...
Функция ЗаполнитьАвтоНаСервере()
	...
	"РегламентированнаяОтчетность.Автозаполнение_РеестрПоНДС_Приложение5",
	ПараметрыЗаполнения, , НСтр("ru = 'Автоматическое заполнение по данным информационной базы'"));
