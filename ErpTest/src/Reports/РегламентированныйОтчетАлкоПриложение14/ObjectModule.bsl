...
Функция ЗаполнитьПоВсейОрганизацииДекларация(
	...
	|
	|ГДЕ (РегистрСведенийАлкоПрил14Декларация.ИДДокИндСтраницы В (&МассивИДДокИндСтраницы)) 
	|И (РегистрСведенийАлкоПрил14Декларация.Активно = Истина)) КАК АлкоПрил14Декларация
	|	
    |СГРУППИРОВАТЬ ПО 
...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма20161305 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "1152032", '2016-05-13', "411", "ФормаОтчета2016Кв2");	
		
	Форма20162710 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "1152032", '2016-10-27', "473", "ФормаОтчета2016Кв4");
