...
Функция ПотребностиЗапланированныеВручную(ПланПроизводства, Периодичность)
	...
	Для каждого СтрокаТЧ Из ТаблицаПродукция Цикл
		...
		ДанныеПоНоменклатуре.ПодразделениеДиспетчер = СтрокаТЧ.ПодразделениеДиспетчер;
		...
		Для каждого ЭлементМатериал Из ДанныеСпецификации.МатериалыИУслуги Цикл
			...
			ДанныеПоНоменклатуре.Вставить("Подразделение",      СтрокаТЧ.ПодразделениеДиспетчер);
			ДанныеПоНоменклатуре.Вставить("Номенклатура",       СтрокаПродукции.Номенклатура);
			ДанныеПоНоменклатуре.Вставить("Характеристика",     СтрокаПродукции.Характеристика);
			ДанныеПоНоменклатуре.Вставить("НачалоПроизводства", Мин(СтрокаТЧ.НачалоПериода, НоваяСтрока.ДинамическийПериод));
