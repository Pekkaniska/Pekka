...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	Инфо.Вставить("Наименование", НСтр("ru = 'Открытые Заказ-наряды по технике'"));
	...
	Команда.Представление = НСтр("ru = 'Открытые Заказ-наряды по технике'");
	Команда.Идентификатор = "пкОткрытыеЗаказНарядыПоТехнике";
