...
Процедура СформироватьРасходыПроизводства(ПараметрыОтчета, ДокументРезультат, ДокументСхемы, КэшПараметровОтчета)
	...
	|			ЗНАЧЕНИЕ(ПланВидовХарактеристик.ВидыСубконтоХозрасчетные.НоменклатурныеГруппы),
	|			Организация = &Организация
	|				И (НЕ ВЫРАЗИТЬ(Субконто1 КАК Справочник.ГруппыФинансовогоУчетаНоменклатуры) В
	|						(ВЫБРАТЬ
	|							ВТНоменклатурныеГруппыЕНВД.Субконто1
	|						ИЗ
	...
	|			ЗНАЧЕНИЕ(ПланВидовХарактеристик.ВидыСубконтоХозрасчетные.СтатьиЗатрат),
	|			Организация = &Организация
	|				И (НЕ ВЫРАЗИТЬ(КорСубконто1 КАК Справочник.ГруппыФинансовогоУчетаНоменклатуры) В
	|						(ВЫБРАТЬ
	|							ВТНоменклатурныеГруппыЕНВД.Субконто1
	|						ИЗ
	|							ВТНоменклатурныеГруппыЕНВД КАК ВТНоменклатурныеГруппыЕНВД))
...
Процедура СформироватьРасходыПоТоварам(ПараметрыОтчета, ДокументРезультат, ДокументСхемы, КэшПараметровОтчета)
	...
	|				И ВЫБОР
	|					КОГДА ТИПЗНАЧЕНИЯ(ХозрасчетныйОбороты.КорСубконто1) = ТИП(ПланВидовХарактеристик.СтатьиДоходов)
	|						ТОГДА ВЫРАЗИТЬ(ХозрасчетныйОбороты.КорСубконто1 КАК ПланВидовХарактеристик.СтатьиДоходов).ВидПрочихДоходов
	|					КОГДА ТИПЗНАЧЕНИЯ(ХозрасчетныйОбороты.КорСубконто1) = ТИП(ПланВидовХарактеристик.СтатьиРасходов)
	|						ТОГДА ВЫРАЗИТЬ(ХозрасчетныйОбороты.КорСубконто1 КАК ПланВидовХарактеристик.СтатьиРасходов).ВидПрочихРасходов
	|					КОНЕЦ В (
	|													   ЗНАЧЕНИЕ(Перечисление.ВидыПрочихДоходовИРасходов.РеализацияОсновныхСредств),
	|													   ЗНАЧЕНИЕ(Перечисление.ВидыПрочихДоходовИРасходов.РеализацияНематериальныхАктивов),
	|													   ЗНАЧЕНИЕ(Перечисление.ВидыПрочихДоходовИРасходов.РеализацияИмущественныхПравКромеПраваТребования),
