...
Функция УниверсальнаяВыгрузка(Параметры) Экспорт
	...
	ДеревоВыгрузки = ИзвлечьСтруктуруXML(ИмяФормы, СтруктураРеквизитовФормы);
...
Функция ПараметрыВыгрузкиОтчета(ИмяФормы, СтруктураРеквизитовФормы, ДанныеОтчета) Экспорт
	...
	Если РазделВключенВОтчет(ИмяФормы, "ДополнительныеФайлы", ДеревоНастройкиСтраниц) Тогда
		...
		ПояснительнаяЗаписка = ИсходноеИмяДополнительногоФайла(ИмяФормы,
		...
		АудиторскоеЗаключение = ИсходноеИмяДополнительногоФайла(ИмяФормы,
...
Функция ИзвлечьСтруктуруXML(ИмяФормы, СтруктураРеквизитовФормы) Экспорт
	...
	Макет = ЭтотОбъект.ПолучитьМакет(ИмяМакетаСтруктурыВыгрузки(ИмяФормы, СтруктураРеквизитовФормы));
