...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = НСтр("ru = 'Отчет предназначен для формирования свода техники для предоставления в военкомат по месту регистрации юридического лица.'");
	НастройкиВарианта.НастройкиДляПоиска.НаименованияПолей =
		НСтр("ru = 'ОбъектЭксплуатации
		|Колонна
		|Организация'");
