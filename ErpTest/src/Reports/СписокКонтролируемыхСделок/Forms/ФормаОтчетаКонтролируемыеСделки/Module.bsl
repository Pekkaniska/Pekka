...
Процедура ПриОткрытии(Отказ)
	...
	Если Отчет.Группировка.Количество() = 0 Тогда
		...
		ГруппировкаОтчета.Представление 	= НСтр("ru = 'Контрагент'");
		ГруппировкаОтчета.Поле 				= "Контрагент";
		ГруппировкаОтчета.Использование 	= Истина;
		ГруппировкаОтчета.ТипГруппировки =  0;	
		
		ГруппировкаОтчета = Отчет.Группировка.Добавить();
		ГруппировкаОтчета.Представление 	= НСтр("ru = 'Договор'");
		ГруппировкаОтчета.Поле 				= "Договор";
		ГруппировкаОтчета.Использование 	= Истина;
		ГруппировкаОтчета.ТипГруппировки = 0;
		
		ГруппировкаОтчета = Отчет.Группировка.Добавить();
		ГруппировкаОтчета.Представление 	= НСтр("ru = 'Документ'");
		ГруппировкаОтчета.Поле 				= "РасчетныйДокумент";
		ГруппировкаОтчета.Использование 	= Истина;
		ГруппировкаОтчета.ТипГруппировки = 0;
		
		ГруппировкаОтчета = Отчет.Группировка.Добавить();
		ГруппировкаОтчета.Представление 	= НСтр("ru = 'Предмет сделки'");
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = НСтр("ru = 'Сведения о контролируемых сделках'");
