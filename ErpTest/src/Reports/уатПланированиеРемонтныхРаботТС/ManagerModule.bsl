...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Планирование ремонтных работ ТС");
	НастройкиВарианта.Описание = НСтр("ru = 'Отчет позволяет получить список транспортных средств, для которых необходимо запланировать ремонтные работы.'");
