...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если ЛимитыДействующиеНаДату.Количество() > 0 Тогда
		...
		ПланФактЛимитов = ЛимитыРасходованияДенежныхСредствСервер.ПланФактЛимитов(ИспользуемаяДата, Документ, ВалютаДокумента, Не ЗначениеЗаполнено(ПараметрДокумент.Значение));
