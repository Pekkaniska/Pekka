...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы = Отчеты.РегламентированныйОтчет4НДФЛ.СтруктураРеквизитовФормы(
		Параметры.Организация, Параметры.мДатаКонцаПериодаОтчета, Параметры);
...
Процедура ФормироватьСтруктуруСтраницОтчета() 
	...
	ЗначениеВРеквизитФормы(
		Отчеты.РегламентированныйОтчет4НДФЛ.ДеревоСтраницОтчета(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета),
...
Процедура ФормироватьСтруктуруСвойствСтраниц() Экспорт
	...
	ЗначениеВРеквизитФормы(
		Отчеты.РегламентированныйОтчет4НДФЛ.СвойстваРазделовДекларации(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета),
