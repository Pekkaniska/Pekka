...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Сводная ведомость по начисленной з/п");
	НастройкиВарианта.Описание = НСтр("ru = 'Отчет служит для анализа начисленной з/п водителей по путевым листам.'");
