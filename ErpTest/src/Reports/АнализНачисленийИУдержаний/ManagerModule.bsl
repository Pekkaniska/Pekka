...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = НСтр("ru = 'Расчетная ведомость (Т-51)'");
	...
	НастройкиВарианта.Описание = НСтр("ru = 'Регламентированная форма справка по ДСВ'");
	...
	НастройкиВарианта.Описание = НСтр("ru = 'Расчетно-платежная ведомость (0504401)'");
	
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Форма0504401с2015");
	НастройкиВарианта.Описание = НСтр("ru = 'Расчетно-платежная ведомость (0504401) с 2015 года'");
	
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Форма0504402");
	НастройкиВарианта.Описание = НСтр("ru = 'Расчетная ведомость (0504402)'");
