...
Процедура ЗаполнитьПоказателиИзРеквизитовФормы(Форма)
	...
	ИначеЕсли Форма.СтруктураРеквизитовФормы.СтранаОтправления = "КГ" Тогда
		...
		мФормаОтчета.Области.СтранаОтправленияНаименование.Значение = "КИРГИЗИЯ";
	...
	ИначеЕсли Форма.СтруктураРеквизитовФормы.СтранаНазначения = "КГ" Тогда
		...
		мФормаОтчета.Области.СтранаНазначенияНаименование.Значение = "КИРГИЗИЯ";
...
Процедура ДобавитьСтроку(Команда)
	Если ТабличныйДокумент.Области.Найти("КодТовара_999") <> Неопределено Тогда 
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Нельзя добавлять более 999 товаров в одну стат. форму, рекомендуется сооздать еще одну");
		Возврат;
	КонецЕсли;
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Пока Истина Цикл 
		...
		Если ЗначениеЗаполнено(ТабличныйДокумент.Области["ЦенаТовараВалРубль"+Суффикс].Значение)
			...
			Если Курс < 40 Или Курс > 200 Тогда 
