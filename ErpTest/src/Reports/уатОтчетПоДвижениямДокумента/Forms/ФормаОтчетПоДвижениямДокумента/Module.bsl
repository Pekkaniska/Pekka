...
//
&НаСервере
Процедура ОбработатьВыводДанныхПоМассиву(СписокПолей, ТаблицаРесурсов, ТаблицаИзмерений, ТаблицаРеквизитов, 
		ТаблицаВидДвижений = Неопределено, Знач ИмяРегистра, СинонимРегистра)
	...
	Макет = Отчеты.уатОтчетПоДвижениямДокумента.ПолучитьМакет("Макет");
	...
	Если Отчет.СпособВыводаОтчета = Перечисления.СпособыВыводаОтчета.ПоГоризонтали Тогда
	...
	Иначе
		...
		КоличествоСтрокШапки = Макс(ТаблицаРесурсов.Колонки.Количество(), ТаблицаИзмерений.Колонки.Количество(),
	...
	Для Каждого СтрокаТаблицы Из ДвиженияДокументаСортировка Цикл
		...
		Если ВидРегистра = "Сведений" ИЛИ ВидРегистра = "Накопления" Тогда
			...
			Если (ВидРегистра = "Накопления") 
				...
				ОбработатьВыводДанныхПоМассиву(СписокПолей, ТаблицаРесурсов, ТаблицаИзмерений, ТаблицаРеквизитов, 
					ТаблицаВидДвижений, ИмяРегистра, СинонимРегистра);
			Иначе
				ОбработатьВыводДанныхПоМассиву(СписокПолей, ТаблицаРесурсов, ТаблицаИзмерений, ТаблицаРеквизитов, , 
					ИмяРегистра, СинонимРегистра);
			КонецЕсли;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Отчет.СпособВыводаОтчета = Перечисления.СпособыВыводаОтчета.ПоГоризонтали;
