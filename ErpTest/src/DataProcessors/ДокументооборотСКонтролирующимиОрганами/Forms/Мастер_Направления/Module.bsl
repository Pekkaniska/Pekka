...
&НаСервере
Функция ИзменитьОформлениеФормы_ФСС()
	
	// ФСС
	Включено = СдаватьВФСС И ПризнакПоддержкиФСС;
	
	Элементы.ГруппаФСС.ТолькоПросмотр 				= ЗапретитьИзменение;
	Элементы.РегНомерФСС.ТолькоПросмотр 			= НЕ Включено;
	Элементы.ДополнительныйКодФСС.ТолькоПросмотр 	= НЕ Включено;
	...
	Элементы.РегНомерФСС.АвтоОтметкаНезаполненного  = Включено;
	Элементы.ДополнительныйКодФСС.АвтоОтметкаНезаполненного  = Включено;
	Если НЕ Включено Тогда
		Элементы.РегНомерФСС.ОтметкаНезаполненного          = Ложь;
		Элементы.ДополнительныйКодФСС.ОтметкаНезаполненного = Ложь;
	КонецЕсли;
