...
Процедура СкладПриИзмененииСервер()
	...
	ОбщегоНазначенияУТ.УстановитьОтборИзмерениюСКлючами(СписокАктов, "Склад", Склад);
...
Процедура ИнициализироватьХозяйственныеОперацииИДокументы()
	...
	Строка.ДобавитьКнопкуСоздать		= Истина;
	Строка.ПолноеИмяДокумента			= Метаданные.Документы.СписаниеПринятыхНаХранениеТоваров.ПолноеИмя();
	Строка.МенеджерРасчетаГиперссылкиКОформлению	= "Обработка.ЖурналСкладскихАктов";
	//-- НЕ УТ
