...
Процедура УстановитьУсловноеОформление()
	...
	ОбщегоНазначенияУТ.УстановитьУсловноеОфорлениеПоляСКлючемРеестраДокументов(ЭтотОбъект,
		Элементы.СписокДокументыПереработкиКонтрагент.Имя,
		"СписокДокументыПереработки.Контрагент");
		
	ОбщегоНазначенияУТ.УстановитьУсловноеОфорлениеПоляСКлючемРеестраДокументов(ЭтотОбъект,
		Элементы.СписокДокументыПереработкиСклад.Имя,
		"СписокДокументыПереработки.Склад");
...
Процедура ОбновитьНавигационнуюСсылку()
	...
	//++ НЕ УТКА
	ИначеЕсли КлючНазначенияИспользования = "ДокументыПриемаВПереработку" Тогда
...
Процедура УстановитьОтборПоСкладу()
	...
	ОбщегоНазначенияУТ.УстановитьОтборИзмерениюСКлючами(СписокДокументыПереработки, "Склад", ОтборСклады);
...
Функция ОбновитьГиперссылкуКОформлению()
	...
	КОформлениюПрием = ОбщегоНазначенияУТ.СформироватьГиперссылкуКОформлению(
		ХозяйственныеОперацииИДокументы.Выгрузить(Новый Структура("КлючНазначенияИспользования", "ДокументыПриемаВПереработку")),
		ПараметрыФормирования, ?(ЕстьПрием И ЕстьПередача, НСтр("ru = 'К оформлению (прием в переработку):'"),""));
	...
	Если ЕстьПрием Тогда
		МассивМенеджеровРасчета.Добавить("Документ.ЗаказДавальца");
	КонецЕсли;
	//-- НЕ УТКА
