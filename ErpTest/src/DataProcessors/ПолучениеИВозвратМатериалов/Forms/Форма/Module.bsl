...
Функция ВыполняетсяОбновлениеЧитаемыхДанных()
	...
	МассивПроверяемыхОбъектов.Добавить("РегистрНакопления.МатериалыИРаботыВПроизводстве");
	МассивПроверяемыхОбъектов.Добавить("РегистрНакопления.ЗаказыМатериаловСУчетомКорректировок");
	МассивПроверяемыхОбъектов.Добавить("РегистрНакопления.ЗаказыМатериаловВПроизводство");
	МассивПроверяемыхОбъектов.Добавить("РегистрНакопления.ТоварыКОтгрузке");
	//++ НЕ УТКА
	МассивПроверяемыхОбъектов.Добавить("РегистрНакопления.ПотребностьВМатериалахВПроизводстве");
	//-- НЕ УТКА	
	
	УстановитьПривилегированныйРежим(Истина);
	Результат = 
	//++ НЕ УТКА
		НЕ ОбновлениеИнформационнойБазы.ОбработкаДанныхЗавершена(Неопределено, "РегистрСведений.ГрафикЭтаповПроизводства")
		ИЛИ
	//-- НЕ УТКА
		НЕ ОбновлениеИнформационнойБазы.ОбработкаДанныхЗавершена(Неопределено, МассивПроверяемыхОбъектов);
