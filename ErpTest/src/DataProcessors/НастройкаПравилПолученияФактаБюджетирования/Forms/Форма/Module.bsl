...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	|			И ПланСчетовМеждународный.Ссылка = ПравилаПолученияФактаПоСтатьямБюджетов.ИсточникДанных
	...
	|			И ПланСчетовМеждународный.Ссылка = ПравилаПолученияФактаПоПоказателямБюджетов.ИсточникДанных
	|
	|СГРУППИРОВАТЬ ПО
	|	ПланСчетовМеждународный.Ссылка,
	|	ПланСчетовМеждународный.Код,
	|	ПланСчетовМеждународный.Наименование";
	
	СвойстваСписка = ОбщегоНазначения.СтруктураСвойствДинамическогоСписка();
	СвойстваСписка.ОсновнаяТаблица = "ПланСчетов.Международный";
	СвойстваСписка.ДинамическоеСчитываниеДанных = Истина;
	СвойстваСписка.ТекстЗапроса = ТекстЗапроса;
	ОбщегоНазначения.УстановитьСвойстваДинамическогоСписка(Элементы.ПланСчетовМеждународный,
		СвойстваСписка);
