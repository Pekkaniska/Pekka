...
Процедура ДекорацияОткрытьРасходыНажатие(Элемент)
	...
	ОткрытьФорму("Отчет.АнализРасходовПриУСН.Форма", ПараметрыФормыАнализаРасходов("ПрочиеРасходы", ПараметрыОтчета));
...
Процедура ДекорацияОткрытьРасходыПоСебестоимостиНажатие(Элемент)
	...
	ОткрытьФорму("Отчет.АнализРасходовПриУСН.Форма", ПараметрыФормыАнализаРасходов("РасходыПоСебестоимости", ПараметрыОтчета));
...
Процедура ДекорацияОткрытьРасходыПоАмортизацииНажатие(Элемент)
	...
	ОткрытьФорму("Отчет.АнализРасходовПриУСН.Форма", ПараметрыФормыАнализаРасходов("РасходыПоАмортизации", ПараметрыОтчета));
...
Процедура ДекорацияОткрытьРасходыПоМатериаламНажатие(Элемент)
	...
	ОткрытьФорму("Отчет.АнализРасходовПриУСН.Форма", ПараметрыФормыАнализаРасходов("РасходыПоМатериалам", ПараметрыОтчета));
