...
Процедура ПолучитьНоменклатуруПоШтрихкодамВСервисе(ШтрихКоды)
	...
	РаботаСНоменклатуройКлиент.ПолучитьНоменклатуруПоШтрихкодам(
		СоздатьНоменклатуруПродолжение, ШтрихКоды, ЭтотОбъект, ИдентификаторЗадания);	
...
Процедура СоздатьНоменклатуруПоИдентификаторам(ИдентификаторыНоменклатуры)
	...
	РаботаСНоменклатуройКлиент.ЗагрузитьНоменклатуруИХарактеристики(СоздатьНоменклатуруПродолжение, ИдентификаторыНоменклатуры, ЭтотОбъект);
...
&НаСервере
Процедура ЗаполнитьНоменклатуру(НоваяНоменклатура)
