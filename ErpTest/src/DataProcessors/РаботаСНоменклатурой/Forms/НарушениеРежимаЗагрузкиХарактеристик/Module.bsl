	...
	Если ВариантНарушения = 0 Тогда
		...
		Если Идентификаторы.Количество() = 1 Тогда
			...
			СоответствияНоменклатуры = РаботаСНоменклатурой.
				ПолучитьСоответствиеНоменклатурыПоИдентификаторам(Идентификаторы[0].ИдентификаторНоменклатуры);
			...
			СтрокаПояснения = НСтр("ru = 'Номенклатура <a href = ""НоменклатураСсылка"">%1</a> загружена без поддержки характеристик. 
				|Загрузка отдельных характеристик не доступна.'");
		...
		СтрокаПояснения = СтрокаПояснения + Символы.ПС + Символы.ПС +
			СтрЗаменить(
				НСтр("ru = 'Для возможности загрузки характеристик необходимо убедится, что вид 
