...
Процедура Далее(Команда)
	...
	Если ЕстьПустыеВидыНоменклатуры() Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Не все виды номенклатуры заполнены'"));
		Возврат;
	КонецЕсли;
...
Функция СтатусыВеденияУчетаХарактеристик()
	...
	Возврат РаботаСНоменклатуройСлужебныйКлиентСервер.СтатусыВеденияУчетаХарактеристик();
...
Процедура ЗагрузитьНоменклатуру()
	...
	РаботаСНоменклатуройКлиент.ЗагрузитьНоменклатуруИХарактеристики(СоздатьНоменклатуруПродолжение, Идентификаторы, ЭтотОбъект, ДополнительныеПараметры);
