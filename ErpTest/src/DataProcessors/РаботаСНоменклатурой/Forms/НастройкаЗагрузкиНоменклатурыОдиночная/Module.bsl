...
Процедура ЗагрузитьНоменклатуру()
	...
	Оповещение = Новый ОписаниеОповещения("ЗагрузитьНоменклатуруПродолжение", ЭтотОбъект, Новый Структура());
	
	РаботаСНоменклатуройКлиент.ЗагрузитьНоменклатуруИХарактеристики(Оповещение, Идентификаторы, 
		ЭтотОбъект, ДополнительныеПараметрыСоздания);
...
Процедура СоздатьВидНоменклатуры()
	...
	РаботаСНоменклатуройКлиент.ЗагрузитьКатегории(
		ЗагрузитьКатегорииЗавершение, Идентификаторы, ЭтотОбъект, Неопределено, Неопределено);
