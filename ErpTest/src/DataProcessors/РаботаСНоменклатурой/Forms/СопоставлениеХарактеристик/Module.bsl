...
Процедура ЗаполнитьСопоставленныеХарактеристики(АдресДанных)
	...
	Если ЭтоАдресВременногоХранилища(АдресДанных) Тогда
		ДанныеХарактеристик = ПолучитьИзВременногоХранилища(АдресДанных);
	Иначе
		Возврат;	
	КонецЕсли;
...
Процедура ЗаписатьСоответствие(Характеристика, ИдентификаторХарактеристики, ПредставлениеХарактеристики)
	...
	РаботаСНоменклатурой.ЗаписатьСоответствиеНоменклатурыИХарактеристик(НоменклатураСсылка, Характеристика, ПараметрыЗаписи);
