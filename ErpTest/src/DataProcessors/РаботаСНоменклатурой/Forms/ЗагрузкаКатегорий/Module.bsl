...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры.Свойство("ИдентификаторыВыбранныхКатегорий", ИдентификаторыВыбранныхКатегорий);
...
Процедура ЗагрузитьКатегории(Команда)
	...
	ОткрытьФорму("Обработка.РаботаСНоменклатурой.Форма.ВыборРежимаЗагрузкиКатегорий", 
		Новый Структура("КоличествоКатегорийДляЗагрузки ", КоличествоКатегорийДляЗагрузки ), ЭтотОбъект, , , , Оповещение);
...
Процедура ПослеВыбораРежимаЗагрузки(Результат, ДополнительныеПараметры) Экспорт
	...
	ПараметрыЗавершения.Вставить("КатегорииКЗагрузке",     ДополнительныеПараметры.КатегорииКЗагрузке);
	ПараметрыЗавершения.Вставить("РежимЗагрузкиКатегорий", Результат.РежимЗагрузкиКатегорий);
	ПараметрыЗавершения.Вставить("ВидНоменклатуры",        Результат.ВидНоменклатуры);
	...
	РаботаСНоменклатуройКлиент.ЗагрузитьКатегории(
		ЗагрузитьКатегорииЗавершение, ДополнительныеПараметры.КатегорииКЗагрузке, ЭтотОбъект, Неопределено, Неопределено, Результат);
...
Процедура ЗагрузитьКатегорииЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли РезультатЗагрузки.Свойство("АдресДанныхЗаполнения") Тогда	
...
Процедура ПостроитьДеревоКатегорий(ИдентификаторСтроки = Неопределено, ТекстПоиска = "", ПродублироватьВКэше = Ложь)
	...
	Если ЗначениеЗаполнено(ТекстПоиска) Тогда
		РаботаСНоменклатуройКлиент.НайтиКатегорииПоСтрокеПоиска(ПостроитьДеревоКатегорийЗавершение, ТекстПоиска, ЭтотОбъект,,
...
Процедура СпозиционироватьНаВыбранномЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если ДополнительныеПараметры.ЭтоСозданиеФормы 
		И ЗначениеЗаполнено(ИдентификаторыВыбранныхКатегорий) Тогда
