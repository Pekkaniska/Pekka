...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДанныеФО.Вставить("ПроверкаДокументов", ПолучитьФункциональнуюОпцию("ИспользоватьПроверкуДокументовПоРегламентированномуУчету"));
	ДанныеФО.Вставить("ИзменяемПроверенные", ПолучитьФункциональнуюОпцию("РазрешатьИзменятьПроверенныеДокументыПоРеглУчету"));
	...
	Элементы.ГруппаСостояниеПроверкиДокументовКПовторнойПроверке.Видимость = ДанныеФО.ИзменяемПроверенные И ДанныеФО.ПроверкаДокументов;
	...
	ДатаОкончанияПериодаДоЗагрузкиНастроек = ДатаОкончанияПериода;
...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	...
	Если ОрганизацияДоЗагрузкиНастроек <> Организация Или ДатаОкончанияПериодаДоЗагрузкиНастроек <> ДатаОкончанияПериода Тогда
		ЗапуститьЗаданияПоОбновлениюДанныхСостоянияРеглУчета(ИнициализироватьСтруктуруЗаданийОбновления(ДанныеФО));
	КонецЕсли;
...
Функция ОтразитьДокументыВРегламентированномУчетеСервер()
	...
	РезультатФоновогоЗадания = ЗапуститьВыполнениеВФоне(ВыполняемыйМетод, ПараметрыОбработки);
...
Процедура ОбновитьДанныеПоОтражениюИПроверкеДокументовВРеглУчете(РезультатВыполненияФоновогоЗадания, ВидОперации)
	...
	Если РезультатВыполненияФоновогоЗадания.Статус = "Выполнено" Тогда
		...
		Если Выборка.Следующий() Тогда
			...
			Элементы[ИмяРеквизита].ЦветТекста = ?(ВидОперации = "НеУказаныСчетаУчета", ЦветаСтиля.ПросроченныеДанныеЦвет, ЦветаСтиля.ЦветГиперссылки);
...
Функция ТребуетсяНастройкаСчетов(МассивОрганизаций)
	...
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовНоменклатуры(), Истина);
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовНоменклатурыУКонтрагентов(), Истина);
	
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовРасчетовСДебиторами(), Истина);
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовРасчетовСКлиентами(), Истина);
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовРасчетовСКомиссионерами(), Истина);
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовРасчетовСКомитентами(), Истина);
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовРасчетовСКредиторами(), Истина);
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовРасчетовСПоставщиками(), Истина);
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовРасчетовСЛизингодателями(), Истина);
	
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовДоходов(), Истина);
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовРасходов(), Истина);
	
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовДенежныхСредств(), Истина);
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовПроизводства(), Истина);
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовПодарочныхСертификатов(), Истина);	
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовТМЦВЭксплуатации(), Истина);
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовВнеоборотныхАктивов(), Истина);
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивВидовСчетов, Перечисления.ВидыСчетовРеглУчета.ВидыСчетовРезервов(), Истина);
	...
	Запрос.УстановитьПараметр("Организации", МассивОрганизаций);
	Запрос.УстановитьПараметр("АнализируемыеВидыСчетов", Перечисления.ВидыСчетовРеглУчета.ВидыСчетовРасчетовСКомиссионерами());
	
	Выборка = Запрос.Выполнить().Выбрать();
	
	ТребуютНастройки = ТребуютНастройки + 2 * Выборка.Количество();
...
Функция ИнициализироватьСтруктуруЗаданийОбновления(ДанныеФункциональныхОпций, ПеречисленныеЗаданияСтрокой = Неопределено)
	...
	Если ПеречисленныеЗаданияСтрокой = Неопределено Тогда
		ПеречисленныеЗаданияСтрокой = "СостояниеРегламентногоЗадания,СостояниеОффлайновыхРасчетов,СостояниеОтраженияДокументов,"+
	...
	Для каждого Задание Из МассивЗаданий Цикл
		...
		ИначеЕсли Задание = "СостояниеПроверкиДокументов" Тогда
			Если ДанныеФункциональныхОпций.ПроверкаДокументов Тогда
				...
				Если ДанныеФункциональныхОпций.ИзменяемПроверенные Тогда
