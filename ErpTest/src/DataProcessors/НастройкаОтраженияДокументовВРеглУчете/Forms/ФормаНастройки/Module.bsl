...
Процедура ЗаполнитьСвойстваСтруктурыТаблицФормы(ВидыСчетовРеглУчета)
	...
	СоответствиеТаблицИИспользуемыхФункциональныхОпций.Вставить("СчетаУчетаПроизводства", 
		ПолучитьФункциональнуюОпцию("ИспользоватьПроизводство") ИЛИ ПолучитьФункциональнуюОпцию("ИспользоватьПроизводствоНаСтороне"));
...
Процедура СохранитьПорядокОтраженияСчетовУчета(ИмяТаблицы, МассивСчетовУчета)
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьНесколькоОрганизаций") Тогда
		...
		Если ОграничениеНаУровнеЗаписей = Неопределено Тогда
