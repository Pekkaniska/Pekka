	...
	Для Каждого Строка Из ВыделенныеСтроки Цикл
		...
		Если ВыделеннаяСтрока <> Неопределено Тогда
			...
			Если Графики = Неопределено Тогда
				...
				ТекстОшибки = СтрШаблон(НСтр("ru='В строке %1 не указан график работы.'"), НомерСтроки);
			...
			Если Не ЗначениеЗаполнено(ВыделеннаяСтрока.РабочийЦентр) Тогда
				...
				ТекстОшибки = СтрШаблон(НСтр("ru='В строке %1 не указан рабочий центр.'"), НомерСтроки);
				ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
					ТекстОшибки,
					,
