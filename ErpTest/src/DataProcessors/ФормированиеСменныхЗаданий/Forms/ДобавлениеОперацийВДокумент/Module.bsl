...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Параметры.СменноеЗадание.Пустая() Тогда
		...
		Заголовок = СтрШаблон(
			?(РежимПодбора, НСтр("ru = 'Подбор операций в %1'"), НСтр("ru = 'Добавление операции в %1'")),
	...
	Иначе
		...
		Заголовок = ?(РежимПодбора, НСтр("ru = 'Подбор операций'"), НСтр("ru = 'Добавление операции'"));
	...
	ЦветНеВыбранногоРежима = ЦветаСтиля.ЦветГиперссылки;
...
Процедура ПодборОперацийКоличествоПриИзменении(Элемент)
	...
	Если ТекущиеДанные.КоличествоБаза <> 0 Тогда
		
		ТекущиеДанные.ВремяВыполнения = ТекущиеДанные.Количество*ТекущиеДанные.ВремяВыполненияБаза/ТекущиеДанные.КоличествоБаза;
...
Процедура ПодборОперацийВремяВыполненияПриИзменении(Элемент)
	...
	Если ТекущиеДанные.ВремяВыполненияБаза <> 0 Тогда
		
		ТекущиеДанные.Количество = ТекущиеДанные.ВремяВыполнения*ТекущиеДанные.КоличествоБаза/ТекущиеДанные.ВремяВыполненияБаза;
...
Процедура ДобавитьСтрокуВПодборОпераций(КлючОперации)
	...
	ИсключаяСвойства = "";
	Если НЕ Участок.Пустая() И Участок <> ДанныеСтроки.Участок Тогда
	...
	НоваяСтрока.КоличествоБаза = НоваяСтрока.Количество;
	НоваяСтрока.ВремяВыполненияБаза = НоваяСтрока.ВремяВыполнения;
