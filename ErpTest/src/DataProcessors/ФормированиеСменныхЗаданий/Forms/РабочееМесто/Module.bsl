...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		МассивСтрок.Добавить(" (");
		МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'отключить'"),,,, "ОтключитьОтборПоЭтапу"));
		МассивСтрок.Добавить(") ");
...
Процедура НастроитьСоставСмен(Команда)
	...
	ОткрытьФорму(
		"Обработка.ФормированиеСменныхЗаданий.Форма.ВыборСмен",
		ПараметрыФормы,
		ЭтотОбъект,
		УникальныйИдентификатор,,,
...
Процедура Подключаемый_ВыполнитьКомандуИнтеграции(Команда)
	...
	ИнтеграцияС1СДокументооборотКлиент.ВыполнитьПодключаемуюКомандуИнтеграции(Команда, ЭтаФорма, Элементы.СменныеЗадания);
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	Если СтруктураРеквизитов.Свойство("РежимНазначения") 
		...
		Если Форма.ЕстьУчастки Тогда
			Элементы.СменыГруппаПредставление.Заголовок = СтрШаблон(НСтр("ru = 'Смена, Участок, %1'"), ОбъектНазначения);
		Иначе
			Элементы.СменыГруппаПредставление.Заголовок = СтрШаблон(НСтр("ru = 'Смена, %1'"), ОбъектНазначения);
		КонецЕсли;
...
Функция ТекстЗапросаСмены()
	...
	Возврат
		...
		|		ВЫБОР Операции.ВремяВыполненияЕдИзм
