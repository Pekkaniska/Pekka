...
Функция СоздатьВедомостиПоРасчетномуДокументу(РасчетныйДокумент, ПараметрыСоздания) Экспорт
	...
	КонецЕсли;	
	Если ПараметрыСоздания.ВРазрезеИсточников Тогда
...
Функция НоваяВедомостьПоКлючу(КлючВедомости, ОписаниеОперации, СпособВыплаты)
	...
	Ведомость.ПеречислениеНДФЛВыполнено = Истина;
	...
	Для Каждого Реквизит Из ДокументМенеджер.РеквизитыОтветственныхЛиц() Цикл
...
Функция СохранитьВедомости(Ведомости, РежимЗаписи)	Экспорт
