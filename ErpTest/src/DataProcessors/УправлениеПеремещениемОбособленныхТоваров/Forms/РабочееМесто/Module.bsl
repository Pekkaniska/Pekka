...
Процедура УстановитьСтатус(Команда)
	...
	ИначеЕсли Команда = Команды.УстановитьСтатусЗаказовМатериаловКОбеспечению.Имя Тогда
		
		ТипДокумента = Тип("ДокументСсылка.ЗаказМатериаловВПроизводство");
		Статус = ПредопределенноеЗначение("Перечисление.СтатусыЗаказовМатериаловВПроизводство.КОбеспечению");
