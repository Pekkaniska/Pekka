...
Процедура УстановитьУсловноеОформление()
	...
	ОбщегоНазначенияУТ.УстановитьУсловноеОфорлениеПоляСКлючемРеестраДокументов(ЭтотОбъект,
		Элементы.СписокДокументыПродажиСклад.Имя,
		"СписокДокументыПродажи.Склад");
	
	ОбщегоНазначенияУТ.УстановитьУсловноеОфорлениеПоляСКлючемРеестраДокументов(ЭтотОбъект,
		Элементы.СписокДокументыПродажиКонтрагент.Имя,
		"СписокДокументыПродажи.Контрагент");
...
Процедура УстановитьОтборыДинамическихСписков(ТекущийКлюч = Неопределено)
	...
	ОбщегоНазначенияУТ.УстановитьОтборИзмерениюСКлючами(СписокДокументыПродажи, "Склад", ОтборСклады);
