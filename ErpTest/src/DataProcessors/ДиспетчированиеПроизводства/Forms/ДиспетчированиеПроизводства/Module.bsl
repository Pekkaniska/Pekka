...
Процедура ОбновитьИнформационнуюСтрокуСпискаМЛ(Результат)
	...
	Если Результат.Свойство("АвтоОбновление") И НЕ Результат.АвтоОбновление Тогда
		...
		МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'обновить'"),,,, "#ОбновитьСписокМЛ"));
		МассивСтрок.Добавить(")");
...
Процедура ОбновитьДиспетчированиеРЦ(Результат)
	...
	ОформитьЭлементыОтбора("ОтборРабочиеЦентрыОтставание", НСтр("ru = 'Есть отставание от расписания'"), ДанныеДиспетчированиеРЦ.ОтставаниеОтРасписания);
	ОформитьЭлементыОтбора("ОтборРабочиеЦентрыОпережение", НСтр("ru = 'Есть опережение расписания'"), ДанныеДиспетчированиеРЦ.ОпережениеОтРасписания);
	ОформитьЭлементыОтбора("ОтборРабочиеЦентрыРасписаниеНеСформировано", НСтр("ru = 'Не сформировано расписание'"), ДанныеДиспетчированиеРЦ.НеСформированоРасписание);
	...
	Для каждого ИдентификаторСтроки Из Элементы.СписокМаршрутныхЛистов.ВыделенныеСтроки Цикл
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Маршрутный лист производства'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Процедура ПередатьКВыполнению(ВыбраннаяСтрока = Неопределено)
	...
	УстановитьСтатусМЛ("КВыполнению", НСтр("ru = 'К выполнению'"), МассивСсылок);
...
Функция ВыполняетсяОбновлениеЧитаемыхДанных()
	...
	МассивПроверяемыхОбъектов.Добавить("РегистрНакопления.ТрудозатратыКОформлению");
	МассивПроверяемыхОбъектов.Добавить("РегистрНакопления.РаспоряженияНаВыпускПродукции");
	МассивПроверяемыхОбъектов.Добавить("Документ.МаршрутныйЛистПроизводства");
	МассивПроверяемыхОбъектов.Добавить("РегистрНакопления.ДоступностьВидовРабочихЦентров");
	
	Возврат НЕ ОбновлениеИнформационнойБазы.ОбработкаДанныхЗавершена(Неопределено, МассивПроверяемыхОбъектов)
		ИЛИ НЕ ОбновлениеИнформационнойБазы.ОбработкаДанныхЗавершена(Неопределено, "РегистрСведений.ГрафикЭтаповПроизводства");
