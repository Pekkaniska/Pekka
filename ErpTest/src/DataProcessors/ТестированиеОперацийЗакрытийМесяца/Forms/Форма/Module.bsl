...
Функция ВсеМесяцыЗакрыты()
	...
	|		ПО (ИСТИНА)
	|ГДЕ
	|	Константы.ИспользоватьРеглУчет
	|	И ОтражениеДокументовВРеглУчете.ДатаОтражения >= Константы.ДатаНачалаВеденияРеглУчета
	|	И ОтражениеДокументовВРеглУчете.ДатаОтражения < &КонецРасчета
	|	И ОтражениеДокументовВРеглУчете.Статус В (ЗНАЧЕНИЕ(Перечисление.СтатусыОтраженияДокументовВРеглУчете.КОтражениюВРеглУчете),
