...
Функция ЭтапыДляТестирования() Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьМеждународныйФинансовыйУчет") Тогда
		ЭтапыДляТестирования.Добавить("МеждународныйУчет", " " + НСтр("ru = 'Отражение в международном учете'"), Истина);
	КонецЕсли;
	//-- НЕ УТКА
...
Функция РазделыТестирования() Экспорт
	...
	//++ НЕ УТКА
	Если ПолучитьФункциональнуюОпцию("ИспользоватьМеждународныйФинансовыйУчет") Тогда
		РазделыТестирования.Добавить("МеждународныйУчет", " " + НСтр("ru = 'Отражение в международном учете'"), Истина);
	КонецЕсли;
	//-- НЕ УТКА
...
Функция ТестироватьЗаПериод(ПараметрыОбработки)
	...
	Для каждого ЭтапТестирования Из ПараметрыОбработки.ЭтапыТестирования Цикл
		...
		Если ЭтапТестирования.Значение = "ПереходНаНовыеВзаиморасчеты" И Не ПолучитьФункциональнуюОпцию("НоваяАрхитектураВзаиморасчетов") Тогда
		...
		Если ЭтапТестирования.Значение = "ПерезаполнитьНовыеВзаиморасчеты" И ПолучитьФункциональнуюОпцию("НоваяАрхитектураВзаиморасчетов") Тогда
