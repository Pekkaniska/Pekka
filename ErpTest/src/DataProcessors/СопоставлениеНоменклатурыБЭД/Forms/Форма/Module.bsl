...
Процедура ПриОткрытии(Отказ)
	...
	ОжидатьЗавершениеПоискаВариантов();
...
Процедура НадписьРаботаСНоменклатуройПодсказкаНажатие(Элемент)
	...
	ОткрытьФорму("Обработка.РаботаСНоменклатурой.Форма.ПанельАдминистрирования", ПараметрыОткрытия, ЭтотОбъект,,,,
		Новый ОписаниеОповещения("РаботаСНоменклатуройПодсказкаЗавершение", ЭтотОбъект),
...
Процедура УстановитьСвойстваЭлементаОтбораПоСопоставлению()
	...
	Элементы.СопоставленоОтбор.СписокВыбора[0].Представление = "Все (" + ВсегоЗаписей + ")";
	Элементы.СопоставленоОтбор.СписокВыбора[1].Представление = "Сопоставленные (" + СопоставленоЗаписей + ")";
	Элементы.СопоставленоОтбор.СписокВыбора[2].Представление = "Несопоставленные (" + НеСопоставленоЗаписей + ")";
...
&НаКлиенте
Процедура ОжидатьЗавершениеПоискаВариантов()
...
&НаКлиенте
Процедура РаботаСНоменклатуройПодсказкаЗавершение(Результат, ДополнительныеПараметры)
	
	РаботаСНоменклатуройПодсказкаЗавершениеНаСервере();
	
КонецПроцедуры

&НаСервере
Процедура РаботаСНоменклатуройПодсказкаЗавершениеНаСервере()
