...
Функция ХозяйственныеОперацииИДокументы()
	...
	СтрокаВыкуп = ХозяйственныеОперацииИДокументы.Добавить();
	ЗаполнитьЗначенияСвойств(СтрокаВыкуп, Строка);
	СтрокаВыкуп.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВыкупТоваровПереданныхВПроизводство;
	...
	Строка.ХозяйственнаяОперация                 = Перечисления.ХозяйственныеОперации.СписаниеТоваровХранящихсяНаСкладе;
	Строка.ДобавитьКнопкуСоздать                 = Истина;
	...
	СтрокаСписание.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.СписаниеТоваровПереданныхВПроизводство;
