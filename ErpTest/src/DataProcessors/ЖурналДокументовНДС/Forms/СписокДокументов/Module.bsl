...
Процедура УстановитьУсловноеОформление()
	...
	ОбщегоНазначенияУТ.УстановитьУсловноеОфорлениеПоляСКлючемРеестраДокументов(ЭтотОбъект,
		Элементы.СписокДокументыНДСКонтрагент.Имя,
		"СписокДокументыНДС.Контрагент");
...
Процедура УстановитьОтборыДинамическихСписков()
	...
	ОбщегоНазначенияУТ.УстановитьОтборИзмерениюСКлючами(СписокДокументыНДС, "Контрагент", Контрагент);
