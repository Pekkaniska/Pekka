...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокТипов.Добавить(Тип("ДокументСсылка.ОтчетБанкаПоОперациямЭквайринга"));
...
Процедура ЖурналПлатежейВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "ЖурналПлатежейСостояние" Тогда
...
Процедура УстановитьУсловноеОформление()
	...
	ОбщегоНазначенияУТ.УстановитьУсловноеОфорлениеПоляСКлючемРеестраДокументов(ЭтотОбъект,
		Элементы.ЖурналПлатежейПолучательПлательщик.Имя,
		"ЖурналПлатежей.ПолучательПлательщик");
		
	ОбщегоНазначенияУТ.УстановитьУсловноеОфорлениеПоляСКлючемРеестраДокументов(ЭтотОбъект,
		Элементы.ЖурналПлатежейБанковскийСчетКасса.Имя,
		"ЖурналПлатежей.БанковскийСчетКасса");
...
Процедура УстановитьОтборЖурналаПлатежей()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
		ЖурналПлатежей,
		"БанковскийСчетКасса",
		Справочники.КлючиРеестраДокументов.КлючиПоЗначениям(МассивВыбранныхКассБанковскихСчетов),
		ВидСравненияКомпоновкиДанных.ВСписке,,
