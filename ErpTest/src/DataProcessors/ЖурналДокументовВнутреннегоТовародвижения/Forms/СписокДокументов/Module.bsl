...
Процедура УстановитьУсловноеОформление()
	...
	ОбщегоНазначенияУТ.УстановитьУсловноеОфорлениеПоляСКлючемРеестраДокументов(ЭтотОбъект,
		Элементы.СписокДокументыВнутреннегоТовародвиженияСклад.Имя,
		"СписокДокументыВнутреннегоТовародвижения.Склад");
...
Процедура СкладПриИзмененииНаСервере()
	...
	ОбщегоНазначенияУТ.УстановитьОтборИзмерениюСКлючами(СписокДокументыВнутреннегоТовародвижения, "Склад", Склад);
	...
	Для каждого Строка Из ХозяйственныеОперацииИДокументы Цикл
		Если Строка.Отбор Тогда
			Если Строка.ТипДокумента = Тип("ДокументСсылка.ВнутреннееПотреблениеТоваров") Тогда
				...
				//++ НЕ УТКА
				Менеджеры.Вставить("ЗаказНаРемонт", "Документ.ЗаказНаРемонт");
				//-- НЕ УТКА
			...
			ИначеЕсли Строка.ТипДокумента = Тип("ДокументСсылка.ПередачаМатериаловВПроизводство") Тогда
				Менеджеры.Вставить("ЗаказМатериаловВПроизводство", "Документ.ЗаказМатериаловВПроизводство");
				//++ НЕ УТКА
				Менеджеры.Вставить("ЗаказНаПроизводство", "Документ.ЗаказНаПроизводство");
				//-- НЕ УТКА
