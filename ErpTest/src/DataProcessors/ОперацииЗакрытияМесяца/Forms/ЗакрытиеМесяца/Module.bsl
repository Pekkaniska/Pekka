...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РежимРаботы.ДоступностьВидовУчета.Вставить("РегламентированныйУчет",
		...
		//++ НЕ УТ
		ИЛИ ПравоДоступа("Использование", Метаданные.Обработки.ОтражениеДокументовВРеглУчете)
		//-- НЕ УТ
		);
	РежимРаботы.ДоступностьВидовУчета.Вставить("МеждународныйУчет",
		Ложь
		//++ НЕ УТКА
		ИЛИ ПравоДоступа("Использование", Метаданные.Обработки.ОтражениеДокументовВМеждународномУчете)
		//-- НЕ УТКА
		);
...
Процедура ОткрытьЗаданияКПогашениюСтоимостиТМЦ(Команда)
	...
	//++ НЕ УТ
	ОткрытьФорму(
		"РегистрСведений.ЗаданияКПогашениюСтоимостиТМЦВЭксплуатации.ФормаСписка",
		ПараметрыФормыРегистраЗаданий());
	//-- НЕ УТ
