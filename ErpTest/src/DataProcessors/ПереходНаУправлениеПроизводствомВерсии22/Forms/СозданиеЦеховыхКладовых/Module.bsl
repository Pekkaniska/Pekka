...
Процедура ЗаполнитьСхемыОбеспеченияПроизводства()
	...
	ШаблонЗапросаНастройкиПередачи1 = ПроизводствоСервер.ТекстЗапросаНастройкиПередачиМатериалов(
		"Таблица",
		,
	...
	ШаблонЗапросаНастройкиПередачи2 = ПроизводствоСервер.ТекстЗапросаНастройкиПередачиМатериалов(
		"Таблица",
		"Этап.Подразделение",
		Перечисления.ВариантыЗаполненияОбеспеченияПроизводства.ПоНастройкамПередачиВПроизводство);
