...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("КлючНазначенияФормы")
		...
		КлючНазначенияИспользования = Обработки.ЖурналДокументовНМА2_4.КлючНазначенияФормыПоУмолчанию2_2();
		КлючНастроек = "";
	Иначе
...
Процедура ВосстановитьНастройки()
	...
	Настройки = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("Обработка.ЖурналДокументовНМА2_4.Форма.ДокументыПоНМА2_2", КлючНазначенияИспользования);
...
Процедура СохранитьНастройки()
	...
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("Обработка.ЖурналДокументовНМА2_4.Форма.ДокументыПоНМА2_2", КлючНазначенияИспользования, Настройки);
...
Процедура ЗаполнитьРеквизитыФормыПриСоздании()
	...
	ТаблицаЗначенийДоступно = Обработки.ЖурналДокументовНМА2_4.ИнициализироватьХозяйственныеОперацииИДокументы2_2(
