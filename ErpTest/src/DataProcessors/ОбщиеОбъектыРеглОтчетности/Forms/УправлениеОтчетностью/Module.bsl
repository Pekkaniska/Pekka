...
Процедура ПоказатьСДвухмернымШтрихкодомPDF417(Команда)
	...
	Если Элементы.ЖурналОтчетов.ТекущиеДанные.НаименованиеОтчета = "Декларация по транспортному налогу (годовая)" Тогда
		ОписаниеТрНал = ОписаниеРегОтчета(Элементы.ЖурналОтчетов.ТекущаяСтрока);
