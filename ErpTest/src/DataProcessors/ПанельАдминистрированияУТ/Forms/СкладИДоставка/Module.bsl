...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаголовокОтключения = НСтр("ru = 'Перед отключением обособленного обеспечения, необходимо отключить учет затрат по всем направлениям деятельности.'");
	//++ НЕ УТКА
	ЗаголовокОтключения = НСтр("ru = 'Перед отключением обособленного обеспечения, необходимо отключить:
		|– использование собственного производства (раздел ""НСИ и администрирование"" — ""Производство"")
		|– использование производства из давальческого сырья (раздел ""НСИ и администрирование"" — ""Продажи"")'");
	Если ПолучитьФункциональнуюОпцию("ИспользоватьУчетЗатратПоНаправлениямДеятельности") Тогда
		ЗаголовокОтключения = НСтр("ru = 'Перед отключением обособленного обеспечения, необходимо отключить:
			|– использование собственного производства (раздел ""НСИ и администрирование"" — ""Производство"")
			|– использование производства из давальческого сырья (раздел ""НСИ и администрирование"" — ""Продажи""),
			|а также необходимо отключить учет затрат по всем направлениям деятельности.'");
	КонецЕсли;
	//-- НЕ УТКА
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "ФормированиеЗаказовПоПотребностям"
		...
		ВариантОбеспеченияРЦ = ?(НаборКонстант.ИспользоватьРасширенноеОбеспечениеПотребностей,
			НаборКонстант.ОптимизироватьЗапасыРаспределительногоЦентра, 2);
...
//++ НЕ УТКА
	ПодстановкаСпособы = НСтр("ru = 'покупка, перемещение, сборка, производство'");
//-- НЕ УТКА
