...
Функция СохранитьЗначениеРеквизита(РеквизитПутьКДанным, Результат)
	...
	//++ НЕ УТ
	Если РеквизитПутьКДанным = "РежимСписанияТоваровПоклажедателя" Тогда
			
			Если РежимСписанияТоваровПоклажедателя = 0 Тогда
				Константы.ПорядокОформленияВыкупаПриСписанииТоваров.Установить(Перечисления.НастройкиОформленияВыкупаПриСписанииТоваров.ПриПеремещении);
				НаборКонстант.ПорядокОформленияВыкупаПриСписанииТоваров = Перечисления.НастройкиОформленияВыкупаПриСписанииТоваров.ПриПеремещении;
			Иначе
				...
				НаборКонстант.ПорядокОформленияВыкупаПриСписанииТоваров = Перечисления.НастройкиОформленияВыкупаПриСписанииТоваров.ПриФактическомПотреблении;
			КонецЕсли;
			КонстантаИмя = "ПорядокОформленияВыкупаПриСписанииТоваров";
	КонецЕсли;
	//-- НЕ УТ
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ПорядокОформленияВыкупаПриСписанииТоваров"
	 ИЛИ РеквизитПутьКДанным = "РежимСписанияТоваровПоклажедателя"
	 ИЛИ РеквизитПутьКДанным = "" Тогда
		...
		Если ПолучитьФункциональнуюОпцию("УправлениеПредприятием") Тогда
			Если Константы.ПорядокОформленияВыкупаПриСписанииТоваров.Получить() = Перечисления.НастройкиОформленияВыкупаПриСписанииТоваров.ПриПеремещении Тогда
				РежимСписанияТоваровПоклажедателя = 0;
			Иначе
				РежимСписанияТоваровПоклажедателя = 1;
			КонецЕсли;
			
			НастройкаВыкупаДоступна = НаборКонстант.ИспользоватьОтветственноеХранениеВПроцессеЗакупки И НаборКонстант.ИспользоватьУправлениеПроизводством2_2;
			Элементы.СписаниеПриПередачеВПроизводство.Доступность = НастройкаВыкупаДоступна;
			Элементы.СписаниеПриРасходеНаВыпуск.Доступность = НастройкаВыкупаДоступна;
			
			Элементы.ГруппаОтветственноеХранениеВПроцессеЗакупкиПередачаВПроизводствоПредупреждение.Видимость = Не НаборКонстант.ИспользоватьУправлениеПроизводством2_2;
		Иначе
			Элементы.ГруппаОтветственноеХранениеВПроцессеЗакупкиПередачаВПроизводство.Видимость = Ложь;
		КонецЕсли;
