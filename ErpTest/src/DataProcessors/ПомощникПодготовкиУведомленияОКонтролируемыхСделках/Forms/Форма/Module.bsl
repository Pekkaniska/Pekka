...
Функция НастройкиФормыИзмененияРеквизитовДляТоваров(Заголовок, Уведомление)
	...
	Если Уведомление.ВерсияУведомления = Документы.УведомлениеОКонтролируемыхСделках.ВерсияУведомления_2012() Тогда
...
Функция НастройкиФормыИзмененияРеквизитовДляСоглашений(Заголовок)
	...
	СтруктураИзменяемогоРеквизита.Вставить("ОсновноеПредставлениеВВидеКодаИНаименования", Истина);
	СтруктураИзменяемогоРеквизита.Вставить("СписокВозможныхЗначенийРеквизита", КонтролируемыеСделкиПовтИсп.СписокКодовНаименованийСделки());
	...
	СтруктураИзменяемогоРеквизита.Вставить("ОсновноеПредставлениеВВидеКодаИНаименования", Истина);
	СтруктураИзменяемогоРеквизита.Вставить("СписокВозможныхЗначенийРеквизита", КонтролируемыеСделкиПовтИсп.КодыУсловийПоставки());
	ИзменяемыеРеквизиты.Вставить(СтруктураИзменяемогоРеквизита.ИмяРеквизита, СтруктураИзменяемогоРеквизита);
