...
Процедура ПриАктивизацииСтрокиИзменяемыхРеквизитовОбработчикОжидания()
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОтбор(СписокИзменяемыхОбъектовТекущегоУсловия.Отбор,
												ИзменяемыйРеквизит,
												ТекущиеДанныеТаблицы.Ссылка);
												
	ОтсутствиеДанных = ?(ТипЗнч(ТекущиеДанныеТаблицы.Ссылка) = Тип("Булево"),
						Не ТекущиеДанныеТаблицы.Ссылка, 
						Не ЗначениеЗаполнено(ТекущиеДанныеТаблицы.Ссылка));
	...
	Элементы.СписокИзменяемыхОбъектовТекущегоУсловияПодобрать.Видимость = ЗначениеЗаполнено(ПутьКОбработкеПодбора) И Не ОтсутствиеДанных;
	Элементы.СписокИзменяемыхОбъектовТекущегоУсловияУстановитьНовоеЗначение.Доступность = ТекущиеДанныеТаблицы.СуществуютЭлементыСДаннымРеквизитом;
