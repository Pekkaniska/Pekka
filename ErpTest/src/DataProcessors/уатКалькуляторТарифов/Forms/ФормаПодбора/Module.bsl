...
#Область ОбработчикиСобытийЭлементовТаблицыФормы_СписокТарифов
...
Процедура СписокТарифовВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если ЗапрашиватьКоличество Тогда
		ПоказатьВводЧисла(Новый ОписаниеОповещения("СписокТарифовВыборЗавершение", ЭтотОбъект, Новый Структура("ТекСтрока, Количество", ТекСтрока, Количество)), Количество, "Введите количество", 10, 2);
		Возврат;
	КонецЕсли;
