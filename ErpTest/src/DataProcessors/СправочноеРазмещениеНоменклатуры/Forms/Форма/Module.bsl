...
Процедура ЗаполнитьПоДокументуПриемкиСервер()
	...
	//++ НЕ УТКА
	ИначеЕсли ТипОбъекта = Тип("ДокументСсылка.ДвижениеПродукцииИМатериалов") Тогда
		
		РеквизитыДокументаПриемки = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Объект.ДокументПриемки, "Получатель,Дата");
		
		Объект.Дата  = РеквизитыДокументаПриемки.Дата;
		Объект.Склад = РеквизитыДокументаПриемки.Получатель;
		
		ИменаРеквизитовСклада =
		...
		РеквизитыСклада = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Объект.Склад, ИменаРеквизитовСклада);
		
		Если РеквизитыСклада.ИспользоватьОрдернуюСхемуПриПоступлении
				И Объект.Дата >= РеквизитыСклада.ДатаНачалаОрдернойСхемыПриПоступлении
			Или Не РеквизитыСклада.ИспользоватьАдресноеХранениеСправочно
			Или РеквизитыСклада.ИспользоватьАдресноеХранение
				И Объект.Дата >= РеквизитыСклада.ДатаНачалаАдресногоХраненияОстатков Тогда
	...
	ИначеЕсли ТипОбъекта = Тип("ДокументСсылка.ПриобретениеТоваровУслуг")
		//++ НЕ УТ
		Или ТипОбъекта = Тип("ДокументСсылка.ПриемкаТоваровНаХранение")
		//-- НЕ УТ
		Тогда
