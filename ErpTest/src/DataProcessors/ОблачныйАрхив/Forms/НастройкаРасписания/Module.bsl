...
Функция СформироватьРезультат()
	...
	Результат.Вставить("Еженедельно",
		Новый Структура("Время, ДниНедели",
			...
			ИнтернетПоддержкаПользователейКлиентСервер.ОтмеченныеЭлементыСпискаЗначений(ЭтотОбъект.Еженедельно_ДниНедели, Истина)));
	Результат.Вставить("Ежемесячно_ПоДням",
		Новый Структура("Время, ДниМесяца",
			...
			ИнтернетПоддержкаПользователейКлиентСервер.ОтмеченныеЭлементыСпискаЗначений(ЭтотОбъект.Ежемесячно_ПоДням_ДниМесяца, Истина)));
	Результат.Вставить("Ежемесячно_ПоДнямНедели",
		Новый Структура("Время, НомерНедели, ДниНедели",
			...
			ИнтернетПоддержкаПользователейКлиентСервер.ОтмеченныеЭлементыСпискаЗначений(ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели, Истина)));
