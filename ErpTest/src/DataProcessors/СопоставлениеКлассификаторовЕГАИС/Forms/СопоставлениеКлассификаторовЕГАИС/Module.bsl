...
Процедура ЗаполнитьТаблицыДляСопоставленияПоТТН()
	...
	Для Каждого СтрокаТЧ Из ТаблицаНеНайденных Цикл
		...
		НайденныйКонтрагент = ИнтеграцияЕГАИС.ЗначениеОпределяемогоТипаПоНаименованию("КонтрагентГИСМ", СтрокаТЧ.НаименованиеЕГАИС, Ложь);
		...
		Иначе
			...
			НайденныйКонтрагент = ИнтеграцияЕГАИС.ЗначениеОпределяемогоТипаПоНаименованию("КонтрагентГИСМ", УпрощенноеНаименование, Ложь);
...
Процедура ОбновитьЗаголовкиСтраниц()
	...
	СтруктураПоиска     = Новый Структура("Номенклатура", ИнтеграцияЕГАИС.ПустоеЗначениеОпределяемогоТипа("Номенклатура"));
