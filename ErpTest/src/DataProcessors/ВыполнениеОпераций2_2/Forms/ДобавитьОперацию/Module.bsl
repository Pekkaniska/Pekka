...
Функция ЗаписатьДанные(ТребуетсяРучноеЗаполнение = Ложь)
	...
	ОперацияОбъект.Заполнить(ЗначенияЗаполненияНовойОперации());
...
Процедура ЗаполнитьРеквизитыФормыПоДаннымОперации()
	...
	ДанныеОперации = РегистрыСведений.ОчередьПроизводственныхОпераций.ДанныеОперацииИзОчереди(Параметры.КлючОперации);
