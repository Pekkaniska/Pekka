...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Отбор") И ТипЗнч(Параметры.Отбор) = Тип("Структура")
		...
		УстановитьПараметрыФункциональныхОпцийФормы(Новый Структура("Период, Организация", Дата, ВыбраннаяОрганизация));
	Иначе
...
Процедура УстановитьОтборПоОрганизации()
	...
	УстановитьПараметрыФункциональныхОпцийФормы(Новый Структура("Организация", ВыбраннаяОрганизация));
...
Процедура УстановитьДоступностьПриОткрытииФормы()
	...
	НеИзменятьПроводки = Не РеглУчетПроведениеСервер.ДокументОтражаетсяВРеглУчете(Документ, ДатаОтражения);
...
Функция ПараметрыОтраженияДокументаВРеглУчете()
	...
	ПараметрыОтражения.Вставить("Организация", ВыбраннаяОрганизация);
...
Процедура ОбновитьДанныеРеквизитовДокумента()
	...
	Если Не Документ.Пустая() Тогда
		...
		Если Не ЗначенияРеквизитов.Свойство("ОрганизацияПолучатель") Или Не ЗначениеЗаполнено(ОрганизацияПолучатель) Тогда
