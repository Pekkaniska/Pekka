...
Функция СвойстваНачисленийПоКатегориям() Экспорт
	...
	ДоступныеОбозначенияВТабелеУчетаРабочегоВремени.Добавить(ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.ОсновнойОтпуск"));
	ДоступныеОбозначенияВТабелеУчетаРабочегоВремени.Добавить(ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.ДополнительныйОтпуск"));
	ДоступныеОбозначенияВТабелеУчетаРабочегоВремени.Добавить(ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыИспользованияРабочегоВремени.ОтпускНаОбучение"));
	...
	Для Каждого КлючИЗначение Из КоллекторНачислений Цикл
		...
		Если ОтборВедущих <> Неопределено Тогда
			...
			Если РасчетЗарплатыРасширенный.НачислениеРассчитываетсяПоЧасам(НачислениеОбъект) 
				...
				// ..Дополняются по условию из базы данных.
				ОбщегоНазначенияКлиентСервер.ДополнитьМассив(
					ВедущиеНачисления, НачисленияПоОтбору(ОтборВедущих, "РеквизитДопУпорядочивания"), Истина);
				// Заполняем табличную часть полученными вытесняющими начислениями.
...
//       По умолчанию Ложь, в этом случае значение реквизита заполняется когда реквизит пустой, либо при изменении параметров выбора.
//       Если передать значение Истина, то значение реквизита будет заполнено только если реквизит пустой.
...
Процедура ЗаполнитьВытесняемыеВидыРасчетовДляОтпусков() Экспорт 
	...
	Отпуска = НачисленияПоКатегории(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаОтпуска);
...
Функция ИмяСобытияПодборНачислений()
	Возврат НСтр("ru = 'Подбор начислений'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
КонецФункции
...
Функция ВариантыПодбораНачисленийВДокументах()
	...
	Описание.ФиксированныеОтборы.ВидОтпуска = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыОтпусков.Основной");
