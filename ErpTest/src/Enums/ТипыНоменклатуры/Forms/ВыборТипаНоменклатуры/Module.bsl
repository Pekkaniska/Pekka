...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИспользуютсяОсобенностиУчетаНоменклатуры = Перечисления.ТипыНоменклатуры.ВключеныФООсобенностейУчетаНоменклатуры();
	
	Элементы.ОсобенностьУчетаБезОсобенностейУчета.Видимость         = ИспользуютсяОсобенностиУчетаНоменклатуры;
	...
	Элементы.ОсобенностьУчетаПодконтрольнаяПродукцияВЕТИС.Видимость = ПолучитьФункциональнуюОпцию("ВестиУчетПодконтрольныхТоваровВЕТИС");
	Элементы.ОсобенностьУчетаОрганизациейПродавцом.Видимость        = ИспользоватьПродажуАгентскихУслуг;
	Элементы.ОсобенностьУчетаОрганизациейПоАгентскойСхеме.Видимость = ИспользоватьПродажуАгентскихУслуг
																		И ИспользоватьНесколькоОрганизаций;
	Элементы.ОсобенностьУчетаПартнером.Видимость                    = ИспользоватьПродажуАгентскихУслуг;
	
	Элементы.ДекорацияОсобенностиТовараОтступ.Видимость = ИспользуютсяОсобенностиУчетаНоменклатуры;
	Элементы.ДекорацияОсобенностиУслугиОтступ.Видимость = ИспользоватьПродажуАгентскихУслуг;
	...
	СуффиксыИменЭлементов.Добавить("ОрганизациейПродавцом");
	СуффиксыИменЭлементов.Добавить("ОрганизациейПоАгентскойСхеме");
	СуффиксыИменЭлементов.Добавить("Партнером");
