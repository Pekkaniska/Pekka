...
//
// Параметры:
//	ИсточникДанных - Строка - Имя источника данных.
//	Характеристика - Строка - Имя характеристики (показателя) источника данных.
//
// Возвращаемое значение:
//	Строка - Имя СКД.
//
...
// Добавляет отбор по контрагентам.
//
// Параметры:
...
// Выполняет группировку однотипных показателей для сокращения количества выполняемых запросов.
//
// Параметры:
//	Показатели - ТаблицаЗначений - См. ЗаполнениеФормСтатистики.НовыйОписаниеПоказателей().
//
...
// Возвращает имя настроек расшифровки.
//
// Параметры:
//	ИсточникДанных - ПеречислениеСсылка.ИсточникиДанныхСтатистическихПоказателей - Источник данных.
//	РазделИсточникаДанных - Строка - Раздел источник данных.
//	Характеристика - Строка - Название характеристики.
//
// Возвращаемое значение:
//	Строка - Имя настроек расшифровки.
//
Функция ИмяНастроекРасшифровки(ИсточникДанных, РазделИсточникаДанных = "", Характеристика = "") Экспорт
	...
	ИначеЕсли ИмяСхемы = "ПроизводствоИПродажи" Тогда
		...
		Если Характеристика =    "ОстатокВЕдиницахСтатистическогоУчета"
			...
			ИЛИ Характеристика = "ОбъемРеализацииВключаяНДСВЕдиницахСтатистическогоУчета" Тогда
