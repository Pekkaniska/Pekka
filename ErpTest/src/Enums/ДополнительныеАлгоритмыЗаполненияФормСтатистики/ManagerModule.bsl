...
// Выполняет действия перед удалением неиспользуемых показателей.
//
// Параметры:
...
// Выполняет подготовительные действия до расчета показателей.
//
// Параметры:
//	Показатели - ТаблицаЗначений - см. ЗаполнениеФормСтатистики.НовыйОписаниеПоказателей().
//	ТаблицаРасшифровки - ТаблицаЗначений - Таблица расшифровки показателей.
//
Процедура ПрименитьДоРасчетаПоказателей(Показатели, ТаблицаРасшифровки) Экспорт
	...
	Для Каждого Формула Из Формулы Цикл
		...
		ЗаполнениеФормСтатистикиПереопределяемый.ЧисленностьПерсонала(Показатели, Формула);
...
// Выполняет завершающие действия после расчета показателей.
//
// Параметры:
//	Показатели - ТаблицаЗначений - см. ЗаполнениеФормСтатистики.НовыйОписаниеПоказателей().
//	ТаблицаРасшифровки - ТаблицаЗначений - Таблица расшифровки показателей.
...
// Возвращает ключевые поля для алгоритма.
//
// Параметры:
//	Алгоритм - ПеречислениеСсылка.ДополнительныеАлгоритмыЗаполненияФормСтатистики - Требуемый алгоритм.
//
// Возвращаемое значение:
//	Строка - Имена ключевых полей через запятую.
//
