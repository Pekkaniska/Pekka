...
Процедура КомандаВыполнить(Команда)
	...
	ПоказатьВопрос(Новый ОписаниеОповещения("КомандаВыполнитьЗавершение", ЭтотОбъект), НСтр("ru = 'Действие необратимо. Продолжить??'"),РежимДиалогаВопрос.ДаНет,,КодВозвратаДиалога.Да);
