...
Функция РазрешеноПеретаскивание(СтрокаДерева, РодительПриемник)
	...
	Если Не ЗначениеЗаполнено(ВидПеретаскиваемогоЭлемента)
		ИЛИ НЕ МожноДобавитьВСтруктуруОтчета(ВидПеретаскиваемогоЭлемента, РодительПриемник, ЭтоСвязанный) Тогда
		Возврат Ложь;
	КонецЕсли;
...
Процедура ЗаполнитьДанныеНовогоЭлемента(НоваяСтрока, ДанныеЭлемента)
	...
	ИначеЕсли ВидЭлемента = ВидЭлемента("ИтогПоГруппе") Тогда
		...
		КонецЕсли;
		Если ТекущаяГруппа <> Неопределено Тогда
			НаименованиеДляПечати = НСтр("ru = 'Итого'") + " " + НРег(ТекущаяГруппа.НаименованиеДляПечати);
...
Процедура УстановитьУсловноеОформление()
	...
	ОформитьПредставлениеТипИтога(ТипыИтогов.Сальдо,	НСтр("ru = 'Начальное сальдо'"), Истина);
	ОформитьПредставлениеТипИтога(ТипыИтогов.СальдоДт,	НСтр("ru = 'Начальное сальдо Дт'"), Истина);
	ОформитьПредставлениеТипИтога(ТипыИтогов.СальдоКт,	НСтр("ru = 'Начальное сальдо Кт'"), Истина);
	ОформитьПредставлениеТипИтога(ТипыИтогов.Сальдо,	НСтр("ru = 'Конечное сальдо'"), Ложь);
	ОформитьПредставлениеТипИтога(ТипыИтогов.СальдоДт,	НСтр("ru = 'Конечное сальдо Дт'"), Ложь);
	ОформитьПредставлениеТипИтога(ТипыИтогов.СальдоКт,	НСтр("ru = 'Конечное сальдо Кт'"), Ложь);
