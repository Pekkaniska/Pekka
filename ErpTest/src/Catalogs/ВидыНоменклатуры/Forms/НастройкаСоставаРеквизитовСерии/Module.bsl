...
Процедура ОК(Команда)
	...
	Если АвтоматическиГенерироватьСерии Тогда
		...
		Если Не ИспользоватьДатуПроизводстваСерии
			...
			ТекстСообщения = НСтр("ru = 'Автоматическая генарация серий возможна по реквизитам: ""Дата производства"", ""%Производитель%"", ""%ОсобенностьУчета%"". Включите использование одного из этих реквизитов.'");
