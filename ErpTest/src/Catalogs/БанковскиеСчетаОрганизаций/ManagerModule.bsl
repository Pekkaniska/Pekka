...
Функция НастройкиПолейФормы() Экспорт
	...
	Элемент.Поля.Добавить("ОтдельныйСчетГОЗ");
	Элемент.Поля.Добавить("ГосударственныйКонтракт");
	Элемент.Поля.Добавить("РазрешитьПлатежиБезУказанияЗаявок");
...
Функция ВременнаяТаблицаДанныхПоСуществующимОперациям(ПараметрыАнализатора)
	...
	|	ДанныеРегистра.БанковскийСчет КАК БанковскийСчет
...
Функция ВременнаяТаблицаДвиженийСоСчетами(ВременнаяТаблицаДвижений)
	...
	|	ТаблицаДвижений.БанковскийСчет КАК БанковскийСчет,
	|
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.БанковскиеСчетаОрганизаций КАК АналитикаУчета
	|		ПО ТаблицаДвижений.БанковскийСчет = АналитикаУчета.Ссылка";
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ОбновлениеИнформационнойБазыУТ.ЗаполнитьПустойРеквизитЗначениемПоУмолчаниюЗарегистрироватьДанныеКОбработке(
		Параметры, "Справочник.БанковскиеСчетаОрганизаций", "ТипСчета");
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ОбновлениеИнформационнойБазыУТ.ЗаполнитьПустойРеквизитЗначениемПоУмолчанию(
		Параметры, "Справочник.БанковскиеСчетаОрганизаций", "ТипСчета", Перечисления.ТипыБанковскихСчетов.Расчетный);
...
// Выполняет анализ всех неотраженных операций по безналичным денежным средствам,
...
Процедура ЗаполнитьРегистрТребующихНастройкиНаОснованииАнализаНеотраженныхОпераций(ПараметрыАнализатора) Экспорт
	...
	|	ТаблицаДвиженийСоСчетами.БанковскийСчет КАК АналитикаУчета,
	...
	ИмяСобытия = НСтр("ru = 'Анализ отражения безналичных денежных средств, требующих настройки'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
