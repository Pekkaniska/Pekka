...
Процедура ЗаполнитьДанныеХозяйствующегоСубъекта(ДанныеХозяйствующегоСубъекта)
	...
	Контрагент = ИнтеграцияВЕТИСПереопределяемый.КонтрагентПоИННКПП(ИНН, КПП);
...
Процедура КонтрагентСоздание(Элемент, СтандартнаяОбработка)
	...
	ДанныеКонтрагента.Вставить("СокращенноеНаименование", НаименованиеПолное);
	ДанныеКонтрагента.Вставить("ИНН",                     ИНН);
	ДанныеКонтрагента.Вставить("КПП",                     КПП);
	ДанныеКонтрагента.Вставить("ЮридическийАдрес",        ПредставлениеАдреса);
