...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		...
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеПриСозданииНаСервере(ЭтаФорма);
	КонецЕсли;
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда") Тогда
		...
		МодульОхранаТрудаФормы.ПроверитьЗаполнениеПозицииШтатногоРасписания(ЭтотОбъект, ПроверяемыеРеквизиты, Отказ);
	КонецЕсли;
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ХарактеристикиПерсонала") Тогда
		...
		МодульХарактеристикиПерсоналаФормы.ПроверитьЗаполнениеПозицииШтатногоРасписания(ЭтаФорма, Отказ, ПроверяемыеРеквизиты);
	КонецЕсли;
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеОбработкаПроверкиЗаполненияНаСервере(ЭтаФорма, Отказ, ПроверяемыеРеквизиты);
	КонецЕсли;
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеПередЗаписьюНаСервере(ЭтаФорма, Отказ, ТекущийОбъект, ПараметрыЗаписи);
	КонецЕсли;
...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеПриЗаписиНаСервере(ЭтаФорма, Отказ, ТекущийОбъект, ПараметрыЗаписи);
	КонецЕсли;
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеПослеЗаписиНаСервере(ЭтаФорма, ТекущийОбъект, ПараметрыЗаписи);
	КонецЕсли;
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	Оповестить("Запись_ПозицияШтатногоРасписания", Объект.Ссылка, ВладелецФормы);
КонецПроцедуры
...
Процедура ДополнитьФорму()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеПриДополненииФормы(ЭтаФорма);
	КонецЕсли;
...
Процедура ПоместитьДанныеОбъектаВФорму(ТекущийОбъект, ЗначениеКопирования = Неопределено)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеПриЧтенииНаСервере(ЭтаФорма, ТекущийОбъект);
	КонецЕсли;
...
#Область Подключаемый_МедицинскиеОсмотры

&НаКлиенте
Процедура Подключаемый_МедицинскиеОсмотрыШтатноеРасписаниеЭлементФормыПриИзменении(Элемент)
	
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда") Тогда
		МодульМедицинскиеОсмотрыФормыКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("МедицинскиеОсмотрыФормыКлиент");
		МодульМедицинскиеОсмотрыФормыКлиент.ШтатноеРасписаниеЭлементПриИзменении(ЭтаФорма, Элемент);
	КонецЕсли
	
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_МедицинскиеОсмотрыШтатноеРасписаниеЭлементФормыПриОкончанииРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования)
	
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда") Тогда
		МодульМедицинскиеОсмотрыФормыКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("МедицинскиеОсмотрыФормыКлиент");
		МодульМедицинскиеОсмотрыФормыКлиент.ШтатноеРасписаниеЭлементПриОкончанииРедактирования(ЭтаФорма, Элемент, НоваяСтрока, ОтменаРедактирования);
	КонецЕсли
	
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_МедицинскиеОсмотрыШтатноеРасписаниеЭлементФормыПослеУдаления(Элемент)
	
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда") Тогда
		МодульМедицинскиеОсмотрыФормыКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("МедицинскиеОсмотрыФормыКлиент");
		МодульМедицинскиеОсмотрыФормыКлиент.ШтатноеРасписаниеЭлементПослеУдаления(ЭтаФорма, Элемент);
	КонецЕсли
	
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_МедицинскиеОсмотрыШтатноеРасписаниеЭлементФормыПриОкончанииРедактированияЗавершение(ИмяЭлемента, ДополнительныеПараметры = Неопределено) Экспорт
	
	МедицинскиеОсмотрыЭлементФормыПриОкончанииРедактированияНаСервере(ИмяЭлемента, ДополнительныеПараметры);
	
КонецПроцедуры

&НаСервере
Процедура МедицинскиеОсмотрыЭлементФормыПриОкончанииРедактированияНаСервере(ИмяЭлемента, ДополнительныеПараметры)
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеЭлементПриОкончанииРедактирования(ЭтаФорма, ИмяЭлемента, ДополнительныеПараметры);
	КонецЕсли
	
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_МедицинскиеОсмотрыШтатноеРасписаниеЭлементФормыПослеУдаленияЗавершение(ИмяЭлемента, ДополнительныеПараметры = Неопределено) Экспорт
	
	МедицинскиеОсмотрыЭлементФормыПослеУдаленияНаСервере(ИмяЭлемента, ДополнительныеПараметры);
	
КонецПроцедуры

&НаСервере
Процедура МедицинскиеОсмотрыЭлементФормыПослеУдаленияНаСервере(ИмяЭлемента, ДополнительныеПараметры)
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеЭлементПослеУдаления(ЭтаФорма, ИмяЭлемента, ДополнительныеПараметры);
	КонецЕсли
...
Процедура Подключаемый_ОбработчикКоманды(Команда)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда") Тогда
		МодульМедицинскиеОсмотрыФормыКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("МедицинскиеОсмотрыФормыКлиент");
		МодульМедицинскиеОсмотрыФормыКлиент.ШтатноеРасписаниеПриВыполненииКоманды(ЭтаФорма, Команда);
	КонецЕсли
	
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_ОбработчикКомандыЗавершение(Результат, ДополнительныеПараметры) Экспорт
	МедицинскиеОсмотрыОбработкаКомандыНаСервере(Результат, ДополнительныеПараметры);	
КонецПроцедуры

&НаСервере
Процедура МедицинскиеОсмотрыОбработкаКомандыНаСервере(Результат, ДополнительныеПараметры)
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
		МодульМедицинскиеОсмотрыФормы = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотрыФормы");
		МодульМедицинскиеОсмотрыФормы.ШтатноеРасписаниеПриВыполненииКоманды(ЭтаФорма, Результат, ДополнительныеПараметры);
	КонецЕсли
