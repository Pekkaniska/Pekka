...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьВидимостьСкидокНаценокСервер();
...
Процедура ХозяйственнаяОперацияПриИзменении(Элемент)
	...
	УстановитьВидимостьСкидокНаценокПоВидуХозОперации(ЭтотОбъект);
...
&НаСервере
Процедура УстановитьВидимостьСкидокНаценокСервер()
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьВидимостьСкидокНаценокПоВидуХозОперации(Форма)
	
	Если Форма.Объект.ХозяйственнаяОперация = ПеречислениеПередачаНаКомиссию() Тогда
		Форма.Элементы.ГруппаСкидкиНаценки.Видимость = Ложь;
	Иначе
		Форма.Элементы.ГруппаСкидкиНаценки.Видимость = Истина;
	КонецЕсли;
