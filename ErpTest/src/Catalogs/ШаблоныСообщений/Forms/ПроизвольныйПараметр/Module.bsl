...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначенияКлиентСервер.ЭтоМобильныйКлиент() Тогда // Временное решение для работы в мобильном клиенте, будет удалено в следующих версиях
		...
		Элементы.Переместить(Элементы.ГруппаКоманднаяПанельФормы, Элементы.ФормаКоманднаяПанель);
		
		Элементы.ГруппаКоманднаяПанельФормы.Вид = ВидГруппыФормы.ГруппаКнопок;
