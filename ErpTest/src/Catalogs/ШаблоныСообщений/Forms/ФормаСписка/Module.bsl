...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначенияКлиентСервер.ЭтоМобильныйКлиент() Тогда // Временное решение для работы в мобильном клиенте, будет удалено в следующих версиях
		...
		Элементы.Переместить(Элементы.ГруппаКоманднаяПанельСписка, Элементы.ФормаКоманднаяПанель);
		Элементы.ГруппаКоманднаяПанельСписка.Вид = ВидГруппыФормы.ГруппаКнопок;
		
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаГруппаСоздать", "Картинка", БиблиотекаКартинок.СоздатьЭлементСписка);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаГруппаСоздать", "Отображение", ОтображениеКнопки.Картинка);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаГруппаСоздать", "Заголовок", НСтр("ru ='Создать'"));
		
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаСоздатьШаблонЭлектронногоПисьма", "ТолькоВоВсехДействиях", Ложь);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаСоздатьШаблонСообщенияSMS", "ТолькоВоВсехДействиях", Ложь);
...
Процедура СоздатьШаблонЭлектронногоПисьма(Команда)
	...
	ПараметрыФормы.Вставить("ВидСообщения", "ЭлектронноеПисьмо");
