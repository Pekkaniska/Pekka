...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если ТипЗнч(ВыбраннаяСтрока) = Тип("СтрокаГруппировкиДинамическогоСписка")
		И ВыбраннаяСтрока.ИмяГруппировки = "КассоваяКнига" Тогда
...
Процедура СписокПередНачаломИзменения(Элемент, Отказ)
	...
	Если ТипЗнч(Элемент.ТекущаяСтрока) = Тип("СтрокаГруппировкиДинамическогоСписка")
		И Элемент.ТекущаяСтрока.ИмяГруппировки = "КассоваяКнига" Тогда
		Отказ = Истина;
		ПоказатьЗначение(, Элемент.ТекущаяСтрока.Ключ);
	КонецЕсли;
