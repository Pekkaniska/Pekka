...
//                           Периодичность - Перечисление.Периодичность - массив предопределенных интервалов.
//
// Возвращаемое значение:
//   ТаблицаЗначений - в таблице содержатся конкретные даты из переданного периода для предопределенных интервалов год,
...
Функция ИнтервалыОтчета(ПериодОтчета) Экспорт
	...
	КвантПериода = БюджетнаяОтчетностьКлиентСервер.МинимальнаяПериодичность(Периодичность);
...
// Проверяет наличие ссылок в отчетах на переданный элемент отчета.
//
// Параметры:
//  ЭлементОтчета - Справочник.ЭлементыФинансовыхОтчетов - текущий элемент отчета.
//
// Возвращаемое значение:
//   Число - количество отчетов в которых использован текущий элемент отчета.
//
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	"ВЫБРАТЬ 
		...
		|ИЗ
		|	Справочник.ЭлементыФинансовыхОтчетов КАК Таблица
		|ГДЕ
		|	Таблица.ЗначениеАналитики В (&ПустыеЗначенияДляОбработки)
		|	И Таблица.Владелец ССЫЛКА Справочник.ВидыБюджетов";
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ПолноеИмяМетаданных = "Справочник.ЭлементыФинансовыхОтчетов";
	МетаданныеОбъекта = Метаданные.Справочники.ЭлементыФинансовыхОтчетов;
	
	ПустыеЗначенияДляОбработки = БюджетированиеВызовСервера.ЗаменяемыеПустыеЗначенияАналитики();
	ЗначениеЗамены = БюджетированиеКлиентСервер.ПустоеЗначениеАналитики();
	
	РеквизитыПоиска = Новый Массив;
	РеквизитыПоиска.Добавить("ЗначениеАналитики");
