...
&НаКлиенте
Процедура ПриОткрытии(Отказ) //Рарус
	
	Если ЭтотОбъект.ВладелецФормы <> Неопределено И ЭтотОбъект.ВладелецФормы.Имя = "пкОсновнойДоговорСПоставщиком" Тогда
		
		Отбор = ЭтотОбъект.Список.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
		Отбор.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("ДополнительныеРеквизиты.Значение");
		Отбор.ВидСравнения = ВидСравненияКомпоновкиДанных.Равно;
		Отбор.Использование = Истина;
		Отбор.РежимОтображения = РежимОтображенияЭлементаНастройкиКомпоновкиДанных.Недоступный;
		Отбор.ПравоеЗначение = Истина;	
		ЭтотОбъект.Элементы.ЕстьОсновнойДоговорСПоставщиком.Доступность = Ложь;
		ЭтотОбъект.Элементы.ЕстьОсновнойДоговорСПоставщиком.Видимость = Ложь;
	КонецЕсли;             
