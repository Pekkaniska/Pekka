...
Процедура ЗаполнитьТекстЗапросаДинамическогоСписка(СтруктураДоступныеКонтексты)
	...
	Если Параметры.Свойство("Отбор")
		...
		|ГДЕ
		|	" + ВнеоборотныеАктивыЛокализация.УсловияОтбораПоВидуНалога("ТаблицаСправочника");
		...
		АвтоЗаголовок = Ложь;
		Заголовок = ВнеоборотныеАктивыЛокализация.ЗаголовокФормыВыбораОСПоВидуНалога(
	...
	Если Не СтруктураДоступныеКонтексты.Свойство("БУ") Тогда
		...
		|	ЗНАЧЕНИЕ(Перечисление.ГруппыОС.ПустаяСсылка) КАК БУГруппаОС,
	...
	Иначе
		...
		|	ТаблицаСправочника.АмортизационнаяГруппа КАК БУАмортизационнаяГруппа";
