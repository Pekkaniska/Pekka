...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ЭтапыПроизводстваВидыРабочихЦентров.Ссылка КАК Ссылка
	|ИЗ
	|	Справочник.ЭтапыПроизводства.ВидыРабочихЦентров КАК ЭтапыПроизводстваВидыРабочихЦентров
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ЭтапыПроизводства.ОтборПоСвойствам КАК ЭтапыПроизводстваОтборПоСвойствам
	|		ПО ЭтапыПроизводстваВидыРабочихЦентров.Ссылка = ЭтапыПроизводстваОтборПоСвойствам.Ссылка
	|			И ЭтапыПроизводстваВидыРабочихЦентров.УдалитьОтборСвойство = ЭтапыПроизводстваОтборПоСвойствам.Свойство
	|			И ЭтапыПроизводстваВидыРабочихЦентров.КлючСвязи = ЭтапыПроизводстваОтборПоСвойствам.КлючСвязи
	|ГДЕ
	|	ЭтапыПроизводстваВидыРабочихЦентров.УдалитьОтборСвойство <> ЗНАЧЕНИЕ(ПланВидовХарактеристик.ДополнительныеРеквизитыИСведения.ПустаяСсылка)
	|	И ЭтапыПроизводстваОтборПоСвойствам.Свойство ЕСТЬ NULL
	|
	|ОБЪЕДИНИТЬ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ЭтапыПроизводства.ОтборПоСвойствам КАК ЭтапыПроизводстваОтборПоСвойствам
	|		ПО ЭтапыПроизводстваАльтернативныеВидыРабочихЦентров.Ссылка = ЭтапыПроизводстваОтборПоСвойствам.Ссылка
	|			И ЭтапыПроизводстваАльтернативныеВидыРабочихЦентров.УдалитьОтборСвойство = ЭтапыПроизводстваОтборПоСвойствам.Свойство
	|			И ЭтапыПроизводстваАльтернативныеВидыРабочихЦентров.КлючСвязи = ЭтапыПроизводстваОтборПоСвойствам.КлючСвязи
	|ГДЕ
	|	(ЭтапыПроизводстваАльтернативныеВидыРабочихЦентров.УдалитьОтборСвойство <> ЗНАЧЕНИЕ(ПланВидовХарактеристик.ДополнительныеРеквизитыИСведения.ПустаяСсылка)
	|				И ЭтапыПроизводстваОтборПоСвойствам.Свойство ЕСТЬ NULL
	|			ИЛИ ЭтапыПроизводстваАльтернативныеВидыРабочихЦентров.КлючСвязи = &ПустойКлючСвязи)
	|
	|");
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			Если СправочникОбъект.ПланироватьРаботуВидовРабочихЦентров = Истина
				И СправочникОбъект.ПорядокРаботыВидовРабочихЦентров.Пустая()
			...
			Для каждого ТабличнаяЧасть Из СтрРазделить("ВидыРабочихЦентров,АльтернативныеВидыРабочихЦентров",",") Цикл
				Для каждого Строка Из СправочникОбъект[ТабличнаяЧасть] Цикл
					...
					Если ЗначениеЗаполнено(Строка.УдалитьОтборСвойство)
