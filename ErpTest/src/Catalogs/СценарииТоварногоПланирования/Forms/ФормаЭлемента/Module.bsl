...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	//++ НЕ УТ
	Если СтруктураРеквизитов.Свойство("ИспользоватьВПланированииПроизводства")
		ИЛИ Инициализация Тогда
		
		Элементы.ИспользоватьДляПланированияМатериалов.Доступность = Объект.ИспользоватьВПланированииПроизводства;
		Элементы.ИспользоватьДляЗаказовНаПроизводство.Доступность = Объект.ИспользоватьВПланированииПроизводства;
		Элементы.ИспользоватьДляЗаказовНаВнутреннееПотребление.Доступность = Объект.ИспользоватьВПланированииПроизводства;
		Элементы.НадписьВидыПлановПроизводства.Доступность = Объект.ИспользоватьВПланированииПроизводства;
...
Процедура ОбновитьНадписиВидовПланов()
	...
	//++ НЕ УТ
	ВидыПланов.Вставить("ПланПроизводства", 
		Новый Структура("Количество, Ссылка, ТипПлана", 0, Неопределено, Перечисления.ТипыПланов.ПланПроизводства));
	//-- НЕ УТ
	...
	Если ЗначениеЗаполнено(Объект.Ссылка) Тогда
		...
		//++ НЕ УТ
		ТипыПланов.Вставить(Перечисления.ТипыПланов.ПланПроизводства, "ПланПроизводства");
		//-- НЕ УТ
	...
	//++ НЕ УТ
	ОбновитьНадписьВидовПланов(ВидыПланов, "ПланПроизводства", НадписьВидыПлановПроизводства);
	//-- НЕ УТ
