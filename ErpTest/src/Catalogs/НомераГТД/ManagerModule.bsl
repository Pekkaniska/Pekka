...
//
// Возвращаемое значение:
//    Регистрационный номер - Структура -
//      * РегистрационныйНомер - регистрационный номер таможенной декларации либо пустая строка, 
//                                     если его не удалось определить.
//      * ПорядковыйНомерТовара - порядковый номер товара из графы 32 ДТ
