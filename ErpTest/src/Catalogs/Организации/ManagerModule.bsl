...
//Рарус Владимир Подрезов 18.01.2017
	|	Организации.пкНаименованиеПолное КАК пкНаименованиеПолное,
...
//		Наименование = ?(Не ПустаяСтрока(Выборка.НаименованиеСокращенное), Выборка.НаименованиеСокращенное, Выборка.Наименование);
		Представление = ?(Не ПустаяСтрока(Выборка.пкНаименованиеПолное), Выборка.пкНаименованиеПолное, ?(Не ПустаяСтрока(Выборка.НаименованиеСокращенное), Выборка.НаименованиеСокращенное, Выборка.Наименование));
		Наименование = ?(Не ПустаяСтрока(Выборка.пкНаименованиеПолное), Выборка.пкНаименованиеПолное, ?(Не ПустаяСтрока(Выборка.НаименованиеСокращенное), Выборка.НаименованиеСокращенное, Выборка.Наименование));
//Рарус Владимир Подрезов Конец
...
//
Функция НалогообложениеНДС(Организация = Неопределено, Склад = Неопределено, Дата = Неопределено) Экспорт
