...
//rarus+ saveld 21.11.2016 В некоторых ситуациях возвращаемая из ДО структура не соответствует ожидаемой. В этом случае не обрабатываем заполнение.				
					Попытка
//rarus- saveld 21.11.2016					
