...
Функция ЗаполнитьСтруктуруСочетаний(Элемент, ЭтоAlt, ЭтоCtrl, ЭтоShift)

	СтруктураВозврата = Новый Структура;
	СтруктураВозврата.Вставить("Элемент", Элемент);
...
Функция ПредставлениеСочетанияКлавиш(НоваяСтрока, Данные, Имя, Сочетание)
	...
	НайденныеСтроки = Данные.КомандыФормы.НайтиСтроки(ЗаполнитьСтруктуруСочетаний(Строка(Сочетание.Клавиша), Сочетание.Alt, Сочетание.Ctrl, Сочетание.Shift));
	Если НайденныеСтроки.Количество() > 0 Тогда
		НоваяСтрока[Имя+"_"] = НайденныеСтроки[0].Заголовок;
	КонецЕсли;
	
	НайденныеСтроки = Данные.БыстрыеТовары.НайтиСтроки(ЗаполнитьСтруктуруСочетаний(Строка(Сочетание.Клавиша), Сочетание.Alt, Сочетание.Ctrl, Сочетание.Shift));
	Если НайденныеСтроки.Количество() > 0 Тогда
		НоваяСтрока[Имя+"_"] = НайденныеСтроки[0].Заголовок;
	КонецЕсли;
