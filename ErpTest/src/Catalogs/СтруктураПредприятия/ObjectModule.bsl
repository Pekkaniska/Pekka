...
Процедура ПередЗаписью(Отказ)
	...
	Иначе
		...
		Реквизиты.Вставить("ПометкаУдаления", "ПометкаУдаления");
		//++ НЕ УТ
		...
		ПометкаУдаленияДоЗаписи = РеквизитыДоЗаписи.ПометкаУдаления;
	...
	ДополнительныеСвойства.Вставить("ПометкаУдаленияДоЗаписи", ПометкаУдаленияДоЗаписи);
...
Процедура ПриЗаписи(Отказ)
	...
	Если ДополнительныеСвойства.РассчитатьДлительностьПроизводства Тогда
		...
		УправлениеДаннымиОбИзделиях.РассчитатьДлительностьПроизводства(Ссылка,, Отказ);
