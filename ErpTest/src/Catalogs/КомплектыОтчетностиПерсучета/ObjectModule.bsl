...
Процедура ПоместитьОписанияФайловКомплектаВМассив(МассивОписанийФайловВыгрузки, УникальныйИдентификатор) Экспорт
	...
	Для Каждого Файл Из ДополнительныеФайлы Цикл
		ДанныеФайлаДокумента = РаботаСФайлами.ДанныеФайла(Файл, УникальныйИдентификатор, Истина);
...
Процедура ПроверитьДанныеРСВЗа2012(ДанныеРСВ, Ошибки, Отказ = Ложь)
	...
	ОбщийНалоговыйРежим = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ОбщийНалоговыйРежим");
	УпрощенныйНалоговыйРежим = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.УпрощенныйНалоговыйРежим");
	ЕНВД = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.ЕНВД");
