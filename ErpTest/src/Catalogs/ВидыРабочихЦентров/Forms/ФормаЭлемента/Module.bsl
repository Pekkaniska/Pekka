...
Процедура УправлениеВидимостью(Форма)
	...
	ПоказыватьПараметрыГрафика = Форма.ИспользуетсяПроизводство21 ИЛИ Форма.ПланируетсяГрафикПроизводства;
	
	Форма.Элементы.ГруппаПланироватьРаботу.Видимость = Объект.ПланироватьРаботу
		И ПоказыватьПараметрыГрафика;
	
	Форма.Элементы.ПланироватьРаботуРабочихЦентров.Видимость = ПоказыватьПараметрыГрафика;
	
	Форма.Элементы.ГруппаПланироватьРаботуРабочихЦентров.Видимость = Объект.ПланироватьРаботуРабочихЦентров
		И ПоказыватьПараметрыГрафика;
	
	Форма.Элементы.ГруппаМаксимальнаяДоступностьРЦ.Видимость = Объект.ПланироватьРаботу
		И ПоказыватьПараметрыГрафика;
	
	Форма.Элементы.ГруппаРезервДоступностиРеквизиты.Видимость = ПоказыватьПараметрыГрафика
		И (Объект.ПланироватьРаботу ИЛИ Объект.ПланироватьРаботуРабочихЦентров);
