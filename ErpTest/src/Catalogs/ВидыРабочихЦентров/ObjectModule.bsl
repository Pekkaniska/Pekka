...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ПланируетсяГрафик = НастройкиПодсистемы.ИспользуетсяПроизводство21
		ИЛИ НастройкиПодсистемы.ПланируетсяГрафикПроизводства;
	
	Если НЕ ПланироватьРаботу ИЛИ НЕ ПланируетсяГрафик Тогда
