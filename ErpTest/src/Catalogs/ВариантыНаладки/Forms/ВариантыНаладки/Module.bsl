...
Процедура ДлительностьПереналадкиТаблицаПриАктивизацииЯчейки(Элемент)
	...
	ТекстВТаблицеВыделеноЦветом = Новый ФорматированнаяСтрока(НСтр("ru = 'темно-синим цветом'"), Новый Шрифт(,,Истина), WebЦвета.ТемноСиний);
	...
	ИначеЕсли ПриоритетНастройки = 2 Тогда
		...
		ПояснениеПоНастройке = Новый ФорматированнаяСтрока(ПояснениеПоНастройкеТекст, " ", НСтр("ru = '(в таблице выделена'"), " ", ТекстВТаблицеВыделеноЦветом, ").");
