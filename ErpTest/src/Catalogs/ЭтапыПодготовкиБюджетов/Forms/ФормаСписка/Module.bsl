...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Отбор") Тогда
		Если Параметры.Отбор.Свойство("Владелец") Тогда
			...
			Если Пользователи.РолиДоступны("УправлениеБюджетнымПроцессом") 
				Или Пользователи.РолиДоступны("ПолныеПрава") Тогда
				ЧастиЗаголовка.Добавить(" ");
				ЧастиЗаголовка.Добавить("(");
				ЧастиЗаголовка.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'Обзор бюджетного процесса'"), , , , "Обзор"));
				ЧастиЗаголовка.Добавить(")");
			КонецЕсли;
