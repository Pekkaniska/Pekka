...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(Объект.Ссылка) Тогда // Новый
		...
		ОбновитьПризнакАвтоНаименования(Объект.Наименование, Объект.Организация, Объект.Контрагент, НаименованиеСформированоАвтоматически);
	КонецЕсли;
...
Процедура ОбновитьПризнакАвтоНаименования(Знач Наименование, Знач Организация, Знач Контрагент, НаименованиеСформированоАвтоматически)

	НаименованиеСформированоАвтоматически = Наименование = АвтоматическиСформированноеНаименование(Организация, Контрагент);
...
Процедура ЗаполнитьНаименование()
	...
	Если ЗначениеЗаполнено(Организация) И ЗначениеЗаполнено(Контрагент)
		И (НЕ ЗначениеЗаполнено(Объект.Наименование) ИЛИ НаименованиеСформированоАвтоматически) Тогда
		
		Объект.Наименование = АвтоматическиСформированноеНаименование(Организация, Контрагент);
		НаименованиеСформированоАвтоматически = Истина;
	КонецЕсли;
...
&НаКлиентеНаСервереБезКонтекста
Функция АвтоматическиСформированноеНаименование(Отправитель, Получатель)

	Возврат СтрШаблон("%1 -> %2", Отправитель, Получатель);
