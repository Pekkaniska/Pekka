...
Процедура ПриЗаписи(Отказ)
	...
	Если Не ДополнительныеСвойства.Свойство("Использование", Использование) Тогда
		ВызватьИсключение НСтр("ru = 'Необходимо заполнить дополнительное свойство ""Использование""'");
	КонецЕсли;
	
	Расписание = Неопределено;
	Если Не ДополнительныеСвойства.Свойство("Расписание", Расписание) Тогда
		ВызватьИсключение НСтр("ru = 'Необходимо заполнить дополнительное свойство ""Расписание""'");
	КонецЕсли;
