...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	//++ НЕ УТ
	Если ДоступныПлатежиПо275ФЗ() Тогда
...
Функция ДоступныПлатежиПо275ФЗ() Экспорт
	...
	Возврат ОтдельныйСчетГОЗ
		И (ХарактерДоговора = Перечисления.ХарактерыДоговоровФинансовыхИнструментов.Депозит
		Или ХарактерДоговора = Перечисления.ХарактерыДоговоровФинансовыхИнструментов.КредитИлиЗайм
			И ТипДоговора = Перечисления.ТипыДоговораКредитовИДепозитов.КредитВБанке);
