...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	Если СтруктураРеквизитов.Свойство("РежимРаботыПоУчасткам")
		...
		Если Форма.ЕстьУчастки Тогда
			...
			Иначе
				МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'Участки'"),,,,"#Участки"));
			КонецЕсли;
		...
		Если Форма.РежимРаботыПоУчасткам Тогда
			МассивСтрок.Добавить(Новый ФорматированнаяСтрока(НСтр("ru = 'Виды рабочих центров'"),,,,"#ВидыРЦ"));
		Иначе
