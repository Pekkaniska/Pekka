...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СвойстваСписка.ОсновнаяТаблица = "ЖурналДокументов.АвансовыеОтчеты";
	...
	//++ НЕ УТ
	Элементы.СписокСоздатьПоступлениеДенежныхДокументов.Видимость  = ВидимостьСозданияПоступленияДД;
	//-- НЕ УТ
	...
	//++ НЕ УТ
	Элементы.СписокКонтекстноеМенюСоздатьПоступлениеДенежныхДокументов.Видимость  = ВидимостьСозданияПоступленияДД;
	//-- НЕ УТ
	...
	Если КнопокСоздания = 1 Тогда
		...
		//++ НЕ УТ
		ИначеЕсли ВидимостьСозданияПоступленияДД Тогда
			ЭлементСоздания = Элементы.СписокСоздатьПоступлениеДенежныхДокументов;
		//-- НЕ УТ
		КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	ОтборЭлемента = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Ссылка.Валюта");
	ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.НеЗаполнено;
	
	ОтборЭлемента = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Тип");
	ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.Равно;
	ОтборЭлемента.ПравоеЗначение = Тип("ДокументСсылка.ПоступлениеДенежныхДокументов");
...
Функция ТекстЗапросаСписка()
	...
	|		,ТИП(Документ.ОтчетОператораСистемыПлатон)
	//-- НЕ УТ
	|	)
