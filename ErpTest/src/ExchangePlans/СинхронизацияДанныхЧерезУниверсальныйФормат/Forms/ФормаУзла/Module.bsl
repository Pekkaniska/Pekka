...
#Область ГруппаНастройкаДополнительныхОтборов
	...
	Элементы.ГруппаСтраницыОтборПоРазделамУчета.Видимость = Объект.ВариантНастройки <> "ОбменУП2ЗУП3";
...
#Область ВидыЦен
	...
	Элементы.ГруппаОтправлятьВидыЦенНоменклатуры.Видимость = Объект.ВариантНастройки <> "ОбменУП2ЗУП3";
	
	Если Элементы.ГруппаОтправлятьВидыЦенНоменклатуры.Видимость Тогда
