...
// Возвращает строку: представление конфигурации-корреспондента для последующего отображения пользователю.
// 
// Параметры:
//  КраткоеИмяКонфигурации - Строка - краткое представление конфигурации корреспондента.
//
// Возвращаемое значение:
//  Строка - полное представление конфигурации корреспондента.
//
Функция ПолучитьПредставлениеКонфигурацииКорреспондента(КраткоеИмяКонфигурации) Экспорт
	...
	ИначеЕсли КраткоеИмяКонфигурации = "УправлениеПроизводственнымПредприятием" Тогда
...
Процедура АктуализацияРеквизитовУзлаПланаОбмена(УзелПланаОбмена) Экспорт
	...
	Если Не УзелПланаОбмена.ИспользоватьОтборПоРазделамУчета Тогда
		...
		Если УзелПланаОбмена.РежимВыгрузкиДокументов <> Перечисления.РежимыВыгрузкиОбъектовОбмена.НеВыгружать Тогда
