...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена          = НСтр("ru='Настройка синхронизации с 1С:Документооборотом КОРП, ред. 1.4'");
	ОписаниеВарианта.ЗаголовокУзлаПланаОбмена                  = НСтр("ru='Синхронизация с 1С:Документооборотом КОРП, ред. 1.4'");
	...
	ОписаниеВарианта.КраткаяИнформацияПоОбмену                 = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами 
	|""1С:ERP Управление предприятием, редакция 2"", и ""1С:Документооборот, редакция 2"".'");
	ОписаниеВарианта.ПодробнаяИнформацияПоОбмену               = "ПланОбмена.ОбменУправлениеПредприятиемДокументооборот.Форма.ПодробнаяИнформация";
...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат НСтр("ru = 'Создать обмен с конфигурацией ""1С:Документооборот КОРП, ред. 1.4""'");
