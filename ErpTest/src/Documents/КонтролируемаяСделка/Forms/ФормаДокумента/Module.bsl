...
Функция ЗаполняемыеКодыПредметовСделок(Товар, ВерсияУведомления)
	...
	Если НЕ Товар И ВерсияУведомления = Документы.УведомлениеОКонтролируемыхСделках.ВерсияУведомления_2012() Тогда
	...
	Если Товар И ВерсияУведомления = Документы.УведомлениеОКонтролируемыхСделках.ВерсияУведомления_2012() Тогда
...
Процедура УстановитьВидимостьКлассификаторовПредметаСделки()
	...
	ВерсияУведомления_2012 = Документы.УведомлениеОКонтролируемыхСделках.ВерсияУведомления_2012();
