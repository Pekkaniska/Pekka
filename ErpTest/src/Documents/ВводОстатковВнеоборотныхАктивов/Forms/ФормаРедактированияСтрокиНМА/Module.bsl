...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ЭтоНовый И НЕ Параметры.Копирование Тогда
		...
		СчетаАмортизации = ПланыСчетов.Хозрасчетный.АмортизацияНематериальныхАктивов;
	...
	ФактическийСрокИспользованияНУРасшифровка = БухгалтерскийУчетКлиентСерверПереопределяемый.РасшифровкаСрокаПолезногоИспользования(ФактическийСрокИспользованияДо2009);
...
Процедура ОбновитьСвойстваЭлементовФормы(ИзмененныеРеквизиты=Неопределено)
	...
	Если ОбновитьВсе Или Реквизиты.Свойство("ВидОбъектаУчета") Тогда
		...
		Если ВидОбъектаУчета = Перечисления.ВидыОбъектовУчетаНМА.РасходыНаНИОКР Тогда
			...
			Элементы.НачислятьАмортизациюБУ.ФорматРедактирования = "БЛ='Не списывать'; БИ=Действует";
			Элементы.НачислятьАмортизациюНУ.ФорматРедактирования = "БЛ='Не списывать'; БИ=Действует";
		...
		Иначе
			...
			Элементы.НачислятьАмортизациюНУ.Заголовок = НСтр("ru='Начисление амортизации'");
			...
			Элементы.НачислятьАмортизациюБУ.ФорматРедактирования = "БЛ='Не начислять'; БИ=Действует";
			Элементы.НачислятьАмортизациюНУ.ФорматРедактирования = "БЛ='Не начислять'; БИ=Действует";
