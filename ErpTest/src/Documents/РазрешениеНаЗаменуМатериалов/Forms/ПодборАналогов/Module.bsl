...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьТекстЗапросаДинамическихСписков();
	...
	ПоказатьДоступныеОстатки	= Параметры.ПоказатьДоступныеОстатки;
	...
	Если ЗначениеЗаполнено(Параметры.ЗаказНаПроизводство) Тогда
		...
		ЗаказНаПроизводствоНомер	= ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(Реквизиты.Номер);
		ЗаказНаПроизводствоДата		= Формат(Реквизиты.Дата, "ДЛФ=D");
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(Параметры.ЗаказКлиента) Тогда
		...
		ЗаказКлиентаНомер			= ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(Реквизиты.Номер);
		ЗаказКлиентаДата			= Формат(Реквизиты.Дата, "ДЛФ=D");
	КонецЕсли;
	...
	ВидимостьУпаковки = ДанныеВыбора.Количество() > 1;
	
	Элементы.Упаковка.Видимость			= ВидимостьУпаковки;
	Элементы.ЕдиницаИзмерения.Видимость	= Не ВидимостьУпаковки;
	
	Если ВидимостьУпаковки Тогда 
		
		СписокВыбора = Элементы.Упаковка.СписокВыбора;
		
		Для Каждого ЗначениеВыбора Из ДанныеВыбора Цикл
			
			ЗначениеЭлемента      = ЗначениеВыбора.Значение;
			
			ЗначениеУпаковки      = ?(ТипЗнч(ЗначениеЭлемента) = Тип("Структура"), ЗначениеЭлемента.Значение, ЗначениеЭлемента);
			ПредставлениеУпаковки = ЗначениеВыбора.Представление;
			
			СписокВыбора.Добавить(ЗначениеУпаковки, ПредставлениеУпаковки);
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Материалы, "СкладПоУмолчанию",	Справочники.Склады.СкладПоУмолчанию());
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Аналоги, "СкладПоУмолчанию",		Справочники.Склады.СкладПоУмолчанию());
	
	Если Не ПоказатьДоступныеОстатки Тогда
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ на производство, Заказ клиента, Спецификация'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ на производство, Спецификация'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ клиента, Спецификация'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Спецификация'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ на производство, Заказ клиента, Подразделение, Изделие, Характеристика изделия'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ на производство, Заказ клиента, Подразделение, Изделие'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ на производство, Заказ клиента, Изделие, Характеристика изделия'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ на производство, Заказ клиента, Изделие'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ на производство, Подразделение, Изделие, Характеристика изделия'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ на производство, Подразделение, Изделие'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ клиента, Подразделение, Изделие, Характеристика изделия'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ клиента, Подразделение, Изделие'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ на производство, Изделие, Характеристика изделия'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ на производство, Изделие'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ клиента, Изделие, Характеристика изделия'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ клиента, Изделие'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Подразделение, Изделие, Характеристика изделия'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Подразделение, Изделие'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ на производство'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Заказ клиента'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Подразделение'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Изделие, Характеристика изделия'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Изделие'"));
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'По предприятию в целом'"));
...
Процедура ОбновитьПредставлениеОбластиДействия(ТекущиеДанные)
	...
	Если ЗначениеЗаполнено(ТекущиеДанные.ДатаОкончанияДействия) Тогда
		ШаблонПредставления = НСтр("ru = 'С %1 по %2 для'") + " ";
	...
	Иначе
		ШаблонПредставления = НСтр("ru = 'С %1 для'") + " ";
		ТекстПредставления = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонПредставления,
			Формат(ТекущиеДанные.ДатаНачалаДействия, "ДЛФ=D"));
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ТекущиеДанные.ЗаказНаПроизводство) Тогда
		...
		ШаблонПредставления = НСтр("ru = 'заказа на производство №%1 от %2;'") + " ";
	...
	Если ЗначениеЗаполнено(ТекущиеДанные.ЗаказКлиента) Тогда
		...
		ШаблонПредставления = НСтр("ru = 'заказа клиента №%1 от %2;'") + " ";
	...
	Если ЗначениеЗаполнено(ТекущиеДанные.Подразделение) Тогда
		...
		ШаблонПредставления = НСтр("ru = 'подразделения ""%1"";'") + " ";
	...
	Если ЗначениеЗаполнено(ТекущиеДанные.Спецификация) Тогда
		...
		ШаблонПредставления = НСтр("ru = 'спецификации ""%1"";'") + " ";
	...
	Если ЗначениеЗаполнено(ТекущиеДанные.ХарактеристикаИзделия) Тогда
		...
		ШаблонПредставления = НСтр("ru = 'характеристики ""%1"";'") + " ";
	...
	Иначе
		ПредставлениеОбластиДействия = ПредставлениеОбластиДействия + НСтр("ru = 'предприятия в целом'");
	КонецЕсли;
...
&НаСервере
Процедура УстановитьТекстЗапросаДинамическихСписков()

	// Материалы
	МатериалыТекстЗапроса = СтрЗаменить(Материалы.ТекстЗапроса,
										"&ТекстЗапросаКоэффициентУпаковки",
										Справочники.УпаковкиЕдиницыИзмерения.ТекстЗапросаКоэффициентаУпаковки(
										"РазрешениеНаЗаменуМатериалыПереопределяемый.Упаковка",
										"РазрешениеНаЗаменуМатериалыПереопределяемый.Номенклатура"));
										
	ТекстЗапросаДляПолученияСклада = ПроизводствоСервер.ТекстЗапросаНастройкиПередачиМатериалов(
										"РазрешениеНаЗаменуМатериалыПереопределяемый", 
										"&Подразделение",
										ОбеспечениеПроизводства.ВариантЗаполненияОбеспеченияПоВерсииПроизводства(Параметры.ИспользоватьПроизводство2_2));
										
	МатериалыТекстЗапроса = СтрЗаменить(
								МатериалыТекстЗапроса, 
								"&ТекстПолеСклад", 
	...
	СвойстваСписка.ТекстЗапроса = МатериалыТекстЗапроса;
	ОбщегоНазначения.УстановитьСвойстваДинамическогоСписка(Элементы.Материалы, СвойстваСписка);
								
	// Аналоги
	АналогиТекстЗапроса = СтрЗаменить(Аналоги.ТекстЗапроса,
										"&ТекстЗапросаКоэффициентУпаковки",
										Справочники.УпаковкиЕдиницыИзмерения.ТекстЗапросаКоэффициентаУпаковки(
	...
	ТекстЗапросаДляПолученияСклада = ПроизводствоСервер.ТекстЗапросаНастройкиПередачиМатериалов(
										"РазрешениеНаЗаменуАналогиПереопределяемый", 
										"&Подразделение",
										ОбеспечениеПроизводства.ВариантЗаполненияОбеспеченияПоВерсииПроизводства(Параметры.ИспользоватьПроизводство2_2));
										
	АналогиТекстЗапроса = СтрЗаменить(
								АналогиТекстЗапроса, 
								"&ТекстПолеСклад", 
								ТекстЗапросаДляПолученияСклада.ТекстПолеСклад);
	...
	СвойстваСписка = ОбщегоНазначения.СтруктураСвойствДинамическогоСписка();
	СвойстваСписка.ТекстЗапроса = АналогиТекстЗапроса;
	ОбщегоНазначения.УстановитьСвойстваДинамическогоСписка(Элементы.Аналоги, СвойстваСписка);
