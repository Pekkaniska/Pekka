...
Функция ПараметрыРегистрацииСчетовФактурВыданных(Объект) Экспорт
	...
	ДокументыРеализации = Объект.Товары.Выгрузить().ВыгрузитьКолонку("ДокументРеализации");
	ВозвратТолькоПоРеализациямТоваров = Истина;
	Для Каждого ДокументРеализации Из ДокументыРеализации Цикл
		Если Не ЗначениеЗаполнено(ДокументРеализации) ИЛИ ТипЗнч(ДокументРеализации) <> Тип("ДокументСсылка.РеализацияТоваровУслуг") Тогда 
			ВозвратТолькоПоРеализациямТоваров = Ложь;
		КонецЕсли;
	КонецЦикла;
	...
	ПараметрыРегистрации.ВозвратТоваровПоставщику = 
		...
		И ВозвратТолькоПоРеализациямТоваров;
