...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	|	И НЕ ТИПЗНАЧЕНИЯ(Расчеты.ЗаказПоставщику) В (
...
Функция ТекстЗапросаТаблицаСебестоимостьТоваров(Запрос, ТекстыЗапроса, Регистры) Экспорт
	...
	|		ТОГДА ЕСТЬNULL(ТаблицаАналитикУчетаПартийПоступления.НалогообложениеНДС, ТоварыДокумента.ЗакупкаПодДеятельность)
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	...
	|	СУММА(ВЫБОР 
	|			КОГДА ЕСТЬNULL(ТаблицаАналитикУчетаПартийПоступления.НалогообложениеНДС, ТоварыДокумента.ЗакупкаПодДеятельность)
