...
Процедура СуммаПриИзменении(Элемент)
	...
	ТекущаяСтрока = Элементы.ДвиженияМеждународный.ТекущиеДанные;
	ТекущаяСтрока.СуммаПредставления = РассчитатьСуммуПредставления(ТекущаяСтрока.Сумма, Объект.Дата);
...
Функция ПараметрыДокумента(Форма, ТекущиеДанные, ДтКт)
...
Процедура ИзменитьПараметрыВыбораПолейСубконто(Форма, ДтКт = "")
	...
	ПараметрыДокумента = ПараметрыДокумента(Форма, СтрокаТаблицы, ДтКт);
	ШаблонИмяПоляОбъекта = "Субконто"+ДтКт+"%Индекс%";
