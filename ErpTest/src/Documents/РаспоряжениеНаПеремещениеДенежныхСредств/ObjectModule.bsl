...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	//++ НЕ УТ
	Если ХозяйственнаяОперация <> Перечисления.ХозяйственныеОперации.ПеречислениеДенежныхСредствНаДругойСчет
		И МассивРеквизитовОперации.Найти("БанковскийСчет") <> Неопределено И ЗначениеЗаполнено(БанковскийСчет) Тогда
		
		ОтдельныйСчетГОЗ = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(БанковскийСчет, "ОтдельныйСчетГОЗ");
		Если ОтдельныйСчетГОЗ Тогда
			ТекстОшибки = НСтр("ru='С использованием отдельного банковского счета операция %1 не допускается.'");
			ТекстОшибки = СтрШаблон(ТекстОшибки, ХозяйственнаяОперация);
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				ТекстОшибки,
				ЭтотОбъект,
				"БанковскийСчет",
	...
	Если ЗначениеЗаполнено(БанковскийСчетПолучатель) Тогда
		...
		ОтдельныйСчетГОЗ = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(БанковскийСчетПолучатель, "ОтдельныйСчетГОЗ");
		Если ОтдельныйСчетГОЗ Тогда
			ТекстОшибки = НСтр("ru='Операции зачисления денежных средств на отдельный банковский счет не допускаются.'");
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				ТекстОшибки,
				ЭтотОбъект,
