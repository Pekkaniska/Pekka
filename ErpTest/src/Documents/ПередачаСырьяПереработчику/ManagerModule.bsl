...
Функция ТекстЗапросаВтТаблицаВидыЗапасов(Запрос, ТекстыЗапроса)
	...
	|		И &Партнер                   = АналитикаПереданнойНоменклатурыУчетСырьяПоНазначениям.Склад
	...
	|	ПО 
	|		Аналитика.Номенклатура = АналитикаПереданнойНоменклатурыБезНазначения.Номенклатура
	|		И Аналитика.Характеристика = АналитикаПереданнойНоменклатурыБезНазначения.Характеристика
	|		И &Серия = АналитикаПереданнойНоменклатурыБезНазначения.Серия
	|		И &Партнер = АналитикаПереданнойНоменклатурыБезНазначения.Склад
	...
	|		И Справочник.ВладелецТовара = АналитикаКомиссионнойНоменклатуры.Склад
...
// заполняет вид запасов получателя в ТЧ ВидыЗапасов.
//
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Пока ВыборкаПоДокументам.Следующий() Цикл
		...
		Попытка
			...
			ЭлементБлокировки = Блокировка.Добавить("РегистрНакопления.ТоварыПереданныеПереработчику.НаборЗаписей");
			...
			Если ВыборкаПоДокументам.ОбработатьВидЗапасов = Истина Тогда
