...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтандартныеПодсистемыСервер.УстановитьУсловноеОформлениеПоляДата(ЭтотОбъект, "Список.ДатаПлатежа", Элементы.ДатаПлатежа.Имя);
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "ЕстьФайлы" Тогда
		...
		ОткрытьФорму("Обработка.РаботаСФайлами.Форма.ПрисоединенныеФайлы",
			...
			ЭтаФорма);
	//Рарус Владимир Подрезов 06.03.2017
	ИначеЕсли Поле.Имя = "пкПрикрепленыФайлыВДО" Тогда
		СтандартнаяОбработка = Ложь;
