...
Процедура УстановитьОграничениеТипаДоговора()
	...
	Для каждого Область Из ОбластиПланированияОтбор Цикл
		Если Область.Пометка Тогда
			Если Область.Значение = Перечисления.ОбластиПланированияПлатежей.Лизинг Тогда
				ДоговорЛизинга = Истина;
			Иначе
	...
	//++ НЕ УТ
	Если ДоговорКредитов И ДоговорЛизинга
		Или Не ДоговорКредитов И Не ДоговорЛизинга Тогда
		Элементы.ДоговорОтбор.ОграничениеТипа = Новый ОписаниеТипов("СправочникСсылка.ДоговорыКредитовИДепозитов, СправочникСсылка.ДоговорыЛизинга");
	...
	//++ НЕ УТ
	ИначеЕсли ДоговорЛизинга Тогда
		Элементы.ДоговорОтбор.ОграничениеТипа = Новый ОписаниеТипов("СправочникСсылка.ДоговорыЛизинга");
	КонецЕсли;
	//-- НЕ УТ
