...
Процедура УстановитьЗаголовкиПолейСтрокиСтажа(СтрокаСтажа)
	...
	Если СтрокаСтажа.ОснованиеИсчисляемогоСтажа = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ОснованияИсчисляемогоСтраховогоСтажа.ВОДОЛАЗ") Тогда
