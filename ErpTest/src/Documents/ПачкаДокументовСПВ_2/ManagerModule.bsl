...
Функция ТекстФайла(ВыборкаПоШапкеДокумента, ВыборкаПоСотрудникам)
	...
	ФорматПризнакНачисленияВзносовОПС = Новый Структура("ПризнакНачисленияВзносовОПС", ОбщегоНазначенияКлиентСервер.СкопироватьРекурсивно(ФорматСПВ.ПризнакНачисленияВзносовОПС));
	ФорматСПВ.Удалить("ПризнакНачисленияВзносовОПС");
	ФорматПризнакНачисленияВзносовПоДопТарифу = Новый Структура("ПризнакНачисленияВзносовПоДопТарифу", ОбщегоНазначенияКлиентСервер.СкопироватьРекурсивно(ФорматСПВ.ПризнакНачисленияВзносовПоДопТарифу));
	...
	Пока ВыборкаПоСотрудникам.СледующийПоЗначениюПоля("НомерСтроки")	Цикл		
		ДанныеШапки = ОбщегоНазначенияКлиентСервер.СкопироватьРекурсивно(ФорматСПВ);
