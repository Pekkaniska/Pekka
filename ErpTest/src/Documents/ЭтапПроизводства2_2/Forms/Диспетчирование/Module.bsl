...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Проверка и запуск фонового распределения видов запасов на производство (если требуется).
	ЗатратыСервер.ПроверитьЗапуститьФоновоеРаспределениеТоваровОрганизацийНаПроизводство();
...
Процедура НастроитьЭлементыФормы()
	...
	Элементы.ГруппаДопОтборТребуетсяНазначитьОперации.Видимость = ИспользуютсяОперации;
