...
Процедура ОткрытьФормуСканированияАлкогольнойПродукции()
	...
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(
		Истина,
		"Документ.ЧекККМ.Форма.ФормаДокументаРМК.ОткрытьФормуСканированияАлкогольнойПродукции");
	...
	ПараметрыОткрытия.Вставить("КонтролироватьСканируемуюПродукциюПоДокументуОснованию", Ложь);
...
Процедура ЗарезервироватьНаКлиенте(РезультатОтложенДо, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли РезультатОтложенДо < Объект.Дата Тогда
		ПоказатьПредупреждение(,НСтр("ru = 'Укажите корректную дату после даты чека'"));
		Возврат;
	КонецЕсли;
...
Процедура ЗаполнитьСлужебныеРеквизитыПоНоменклатуре()
	...
	ЗаполнитьПризнакМаркируемаяАлкогольнаяПродукция = Новый Структура("Номенклатура", "МаркируемаяАлкогольнаяПродукция");
	ЗаполнитьПризнакАлкогольнаяПродукция            = Новый Структура("Номенклатура", "АлкогольнаяПродукция");
	...
	СтруктураДействий.Вставить("ЗаполнитьПризнакМаркируемаяАлкогольнаяПродукция", ЗаполнитьПризнакМаркируемаяАлкогольнаяПродукция);
	СтруктураДействий.Вставить("ЗаполнитьПризнакАлкогольнаяПродукция", ЗаполнитьПризнакАлкогольнаяПродукция);
