...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|	ВЫБОР КОГДА Строки.СтатьяРасходов.ВариантРаспределенияРасходовРегл = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаПрочиеАктивы) ТОГДА
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	ТекстыСозданияВременныхТаблиц.Добавить(ТекстЗапросаТаблицаВТРасходыДокумента());
	ТекстыСозданияВременныхТаблиц.Добавить(ТекстЗапросаТаблицаВТРасходыДокумента);
...
Функция ТекстЗапросаВтСписокСпособовОтражения(ТекстыЗапроса = Неопределено)
	...
	Если Не ПроведениеСерверУТ.ЕстьТаблицаЗапроса("ДокументыКОтражению", ТекстыЗапроса) Тогда
...
Функция ТекстЗапросаВТСпособыОтражения(ТекстыЗапроса = Неопределено)
	...
	Если Не ПроведениеСерверУТ.ЕстьТаблицаЗапроса("ВтСписокСпособовОтражения", ТекстыЗапроса) Тогда
...
Функция ТекстЗапросаТаблицаВТРасходыДокумента(ТекстыЗапроса = Неопределено)
	...
	Если Не ПроведениеСерверУТ.ЕстьТаблицаЗапроса("ВТСпособыОтражения", ТекстыЗапроса) Тогда
	...
	|ГДЕ
	|	НЕ ДокументыКОтражению.Ссылка.КорректировкаОбязательств
	|	И ОценочныеОбязательства.СуммаРезерваСтраховыхВзносов + 
	...
	|ГДЕ
	|	НЕ ДокументыКОтражению.Ссылка.КорректировкаОбязательств
	|	И ОценочныеОбязательства.СуммаРезерваФССНесчастныеСлучаи + 
...
Функция ТекстЗапросаТаблицаВтИсходныеПрочиеРасходы(ТекстыЗапроса)
	...
	Если Не ПроведениеСерверУТ.ЕстьТаблицаЗапроса("ВТРасходыДокумента", ТекстыЗапроса) Тогда
