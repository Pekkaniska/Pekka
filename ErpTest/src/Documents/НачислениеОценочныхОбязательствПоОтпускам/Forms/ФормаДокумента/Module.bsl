...
&НаКлиенте
Процедура РасчетРезерваОтпусковСреднийЗаработокНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ОценочныеОбязательстваЗарплатаКадрыРасширенная") Тогда
		...
		Модуль.ОткрытьФормуВводаСреднегоЗаработкаОбщий(ЭтотОбъект,
...
#Область ОбработчикиСобытийТаблицыФормыОценочныеОбязательства
...
#Область ОбработчикиСобытийТаблицыФормыОценочныеОбязательстваПоСотрудникам
