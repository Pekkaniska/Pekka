...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ НЕ УТ
	ПоддержкаПБУ18 = УчетнаяПолитика.ПоддержкаПБУ18(Параметры.Организация, ДатаДокумента);
	Элементы.ТаблицаРасходовПостояннаяРазница.Видимость = ПоддержкаПБУ18;
	Элементы.ТаблицаРасходовВременнаяРазница.Видимость = ПоддержкаПБУ18;
	//-- НЕ УТ
