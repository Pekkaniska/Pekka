...
Процедура ОтразитьВУчетеНДС(Запрос, ТекстыЗапроса, Регистры)
	...
	|	ТаблицаЗапасов.СчетФактураВыставленныйКомиссионера.Номер КАК НомерСчетаФактурыКомиссионера,
	...
	|	ТаблицаТоваров.СчетФактураВыставленныйКомиссионера.Номер КАК НомерСчетаФактурыКомиссионера,
	...
	УчетНДСУП.ОтразитьОтчетКомиссионера(Запрос, ТекстыЗапроса, Регистры, ТекстТовары, ТекстВознаграждение);
	...
	УчетНДСУП.ОтразитьОтчетКомитенту(Запрос, ТекстыЗапроса, Регистры, ТекстТовары, ТекстВознаграждение);
...
Функция ТекстЗапросаТаблицаРасчетыСКлиентами(Запрос, ТекстыЗапроса, Регистры)
	...
	ТекстЗапроса=СтрЗаменить(ТекстЗапроса,"//ЗачетАвансовКлиентаПоНакладной",
		ВзаиморасчетыСервер.ТекстПроведенияЗачетАвансовКлиентаПоНакладной("ОтчетПоКомиссииМеждуОрганизациями", ШаблонПолейКлиент, "РасшифровкаПлатежаСКлиентом"));
		
	ТекстЗапроса=СтрЗаменить(ТекстЗапроса,"//ЗачетАвансовПоставщикуПоНакладнойПоВознаграждению",
		ВзаиморасчетыСервер.ТекстПроведенияЗачетАвансовКлиентаПоНакладной("ОтчетПоКомиссииМеждуОрганизациями", ШаблонПолейПоставщик, "РасшифровкаПлатежаСПоставщикомВознаграждение"));
...
Функция ТекстЗапросаТаблицаРасчетыСПоставщиками(Запрос, ТекстыЗапроса, Регистры)
	...
	ТекстЗапроса=СтрЗаменить(ТекстЗапроса,"//ЗачетАвансовПоставщикуПоНакладной",
		ВзаиморасчетыСервер.ТекстПроведенияЗачетАвансовПоставщикуПоНакладной("ОтчетПоКомиссииМеждуОрганизациями", ШаблонПолейПоставщик, "РасшифровкаПлатежаСПоставщиком"));
		
	ТекстЗапроса=СтрЗаменить(ТекстЗапроса,"//ЗачетАвансовКлиентаПоНакладнойПоВознаграждению",
		ВзаиморасчетыСервер.ТекстПроведенияЗачетАвансовПоставщикуПоНакладной("ОтчетПоКомиссииМеждуОрганизациями", ШаблонПолейКлиент, "РасшифровкаПлатежаСКлиентомВознаграждение"));
