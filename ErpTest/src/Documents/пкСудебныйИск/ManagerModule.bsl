...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСоздатьНаОсновании, НастройкиФормы) Экспорт
	...
	Документы.пкСудебныйИск.ДобавитьКомандуСоздатьНаОсновании(КомандыСоздатьНаОсновании);
...
Функция ТекстЗапросаТаблица_пкПретензииПоСчетам(Запрос, ТекстыЗапроса, Регистры)
	...
	|	ЗНАЧЕНИЕ(Перечисление.пкСостоянияПретензийПоСчетам.СудебныйИск) КАК Состояние
	|ИЗ
	|	Документ.пкСудебныйИск КАК пкСудебныйИск
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.пкПретензия.Расшифровка КАК пкПретензияРасшифровка
	|		ПО (пкСудебныйИск.Ссылка = &Ссылка)
	|			И пкСудебныйИск.Претензия = пкПретензияРасшифровка.Ссылка";
...
Функция СформироватьКомплектПечатныхФорм(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати) Экспорт
	...
	Иначе
		...
		КомплектПечатныхФорм = РегистрыСведений.НастройкиПечатиОбъектов.КомплектПечатныхФорм(
			Метаданные.Документы.пкСудебныйИск.ПолноеИмя(),
	...
	СтруктураТипов.Вставить("Документ.пкСудебныйИск", МассивОбъектов);
	
	РегистрыСведений.НастройкиПечатиОбъектов.СформироватьКомплектВнешнихПечатныхФорм(
		"Документ.пкСудебныйИск",
		МассивОбъектов,
		ПараметрыПечати,
...
Функция ПолноеИмяОбъекта()
	...
	Возврат "Документ.пкСудебныйИск";
