...
Процедура ОборотноСальдоваяВедомостьПоСчету(Команда)
	...
	ОборотноСальдоваяВедомость(Элементы.ДеревоСводныхДанныхПоСчетам.ТекущиеДанные.Счет);
...
Процедура ПроверитьАктуальностьДанных(ПараметрыЗаполнения, ДополнительныеПараметры = Неопределено) Экспорт
	...
	ТекстПредупрежденияНеАктуальныхДанных = ПредупреждениеНеАктуальныхДанных(Объект.Организация, Объект.Дата);
...
Функция ДолжностиВыбранныхФизЛиц(МассивФизическихЛиц, Организация, Дата)
	...
	ТаблицаСотрудников = КадровыйУчет.ОсновныеСотрудникиФизическихЛиц(МассивФизическихЛиц, Истина, Организация, Дата);
