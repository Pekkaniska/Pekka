...
Функция СформироватьВыходнойФайл(ВыборкаПоШапкеДокумента, ВыборкаСотрудники)
	...
	Пока ВыборкаСотрудники.Следующий() Цикл
		...
		НаборЗаписейАДВ3 = ОбщегоНазначенияКлиентСервер.СкопироватьРекурсивно(ФорматАДВ3);
		...
		Если НаборЗаписейИзменившиесяДанные.ФИО.Значение.Количество() = 0 Тогда  
			НаборЗаписейИзменившиесяДанные.ФИО.НеВыводитьВФайл = Истина;
		КонецЕсли;
