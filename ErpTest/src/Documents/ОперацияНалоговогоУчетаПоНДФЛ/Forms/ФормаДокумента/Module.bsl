...
Процедура ЗаполнитьКатегорииДоходовНДФЛ()
	...
	Если Не ПолучитьФункциональнуюОпцию("ИспользуютсяСтавкиНДФЛМеждународныхДоговоров") Тогда
		СписокКатегорий = СоответствиеКодовИКатегорий[ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыДоходовНДФЛ.Код1010")];
		...
		СоответствиеКодовИКатегорий.Вставить(ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыДоходовНДФЛ.Код1010"), СписокКатегорий);
	КонецЕсли;
