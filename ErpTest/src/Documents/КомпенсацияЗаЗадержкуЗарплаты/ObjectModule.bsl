...
Процедура ЗаполнитьДвиженияПоУчетам(ЗаполняемыеДвижения, Отказ, СтруктураВидовУчета = Неопределено) Экспорт
	...
	Если СтруктураВидовУчета = Неопределено Или СтруктураВидовУчета.ОстальныеВидыУчета Тогда
		...
		УчетНачисленнойЗарплаты.ЗарегистрироватьНачисленияУдержания(ЗаполняемыеДвижения, Отказ, Организация, ПериодРегистрации, НачисленияКомпенсации, Неопределено, Неопределено, Неопределено, ПорядокВыплаты, Ложь);
		
		ОтражениеЗарплатыВБухучетеРасширенный.СформироватьДвиженияБухучетНачисленияУдержанияПоСотрудникам(
							ЗаполняемыеДвижения, Отказ, Организация, ПериодРегистрации,
