...
Функция НастройкиПолейФормы() Экспорт
	...
	Финансы.НовыйОтбор(Элемент.Условие, "ХозяйственнаяОперация", Перечисления.ХозяйственныеОперации.СписаниеДебиторскойЗадолженности);
...
Функция ЗначенияПараметровПроведения(Реквизиты = Неопределено)
	...
	Если Реквизиты <> Неопределено Тогда
		...
		Значения.Вставить("Содержание", УчетУСНСервер.СодержаниеДохода(Реквизиты.ХозяйственнаяОперация,, Реквизиты.Контрагент));
		//-- НЕ УТ
	КонецЕсли;
