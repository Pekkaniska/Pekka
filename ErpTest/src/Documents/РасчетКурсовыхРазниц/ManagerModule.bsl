...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	//++ НЕ УТ
	Запрос.УстановитьПараметр("ОбеспечительныйПлатеж", Перечисления.ТипыПлатежейПоЛизингу.ОбеспечительныйПлатеж);
	//-- НЕ УТ
...
Функция ТекстЗапросаКурсовыеРазницыРасчетыСПоставщикамиПоДокументам()
	...
	|	(ВЫРАЗИТЬ(Остатки.Долг * КурсВалюты.Курс / КурсВалюты.Кратность / КурсВалютыУпр.Курс * КурсВалютыУпр.Кратность КАК ЧИСЛО(31,2))) - Остатки.ДолгУпр КАК ДолгУпр
	|
...
Функция ТекстЗапросаКурсовыеРазницыДенежныеСредстваБезналичные()
	...
	|	(ВЫРАЗИТЬ(ОстаткиНаДень.СуммаОстаток * КурсВалюты.Курс / КурсВалюты.Кратность / КурсВалютыУпр.Курс * КурсВалютыУпр.Кратность КАК ЧИСЛО(31,2))) - ОстаткиНаДень.СуммаУпрОстаток КАК СуммаУпр
	|
	...
	|			ИЛИ (ВЫРАЗИТЬ(ОстаткиНаДень.СуммаОстаток * КурсВалюты.Курс / КурсВалюты.Кратность / КурсВалютыУпр.Курс * КурсВалютыУпр.Кратность КАК ЧИСЛО(31,2))) - ОстаткиНаДень.СуммаУпрОстаток <> 0)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
...
Функция ТекстЗапросаКурсовыеРазницыРасчетыПоФинансовымИнструментам()
	...
	|	(ВЫРАЗИТЬ(ОстаткиНаДень.СуммаВВалюте * КурсВалюты.Курс / КурсВалюты.Кратность / КурсВалютыУпр.Курс * КурсВалютыУпр.Кратность КАК ЧИСЛО(31,2))) - ОстаткиНаДень.СуммаУпр КАК СуммаУпр,
	...
	|			ИЛИ (ВЫРАЗИТЬ(ОстаткиНаДень.СуммаВВалюте * КурсВалюты.Курс / КурсВалюты.Кратность / КурсВалютыУпр.Курс * КурсВалютыУпр.Кратность КАК ЧИСЛО(31,2))) <> ОстаткиНаДень.СуммаУпр)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
