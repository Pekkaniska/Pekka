...
Процедура ЗаполнитьПериодыВзаиморасчетовЗарплаты() Экспорт
	ВедомостьНаВыплатуЗарплаты.ЗаполнитьПериодыВзаиморасчетовЗарплатыВедомости(Метаданные.Документы.ВедомостьНаВыплатуЗарплатыПеречислением.ПолноеИмя());
КонецПроцедуры

Процедура ЗаполнитьФизическиеЛицаЗарплаты() Экспорт
	ВедомостьНаВыплатуЗарплаты.ЗаполнитьФизическиеЛицаЗарплатыВедомости(Метаданные.Документы.ВедомостьНаВыплатуЗарплатыПеречислением.ПолноеИмя());
КонецПроцедуры

Процедура ЗаполнитьСостав() Экспорт
	ВедомостьНаВыплатуЗарплаты.ЗаполнитьСоставВедомости(Метаданные.Документы.ВедомостьНаВыплатуЗарплатыПеречислением.ПолноеИмя(), "ФизическоеЛицо, БанковскийСчет");
КонецПроцедуры	
