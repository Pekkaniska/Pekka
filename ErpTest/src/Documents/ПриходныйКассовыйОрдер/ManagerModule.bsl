...
Функция ЗначенияПараметровПроведения(Реквизиты = Неопределено)
	...
	Если Реквизиты <> Неопределено Тогда
		...
		//++ НЕ УТ
		Значения.Вставить("СкладКассыККМ",               Реквизиты.СкладКассыККМ);
		Значения.Вставить("ТипПервичногоДокумента",      Строка(ТипЗнч(Реквизиты.Ссылка)));
		Значения.Вставить("НомерПервичногоДокумента",    ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(Реквизиты.Номер, Истина, Истина));
		Значения.Вставить("ДатаПервичногоДокумента",     Формат(Реквизиты.Период, "ДЛФ=D"));
