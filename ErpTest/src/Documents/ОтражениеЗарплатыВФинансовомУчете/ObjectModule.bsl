...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	СпособыОтражения = НачисленнаяЗарплатаИВзносы.ВыгрузитьКолонку("СпособОтраженияЗарплатыВБухучете");
	...
	Для Каждого Строка Из НачисленнаяЗарплатаИВзносы Цикл
		...
		Если ЗначениеЗаполнено(Строка.СпособОтраженияЗарплатыВБухучете)
			И ОплатаСдельныхРабот[Строка.СпособОтраженияЗарплатыВБухучете]
			И (Строка.ВидОперации = Перечисления.ВидыОперацийПоЗарплате.ЕжегодныйОтпускОценочныеОбязательства
			Или Строка.ВидОперации = Перечисления.ВидыОперацийПоЗарплате.ЕжегодныйОтпускРезервы
			Или Строка.ВидОперации = Перечисления.ВидыОперацийПоЗарплате.КомпенсацияЕжегодногоОтпускаОценочныеОбязательства) Тогда
			
			ТекстСообщения = НСтр("ru = 'Для отражения отпуска за счет резервов требуется способ отражения на статьи расходов, а не на производство в строке %1 списка ""Начисления и взносы""'");
	...
	Для Каждого Строка Из НайденныеСтроки Цикл
		...
		Если Строка.ВидОперации = Перечисления.ВидыОперацийПоЗарплате.ЕжегодныйОтпускОценочныеОбязательстваИРезервы
