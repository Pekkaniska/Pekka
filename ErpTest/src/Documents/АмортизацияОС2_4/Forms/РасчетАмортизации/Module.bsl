...
Процедура ПослеРасчетаАмортизации()
	...
	Оповестить("Запись_АмортизацияОС");
	ОповеститьОбИзменении(Тип("ДокументСсылка.АмортизацияОС2_4"));
	ОповеститьОбИзменении(Тип("ДокументСсылка.АмортизацияОС"));
