...
Процедура ТекстЗапросаТаблицаПорядокУчетаНМА(ТекстыЗапроса, Регистры)
	...
	ТекстЗапросаВтСписокНМА(ТекстыЗапроса);
	...
	|			) КАК ПорядокУчетаНМА
	|		ПО
	|			ПорядокУчетаНМА.НематериальныйАктив = ТаблицаНМА.НематериальныйАктив
	|ГДЕ
...
Процедура ТекстЗапросаТаблицаПараметрыАмортизацииНМАУУ(ТекстыЗапроса, Регистры)
	...
	|				И НематериальныйАктив В
	|						(ВЫБРАТЬ СписокНМА.НематериальныйАктив ИЗ ВтСписокНМА КАК СписокНМА)
	|				) КАК ПараметрыАмортизацииНМАУУ
	|		ПО
	|			ПараметрыАмортизацииНМАУУ.НематериальныйАктив = ТаблицаНМА.НематериальныйАктив
	|ГДЕ
	|	ТаблицаНМА.Ссылка = &Ссылка
	|	И &ОтражатьВУпрУчете
...
Процедура ТекстЗапросаВтСписокНМА(ТекстыЗапроса)
...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	ВнеоборотныеАктивыСлужебный.ТекстЗапросаПеремещениеСтоимостиНМА(СписокЗапросов);
	ВнеоборотныеАктивыСлужебный.ТекстЗапросаПеремещениеАмортизацииНМА(СписокЗапросов);
