...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Для Каждого УдаляемыйСотрудник Из УдаляемыеСотрудники Цикл
		...
		Для Каждого НайденнаяСтрока Из НайденныеСтроки Цикл
			ТекущийОбъект.ЗаписиСведенияОВычетах.Удалить(НайденнаяСтрока);
		КонецЦикла;
	КонецЦикла;
...
Процедура ЗагрузитьДанныеСправкиИзХранилища(АдресДанныхСправкиВХранилище)
	...
	СоответствиеПутиКДаннымТаблиц.Вставить("ЗаписиСведенияОДоходах", "ЗаписиСведенияОДоходах");
	СоответствиеПутиКДаннымТаблиц.Вставить("ЗаписиСведенияОВычетах", "ЗаписиСведенияОВычетах");
