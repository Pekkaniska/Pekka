...
Функция ЗаполнитьНомераГТДПоОстаткамТоваровВПутиНаСервере()
	...
	|	ТоварыУПартнеровОстатки.НомерГТД.СтранаПроисхождения КАК СтранаПроисхождения,
	...
	НакладныеСервер.РаспределитьКоличествоИЗаполнить(ТаблицаТоварыУПартнеров, ТаблицаТовары, "КоличествоПоДаннымПартнера", Ключ, Условие, Ложь, "НомерГТД, СтранаПроисхождения");
