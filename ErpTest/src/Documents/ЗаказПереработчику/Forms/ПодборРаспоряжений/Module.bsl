...
Процедура ЗаполнитьГрафикПроизводства()
	...
	Иначе
		...
		|	ЕСТЬNULL(НоменклатураВПроизводстве.Запланировано, 0)
		|		+ ЕСТЬNULL(НоменклатураВПроизводстве.ПереданоКПроизводству, 0)
		|		+ ЕСТЬNULL(НоменклатураВПроизводстве.Производится, 0)
		|		+ ЕСТЬNULL(НоменклатураВПроизводстве.Произведено, 0) КАК Количество,
		|	ВЫБОР
