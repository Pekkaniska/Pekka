...
Процедура ЗаполнитьДоговорКонтрагента() 
	...
	ДоговорИзНастройки = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(НастройкаЭДО, "ДоговорКонтрагента");
	
	Если ДоговорКонтрагента <> ДоговорИзНастройки Тогда
		ДоговорКонтрагента = ДоговорИзНастройки;
	КонецЕсли;
