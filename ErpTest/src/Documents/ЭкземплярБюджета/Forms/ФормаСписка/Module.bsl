...
Процедура УстановитьСтатусНаУтверждении(Команда)
	...
	УстановитьСтатус("НаУтверждении", НСтр("ru = 'На утвреждении'"));
...
Процедура УстановитьПараметрыВидимостиКолонокАналитика()
	...
	Для Сч = 1 По 6 Цикл
		...
		Элементы["ОбязательнаяАналитика" + Сч].Видимость = ЗначениеЗаполнено(Аналитика);
		Если Элементы["ОбязательнаяАналитика" + Сч].Видимость Тогда
			Элементы["ОбязательнаяАналитика" + Сч].Заголовок = ЗначенияРеквизитов[Аналитика].Наименование;
		КонецЕсли;
	КонецЦикла;
