...
Функция СоздатьЗадания(МассивДанныхЗаполнения) Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Сменные задания'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Процедура ДобавитьИсполнителей(Ссылка, Исполнители) Экспорт
	...
	Исключение
		...
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Не удалось добавить исполнителей в документ %1'"), Ссылка);
...
Процедура УдалитьИсполнителя(Ссылка, Исполнитель) Экспорт
	...
	Исключение
		...
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Не удалось удалить исполнителя из документа %1'"), Ссылка);
...
Процедура УстановитьСтатусВнутриЗамераВремени(Ссылка, Статус)
	...
	Исключение
		...
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Не удалось установить статус %1 документу %2'"), Статус, Ссылка);
