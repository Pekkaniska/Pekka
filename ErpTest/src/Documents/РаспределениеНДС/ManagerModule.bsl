...
#КонецОбласти
	...
	ВнеоборотныеАктивыСлужебный.ТекстЗапросаНачислениеАмортизацииОС(ТекстыОтражения);
...
Функция ДанныеДляРаспределения(Реквизиты, ДополнительныеСвойства)
	...
	Если ВнеоборотныеАктивы.ИспользуетсяУправлениеВНА_2_4(Реквизиты.Период) Тогда
		ВнеоборотныеАктивы.СформироватьТаблицуПринятыхКУчетуВнеоборотныхАктивовДляРаспределенияНДС_2_4(
	...
	ИначеЕсли ПолучитьФункциональнуюОпцию("ИспользоватьВнеоборотныеАктивы2_2") Тогда
		ВнеоборотныеАктивы.СформироватьТаблицуПринятыхКУчетуВнеоборотныхАктивовДляРаспределенияНДС_2_2(
...
Функция СформироватьДвижения(Реквизиты, ДополнительныеСвойства)
	...
	ВнеоборотныеАктивы.ВключитьВСтоимостьВнеоборотныхАктивовРезультатРаспределенияНДС(
