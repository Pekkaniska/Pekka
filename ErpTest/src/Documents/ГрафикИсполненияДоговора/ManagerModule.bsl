...
// Перезаполняет дату документа и дату регистратора в регистрах РасчетыСКлиентами и РасчетыСПоставщиками.
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ПолноеИмяОбъекта = "Документ.ГрафикИсполненияДоговора";
	...
	|		ПО Этапы.Ссылка = КОбработке.Ссылка
	|СГРУППИРОВАТЬ ПО
	|	КОбработке.Ссылка,
	|	КОбработке.Ссылка.ВерсияДанных,
	|	КОбработке.Ссылка.Дата");
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			Если ДокументОбъект.Дата > Выборка.ДатаПоГрафику Тогда
				
				ДокументОбъект.Дата = Выборка.ДатаПоГрафику;
