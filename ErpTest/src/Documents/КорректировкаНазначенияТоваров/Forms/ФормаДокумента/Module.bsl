...
Процедура ПриЧтенииСозданииНаСервере()
	...
	ЗапретСнятияРезерва = ТипЗнч(Реквизиты.Заказ) = Тип("ДокументСсылка.ЗаказДавальца")
		И Не ЗначениеЗаполнено(Реквизиты.Партнер);
	//-- НЕ УТКА
...
//++ НЕ УТ
	ИспользуютсяОпцииДляОтображенияНазначения = ИспользуютсяОпцииДляОтображенияНазначения
