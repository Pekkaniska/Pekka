...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|	Документ.ОперацияПоЯндексКассе КАК ОперацияПоЯндексКассе
	|ГДЕ
	|	ОперацияПоЯндексКассе.УдалитьНастройкаЯндексКассы <> ЗНАЧЕНИЕ(Справочник.УдалитьНастройкиЯндексКассы.ПустаяСсылка)
	|	И ОперацияПоЯндексКассе.НастройкаЯндексКассы = ЗНАЧЕНИЕ(Справочник.НастройкиЯндексКассы.ПустаяСсылка)";	
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ПолноеИмяОбъекта = "Документ.ОперацияПоЯндексКассе";
	
	ДополнительныеПараметры = ОбновлениеИнформационнойБазы.ДополнительныеПараметрыВыборкиДанныхДляОбработки();
	
	ДополнительныеПараметры.ДополнительныеИсточникиДанных.Вставить("УдалитьНастройкаЯндексКассы");
	...
	|	ОбъектыДляОбработки.Ссылка.УдалитьНастройкаЯндексКассы.НастройкаБЭД КАК НастройкаБЭД
	|ИЗ
	|	ВТОбъектыДляОбработки КАК ОбъектыДляОбработки
	|ГДЕ
	|	ОбъектыДляОбработки.Ссылка.УдалитьНастройкаЯндексКассы <> ЗНАЧЕНИЕ(Справочник.УдалитьНастройкиЯндексКассы.ПустаяСсылка)
	|	И ОбъектыДляОбработки.Ссылка.НастройкаЯндексКассы = ЗНАЧЕНИЕ(Справочник.НастройкиЯндексКассы.ПустаяСсылка)";	
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			ДокументОбъект.НастройкаЯндексКассы = Выборка.НастройкаБЭД;
