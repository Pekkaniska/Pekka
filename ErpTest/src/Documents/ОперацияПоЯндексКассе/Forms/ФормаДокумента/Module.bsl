...
Процедура ОрганизацияПриИзмененииСервер()
	...
	СписокРеквизитов = "БанковскийСчет, СтатьяРасходов, АналитикаРасходов, Подразделение, Эквайер";	
	
	ЗаполнитьЗначенияСвойств(Объект, ЗначенияРеквизитов, СписокРеквизитов);
