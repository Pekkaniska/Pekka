...
Процедура ПриЧтенииСозданииНаСервере()
	...
	Элементы.ОССуммаСписанияУУ.Заголовок  = СтрШаблон(НСтр("ru = 'Сумма упр. (%1)'"), ВалютаУпр);
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, Знач ИзмененныеРеквизиты = "")
	...
	ПараметрыРеквизитовОбъекта = ВнеоборотныеАктивыКлиентСервер.ЗначенияСвойствЗависимыхРеквизитов_СписаниеОС(Объект, ИзмененныеРеквизиты);
	...
	Если СтруктураИзмененныхРеквизитов.Свойство("ЧастичнаяЛиквидация")
		...
		Элементы.ОСГруппаЧастичнойЛиквидации.Видимость = Объект.ОтражатьВРеглУчете И Объект.ЧастичнаяЛиквидация;
	КонецЕсли;
...
Процедура ЗаполнитьПоДаннымОснованияНаСервере()
	...
	Документы.СписаниеОС2_4.ЗаполнитьНаОснованииИнвентаризацииОС(Объект, Истина);
