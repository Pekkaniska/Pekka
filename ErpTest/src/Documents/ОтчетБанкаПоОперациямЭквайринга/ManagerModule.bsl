...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	ИнформацияПлатежа = СтрШаблон(НСтр("ru = 'Начислена комиссия банком ""%1""'"), Реквизиты.Эквайер);
	Запрос.УстановитьПараметр("Содержание", УчетУСНСервер.СодержаниеДохода(Перечисления.ХозяйственныеОперации.КомиссияПоЭквайрингу, ИнформацияПлатежа));
	//-- НЕ УТ
