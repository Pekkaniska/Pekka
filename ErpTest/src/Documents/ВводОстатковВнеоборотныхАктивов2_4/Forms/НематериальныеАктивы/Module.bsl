...
Процедура Подобрать(Команда)
	...
	ПараметрыПодбораНМА = ВнеоборотныеАктивыКлиент.ПараметрыПодбора(Элементы.НМАНематериальныйАктив, ЭтаФорма);
...
Процедура ИзменитьСтрокуНМА(НоваяСтрока = Ложь, Копирование = Ложь)
	...
	ПараметрыФормы.Вставить("Подразделение", Объект.Местонахождение);
