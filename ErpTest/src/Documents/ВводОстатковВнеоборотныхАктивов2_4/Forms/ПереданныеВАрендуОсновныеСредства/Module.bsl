...
Процедура НастроитьЗависимыеЭлементыФормы(Знач ИзмененныеРеквизитыИлиЭлемент = "")
	...
	Если СтруктураИзмененныхРеквизитов.Свойство("ОтражатьВРеглУчете") 
		...
		Для каждого ДанныеСтроки Из Объект.ОС Цикл
			...
			ИзмененныеРеквизитыКопия = ИзмененныеРеквизиты;
			
			СтруктураИзмененныхРеквизитов = Новый Структура(ИзмененныеРеквизитыКопия);
			
			ПараметрыРеквизитовОбъекта = ВнеоборотныеАктивыКлиентСервер.ЗначенияСвойствЗависимыхРеквизитов_ВводОстатков(
											ДанныеСтроки, ВспомогательныеРеквизиты, ИзмененныеРеквизитыКопия);
...
Процедура УстановитьВидимостьПереходаНа2_4(Форма, ДатаДокумента)
	...
	Форма.Элементы.КартинкаДокументПереходаНа2_4.Видимость = Форма.ДатаНачалаУчетаВнеоборотныхАктивов2_4 > ДатаДокумента;
	Форма.Элементы.ДекорацияДокументПереходаНа2_4.Видимость = Форма.ДатаНачалаУчетаВнеоборотныхАктивов2_4 > ДатаДокумента;
