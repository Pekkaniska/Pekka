...
Процедура ВариантОтраженияВУчетеПриИзменении(Элемент)
	...
	Если ИзмененныеРеквизиты.Количество() <> 0 Тогда
		НастроитьЗависимыеЭлементыФормы(ЭтаФорма, СтрСоединить(ИзмененныеРеквизиты, ","));
	КонецЕсли; 
...
Функция ЗначенияСвойствЗависимыхРеквизитов_ВводОстатков2_4(Объект, ВспомогательныеРеквизиты, ИзмененныеРеквизиты)
	...
	Если СтруктураИзмененныхРеквизитов.Свойство("ОтражатьВРеглУчете")
		ИЛИ СтруктураИзмененныхРеквизитов.Свойство("ПрименяетсяПБУ18")
		ИЛИ ОбновитьВсе Тогда
...
Процедура ОрганизацияПриИзмененииНаСервере()
	...
	ЗаполнитьПрименяетсяПБУ18();
	НастроитьЗависимыеЭлементыФормы(ЭтаФорма, "ПрименяетсяПБУ18");
...
&НаСервере
Процедура ЗаполнитьПрименяетсяПБУ18()
