...
Процедура ОткрытьФормуСканированияАлкогольнойПродукции()
	...
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(
		Истина,
		"Документ.ЧекЕГАИСВозврат.Форма.ФормаДокумента.ОткрытьФормуСканированияАлкогольнойПродукции");
...
Процедура ОбработатьДанныеТСДНаСервере(ДанныеПартионнойПродукции, КэшированныеЗначения)
	...
	Для Каждого МаркируемаяАлкогольнаяПродукция Из ЗагрузкаДанныхТСД.МаркируемаяАлкогольнаяПродукция Цикл
		...
		РезультатОбработкиШтрихкода = Документы.ЧекЕГАИСВозврат.ОбработатьШтрихкодАкцизнойМарки(ЭтотОбъект, 
	...
	Если ЗагрузкаДанныхТСД.Упаковки.Количество() > 0 Тогда
		...
		РезультатОбработкиШтрихкода = Документы.ЧекЕГАИСВозврат.ОбработатьШтрихкодУпаковки(ЭтотОбъект,
		                                                                                     ДанныеШтрихкода, 
		                                                                                     ВложенныеШтрихкоды, 
		                                                                                     ПараметрыСканированияАкцизныхМарок);
