...
Функция РеквизитыДляПроведенияПустаяСтруктура()
	...
	РеквизитыДляПроведенияПустаяСтруктура = Новый Структура("Ссылка, Организация, ПериодРегистрации, ПерерасчетВыполнен, Дата, ОтсутствиеВТечениеЧастиСмены, Сотрудник, ИсправленныйДокумент,
		| ОсвобождатьСтавку, СостояниеСотрудника, ДатаНачала, ДатаОкончания, ДатаОтсутствия, ВидОтсутствия, ВидВремениЗамещаемый, ЧасовОтсутствия,
		| РаспределениеПоТерриториямУсловиямТруда, Смена, ПереходящаяЧастьПредыдущейСмены, ПереходящаяЧастьТекущейСмены, РаспределениеРезультатовНачислений");	
