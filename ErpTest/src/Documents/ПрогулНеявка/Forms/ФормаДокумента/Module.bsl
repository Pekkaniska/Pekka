...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		Если Параметры.Свойство("ДанныеЗаполнения")
			Или Параметры.Свойство("ЗначенияЗаполнения")
...
Процедура ОтсутствиеВТечениеЧастиСменыПриИзмененииНаСервере()
	...
	Если Объект.ОтсутствиеВТечениеЧастиСмены
		И Объект.СостояниеСотрудника = ПредопределенноеЗначение("Перечисление.СостоянияСотрудника.Болезнь") Тогда
...
Процедура НастроитьПричиныОтсутствия()
	Элементы.СостояниеБолезнь.Доступность = Не Объект.ОтсутствиеВТечениеЧастиСмены;
КонецПроцедуры
...
&НаСервере
Процедура ЗаполнитьВидОтсутствия(ПервичнаяИнициализацияФормы)
	УстановитьПривилегированныйРежим(Истина);
