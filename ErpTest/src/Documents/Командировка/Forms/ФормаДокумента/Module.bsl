...
Процедура УдержатьНалогПриВыплатеЗарплатыРеквизитыВДанные(ТекущийОбъект) 
	...
	ТекущийОбъект.УдержатьНалогПриВыплатеЗарплаты = ?(ПеречислитьНалог = 1
		И ТекущийОбъект.ПорядокВыплаты = Перечисления.ХарактерВыплатыЗарплаты.Аванс, Истина, Ложь);
...
Процедура УстановитьЗначениеПеречислитьНалогПриИзмененииПорядкаВыплаты() 
	...
	Если Объект.ПорядокВыплаты <> Перечисления.ХарактерВыплатыЗарплаты.Аванс Тогда 
		ПеречислитьНалог = 0;
	КонецЕсли;
...
Процедура УстановитьВидимостьСвойстваПеречислитьНалог() 
	...
	ВидимостьЭлемента = Объект.ПорядокВыплаты = Перечисления.ХарактерВыплатыЗарплаты.Аванс;
