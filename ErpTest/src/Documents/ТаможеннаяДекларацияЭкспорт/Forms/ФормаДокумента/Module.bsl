...
&НаСервере
Процедура ЗаполнитьПараметрыТаможенойДекларацииЭкспортПоОснованию(ВыбранныйДокумент = Неопределено)
	
	Если Объект.ДокументыОснования.Количество() > 0 Тогда
	
		ДокументОбъект = РеквизитФормыВЗначение("Объект");
		ДокументОбъект.ЗаполнитьПараметрыТаможеннойДекларацииЭкспортПоОснованию(ВыбранныйДокумент);
...
Процедура ОбработкаИзмененияСпискаДокументовОснований(ИзмененныйСписокОснований)
	...
	ЗаполнитьПараметрыТаможенойДекларацииЭкспортПоОснованию(Объект.ДокументОснование);
