...
//
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСоздатьНаОсновании, Настройки) Экспорт
	
	СозданиеНаОснованииПереопределяемый.ДобавитьКомандуСоздатьНаОснованииБизнесПроцессЗадание(КомандыСоздатьНаОсновании);
	
КонецПроцедуры

Функция ДобавитьКомандуСоздатьНаОсновании(КомандыСоздатьНаОсновании, Настройки) Экспорт
...
// Обработчик обновления УТ 11.2.3
// Вспомогательная процедура для обработчика обновления ЗакрытьОтрицательныеОстаткиПоРасчетамСКлиентамиВКорректировках
//
// Параметры:
//	 Очередь - Число - очередь отоженной обработки данных 
//
...
Процедура ЗаполнитьДоговорВАналитикеПоПартнерамКорректировокРегистров(Параметры) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ТекстСообщения = НСтр("ru = 'Не удалось дополнить аналитику по партнерам договором при обработке документа: %Ссылка% по причине: %Причина%'");
