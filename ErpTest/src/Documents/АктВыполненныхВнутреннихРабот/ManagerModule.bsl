...
Процедура ИнициализироватьКлючиАналитикиНоменклатуры(Запрос)
	...
	|		Документ.АктВыполненныхВнутреннихРабот.Товары КАК Работы
	|	ГДЕ
	|		Работы.Ссылка = &Ссылка) КАК ТаблицаТовары
...
Функция ТекстЗапросаВтТовары(Запрос, ТекстыЗапроса)
	...
	|	Документ.АктВыполненныхВнутреннихРабот.Товары КАК Работы
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.КлючиАналитикиУчетаНоменклатуры КАК КлючиНоменклатуры
	|			ПО Работы.АналитикаУчетаНоменклатуры = КлючиНоменклатуры.Ссылка
	|
	...
	|			И КлючиНоменклатурыБезНазначения.Склад				= &Подразделение
	...
	|			И КлючиПоПолучателю.Склад				= Работы.Подразделение
	...
	|			И КлючиПоПолучателюБезНазначения.Склад				= Работы.Подразделение
