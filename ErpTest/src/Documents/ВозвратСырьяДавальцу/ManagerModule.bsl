...
Функция ТекстЗапросаТаблицаСуммыДокументовВВалютеРегл(Запрос, ТекстыЗапроса, Регистры)
	...
	|	ТаблицаТовары.Сумма * &КоэффициентПересчетаВВалютуУпр КАК СуммаБезНДСУпр,
	|	0									                  КАК СуммаНДСУпр
	|
	|ИЗ
	|	ВтТаблицаВидыЗапасов КАК ТаблицаТовары
...
Функция ПолучитьРезультатЗапросаПоОстаткамЗаказов(ПараметрыЗаполнения)
	...
	|			И (АналитикаУчетаНоменклатуры.Склад = &СкладОтгрузки)
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	Аналитика,
	|	ВидЗапасов
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	РСАналитика.Номенклатура.ТипНоменклатуры КАК ТипНоменклатуры,
	|	ВЫБОР
	|		КОГДА РСАналитика.Номенклатура.ТипНоменклатуры = ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.МногооборотнаяТара)
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ КАК ЭтоТара,
	...
	|	РСАналитика.Назначение КАК Назначение,
	|	РСАналитика.Номенклатура КАК Номенклатура,
	|	РСАналитика.Характеристика КАК Характеристика,
	|	РСАналитика.Склад КАК Склад,
	|	РСАналитика.Серия КАК Серия,
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.АналитикаУчетаНоменклатуры КАК РСАналитика
	|		ПО РСАналитика.КлючАналитики = ТаблицаОстатки.Аналитика
	|
	|УПОРЯДОЧИТЬ ПО
	|	Номенклатура,
	|	Характеристика";
