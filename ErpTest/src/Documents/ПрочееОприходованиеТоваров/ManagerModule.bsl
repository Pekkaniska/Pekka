...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	Запрос.УстановитьПараметр("Содержание", УчетУСНСервер.СодержаниеДохода(Реквизиты.ХозяйственнаяОперация));
	//-- НЕ УТ
...
Функция ТекстЗапросаВТВидыЗапасов(Запрос, ТекстыЗапроса)
	...
	|	ВЫРАЗИТЬ(Аналитика.Склад КАК Справочник.Склады).ЦеховаяКладовая КАК ЦеховаяКладовая,
...
// Регистрирует данные для обработчика обновления УТ 11.4.3:
// - заполняется новый реквизит "Валюта".
// - заполнение реквизита "Вариант приемки".
// - перенос значения реквизита "Статья доходов" в реквизит "Статья расходов".
//
