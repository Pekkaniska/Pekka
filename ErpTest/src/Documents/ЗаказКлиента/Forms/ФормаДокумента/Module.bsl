...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если ПараметрыЗаписи.РежимЗаписи = РежимЗаписиДокумента.Проведение Тогда
		ОценкаПроизводительностиКлиентСервер.НачатьЗамерВремени(
			"Документ.ЗаказКлиента.ФормаДокумента.Проведение");
	Иначе
		ОценкаПроизводительностиКлиентСервер.НачатьЗамерВремени(
			"Документ.ЗаказКлиента.ФормаДокумента.Запись");
	КонецЕсли;
	// }Рарус ognale 2017.01 techlab@rarus.ru
...
Процедура ДоговорПриИзменении(Элемент)
	...
	//+++rarus-spb_zlov 04.10.2016
	пкМодификацияКлиент.ЗаказКлиентаДоговорПриИзменении(ЭтаФорма);
	//---rarus-spb_zlov 04.10.2016
