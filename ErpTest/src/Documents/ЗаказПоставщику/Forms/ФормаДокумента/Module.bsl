...
//Рарус Владимир Подрезов Закупки 2.4.1 11.08.2016
		ИЛИ Объект.Статус = ПредопределенноеЗначение("Перечисление.СтатусыЗаказовПоставщикам.пкВПути") 
//Рарус Владимир Подрезов Конец
		ИЛИ Объект.Статус = ПредопределенноеЗначение("Перечисление.СтатусыЗаказовПоставщикам.УдалитьКПоступлению") 
...
//Рарус Владимир Подрезов Закупки 2.4.1 11.08.2016
		И Объект.Статус <> ПредопределенноеЗначение("Перечисление.СтатусыЗаказовПоставщикам.пкВПути")
//Рарус Владимир Подрезов Конец
		И Объект.Статус <> ПредопределенноеЗначение("Перечисление.СтатусыЗаказовПоставщикам.УдалитьКПоступлению")
...
//Рарус Владимир Подрезов Закупки 2.4.1 11.08.2016
			Объект.Статус = ПредопределенноеЗначение("Перечисление.СтатусыЗаказовПоставщикам.пкВПути") Или
//Рарус Владимир Подрезов Конец
			Объект.Статус = ПредопределенноеЗначение("Перечисление.СтатусыЗаказовПоставщикам.УдалитьКПоступлению") Или
...
//Рарус Владимир Подрезов Закупки 2.4.1 11.08.2016
	СписокЗначений.Добавить(Перечисления.СтатусыЗаказовПоставщикам.пкВПути);
//Рарус Владимир Подрезов Конец
...
Процедура РассчитатьИтоговыеПоказателиЗаказа(Форма)
	...
	ЗакупкаОблагаетсяНДС = УчетНДСУПКлиентСервер.ЗакупкаОблагаетсяНДС(Форма.Объект.НалогообложениеНДС);
...
//Рарус Владимир Подрезов Закупки 2.4.1 11.08.2016
			Объект.Статус = Перечисления.СтатусыЗаказовПоставщикам.пкВПути Или
//Рарус Владимир Подрезов Конец
			Объект.Статус = Перечисления.СтатусыЗаказовПоставщикам.УдалитьКПоступлению Или
