...
Функция ПечатьСправкиОРаспределенииЗаработка(МассивОбъектов, ОбъектыПечати)
	...
	ПодбираетсяАтоматически = Нстр("ru = '<подбирается автоматически>'");
	...
	Запрос.УстановитьПараметр("ЕстьЕНВД", ПолучитьФункциональнуюОпцию("ИспользоватьСтатьиФинансированияЗарплатаРасширенный"));
	Запрос.УстановитьПараметр("ПодбираетсяАтоматически", ПодбираетсяАтоматически);
	Запрос.Текст = 
	"ВЫБРАТЬ
	...
	|			ТОГДА СтрокиРаспределения.СтатьяФинансирования
	|		ИНАЧЕ """"
	|	КОНЕЦ КАК СтатьяФинансирования,
	|	СтрокиРаспределения.СпособОтраженияЗарплатыВБухучете КАК СпособОтражения,
