...
Процедура ПриЧтенииСозданииНаСервере()
	...
	Элементы.НМАСуммаСписанияУУ.Заголовок = СтрШаблон(НСтр("ru = 'Сумма упр. (%1)'"), ВалютаУпр);
	ВалютаРегл = Строка(Константы.ВалютаРегламентированногоУчета.Получить());
	Элементы.ГруппаРеглУчет.Заголовок = СтрШаблон(НСтр("ru = 'Регламентированный учет (%1)'"), ВалютаРегл);
...
Процедура ЗаполнитьПоДаннымОснованияНаСервере()
	...
	Документы.СписаниеНМА2_4.ЗаполнитьНаОснованииИнвентаризации(Объект, Истина);
