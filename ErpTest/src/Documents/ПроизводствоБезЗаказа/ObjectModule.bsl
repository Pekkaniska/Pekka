...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если РежимЗаписи = РежимЗаписиДокумента.Проведение Тогда
		...
		ДополнительныеСвойства.Вставить("ТаблицаРеквизитовВидовЗапасовПоУмолчанию", ТаблицаРеквизитовВидовЗапасовПоУмолчаниюДляПроведения());
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	ПараметрыЗаполнения.ТаблицаРеквизитовВидовЗапасовПоУмолчанию = ДополнительныеСвойства.ТаблицаРеквизитовВидовЗапасовПоУмолчанию;
...
Функция ТаблицаРеквизитовВидовЗапасовПоУмолчаниюДляПроведения()
	...
	Запрос.Текст =
		...
		|	ПО КлючиАналитики.КлючАналитики = ТаблицаТоваров.АналитикаУчетаНоменклатуры
		|
		|	ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Назначения КАК СпрНазначения
		|	ПО КлючиАналитики.Назначение = СпрНазначения.Ссылка
		|
		|	ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ДоговорыКонтрагентов КАК СпрДоговора
		|	ПО СпрНазначения.Договор = СпрДоговора.Ссылка
		|
		...
		|	СпрДоговора.Контрагент,
		|	СпрНазначения.Партнер,
		|	СпрНазначения.ТипНазначения,
		|	СпрНазначения.Договор
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
