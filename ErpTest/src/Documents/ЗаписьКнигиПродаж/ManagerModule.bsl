...
Функция ДобавитьКомандуСоздатьНаОснованииИсправлениеПрочегоНачисленияНДС(КомандыСозданияНаОсновании) Экспорт
	Если ПравоДоступа("Добавление", Метаданные.Документы.СчетФактураВыданный) Тогда
		...
		КомандаСоздатьНаОсновании.Обработчик = "УчетНДСУПСлужебныйКлиент.ИсправлениеПрочегоНачисленияНДС";
...
#Область НачислениеИВосстановлениеНДС
	...
	|	ВЫБОР 
	|		КОГДА Строки.Субконто2 = НЕОПРЕДЕЛЕНО ИЛИ Строки.Субконто2 = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.ПустаяСсылка)
