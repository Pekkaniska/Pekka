...
Процедура ЗаполнитьТаблицуТоваров()
	...
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ
	|	ВложенныйЗапрос.Организация                                 КАК Организация,
	|	РегАналитика.Склад                                          КАК Переработчик,
	...
	|	РегАналитика.Назначение                                     КАК Назначение,
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.АналитикаУчетаНоменклатуры КАК РегАналитика
	...
	|			ИЛИ РегАналитика.Склад = &Переработчик)
