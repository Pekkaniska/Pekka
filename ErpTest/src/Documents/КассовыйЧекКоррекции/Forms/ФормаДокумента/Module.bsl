...
Процедура ОснованиеДляКоррекцииПриИзменении(Элемент)
	...
	Если НЕ ОснованиеДляКоррекцииЗаданоСтрокой И ЗначениеЗаполнено(Объект.ОснованиеДляКоррекции) Тогда
...
Функция ПолучитьПараметрыЧека();
	...
	Если ОснованиеДляКоррекцииЗаданоСтрокой Тогда
	...
	ИначеЕсли ЗначениеЗаполнено(Объект.ОснованиеДляКоррекции) И Документы.ТипВсеСсылки().СодержитТип(ТипЗнч(Объект.ОснованиеДляКоррекции)) Тогда
		...
		ПараметрыЧека.ДатаДокументаОснования  = НачалоДня(Объект.ОснованиеДляКоррекции.Дата);
	КонецЕсли;
...
Процедура УстановитьДоступностьЭлементовИФормы()
	...
	ОснованиеДляКоррекцииЗаданоСтрокой = ТипЗнч(Объект.ОснованиеДляКоррекции) = Тип("Строка");
	...
	Элементы.ГруппаНомерДатаОснования.Видимость = ОснованиеДляКоррекцииЗаданоСтрокой;
