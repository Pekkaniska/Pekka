...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	Иначе
		ЗаписьДопЛиста = ТипЗнч(Реквизиты.ДатаОснования) = Тип("Дата")
						 И НачалоКвартала(Реквизиты.ДатаОснования) < НачалоКвартала(Реквизиты.Период) 
						 И Реквизиты.ДатаОснования < '20130701';
	КонецЕсли;
