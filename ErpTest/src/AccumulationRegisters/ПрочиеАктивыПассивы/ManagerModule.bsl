...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ДляОбновленияУпрБаланса.Вставить(Тип("ДокументСсылка.ДвижениеПродукцииИМатериалов"), Истина);
	ДляОбновленияУпрБаланса.Вставить(Тип("ДокументСсылка.ПроизводствоБезЗаказа"), Истина);
	ДляОбновленияУпрБаланса.Вставить(Тип("ДокументСсылка.ПоступлениеПредметовЛизинга"), Истина);
	ДляОбновленияУпрБаланса.Вставить(Тип("ДокументСсылка.ПриобретениеУслугПоЛизингу"), Истина);
	// ++ НЕ УТКА
	ДляОбновленияУпрБаланса.Вставить(Тип("ДокументСсылка.ЭтапПроизводства2_2"), Истина);
	// -- НЕ УТКА
	УдалитьДвиженияЛизинга = Новый Соответствие;
	УдалитьДвиженияЛизинга.Вставить(Тип("ДокументСсылка.РасходныйКассовыйОрдер"), Истина);
	УдалитьДвиженияЛизинга.Вставить(Тип("ДокументСсылка.СписаниеБезналичныхДенежныхСредств"), Истина);
	УдалитьДвиженияЛизинга.Вставить(Тип("ДокументСсылка.ПоступлениеПредметовЛизинга"), Истина);
	УдалитьДвиженияЛизинга.Вставить(Тип("ДокументСсылка.ПриобретениеУслугПоЛизингу"), Истина);
	Лизинг = ПланыВидовХарактеристик.СтатьиАктивовПассивов.Лизинг;
	//-- НЕ УТ
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			//++ НЕ УТ
			Если УдалитьДвиженияЛизинга[ТипДокументСсылка] <> Неопределено Тогда
				НаборЗаписей.Прочитать();
				Индекс = 0;
				Пока Индекс < НаборЗаписей.Количество() Цикл
					Запись = НаборЗаписей[Индекс];
					Если Запись.Статья = Лизинг И НЕ ЗначениеЗаполнено(Запись.ВидИсточника) Тогда
