...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	Если Не ПолучитьФункциональнуюОпцию("НоваяАрхитектураВзаиморасчетов") Тогда
		...
		//++ НЕ УТ
		ВнеоборотныеАктивы.ДополнитьТекстыЗапросовПриЗаписиРегистраРасчетыСПоставщикамиПоДокументам(Запрос, МассивТекстовЗапроса);
		//-- НЕ УТ
	...
	Если Не ПолучитьФункциональнуюОпцию("НоваяАрхитектураВзаиморасчетов") Тогда
		...
		//++ НЕ УТ
		ВнеоборотныеАктивы.СформироватьЗаданияПриЗаписиРегистраРасчетыСПоставщикамиПоДокументам(
			РезультатЗапроса, 3, СтруктураВременныеТаблицы);
		//-- НЕ УТ
	КонецЕсли;
