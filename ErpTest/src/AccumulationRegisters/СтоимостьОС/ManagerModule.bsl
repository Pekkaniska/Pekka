...
Функция ДокументыКОтражениюВМеждународномУчете() Экспорт
	...
	ДокументыКОтражению.Добавить("ВыбытиеАрендованныхОС");
	ДокументыКОтражению.Добавить("ИзменениеПараметровОС2_4");
	ДокументыКОтражению.Добавить("МодернизацияОС2_4");
	...
	ДокументыКОтражению.Добавить("ПоступлениеАрендованныхОС");
