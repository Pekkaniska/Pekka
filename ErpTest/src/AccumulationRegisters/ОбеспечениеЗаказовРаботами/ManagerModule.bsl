...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	// Формирование движений для документов ПроизводствоБезЗаказа, РаспределениеВозвратныхОтходов.
	ТекстЗапроса = 
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|		ПО Реквизиты.Ссылка = ТабличнаяЧасть.Ссылка
	...
	|		ПО Реквизиты.Ссылка = ОбеспечениеЗаказовРаботами.Регистратор
	|ГДЕ
	|	Реквизиты.Проведен
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	//++ НЕ УТ
	СписокДокументов.Добавить(Метаданные.Документы.ПроизводствоБезЗаказа.ПолноеИмя());
	СписокДокументов.Добавить(Метаданные.Документы.РаспределениеВозвратныхОтходов.ПолноеИмя());
	//-- НЕ УТ
